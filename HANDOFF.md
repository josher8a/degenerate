...
**Fork:** `rc` — 66 commits ahead of `063359e` (force-pushed to `origin/rc`).
...
66 commits on `rc` (batches 1–22). Key milestones:
...
Tests: 549 → 886. LOC: 12,202 → ~13,200. Corpus: 11 → 15 specs. Source files: 28 → 36.
