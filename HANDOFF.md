...
**Fork:** `rc` — 44 commits ahead of `origin/rc`, 65 commits ahead of `063359e`.
...
65 commits on `rc` (batches 1–22). Key milestones:
...
Tests: 549 → 886. LOC: 12,202 → ~13,100. Corpus: 11 → 15 specs. Source files: 28 → 36.
