...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:spec_12_unions/models/error_model.dart';sealed class CreateOrderError {const CreateOrderError();

factory CreateOrderError.fromResponse(ApiResponse response) {     try {
