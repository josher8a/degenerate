...
@override int get hashCode => Object.hash(status, repository);

@override String toString() => 'CodeSecurityConfigurationRepositories(status: $status, repository: $repository)';
