...
// Source: #/components/schemas/WebhookPullRequestReviewRequested (inline: ReviewRequested)
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'review_requested' &&
...
@override String toString() => 'WebhookPullRequestReviewRequestedReviewRequested2(\n  action: $action,\n  enterprise: $enterprise,\n  installation: $installation,\n  number: $number,\n  organization: $organization,\n  pullRequest: $pullRequest,\n  repository: $repository,\n  requestedTeam: $requestedTeam,\n  sender: $sender,\n)';
