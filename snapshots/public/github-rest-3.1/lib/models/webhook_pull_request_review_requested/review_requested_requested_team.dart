...
@immutable final class ReviewRequestedRequestedTeam {const ReviewRequestedRequestedTeam({required this.id, required this.name, this.deleted, this.description, this.htmlUrl, this.membersUrl, this.nodeId, this.parent, this.permission, this.privacy, this.repositoriesUrl, this.slug, this.url, });

factory ReviewRequestedRequestedTeam.fromJson(Map<String, dynamic> json) { return ReviewRequestedRequestedTeam(
...
ReviewRequestedRequestedTeam copyWith({bool Function()? deleted, String? Function()? description, Uri Function()? htmlUrl, int? id, String Function()? membersUrl, String? name, String Function()? nodeId, TeamParent? Function()? parent, String Function()? permission, TeamPrivacy Function()? privacy, Uri Function()? repositoriesUrl, String Function()? slug, Uri Function()? url, }) { return ReviewRequestedRequestedTeam(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ReviewRequestedRequestedTeam &&
...
@override String toString() { return 'ReviewRequestedRequestedTeam(deleted: $deleted, description: $description, htmlUrl: $htmlUrl, id: $id, membersUrl: $membersUrl, name: $name, nodeId: $nodeId, parent: $parent, permission: $permission, privacy: $privacy, repositoriesUrl: $repositoriesUrl, slug: $slug, url: $url)'; } 
 }
