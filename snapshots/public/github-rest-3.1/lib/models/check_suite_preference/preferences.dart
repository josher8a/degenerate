...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/check_suite_preference/preferences_auto_trigger_checks.dart';@immutable final class Preferences {const Preferences({this.autoTriggerChecks});

factory Preferences.fromJson(Map<String, dynamic> json) { return Preferences(
  autoTriggerChecks: (json['auto_trigger_checks'] as List<dynamic>?)?.map((e) => PreferencesAutoTriggerChecks.fromJson(e as Map<String, dynamic>)).toList(),
); }

final List<PreferencesAutoTriggerChecks>? autoTriggerChecks;
...
Preferences copyWith({List<PreferencesAutoTriggerChecks>? Function()? autoTriggerChecks}) { return Preferences(
