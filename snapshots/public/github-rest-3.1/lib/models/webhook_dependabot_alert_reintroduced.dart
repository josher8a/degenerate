...
W when<W>({required W Function() reintroduced, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookDependabotAlertReintroducedAction$reintroduced() => reintroduced(),
      WebhookDependabotAlertReintroducedAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? reintroduced, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookDependabotAlertReintroducedAction$reintroduced() => reintroduced != null ? reintroduced() : orElse(value),
      WebhookDependabotAlertReintroducedAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'reintroduced' &&
