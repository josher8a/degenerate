...
// Source: #/components/schemas/WebhookPullRequestReviewDismissed
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'dismissed' &&
