...
W when<W>({required W Function() publicized, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookRepositoryPublicizedAction$publicized() => publicized(),
      WebhookRepositoryPublicizedAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? publicized, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookRepositoryPublicizedAction$publicized() => publicized != null ? publicized() : orElse(value),
      WebhookRepositoryPublicizedAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'publicized' &&
