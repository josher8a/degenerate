...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'renamed' &&
...
@override int get hashCode => Object.hash(action, changes, enterprise, installation, membership, organization, repository, sender);

@override String toString() => 'WebhookOrganizationRenamed(action: $action, changes: $changes, enterprise: $enterprise, installation: $installation, membership: $membership, organization: $organization, repository: $repository, sender: $sender)';
