...
// Source: #/components/schemas/WebhookPullRequestReviewThreadUnresolved (inline: PullRequest)
...
factory WebhookPullRequestReviewThreadUnresolvedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadUnresolvedPullRequest(
  ...
  assignees: (json['assignees'] as List<dynamic>).map((e) => e == null ? null : IssueAssignees.fromJson(e as Map<String, dynamic>)).toList(),
