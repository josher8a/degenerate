...
// Source: #/components/schemas/WebhookPullRequestReviewThreadUnresolved (inline: PullRequest > Head)
...
@override String toString() => 'WebhookPullRequestReviewThreadUnresolvedPullRequestHead(label: $label, ref: $ref, repo: $repo, sha: $sha, user: $user)';
