...
WebhookPullRequestReviewThreadResolvedPullRequestHead copyWith({String? Function()? label, String? ref, WebhookPullRequestReviewThreadResolvedPullRequestHeadRepo? Function()? repo, String? sha, DiscussionUser? Function()? user, }) { return WebhookPullRequestReviewThreadResolvedPullRequestHead(
...
@override String toString() => 'WebhookPullRequestReviewThreadResolvedPullRequestHead(label: $label, ref: $ref, repo: $repo, sha: $sha, user: $user)';
