...
W when<W>({required W Function() checksRequested, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookMergeGroupChecksRequestedAction$checksRequested() => checksRequested(),
      WebhookMergeGroupChecksRequestedAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? checksRequested, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookMergeGroupChecksRequestedAction$checksRequested() => checksRequested != null ? checksRequested() : orElse(value),
      WebhookMergeGroupChecksRequestedAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
