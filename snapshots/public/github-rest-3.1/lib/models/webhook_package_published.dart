...
// Source: #/components/schemas/WebhookPackagePublished
...
@override int get hashCode => Object.hash(action, enterprise, installation, organization, package, repository, sender);

@override String toString() => 'WebhookPackagePublished(action: $action, enterprise: $enterprise, installation: $installation, organization: $organization, package: $package, repository: $repository, sender: $sender)';
