...
W when<W>({required W Function() branchProtectionRule, required W Function() checkRun, required W Function() checkSuite, required W Function() codeScanningAlert, required W Function() commitComment, required W Function() contentReference, required W Function() create, required W Function() delete, required W Function() deployment, required W Function() deploymentReview, required W Function() deploymentStatus, required W Function() deployKey, required W Function() discussion, required W Function() discussionComment, required W Function() fork, required W Function() gollum, required W Function() issues, required W Function() issueComment, required W Function() label, required W Function() member, required W Function() membership, required W Function() milestone, required W Function() organization, required W Function() orgBlock, required W Function() pageBuild, required W Function() project, required W Function() projectCard, required W Function() projectColumn, required W Function() public, required W Function() pullRequest, required W Function() pullRequestReview, required W Function() pullRequestReviewComment, required W Function() push, required W Function() registryPackage, required W Function() release, required W Function() repository, required W Function() repositoryDispatch, required W Function() secretScanningAlert, required W Function() star, required W Function() status, required W Function() team, required W Function() teamAdd, required W Function() watch, required W Function() workflowDispatch, required W Function() workflowRun, required W Function() reminder, required W Function() pullRequestReviewThread, required W Function(String value) $unknown, }) { return switch (this) {
      ...
      WebhooksIssuePerformedViaGithubAppEvents$deploymentReview() => deploymentReview(),
      WebhooksIssuePerformedViaGithubAppEvents$deploymentStatus() => deploymentStatus(),
      WebhooksIssuePerformedViaGithubAppEvents$deployKey() => deployKey(),
      WebhooksIssuePerformedViaGithubAppEvents$discussion() => discussion(),
      WebhooksIssuePerformedViaGithubAppEvents$discussionComment() => discussionComment(),
      ...
      WebhooksIssuePerformedViaGithubAppEvents$issueComment() => issueComment(),
      ...
      WebhooksIssuePerformedViaGithubAppEvents$orgBlock() => orgBlock(),
      WebhooksIssuePerformedViaGithubAppEvents$pageBuild() => pageBuild(),
      WebhooksIssuePerformedViaGithubAppEvents$project() => project(),
      WebhooksIssuePerformedViaGithubAppEvents$projectCard() => projectCard(),
      WebhooksIssuePerformedViaGithubAppEvents$projectColumn() => projectColumn(),
      WebhooksIssuePerformedViaGithubAppEvents$public() => public(),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequest() => pullRequest(),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequestReview() => pullRequestReview(),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequestReviewComment() => pullRequestReviewComment(),
      WebhooksIssuePerformedViaGithubAppEvents$push() => push(),
      WebhooksIssuePerformedViaGithubAppEvents$registryPackage() => registryPackage(),
      WebhooksIssuePerformedViaGithubAppEvents$release() => release(),
      WebhooksIssuePerformedViaGithubAppEvents$repository() => repository(),
      WebhooksIssuePerformedViaGithubAppEvents$repositoryDispatch() => repositoryDispatch(),
      WebhooksIssuePerformedViaGithubAppEvents$secretScanningAlert() => secretScanningAlert(),
      ...
      WebhooksIssuePerformedViaGithubAppEvents$teamAdd() => teamAdd(),
      WebhooksIssuePerformedViaGithubAppEvents$watch() => watch(),
      WebhooksIssuePerformedViaGithubAppEvents$workflowDispatch() => workflowDispatch(),
      WebhooksIssuePerformedViaGithubAppEvents$workflowRun() => workflowRun(),
      WebhooksIssuePerformedViaGithubAppEvents$reminder() => reminder(),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequestReviewThread() => pullRequestReviewThread(),
      WebhooksIssuePerformedViaGithubAppEvents$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? branchProtectionRule, W Function()? checkRun, W Function()? checkSuite, W Function()? codeScanningAlert, W Function()? commitComment, W Function()? contentReference, W Function()? create, W Function()? delete, W Function()? deployment, W Function()? deploymentReview, W Function()? deploymentStatus, W Function()? deployKey, W Function()? discussion, W Function()? discussionComment, W Function()? fork, W Function()? gollum, W Function()? issues, W Function()? issueComment, W Function()? label, W Function()? member, W Function()? membership, W Function()? milestone, W Function()? organization, W Function()? orgBlock, W Function()? pageBuild, W Function()? project, W Function()? projectCard, W Function()? projectColumn, W Function()? public, W Function()? pullRequest, W Function()? pullRequestReview, W Function()? pullRequestReviewComment, W Function()? push, W Function()? registryPackage, W Function()? release, W Function()? repository, W Function()? repositoryDispatch, W Function()? secretScanningAlert, W Function()? star, W Function()? status, W Function()? team, W Function()? teamAdd, W Function()? watch, W Function()? workflowDispatch, W Function()? workflowRun, W Function()? reminder, W Function()? pullRequestReviewThread, W Function(String value)? $unknown, }) { return switch (this) {
      WebhooksIssuePerformedViaGithubAppEvents$branchProtectionRule() => branchProtectionRule != null ? branchProtectionRule() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$checkRun() => checkRun != null ? checkRun() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$checkSuite() => checkSuite != null ? checkSuite() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$codeScanningAlert() => codeScanningAlert != null ? codeScanningAlert() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$commitComment() => commitComment != null ? commitComment() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$contentReference() => contentReference != null ? contentReference() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$create() => create != null ? create() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$delete() => delete != null ? delete() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$deployment() => deployment != null ? deployment() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$deploymentReview() => deploymentReview != null ? deploymentReview() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$deploymentStatus() => deploymentStatus != null ? deploymentStatus() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$deployKey() => deployKey != null ? deployKey() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$discussion() => discussion != null ? discussion() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$discussionComment() => discussionComment != null ? discussionComment() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$fork() => fork != null ? fork() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$gollum() => gollum != null ? gollum() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$issues() => issues != null ? issues() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$issueComment() => issueComment != null ? issueComment() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$label() => label != null ? label() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$member() => member != null ? member() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$membership() => membership != null ? membership() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$milestone() => milestone != null ? milestone() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$organization() => organization != null ? organization() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$orgBlock() => orgBlock != null ? orgBlock() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$pageBuild() => pageBuild != null ? pageBuild() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$project() => project != null ? project() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$projectCard() => projectCard != null ? projectCard() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$projectColumn() => projectColumn != null ? projectColumn() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$public() => public != null ? public() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequest() => pullRequest != null ? pullRequest() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequestReview() => pullRequestReview != null ? pullRequestReview() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequestReviewComment() => pullRequestReviewComment != null ? pullRequestReviewComment() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$push() => push != null ? push() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$registryPackage() => registryPackage != null ? registryPackage() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$release() => release != null ? release() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$repository() => repository != null ? repository() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$repositoryDispatch() => repositoryDispatch != null ? repositoryDispatch() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$secretScanningAlert() => secretScanningAlert != null ? secretScanningAlert() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$star() => star != null ? star() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$status() => status != null ? status() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$team() => team != null ? team() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$teamAdd() => teamAdd != null ? teamAdd() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$watch() => watch != null ? watch() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$workflowDispatch() => workflowDispatch != null ? workflowDispatch() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$workflowRun() => workflowRun != null ? workflowRun() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$reminder() => reminder != null ? reminder() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$pullRequestReviewThread() => pullRequestReviewThread != null ? pullRequestReviewThread() : orElse(value),
      WebhooksIssuePerformedViaGithubAppEvents$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
