...
factory ReviewRequestRemovedPullRequest.fromJson(Map<String, dynamic> json) { return ReviewRequestRemovedPullRequest(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User10.fromJson(v as Map<String, dynamic>), fromB: (v) => Team10.fromJson(v as Map<String, dynamic>),)).toList(),
  requestedTeams: (json['requested_teams'] as List<dynamic>).map((e) => PullRequestRequestedTeams.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<ReviewRequestRemovedPullRequestRequestedReviewers> requestedReviewers;

final List<PullRequestRequestedTeams> requestedTeams;
...
ReviewRequestRemovedPullRequest copyWith({WebhooksPullRequest5Links? links, ActiveLockReason? Function()? activeLockReason, int? Function()? additions, WebhooksIssue2Assignee? Function()? assignee, List<WebhooksIssue2Assignees?>? assignees, AuthorAssociation? authorAssociation, WebhooksPullRequest5AutoMerge? Function()? autoMerge, WebhooksPullRequest5Base? base, String? Function()? body, int? Function()? changedFiles, DateTime? Function()? closedAt, int? Function()? comments, Uri? commentsUrl, int? Function()? commits, Uri? commitsUrl, DateTime? createdAt, int? Function()? deletions, Uri? diffUrl, bool? draft, WebhooksPullRequest5Head? head, Uri? htmlUrl, int? id, Uri? issueUrl, List<WebhooksIssue2Labels>? labels, bool? locked, bool? Function()? maintainerCanModify, String? Function()? mergeCommitSha, bool? Function()? mergeable, String? Function()? mergeableState, bool? Function()? merged, DateTime? Function()? mergedAt, PullRequestMergedBy? Function()? mergedBy, WebhooksIssue2Milestone? Function()? milestone, String? nodeId, int? number, Uri? patchUrl, bool? Function()? rebaseable, List<ReviewRequestRemovedPullRequestRequestedReviewers>? requestedReviewers, List<PullRequestRequestedTeams>? requestedTeams, String? reviewCommentUrl, int? Function()? reviewComments, Uri? reviewCommentsUrl, IssuesCreateMilestoneRequestState? state, Uri? statusesUrl, String? title, DateTime? updatedAt, Uri? url, DiscussionUser? Function()? user, }) { return ReviewRequestRemovedPullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ReviewRequestRemovedPullRequest &&
          links == other.links &&
