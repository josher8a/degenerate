...
W when<W>({required W Function() reopenedByUser, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookCodeScanningAlertReopenedByUserAction$reopenedByUser() => reopenedByUser(),
      WebhookCodeScanningAlertReopenedByUserAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? reopenedByUser, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookCodeScanningAlertReopenedByUserAction$reopenedByUser() => reopenedByUser != null ? reopenedByUser() : orElse(value),
      WebhookCodeScanningAlertReopenedByUserAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'reopened_by_user' &&
