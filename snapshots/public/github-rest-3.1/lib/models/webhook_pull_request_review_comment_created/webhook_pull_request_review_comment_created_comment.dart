...
WebhookPullRequestReviewCommentCreatedComment copyWith({WebhooksReviewCommentLinks? links, DiscussionAuthorAssociation? authorAssociation, String? body, String? commitId, DateTime? createdAt, String? diffHunk, Uri? htmlUrl, int? id, int Function()? inReplyToId, int? Function()? line, String? nodeId, String? originalCommitId, int? Function()? originalLine, int? originalPosition, int? Function()? originalStartLine, String? path, int? Function()? position, int? Function()? pullRequestReviewId, Uri? pullRequestUrl, DiscussionReactions? reactions, Side? side, int? Function()? startLine, PullRequestReviewCommentStartSide? Function()? startSide, SubjectType Function()? subjectType, DateTime? updatedAt, Uri? url, DiscussionUser? Function()? user, }) { return WebhookPullRequestReviewCommentCreatedComment(
