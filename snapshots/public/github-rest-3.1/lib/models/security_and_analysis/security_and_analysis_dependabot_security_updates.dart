...
// Source: #/components/schemas/SecurityAndAnalysis (inline: DependabotSecurityUpdates)
...
@override String toString() => 'SecurityAndAnalysisDependabotSecurityUpdates(status: $status)';
