...
// Source: #/components/schemas/SecurityAndAnalysis (inline: SecretScanningAiDetection)
...
@override String toString() => 'SecurityAndAnalysisSecretScanningAiDetection(status: $status)';
