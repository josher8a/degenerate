...
factory ProjectEditedChanges.fromJson(Map<String, dynamic> json) { return ProjectEditedChanges(
  ...
  public: json['public'] != null ? Public.fromJson(json['public'] as Map<String, dynamic>) : null,
...
ProjectEditedChanges copyWith({ProjectEditedChangesDescription? Function()? description, Public? Function()? public, ShortDescription? Function()? shortDescription, ProjectEditedChangesTitle? Function()? title, }) { return ProjectEditedChanges(
