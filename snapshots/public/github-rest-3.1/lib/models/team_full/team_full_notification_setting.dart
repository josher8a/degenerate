...
W when<W>({required W Function() notificationsEnabled, required W Function() notificationsDisabled, required W Function(String value) $unknown, }) { return switch (this) {
      TeamFullNotificationSetting$notificationsEnabled() => notificationsEnabled(),
      TeamFullNotificationSetting$notificationsDisabled() => notificationsDisabled(),
      TeamFullNotificationSetting$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? notificationsEnabled, W Function()? notificationsDisabled, W Function(String value)? $unknown, }) { return switch (this) {
      TeamFullNotificationSetting$notificationsEnabled() => notificationsEnabled != null ? notificationsEnabled() : orElse(value),
      TeamFullNotificationSetting$notificationsDisabled() => notificationsDisabled != null ? notificationsDisabled() : orElse(value),
      TeamFullNotificationSetting$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
