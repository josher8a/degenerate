...
// Source: #/components/schemas/AppsUpdateWebhookConfigForAppRequest
...
@override String toString() => 'AppsUpdateWebhookConfigForAppRequest(url: $url, contentType: $contentType, secret: $secret, insecureSsl: $insecureSsl)';
