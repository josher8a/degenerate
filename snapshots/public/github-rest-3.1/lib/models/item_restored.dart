...
W when<W>({required W Function() restored, required W Function(String value) $unknown, }) { return switch (this) {
      ItemRestoredAction$restored() => restored(),
      ItemRestoredAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? restored, W Function(String value)? $unknown, }) { return switch (this) {
      ItemRestoredAction$restored() => restored != null ? restored() : orElse(value),
      ItemRestoredAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'restored' &&
