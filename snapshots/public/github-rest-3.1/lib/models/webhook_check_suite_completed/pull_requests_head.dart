...
// Source: #/components/schemas/WebhookCheckSuiteCompleted (inline: CheckSuite > PullRequests > Head)
...
@override String toString() => 'PullRequestsHead(ref: $ref, repo: $repo, sha: $sha)';
