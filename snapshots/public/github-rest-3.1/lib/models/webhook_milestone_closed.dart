...
// Source: #/components/schemas/WebhookMilestoneClosed
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'closed' &&
...
@override String toString() => 'WebhookMilestoneClosed(action: $action, enterprise: $enterprise, installation: $installation, milestone: $milestone, organization: $organization, repository: $repository, sender: $sender)';
