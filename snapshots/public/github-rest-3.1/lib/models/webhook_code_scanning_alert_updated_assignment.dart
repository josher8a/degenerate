...
W when<W>({required W Function() updatedAssignment, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookCodeScanningAlertUpdatedAssignmentAction$updatedAssignment() => updatedAssignment(),
      WebhookCodeScanningAlertUpdatedAssignmentAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? updatedAssignment, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookCodeScanningAlertUpdatedAssignmentAction$updatedAssignment() => updatedAssignment != null ? updatedAssignment() : orElse(value),
      WebhookCodeScanningAlertUpdatedAssignmentAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'updated_assignment' &&
