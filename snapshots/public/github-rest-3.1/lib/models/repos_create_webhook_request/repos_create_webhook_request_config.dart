...
// Source: #/components/schemas/ReposCreateWebhookRequest (inline: Config)
...
@override String toString() => 'ReposCreateWebhookRequestConfig(contentType: $contentType, insecureSsl: $insecureSsl, secret: $secret, url: $url)';
