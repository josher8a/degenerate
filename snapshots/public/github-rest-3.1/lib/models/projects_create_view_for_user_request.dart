...
// Source: #/components/schemas/ProjectsCreateViewForUserRequest
...
@override String toString() => 'ProjectsCreateViewForUserRequest(name: $name, layout: $layout, filter: $filter, visibleFields: $visibleFields)';
