...
// Source: #/components/schemas/OrgsCustomPropertiesForReposCreateOrUpdateOrganizationDefinitionsRequest
...
if (properties.isEmpty) { errors.add('properties: must have >= 1 items'); }
