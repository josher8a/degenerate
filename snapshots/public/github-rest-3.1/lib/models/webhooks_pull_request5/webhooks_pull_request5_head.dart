...
WebhooksPullRequest5Head copyWith({String? label, String? ref, WebhooksPullRequest5BaseRepo? repo, String? sha, DiscussionUser? Function()? user, }) { return WebhooksPullRequest5Head(
...
@override String toString() => 'WebhooksPullRequest5Head(label: $label, ref: $ref, repo: $repo, sha: $sha, user: $user)';
