...
// Source: #/components/schemas/WebhooksPullRequest5 (inline: Base)
...
@override String toString() => 'WebhooksPullRequest5Base(label: $label, ref: $ref, repo: $repo, sha: $sha, user: $user)';
