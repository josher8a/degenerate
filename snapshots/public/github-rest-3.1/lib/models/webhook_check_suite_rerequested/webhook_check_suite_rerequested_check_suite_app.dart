...
W when<W>({required W Function() branchProtectionRule, required W Function() checkRun, required W Function() checkSuite, required W Function() codeScanningAlert, required W Function() commitComment, required W Function() contentReference, required W Function() create, required W Function() delete, required W Function() deployment, required W Function() deploymentReview, required W Function() deploymentStatus, required W Function() deployKey, required W Function() discussion, required W Function() discussionComment, required W Function() fork, required W Function() gollum, required W Function() issues, required W Function() issueComment, required W Function() label, required W Function() member, required W Function() membership, required W Function() milestone, required W Function() organization, required W Function() orgBlock, required W Function() pageBuild, required W Function() project, required W Function() projectCard, required W Function() projectColumn, required W Function() public, required W Function() pullRequest, required W Function() pullRequestReview, required W Function() pullRequestReviewComment, required W Function() push, required W Function() registryPackage, required W Function() release, required W Function() repository, required W Function() repositoryDispatch, required W Function() secretScanningAlert, required W Function() star, required W Function() status, required W Function() team, required W Function() teamAdd, required W Function() watch, required W Function() workflowDispatch, required W Function() workflowRun, required W Function() pullRequestReviewThread, required W Function() mergeQueueEntry, required W Function() workflowJob, required W Function(String value) $unknown, }) { return switch (this) {
      ...
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$deploymentReview() => deploymentReview(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$deploymentStatus() => deploymentStatus(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$deployKey() => deployKey(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$discussion() => discussion(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$discussionComment() => discussionComment(),
      ...
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$issueComment() => issueComment(),
      ...
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$orgBlock() => orgBlock(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pageBuild() => pageBuild(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$project() => project(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$projectCard() => projectCard(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$projectColumn() => projectColumn(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$public() => public(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequest() => pullRequest(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequestReview() => pullRequestReview(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequestReviewComment() => pullRequestReviewComment(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$push() => push(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$registryPackage() => registryPackage(),
      ...
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$repositoryDispatch() => repositoryDispatch(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$secretScanningAlert() => secretScanningAlert(),
      ...
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$teamAdd() => teamAdd(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$watch() => watch(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$workflowDispatch() => workflowDispatch(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$workflowRun() => workflowRun(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequestReviewThread() => pullRequestReviewThread(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$mergeQueueEntry() => mergeQueueEntry(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$workflowJob() => workflowJob(),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? branchProtectionRule, W Function()? checkRun, W Function()? checkSuite, W Function()? codeScanningAlert, W Function()? commitComment, W Function()? contentReference, W Function()? create, W Function()? delete, W Function()? deployment, W Function()? deploymentReview, W Function()? deploymentStatus, W Function()? deployKey, W Function()? discussion, W Function()? discussionComment, W Function()? fork, W Function()? gollum, W Function()? issues, W Function()? issueComment, W Function()? label, W Function()? member, W Function()? membership, W Function()? milestone, W Function()? organization, W Function()? orgBlock, W Function()? pageBuild, W Function()? project, W Function()? projectCard, W Function()? projectColumn, W Function()? public, W Function()? pullRequest, W Function()? pullRequestReview, W Function()? pullRequestReviewComment, W Function()? push, W Function()? registryPackage, W Function()? release, W Function()? repository, W Function()? repositoryDispatch, W Function()? secretScanningAlert, W Function()? star, W Function()? status, W Function()? team, W Function()? teamAdd, W Function()? watch, W Function()? workflowDispatch, W Function()? workflowRun, W Function()? pullRequestReviewThread, W Function()? mergeQueueEntry, W Function()? workflowJob, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$branchProtectionRule() => branchProtectionRule != null ? branchProtectionRule() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$checkRun() => checkRun != null ? checkRun() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$checkSuite() => checkSuite != null ? checkSuite() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$codeScanningAlert() => codeScanningAlert != null ? codeScanningAlert() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$commitComment() => commitComment != null ? commitComment() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$contentReference() => contentReference != null ? contentReference() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$create() => create != null ? create() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$delete() => delete != null ? delete() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$deployment() => deployment != null ? deployment() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$deploymentReview() => deploymentReview != null ? deploymentReview() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$deploymentStatus() => deploymentStatus != null ? deploymentStatus() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$deployKey() => deployKey != null ? deployKey() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$discussion() => discussion != null ? discussion() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$discussionComment() => discussionComment != null ? discussionComment() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$fork() => fork != null ? fork() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$gollum() => gollum != null ? gollum() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$issues() => issues != null ? issues() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$issueComment() => issueComment != null ? issueComment() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$label() => label != null ? label() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$member() => member != null ? member() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$membership() => membership != null ? membership() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$milestone() => milestone != null ? milestone() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$organization() => organization != null ? organization() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$orgBlock() => orgBlock != null ? orgBlock() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pageBuild() => pageBuild != null ? pageBuild() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$project() => project != null ? project() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$projectCard() => projectCard != null ? projectCard() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$projectColumn() => projectColumn != null ? projectColumn() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$public() => public != null ? public() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequest() => pullRequest != null ? pullRequest() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequestReview() => pullRequestReview != null ? pullRequestReview() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequestReviewComment() => pullRequestReviewComment != null ? pullRequestReviewComment() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$push() => push != null ? push() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$registryPackage() => registryPackage != null ? registryPackage() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$release() => release != null ? release() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$repository() => repository != null ? repository() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$repositoryDispatch() => repositoryDispatch != null ? repositoryDispatch() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$secretScanningAlert() => secretScanningAlert != null ? secretScanningAlert() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$star() => star != null ? star() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$status() => status != null ? status() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$team() => team != null ? team() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$teamAdd() => teamAdd != null ? teamAdd() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$watch() => watch != null ? watch() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$workflowDispatch() => workflowDispatch != null ? workflowDispatch() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$workflowRun() => workflowRun != null ? workflowRun() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$pullRequestReviewThread() => pullRequestReviewThread != null ? pullRequestReviewThread() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$mergeQueueEntry() => mergeQueueEntry != null ? mergeQueueEntry() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$workflowJob() => workflowJob != null ? workflowJob() : orElse(value),
      WebhookCheckSuiteRerequestedCheckSuiteAppEvents$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
