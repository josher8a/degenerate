...
sealed class PullsCreateReviewError {
  const PullsCreateReviewError();

  int get statusCode;

  factory PullsCreateReviewError.fromResponse(ApiResponse response) {
    try {
...
final class PullsCreateReviewError$403 extends PullsCreateReviewError {
  const PullsCreateReviewError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class PullsCreateReviewError$422 extends PullsCreateReviewError {
  const PullsCreateReviewError$422(this.error);
  final ValidationErrorSimple error;
  @override
  int get statusCode => 422;
}

final class PullsCreateReviewError$Unknown extends PullsCreateReviewError {
  const PullsCreateReviewError$Unknown(this.statusCode, this.rawBody);
  @override
