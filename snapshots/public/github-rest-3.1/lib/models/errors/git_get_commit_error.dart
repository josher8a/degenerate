...
sealed class GitGetCommitError {
  const GitGetCommitError();

  int get statusCode;

  factory GitGetCommitError.fromResponse(ApiResponse response) {
    try {
...
final class GitGetCommitError$404 extends GitGetCommitError {
  const GitGetCommitError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class GitGetCommitError$409 extends GitGetCommitError {
  const GitGetCommitError$409(this.error);
  final BasicError error;
  @override
  int get statusCode => 409;
}

final class GitGetCommitError$Unknown extends GitGetCommitError {
  const GitGetCommitError$Unknown(this.statusCode, this.rawBody);
  @override
