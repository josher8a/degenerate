...
sealed class ActionsReRunJobForWorkflowRunError {
  const ActionsReRunJobForWorkflowRunError();

  int get statusCode;

  factory ActionsReRunJobForWorkflowRunError.fromResponse(ApiResponse response) {
    try {
...
final class ActionsReRunJobForWorkflowRunError$403 extends ActionsReRunJobForWorkflowRunError {
  const ActionsReRunJobForWorkflowRunError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class ActionsReRunJobForWorkflowRunError$Unknown extends ActionsReRunJobForWorkflowRunError {
  const ActionsReRunJobForWorkflowRunError$Unknown(this.statusCode, this.rawBody);
  @override
