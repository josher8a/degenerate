...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/code_scanning_get_sarif_response503.dart';sealed class CodeScanningGetSarifError {const CodeScanningGetSarifError();

factory CodeScanningGetSarifError.fromResponse(ApiResponse response) {     try {
