...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/code_scanning_get_codeql_database_response503.dart';sealed class CodeScanningGetCodeqlDatabaseError {const CodeScanningGetCodeqlDatabaseError();

factory CodeScanningGetCodeqlDatabaseError.fromResponse(ApiResponse response) {     try {
...
final class CodeScanningGetCodeqlDatabaseError$403 extends CodeScanningGetCodeqlDatabaseError {const CodeScanningGetCodeqlDatabaseError$403(this.error);
