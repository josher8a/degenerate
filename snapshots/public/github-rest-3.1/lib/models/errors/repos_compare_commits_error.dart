...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/repos_compare_commits_response503.dart';sealed class ReposCompareCommitsError {const ReposCompareCommitsError();

factory ReposCompareCommitsError.fromResponse(ApiResponse response) {     try {
