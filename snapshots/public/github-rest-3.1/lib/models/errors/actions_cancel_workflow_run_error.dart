...
sealed class ActionsCancelWorkflowRunError {
  const ActionsCancelWorkflowRunError();

  int get statusCode;

  factory ActionsCancelWorkflowRunError.fromResponse(ApiResponse response) {
    try {
...
final class ActionsCancelWorkflowRunError$409 extends ActionsCancelWorkflowRunError {
  const ActionsCancelWorkflowRunError$409(this.error);
  final BasicError error;
  @override
  int get statusCode => 409;
}

final class ActionsCancelWorkflowRunError$Unknown extends ActionsCancelWorkflowRunError {
  const ActionsCancelWorkflowRunError$Unknown(this.statusCode, this.rawBody);
  @override
