...
sealed class ReposCreateOrgRulesetError {
  const ReposCreateOrgRulesetError();

  int get statusCode;

  factory ReposCreateOrgRulesetError.fromResponse(ApiResponse response) {
    try {
...
final class ReposCreateOrgRulesetError$404 extends ReposCreateOrgRulesetError {
  const ReposCreateOrgRulesetError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class ReposCreateOrgRulesetError$422 extends ReposCreateOrgRulesetError {
  const ReposCreateOrgRulesetError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class ReposCreateOrgRulesetError$500 extends ReposCreateOrgRulesetError {
  const ReposCreateOrgRulesetError$500(this.error);
  final BasicError error;
  @override
  int get statusCode => 500;
}

final class ReposCreateOrgRulesetError$Unknown extends ReposCreateOrgRulesetError {
  const ReposCreateOrgRulesetError$Unknown(this.statusCode, this.rawBody);
  @override
