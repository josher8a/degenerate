...
import 'package:pub_github_rest_3_1/models/repos_create_or_update_file_contents_response409.dart';
...
sealed class ReposCreateOrUpdateFileContentsError {
  const ReposCreateOrUpdateFileContentsError();

  int get statusCode;

  factory ReposCreateOrUpdateFileContentsError.fromResponse(ApiResponse response) {
    try {
...
final class ReposCreateOrUpdateFileContentsError$404 extends ReposCreateOrUpdateFileContentsError {
  const ReposCreateOrUpdateFileContentsError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class ReposCreateOrUpdateFileContentsError$409 extends ReposCreateOrUpdateFileContentsError {
  const ReposCreateOrUpdateFileContentsError$409(this.error);
  final ReposCreateOrUpdateFileContentsResponse409 error;
  @override
  int get statusCode => 409;
}

final class ReposCreateOrUpdateFileContentsError$422 extends ReposCreateOrUpdateFileContentsError {
  const ReposCreateOrUpdateFileContentsError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class ReposCreateOrUpdateFileContentsError$Unknown extends ReposCreateOrUpdateFileContentsError {
  const ReposCreateOrUpdateFileContentsError$Unknown(this.statusCode, this.rawBody);
  @override
