...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/orgs_remove_outside_collaborator_response422.dart';sealed class OrgsRemoveOutsideCollaboratorError {const OrgsRemoveOutsideCollaboratorError();

factory OrgsRemoveOutsideCollaboratorError.fromResponse(ApiResponse response) {     try {
