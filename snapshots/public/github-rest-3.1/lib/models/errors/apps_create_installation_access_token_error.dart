...
sealed class AppsCreateInstallationAccessTokenError {
  const AppsCreateInstallationAccessTokenError();

  int get statusCode;

  factory AppsCreateInstallationAccessTokenError.fromResponse(ApiResponse response) {
    try {
...
final class AppsCreateInstallationAccessTokenError$401 extends AppsCreateInstallationAccessTokenError {
  const AppsCreateInstallationAccessTokenError$401(this.error);
  final BasicError error;
  @override
  int get statusCode => 401;
}

final class AppsCreateInstallationAccessTokenError$403 extends AppsCreateInstallationAccessTokenError {
  const AppsCreateInstallationAccessTokenError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class AppsCreateInstallationAccessTokenError$404 extends AppsCreateInstallationAccessTokenError {
  const AppsCreateInstallationAccessTokenError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class AppsCreateInstallationAccessTokenError$422 extends AppsCreateInstallationAccessTokenError {
  const AppsCreateInstallationAccessTokenError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class AppsCreateInstallationAccessTokenError$Unknown extends AppsCreateInstallationAccessTokenError {
  const AppsCreateInstallationAccessTokenError$Unknown(this.statusCode, this.rawBody);
  @override
