...
sealed class ActionsAddCustomLabelsToSelfHostedRunnerForOrgError {
  const ActionsAddCustomLabelsToSelfHostedRunnerForOrgError();

  int get statusCode;

  factory ActionsAddCustomLabelsToSelfHostedRunnerForOrgError.fromResponse(ApiResponse response) {
    try {
...
final class ActionsAddCustomLabelsToSelfHostedRunnerForOrgError$404 extends ActionsAddCustomLabelsToSelfHostedRunnerForOrgError {
  const ActionsAddCustomLabelsToSelfHostedRunnerForOrgError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class ActionsAddCustomLabelsToSelfHostedRunnerForOrgError$422 extends ActionsAddCustomLabelsToSelfHostedRunnerForOrgError {
  const ActionsAddCustomLabelsToSelfHostedRunnerForOrgError$422(this.error);
  final ValidationErrorSimple error;
  @override
  int get statusCode => 422;
}

final class ActionsAddCustomLabelsToSelfHostedRunnerForOrgError$Unknown extends ActionsAddCustomLabelsToSelfHostedRunnerForOrgError {
  const ActionsAddCustomLabelsToSelfHostedRunnerForOrgError$Unknown(this.statusCode, this.rawBody);
  @override
