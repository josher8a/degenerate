...
sealed class ActivityListNotificationsForAuthenticatedUserError {
  const ActivityListNotificationsForAuthenticatedUserError();

  int get statusCode;

  factory ActivityListNotificationsForAuthenticatedUserError.fromResponse(ApiResponse response) {
    try {
...
final class ActivityListNotificationsForAuthenticatedUserError$401 extends ActivityListNotificationsForAuthenticatedUserError {
  const ActivityListNotificationsForAuthenticatedUserError$401(this.error);
  final BasicError error;
  @override
  int get statusCode => 401;
}

final class ActivityListNotificationsForAuthenticatedUserError$403 extends ActivityListNotificationsForAuthenticatedUserError {
  const ActivityListNotificationsForAuthenticatedUserError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class ActivityListNotificationsForAuthenticatedUserError$422 extends ActivityListNotificationsForAuthenticatedUserError {
  const ActivityListNotificationsForAuthenticatedUserError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class ActivityListNotificationsForAuthenticatedUserError$Unknown extends ActivityListNotificationsForAuthenticatedUserError {
  const ActivityListNotificationsForAuthenticatedUserError$Unknown(this.statusCode, this.rawBody);
  @override
