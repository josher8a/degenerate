...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/validation_error.dart';sealed class OrgsListPatGrantRequestsError {const OrgsListPatGrantRequestsError();

factory OrgsListPatGrantRequestsError.fromResponse(ApiResponse response) {     try {
