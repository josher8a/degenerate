...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/gists_check_is_starred_response404.dart';sealed class GistsCheckIsStarredError {const GistsCheckIsStarredError();

factory GistsCheckIsStarredError.fromResponse(ApiResponse response) {     try {
