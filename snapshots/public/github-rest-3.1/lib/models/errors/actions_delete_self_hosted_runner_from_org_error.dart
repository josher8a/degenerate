...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/validation_error_simple.dart';sealed class ActionsDeleteSelfHostedRunnerFromOrgError {const ActionsDeleteSelfHostedRunnerFromOrgError();

factory ActionsDeleteSelfHostedRunnerFromOrgError.fromResponse(ApiResponse response) {     try {
