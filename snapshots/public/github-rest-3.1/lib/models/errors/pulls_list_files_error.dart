...
import 'package:pub_github_rest_3_1/models/pulls_list_files_response503.dart';
import 'package:pub_github_rest_3_1/models/validation_error.dart';

sealed class PullsListFilesError {
  const PullsListFilesError();

  int get statusCode;

  factory PullsListFilesError.fromResponse(ApiResponse response) {
    try {
...
final class PullsListFilesError$422 extends PullsListFilesError {
  const PullsListFilesError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class PullsListFilesError$500 extends PullsListFilesError {
  const PullsListFilesError$500(this.error);
  final BasicError error;
  @override
  int get statusCode => 500;
}

final class PullsListFilesError$503 extends PullsListFilesError {
  const PullsListFilesError$503(this.error);
  final PullsListFilesResponse503 error;
  @override
  int get statusCode => 503;
}

final class PullsListFilesError$Unknown extends PullsListFilesError {
  const PullsListFilesError$Unknown(this.statusCode, this.rawBody);
  @override
