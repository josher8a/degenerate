...
sealed class AppsGetSubscriptionPlanForAccountStubbedError {
  const AppsGetSubscriptionPlanForAccountStubbedError();

  int get statusCode;

  factory AppsGetSubscriptionPlanForAccountStubbedError.fromResponse(ApiResponse response) {
    try {
...
final class AppsGetSubscriptionPlanForAccountStubbedError$401 extends AppsGetSubscriptionPlanForAccountStubbedError {
  const AppsGetSubscriptionPlanForAccountStubbedError$401(this.error);
  final BasicError error;
  @override
  int get statusCode => 401;
}

final class AppsGetSubscriptionPlanForAccountStubbedError$Unknown extends AppsGetSubscriptionPlanForAccountStubbedError {
  const AppsGetSubscriptionPlanForAccountStubbedError$Unknown(this.statusCode, this.rawBody);
  @override
