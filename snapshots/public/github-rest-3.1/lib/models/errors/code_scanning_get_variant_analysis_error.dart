...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/code_scanning_get_variant_analysis_response503.dart';sealed class CodeScanningGetVariantAnalysisError {const CodeScanningGetVariantAnalysisError();

factory CodeScanningGetVariantAnalysisError.fromResponse(ApiResponse response) {     try {
...
final class CodeScanningGetVariantAnalysisError$404 extends CodeScanningGetVariantAnalysisError {const CodeScanningGetVariantAnalysisError$404(this.error);
