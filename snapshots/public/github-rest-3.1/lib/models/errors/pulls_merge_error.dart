...
import 'package:pub_github_rest_3_1/models/pulls_merge_response405.dart';
import 'package:pub_github_rest_3_1/models/pulls_merge_response409.dart';
import 'package:pub_github_rest_3_1/models/validation_error.dart';

sealed class PullsMergeError {
  const PullsMergeError();

  int get statusCode;

  factory PullsMergeError.fromResponse(ApiResponse response) {
    try {
...
final class PullsMergeError$403 extends PullsMergeError {
  const PullsMergeError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class PullsMergeError$404 extends PullsMergeError {
  const PullsMergeError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class PullsMergeError$405 extends PullsMergeError {
  const PullsMergeError$405(this.error);
  final PullsMergeResponse405 error;
  @override
  int get statusCode => 405;
}

final class PullsMergeError$409 extends PullsMergeError {
  const PullsMergeError$409(this.error);
  final PullsMergeResponse409 error;
  @override
  int get statusCode => 409;
}

final class PullsMergeError$422 extends PullsMergeError {
  const PullsMergeError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class PullsMergeError$Unknown extends PullsMergeError {
  const PullsMergeError$Unknown(this.statusCode, this.rawBody);
  @override
