...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';sealed class ActionsGetCustomOidcSubClaimForRepoError {const ActionsGetCustomOidcSubClaimForRepoError();

factory ActionsGetCustomOidcSubClaimForRepoError.fromResponse(ApiResponse response) {     try {
...
final class ActionsGetCustomOidcSubClaimForRepoError$Unknown extends ActionsGetCustomOidcSubClaimForRepoError {const ActionsGetCustomOidcSubClaimForRepoError$Unknown(this.statusCode, this.rawBody, );
