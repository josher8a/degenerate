...
sealed class OrgsGetOrgRulesetHistoryError {
  const OrgsGetOrgRulesetHistoryError();

  int get statusCode;

  factory OrgsGetOrgRulesetHistoryError.fromResponse(ApiResponse response) {
    try {
...
final class OrgsGetOrgRulesetHistoryError$404 extends OrgsGetOrgRulesetHistoryError {
  const OrgsGetOrgRulesetHistoryError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class OrgsGetOrgRulesetHistoryError$500 extends OrgsGetOrgRulesetHistoryError {
  const OrgsGetOrgRulesetHistoryError$500(this.error);
  final BasicError error;
  @override
  int get statusCode => 500;
}

final class OrgsGetOrgRulesetHistoryError$Unknown extends OrgsGetOrgRulesetHistoryError {
  const OrgsGetOrgRulesetHistoryError$Unknown(this.statusCode, this.rawBody);
  @override
