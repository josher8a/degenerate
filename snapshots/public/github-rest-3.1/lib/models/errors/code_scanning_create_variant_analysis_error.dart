...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/code_scanning_create_variant_analysis_response503.dart';sealed class CodeScanningCreateVariantAnalysisError {const CodeScanningCreateVariantAnalysisError();

factory CodeScanningCreateVariantAnalysisError.fromResponse(ApiResponse response) {     try {
...
final class CodeScanningCreateVariantAnalysisError$404 extends CodeScanningCreateVariantAnalysisError {const CodeScanningCreateVariantAnalysisError$404(this.error);
