...
import 'package:pub_github_rest_3_1/models/search_code_response503.dart';
import 'package:pub_github_rest_3_1/models/validation_error.dart';

sealed class SearchCodeError {
  const SearchCodeError();

  int get statusCode;

  factory SearchCodeError.fromResponse(ApiResponse response) {
    try {
...
final class SearchCodeError$403 extends SearchCodeError {
  const SearchCodeError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class SearchCodeError$422 extends SearchCodeError {
  const SearchCodeError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class SearchCodeError$503 extends SearchCodeError {
  const SearchCodeError$503(this.error);
  final SearchCodeResponse503 error;
  @override
  int get statusCode => 503;
}

final class SearchCodeError$Unknown extends SearchCodeError {
  const SearchCodeError$Unknown(this.statusCode, this.rawBody);
  @override
