...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';sealed class ActivityDeleteThreadSubscriptionError {const ActivityDeleteThreadSubscriptionError();

factory ActivityDeleteThreadSubscriptionError.fromResponse(ApiResponse response) {     try {
