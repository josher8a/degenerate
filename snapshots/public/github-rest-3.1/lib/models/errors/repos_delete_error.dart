...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/repos_delete_response403.dart';sealed class ReposDeleteError {const ReposDeleteError();

factory ReposDeleteError.fromResponse(ApiResponse response) {     try {
