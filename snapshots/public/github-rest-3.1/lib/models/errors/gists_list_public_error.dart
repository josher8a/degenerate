...
sealed class GistsListPublicError {
  const GistsListPublicError();

  int get statusCode;

  factory GistsListPublicError.fromResponse(ApiResponse response) {
    try {
...
final class GistsListPublicError$403 extends GistsListPublicError {
  const GistsListPublicError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class GistsListPublicError$422 extends GistsListPublicError {
  const GistsListPublicError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class GistsListPublicError$Unknown extends GistsListPublicError {
  const GistsListPublicError$Unknown(this.statusCode, this.rawBody);
  @override
