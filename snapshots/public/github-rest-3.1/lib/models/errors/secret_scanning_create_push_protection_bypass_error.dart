...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/secret_scanning_create_push_protection_bypass_response503.dart';sealed class SecretScanningCreatePushProtectionBypassError {const SecretScanningCreatePushProtectionBypassError();

factory SecretScanningCreatePushProtectionBypassError.fromResponse(ApiResponse response) {     try {
