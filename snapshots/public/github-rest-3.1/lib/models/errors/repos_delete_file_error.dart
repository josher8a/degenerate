...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/repos_delete_file_response503.dart';import 'package:pub_github_rest_3_1/models/validation_error.dart';sealed class ReposDeleteFileError {const ReposDeleteFileError();

factory ReposDeleteFileError.fromResponse(ApiResponse response) {     try {
...
final class ReposDeleteFileError$409 extends ReposDeleteFileError {const ReposDeleteFileError$409(this.error);
...
final class ReposDeleteFileError$422 extends ReposDeleteFileError {const ReposDeleteFileError$422(this.error);
...
final class ReposDeleteFileError$Unknown extends ReposDeleteFileError {const ReposDeleteFileError$Unknown(this.statusCode, this.rawBody, );
