...
import 'package:pub_github_rest_3_1/models/activity_list_public_events_response503.dart';
...
sealed class ActivityListPublicEventsError {
  ...
  factory ActivityListPublicEventsError.fromResponse(ApiResponse response) {
    try {
...
final class ActivityListPublicEventsError$403 extends ActivityListPublicEventsError {
  const ActivityListPublicEventsError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class ActivityListPublicEventsError$503 extends ActivityListPublicEventsError {
  const ActivityListPublicEventsError$503(this.error);
  final ActivityListPublicEventsResponse503 error;
  @override
  int get statusCode => 503;
}

final class ActivityListPublicEventsError$Unknown extends ActivityListPublicEventsError {
  const ActivityListPublicEventsError$Unknown(this.statusCode, this.rawBody);
  @override
