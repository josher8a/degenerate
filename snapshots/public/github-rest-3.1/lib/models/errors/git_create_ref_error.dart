...
sealed class GitCreateRefError {
  const GitCreateRefError();

  int get statusCode;

  factory GitCreateRefError.fromResponse(ApiResponse response) {
    try {
...
final class GitCreateRefError$409 extends GitCreateRefError {
  const GitCreateRefError$409(this.error);
  final BasicError error;
  @override
  int get statusCode => 409;
}

final class GitCreateRefError$422 extends GitCreateRefError {
  const GitCreateRefError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class GitCreateRefError$Unknown extends GitCreateRefError {
  const GitCreateRefError$Unknown(this.statusCode, this.rawBody);
  @override
