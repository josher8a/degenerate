...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/campaigns_list_org_campaigns_response503.dart';sealed class CampaignsListOrgCampaignsError {const CampaignsListOrgCampaignsError();

factory CampaignsListOrgCampaignsError.fromResponse(ApiResponse response) {     try {
...
final class CampaignsListOrgCampaignsError$404 extends CampaignsListOrgCampaignsError {const CampaignsListOrgCampaignsError$404(this.error);
