...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/basic_error.dart';import 'package:pub_github_rest_3_1/models/pulls_get_response503.dart';sealed class PullsGetError {const PullsGetError();

factory PullsGetError.fromResponse(ApiResponse response) {     try {
