...
sealed class ActivityListStargazersForRepoError {
  const ActivityListStargazersForRepoError();

  int get statusCode;

  factory ActivityListStargazersForRepoError.fromResponse(ApiResponse response) {
    try {
...
final class ActivityListStargazersForRepoError$422 extends ActivityListStargazersForRepoError {
  const ActivityListStargazersForRepoError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class ActivityListStargazersForRepoError$Unknown extends ActivityListStargazersForRepoError {
  const ActivityListStargazersForRepoError$Unknown(this.statusCode, this.rawBody);
  @override
