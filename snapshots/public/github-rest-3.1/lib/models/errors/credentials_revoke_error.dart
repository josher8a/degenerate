...
sealed class CredentialsRevokeError {
  const CredentialsRevokeError();

  int get statusCode;

  factory CredentialsRevokeError.fromResponse(ApiResponse response) {
    try {
...
final class CredentialsRevokeError$422 extends CredentialsRevokeError {
  const CredentialsRevokeError$422(this.error);
  final ValidationErrorSimple error;
  @override
  int get statusCode => 422;
}

final class CredentialsRevokeError$500 extends CredentialsRevokeError {
  const CredentialsRevokeError$500(this.error);
  final BasicError error;
  @override
  int get statusCode => 500;
}

final class CredentialsRevokeError$Unknown extends CredentialsRevokeError {
  const CredentialsRevokeError$Unknown(this.statusCode, this.rawBody);
  @override
