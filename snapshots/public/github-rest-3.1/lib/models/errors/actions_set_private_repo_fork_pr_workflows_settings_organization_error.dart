...
sealed class ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError {
  const ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError();

  int get statusCode;

  factory ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError.fromResponse(ApiResponse response) {
    try {
...
final class ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$403 extends ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError {
  const ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$403(this.error);
  final BasicError error;
  @override
  int get statusCode => 403;
}

final class ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$404 extends ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError {
  const ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$404(this.error);
  final BasicError error;
  @override
  int get statusCode => 404;
}

final class ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$422 extends ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError {
  const ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$422(this.error);
  final ValidationError error;
  @override
  int get statusCode => 422;
}

final class ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$Unknown extends ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError {
  const ActionsSetPrivateRepoForkPrWorkflowsSettingsOrganizationError$Unknown(this.statusCode, this.rawBody);
  @override
