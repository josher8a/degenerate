...
@override int get hashCode => Object.hash(action, comment, discussion, enterprise, installation, organization, repository, sender);

@override String toString() => 'WebhookDiscussionCommentDeleted(action: $action, comment: $comment, discussion: $discussion, enterprise: $enterprise, installation: $installation, organization: $organization, repository: $repository, sender: $sender)';
