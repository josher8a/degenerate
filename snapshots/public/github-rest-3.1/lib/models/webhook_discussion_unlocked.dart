...
// Source: #/components/schemas/WebhookDiscussionUnlocked
...
@override String toString() => 'WebhookDiscussionUnlocked(action: $action, discussion: $discussion, enterprise: $enterprise, installation: $installation, organization: $organization, repository: $repository, sender: $sender)';
