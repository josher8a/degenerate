...
// Source: #/components/schemas/WebhookOrganizationRenamed (inline: Changes)
...
@override int get hashCode => login.hashCode;

@override String toString() => 'WebhookOrganizationRenamedChanges(login: $login)';
