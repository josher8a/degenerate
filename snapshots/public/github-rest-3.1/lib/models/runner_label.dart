...
W when<W>({required W Function() readOnly, required W Function() custom, required W Function(String value) $unknown, }) { return switch (this) {
      RunnerLabelType$readOnly() => readOnly(),
      RunnerLabelType$custom() => custom(),
      RunnerLabelType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? readOnly, W Function()? custom, W Function(String value)? $unknown, }) { return switch (this) {
      RunnerLabelType$readOnly() => readOnly != null ? readOnly() : orElse(value),
      RunnerLabelType$custom() => custom != null ? custom() : orElse(value),
      RunnerLabelType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
