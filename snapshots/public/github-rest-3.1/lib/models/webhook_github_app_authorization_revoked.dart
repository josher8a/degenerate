...
W when<W>({required W Function() revoked, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookGithubAppAuthorizationRevokedAction$revoked() => revoked(),
      WebhookGithubAppAuthorizationRevokedAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? revoked, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookGithubAppAuthorizationRevokedAction$revoked() => revoked != null ? revoked() : orElse(value),
      WebhookGithubAppAuthorizationRevokedAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
