...
// Source: #/components/schemas/SecretScanningFirstDetectedLocation
...
factory SecretScanningFirstDetectedLocation.fromJson(Object? json) {   if (json is Map<String, dynamic> && SecretScanningLocationCommit.canParse(json)) {
