...
if (digest.runes.length < 71) { errors.add('digest: length must be >= 71'); }
if (digest.runes.length > 71) { errors.add('digest: length must be <= 71'); }
...
if (version$ != null) {
  ...
  if (version$.runes.length > 100) { errors.add('version: length must be <= 100'); }
}
...
if (cluster$ != null) {
  if (cluster$.runes.length > 128) { errors.add('cluster: length must be <= 128'); }
}
if (deploymentName.runes.length > 256) { errors.add('deploymentName: length must be <= 256'); }
...
if (githubRepository$ != null) {
  ...
  if (githubRepository$.runes.length > 100) { errors.add('githubRepository: length must be <= 100'); }
