...
// Source: #/components/schemas/OrganizationUpdateIssueType
...
@override String toString() => 'OrganizationUpdateIssueType(name: $name, isEnabled: $isEnabled, description: $description, color: $color)';
