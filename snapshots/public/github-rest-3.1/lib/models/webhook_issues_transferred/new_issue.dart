...
NewIssue copyWith({ActiveLockReason? Function()? activeLockReason, WebhooksIssue2Assignee? Function()? assignee, List<WebhooksIssue2Assignees?>? assignees, DiscussionAuthorAssociation? authorAssociation, String? Function()? body, DateTime? Function()? closedAt, int? comments, Uri? commentsUrl, DateTime? createdAt, bool Function()? draft, Uri? eventsUrl, Uri? htmlUrl, int? id, List<WebhooksIssue2Labels> Function()? labels, String? labelsUrl, bool Function()? locked, WebhooksIssue2Milestone? Function()? milestone, String? nodeId, int? number, WebhooksIssue2PerformedViaGithubApp? Function()? performedViaGithubApp, WebhooksIssue2PullRequest Function()? pullRequest, DiscussionReactions? reactions, Uri? repositoryUrl, IssueComment? Function()? pinnedComment, SubIssuesSummary Function()? subIssuesSummary, IssueDependenciesSummary Function()? issueDependenciesSummary, List<IssueFieldValue> Function()? issueFieldValues, IssuesCreateMilestoneRequestState Function()? state, String? Function()? stateReason, Uri Function()? timelineUrl, String? title, IssueType Function()? type, DateTime? updatedAt, Uri? url, DiscussionUser? Function()? user, }) { return NewIssue(
