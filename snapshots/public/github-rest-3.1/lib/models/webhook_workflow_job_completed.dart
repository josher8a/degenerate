...
// Source: #/components/schemas/WebhookWorkflowJobCompleted
...
@override String toString() => 'WebhookWorkflowJobCompleted(action: $action, enterprise: $enterprise, installation: $installation, organization: $organization, repository: $repository, sender: $sender, workflowJob: $workflowJob, deployment: $deployment)';
