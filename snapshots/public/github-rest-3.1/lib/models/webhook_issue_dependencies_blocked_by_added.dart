...
W when<W>({required W Function() blockedByAdded, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookIssueDependenciesBlockedByAddedAction$blockedByAdded() => blockedByAdded(),
      WebhookIssueDependenciesBlockedByAddedAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? blockedByAdded, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookIssueDependenciesBlockedByAddedAction$blockedByAdded() => blockedByAdded != null ? blockedByAdded() : orElse(value),
      WebhookIssueDependenciesBlockedByAddedAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'blocked_by_added' &&
