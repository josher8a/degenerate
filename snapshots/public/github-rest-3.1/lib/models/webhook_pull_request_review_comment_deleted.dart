...
// Source: #/components/schemas/WebhookPullRequestReviewCommentDeleted
...
@override String toString() => 'WebhookPullRequestReviewCommentDeleted(action: $action, comment: $comment, enterprise: $enterprise, installation: $installation, organization: $organization, pullRequest: $pullRequest, repository: $repository, sender: $sender)';
