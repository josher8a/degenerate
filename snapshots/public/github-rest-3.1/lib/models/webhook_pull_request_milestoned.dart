...
// Source: #/components/schemas/WebhookPullRequestMilestoned
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] == 'milestoned' &&
