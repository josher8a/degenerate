...
// Source: #/components/schemas/ChecksUpdateRequest (inline: Completed)
...
@override String toString() => 'ChecksUpdateRequestCompleted(status: $status, additionalProperties: $additionalProperties)';
