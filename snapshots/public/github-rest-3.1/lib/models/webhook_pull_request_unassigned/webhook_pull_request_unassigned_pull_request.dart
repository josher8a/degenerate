...
WebhookPullRequestUnassignedPullRequest copyWith({WebhooksPullRequest5Links? links, ActiveLockReason? Function()? activeLockReason, int? Function()? additions, WebhooksIssueAssignee? Function()? assignee, List<WebhooksPullRequest5Assignees?>? assignees, AuthorAssociation? authorAssociation, WebhooksPullRequest5AutoMerge? Function()? autoMerge, WebhookPullRequestUnassignedPullRequestBase? base, String? Function()? body, int? Function()? changedFiles, DateTime? Function()? closedAt, int? Function()? comments, Uri? commentsUrl, int? Function()? commits, Uri? commitsUrl, DateTime? createdAt, int? Function()? deletions, Uri? diffUrl, bool? draft, WebhookPullRequestAssignedPullRequestHead? head, Uri? htmlUrl, int? id, Uri? issueUrl, List<WebhooksIssue2Labels>? labels, bool? locked, bool? Function()? maintainerCanModify, String? Function()? mergeCommitSha, bool? Function()? mergeable, String? Function()? mergeableState, bool? Function()? merged, DateTime? Function()? mergedAt, WebhooksPullRequest5MergedBy? Function()? mergedBy, WebhooksIssueMilestone? Function()? milestone, String? nodeId, int? number, Uri? patchUrl, bool? Function()? rebaseable, List<WebhookPullRequestAssignedPullRequestRequestedReviewers>? requestedReviewers, List<WebhooksPullRequest5RequestedTeams>? requestedTeams, String? reviewCommentUrl, int? Function()? reviewComments, Uri? reviewCommentsUrl, IssuesCreateMilestoneRequestState? state, Uri? statusesUrl, String? title, DateTime? updatedAt, Uri? url, WebhooksIssueCommentUser? Function()? user, }) { return WebhookPullRequestUnassignedPullRequest(
