...
WebhookPullRequestUnassignedPullRequestBase copyWith({String? Function()? label, String? ref, WebhooksPullRequest5BaseRepo? repo, String? sha, DiscussionUser? Function()? user, }) { return WebhookPullRequestUnassignedPullRequestBase(
...
@override String toString() => 'WebhookPullRequestUnassignedPullRequestBase(label: $label, ref: $ref, repo: $repo, sha: $sha, user: $user)';
