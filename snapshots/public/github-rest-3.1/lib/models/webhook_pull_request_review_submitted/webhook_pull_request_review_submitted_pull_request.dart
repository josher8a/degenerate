...
WebhookPullRequestReviewSubmittedPullRequest copyWith({WebhooksPullRequest5Links? links, ActiveLockReason? Function()? activeLockReason, WebhooksIssueAssignee? Function()? assignee, List<WebhooksPullRequest5Assignees?>? assignees, AuthorAssociation? authorAssociation, WebhooksPullRequest5AutoMerge? Function()? autoMerge, WebhooksPullRequest5Base? base, String? Function()? body, String? Function()? closedAt, Uri? commentsUrl, Uri? commitsUrl, String? createdAt, Uri? diffUrl, bool? draft, WebhookPullRequestAssignedPullRequestHead? head, Uri? htmlUrl, int? id, Uri? issueUrl, List<WebhooksIssue2Labels>? labels, bool? locked, String? Function()? mergeCommitSha, String? Function()? mergedAt, WebhooksIssueMilestone? Function()? milestone, String? nodeId, int? number, Uri? patchUrl, List<WebhookPullRequestAssignedPullRequestRequestedReviewers>? requestedReviewers, List<WebhooksPullRequest5RequestedTeams>? requestedTeams, String? reviewCommentUrl, Uri? reviewCommentsUrl, IssuesCreateMilestoneRequestState? state, Uri? statusesUrl, String? title, String? updatedAt, Uri? url, WebhooksIssueCommentUser? Function()? user, }) { return WebhookPullRequestReviewSubmittedPullRequest(
