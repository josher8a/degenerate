...
W when<W>({required W Function() disabled, required W Function() enabled, required W Function(String value) $unknown, }) { return switch (this) {
      CustomPatternSettingsPushProtectionSetting$disabled() => disabled(),
      CustomPatternSettingsPushProtectionSetting$enabled() => enabled(),
      CustomPatternSettingsPushProtectionSetting$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? disabled, W Function()? enabled, W Function(String value)? $unknown, }) { return switch (this) {
      CustomPatternSettingsPushProtectionSetting$disabled() => disabled != null ? disabled() : orElse(value),
      CustomPatternSettingsPushProtectionSetting$enabled() => enabled != null ? enabled() : orElse(value),
      CustomPatternSettingsPushProtectionSetting$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
