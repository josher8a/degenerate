...
WebhookMarketplacePurchaseChangedPreviousMarketplacePurchase copyWith({WebhooksMarketplacePurchaseAccount? account, String? billingCycle, String? Function()? freeTrialEndsOn, String? Function()? nextBillingDate, bool? Function()? onFreeTrial, WebhooksPreviousMarketplacePurchasePlan? plan, int? unitCount, }) { return WebhookMarketplacePurchaseChangedPreviousMarketplacePurchase(
...
@override String toString() => 'WebhookMarketplacePurchaseChangedPreviousMarketplacePurchase(account: $account, billingCycle: $billingCycle, freeTrialEndsOn: $freeTrialEndsOn, nextBillingDate: $nextBillingDate, onFreeTrial: $onFreeTrial, plan: $plan, unitCount: $unitCount)';
