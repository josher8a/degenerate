...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant20)
...
@immutable final class Variant20 {const Variant20({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant20.fromJson(Map<String, dynamic> json) { return Variant20(
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'workflows'; } 
Variant20 copyWith({RepositoryRuleWorkflowsType? type, RepositoryRuleWorkflowsParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant20(
  type: type ?? this.type,
...
@override String toString() => 'Variant20(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
