...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant21)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_code_scanning/repository_rule_code_scanning_parameters.dart';import 'package:pub_github_rest_3_1/models/repository_rule_code_scanning/repository_rule_code_scanning_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant21 {const Variant21({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant21.fromJson(Map<String, dynamic> json) { return Variant21(
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'code_scanning'; } 
Variant21 copyWith({RepositoryRuleCodeScanningType? type, RepositoryRuleCodeScanningParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant21(
  type: type ?? this.type,
...
@override String toString() => 'Variant21(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
