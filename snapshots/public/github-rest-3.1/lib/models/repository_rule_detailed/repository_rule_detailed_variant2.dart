...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant2)
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'update'; } 
RepositoryRuleDetailedVariant2 copyWith({RepositoryRuleUpdateType? type, RepositoryRuleUpdateParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return RepositoryRuleDetailedVariant2(
  type: type ?? this.type,
...
@override String toString() => 'RepositoryRuleDetailedVariant2(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
