...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant5)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_merge_queue/repository_rule_merge_queue_parameters.dart';import 'package:pub_github_rest_3_1/models/repository_rule_merge_queue/repository_rule_merge_queue_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant5 {const Variant5({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant5.fromJson(Map<String, dynamic> json) { return Variant5(
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'merge_queue'; } 
Variant5 copyWith({RepositoryRuleMergeQueueType? type, RepositoryRuleMergeQueueParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant5(
  type: type ?? this.type,
...
@override String toString() => 'Variant5(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
