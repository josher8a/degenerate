...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant10)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_non_fast_forward/repository_rule_non_fast_forward_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant10 {const Variant10({required this.type, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant10.fromJson(Map<String, dynamic> json) { return Variant10(
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'non_fast_forward'; } 
Variant10 copyWith({RepositoryRuleNonFastForwardType? type, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant10(
  type: type ?? this.type,
...
@override String toString() => 'Variant10(type: $type, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
