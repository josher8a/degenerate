...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant19)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_max_file_size/repository_rule_max_file_size_parameters.dart';import 'package:pub_github_rest_3_1/models/repository_rule_max_file_size/repository_rule_max_file_size_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant19 {const Variant19({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant19.fromJson(Map<String, dynamic> json) { return Variant19(
...
@override String toString() => 'Variant19(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
