...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant11)
...
@immutable final class Variant11 {const Variant11({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant11.fromJson(Map<String, dynamic> json) { return Variant11(
...
Variant11 copyWith({RepositoryRuleCommitMessagePatternType? type, RepositoryRuleBranchNamePatternParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant11(
  type: type ?? this.type,
...
@override String toString() => 'Variant11(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
