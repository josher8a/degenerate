...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant18)
...
@immutable final class Variant18 {const Variant18({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant18.fromJson(Map<String, dynamic> json) { return Variant18(
...
Variant18 copyWith({RepositoryRuleFileExtensionRestrictionType? type, RepositoryRuleFileExtensionRestrictionParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant18(
  type: type ?? this.type,
...
@override String toString() => 'Variant18(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
