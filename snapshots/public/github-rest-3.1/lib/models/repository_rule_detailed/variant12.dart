...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant12)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_branch_name_pattern/repository_rule_branch_name_pattern_parameters.dart';import 'package:pub_github_rest_3_1/models/repository_rule_commit_author_email_pattern/repository_rule_commit_author_email_pattern_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant12 {const Variant12({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant12.fromJson(Map<String, dynamic> json) { return Variant12(
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'commit_author_email_pattern'; } 
Variant12 copyWith({RepositoryRuleCommitAuthorEmailPatternType? type, RepositoryRuleBranchNamePatternParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant12(
  type: type ?? this.type,
...
@override String toString() => 'Variant12(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
