...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant8)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_pull_request/repository_rule_pull_request_parameters.dart';import 'package:pub_github_rest_3_1/models/repository_rule_pull_request/repository_rule_pull_request_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant8 {const Variant8({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant8.fromJson(Map<String, dynamic> json) { return Variant8(
...
Variant8 copyWith({RepositoryRulePullRequestType? type, RepositoryRulePullRequestParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant8(
  type: type ?? this.type,
...
@override String toString() => 'Variant8(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
