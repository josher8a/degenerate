...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant22)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_copilot_code_review/repository_rule_copilot_code_review_parameters.dart';import 'package:pub_github_rest_3_1/models/repository_rule_copilot_code_review/repository_rule_copilot_code_review_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant22 {const Variant22({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant22.fromJson(Map<String, dynamic> json) { return Variant22(
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'copilot_code_review'; } 
Variant22 copyWith({RepositoryRuleCopilotCodeReviewType? type, RepositoryRuleCopilotCodeReviewParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant22(
  type: type ?? this.type,
...
@override String toString() => 'Variant22(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
