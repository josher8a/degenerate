...
// Source: #/components/schemas/RepositoryRuleDetailed (inline: Variant17)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_github_rest_3_1/models/repository_rule_max_file_path_length/repository_rule_max_file_path_length_parameters.dart';import 'package:pub_github_rest_3_1/models/repository_rule_max_file_path_length/repository_rule_max_file_path_length_type.dart';import 'package:pub_github_rest_3_1/models/repository_rule_ruleset_info/ruleset_source_type.dart';/// User-defined metadata to store domain-specific information limited to 8 keys with scalar values.
@immutable final class Variant17 {const Variant17({required this.type, this.parameters, this.rulesetSourceType, this.rulesetSource, this.rulesetId, });

factory Variant17.fromJson(Map<String, dynamic> json) { return Variant17(
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'max_file_path_length'; } 
Variant17 copyWith({RepositoryRuleMaxFilePathLengthType? type, RepositoryRuleMaxFilePathLengthParameters? Function()? parameters, RulesetSourceType? Function()? rulesetSourceType, String? Function()? rulesetSource, int? Function()? rulesetId, }) { return Variant17(
  type: type ?? this.type,
...
@override String toString() => 'Variant17(type: $type, parameters: $parameters, rulesetSourceType: $rulesetSourceType, rulesetSource: $rulesetSource, rulesetId: $rulesetId)';
