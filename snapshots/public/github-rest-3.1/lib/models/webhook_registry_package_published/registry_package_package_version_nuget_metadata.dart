...
// Source: #/components/schemas/WebhookRegistryPackagePublished (inline: RegistryPackage > PackageVersion > NugetMetadata)
...
factory RegistryPackagePackageVersionNugetMetadata.fromJson(Map<String, dynamic> json) { return RegistryPackagePackageVersionNugetMetadata(
  id: json['id'] != null ? OneOf3.parse(json['id'], fromA: (v) => v as String, fromB: (v) => v as Map<String, dynamic>, fromC: (v) => (v as num).toInt(), greedy: const {1},) : null,
