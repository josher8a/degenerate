...
WebhookPullRequestReviewEditedPullRequestBase copyWith({String? label, String? ref, WebhookPullRequestReviewEditedPullRequestBaseRepo? repo, String? sha, DiscussionUser? Function()? user, }) { return WebhookPullRequestReviewEditedPullRequestBase(
...
@override String toString() => 'WebhookPullRequestReviewEditedPullRequestBase(label: $label, ref: $ref, repo: $repo, sha: $sha, user: $user)';
