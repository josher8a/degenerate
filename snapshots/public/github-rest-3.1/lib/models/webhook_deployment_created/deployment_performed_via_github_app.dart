...
W when<W>({required W Function() branchProtectionRule, required W Function() checkRun, required W Function() checkSuite, required W Function() codeScanningAlert, required W Function() commitComment, required W Function() contentReference, required W Function() create, required W Function() delete, required W Function() deployment, required W Function() deploymentReview, required W Function() deploymentStatus, required W Function() deployKey, required W Function() discussion, required W Function() discussionComment, required W Function() fork, required W Function() gollum, required W Function() issues, required W Function() issueComment, required W Function() label, required W Function() member, required W Function() membership, required W Function() milestone, required W Function() organization, required W Function() orgBlock, required W Function() pageBuild, required W Function() project, required W Function() projectCard, required W Function() projectColumn, required W Function() public, required W Function() pullRequest, required W Function() pullRequestReview, required W Function() pullRequestReviewComment, required W Function() push, required W Function() registryPackage, required W Function() release, required W Function() repository, required W Function() repositoryDispatch, required W Function() secretScanningAlert, required W Function() star, required W Function() status, required W Function() team, required W Function() teamAdd, required W Function() watch, required W Function() workflowDispatch, required W Function() workflowRun, required W Function() workflowJob, required W Function() pullRequestReviewThread, required W Function() mergeQueueEntry, required W Function() secretScanningAlertLocation, required W Function() mergeGroup, required W Function(String value) $unknown, }) { return switch (this) {
      DeploymentPerformedViaGithubAppEvents$branchProtectionRule() => branchProtectionRule(),
      DeploymentPerformedViaGithubAppEvents$checkRun() => checkRun(),
      DeploymentPerformedViaGithubAppEvents$checkSuite() => checkSuite(),
      DeploymentPerformedViaGithubAppEvents$codeScanningAlert() => codeScanningAlert(),
      DeploymentPerformedViaGithubAppEvents$commitComment() => commitComment(),
      DeploymentPerformedViaGithubAppEvents$contentReference() => contentReference(),
      DeploymentPerformedViaGithubAppEvents$create() => create(),
      DeploymentPerformedViaGithubAppEvents$delete() => delete(),
      DeploymentPerformedViaGithubAppEvents$deployment() => deployment(),
      DeploymentPerformedViaGithubAppEvents$deploymentReview() => deploymentReview(),
      DeploymentPerformedViaGithubAppEvents$deploymentStatus() => deploymentStatus(),
      DeploymentPerformedViaGithubAppEvents$deployKey() => deployKey(),
      DeploymentPerformedViaGithubAppEvents$discussion() => discussion(),
      DeploymentPerformedViaGithubAppEvents$discussionComment() => discussionComment(),
      DeploymentPerformedViaGithubAppEvents$fork() => fork(),
      DeploymentPerformedViaGithubAppEvents$gollum() => gollum(),
      DeploymentPerformedViaGithubAppEvents$issues() => issues(),
      DeploymentPerformedViaGithubAppEvents$issueComment() => issueComment(),
      DeploymentPerformedViaGithubAppEvents$label() => label(),
      DeploymentPerformedViaGithubAppEvents$member() => member(),
      DeploymentPerformedViaGithubAppEvents$membership() => membership(),
      DeploymentPerformedViaGithubAppEvents$milestone() => milestone(),
      DeploymentPerformedViaGithubAppEvents$organization() => organization(),
      DeploymentPerformedViaGithubAppEvents$orgBlock() => orgBlock(),
      DeploymentPerformedViaGithubAppEvents$pageBuild() => pageBuild(),
      DeploymentPerformedViaGithubAppEvents$project() => project(),
      DeploymentPerformedViaGithubAppEvents$projectCard() => projectCard(),
      DeploymentPerformedViaGithubAppEvents$projectColumn() => projectColumn(),
      DeploymentPerformedViaGithubAppEvents$public() => public(),
      DeploymentPerformedViaGithubAppEvents$pullRequest() => pullRequest(),
      DeploymentPerformedViaGithubAppEvents$pullRequestReview() => pullRequestReview(),
      DeploymentPerformedViaGithubAppEvents$pullRequestReviewComment() => pullRequestReviewComment(),
      DeploymentPerformedViaGithubAppEvents$push() => push(),
      DeploymentPerformedViaGithubAppEvents$registryPackage() => registryPackage(),
      DeploymentPerformedViaGithubAppEvents$release() => release(),
      DeploymentPerformedViaGithubAppEvents$repository() => repository(),
      DeploymentPerformedViaGithubAppEvents$repositoryDispatch() => repositoryDispatch(),
      DeploymentPerformedViaGithubAppEvents$secretScanningAlert() => secretScanningAlert(),
      DeploymentPerformedViaGithubAppEvents$star() => star(),
      DeploymentPerformedViaGithubAppEvents$status() => status(),
      DeploymentPerformedViaGithubAppEvents$team() => team(),
      DeploymentPerformedViaGithubAppEvents$teamAdd() => teamAdd(),
      DeploymentPerformedViaGithubAppEvents$watch() => watch(),
      DeploymentPerformedViaGithubAppEvents$workflowDispatch() => workflowDispatch(),
      DeploymentPerformedViaGithubAppEvents$workflowRun() => workflowRun(),
      DeploymentPerformedViaGithubAppEvents$workflowJob() => workflowJob(),
      DeploymentPerformedViaGithubAppEvents$pullRequestReviewThread() => pullRequestReviewThread(),
      DeploymentPerformedViaGithubAppEvents$mergeQueueEntry() => mergeQueueEntry(),
      DeploymentPerformedViaGithubAppEvents$secretScanningAlertLocation() => secretScanningAlertLocation(),
      DeploymentPerformedViaGithubAppEvents$mergeGroup() => mergeGroup(),
      DeploymentPerformedViaGithubAppEvents$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? branchProtectionRule, W Function()? checkRun, W Function()? checkSuite, W Function()? codeScanningAlert, W Function()? commitComment, W Function()? contentReference, W Function()? create, W Function()? delete, W Function()? deployment, W Function()? deploymentReview, W Function()? deploymentStatus, W Function()? deployKey, W Function()? discussion, W Function()? discussionComment, W Function()? fork, W Function()? gollum, W Function()? issues, W Function()? issueComment, W Function()? label, W Function()? member, W Function()? membership, W Function()? milestone, W Function()? organization, W Function()? orgBlock, W Function()? pageBuild, W Function()? project, W Function()? projectCard, W Function()? projectColumn, W Function()? public, W Function()? pullRequest, W Function()? pullRequestReview, W Function()? pullRequestReviewComment, W Function()? push, W Function()? registryPackage, W Function()? release, W Function()? repository, W Function()? repositoryDispatch, W Function()? secretScanningAlert, W Function()? star, W Function()? status, W Function()? team, W Function()? teamAdd, W Function()? watch, W Function()? workflowDispatch, W Function()? workflowRun, W Function()? workflowJob, W Function()? pullRequestReviewThread, W Function()? mergeQueueEntry, W Function()? secretScanningAlertLocation, W Function()? mergeGroup, W Function(String value)? $unknown, }) { return switch (this) {
      DeploymentPerformedViaGithubAppEvents$branchProtectionRule() => branchProtectionRule != null ? branchProtectionRule() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$checkRun() => checkRun != null ? checkRun() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$checkSuite() => checkSuite != null ? checkSuite() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$codeScanningAlert() => codeScanningAlert != null ? codeScanningAlert() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$commitComment() => commitComment != null ? commitComment() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$contentReference() => contentReference != null ? contentReference() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$create() => create != null ? create() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$delete() => delete != null ? delete() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$deployment() => deployment != null ? deployment() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$deploymentReview() => deploymentReview != null ? deploymentReview() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$deploymentStatus() => deploymentStatus != null ? deploymentStatus() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$deployKey() => deployKey != null ? deployKey() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$discussion() => discussion != null ? discussion() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$discussionComment() => discussionComment != null ? discussionComment() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$fork() => fork != null ? fork() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$gollum() => gollum != null ? gollum() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$issues() => issues != null ? issues() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$issueComment() => issueComment != null ? issueComment() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$label() => label != null ? label() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$member() => member != null ? member() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$membership() => membership != null ? membership() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$milestone() => milestone != null ? milestone() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$organization() => organization != null ? organization() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$orgBlock() => orgBlock != null ? orgBlock() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$pageBuild() => pageBuild != null ? pageBuild() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$project() => project != null ? project() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$projectCard() => projectCard != null ? projectCard() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$projectColumn() => projectColumn != null ? projectColumn() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$public() => public != null ? public() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$pullRequest() => pullRequest != null ? pullRequest() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$pullRequestReview() => pullRequestReview != null ? pullRequestReview() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$pullRequestReviewComment() => pullRequestReviewComment != null ? pullRequestReviewComment() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$push() => push != null ? push() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$registryPackage() => registryPackage != null ? registryPackage() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$release() => release != null ? release() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$repository() => repository != null ? repository() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$repositoryDispatch() => repositoryDispatch != null ? repositoryDispatch() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$secretScanningAlert() => secretScanningAlert != null ? secretScanningAlert() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$star() => star != null ? star() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$status() => status != null ? status() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$team() => team != null ? team() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$teamAdd() => teamAdd != null ? teamAdd() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$watch() => watch != null ? watch() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$workflowDispatch() => workflowDispatch != null ? workflowDispatch() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$workflowRun() => workflowRun != null ? workflowRun() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$workflowJob() => workflowJob != null ? workflowJob() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$pullRequestReviewThread() => pullRequestReviewThread != null ? pullRequestReviewThread() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$mergeQueueEntry() => mergeQueueEntry != null ? mergeQueueEntry() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$secretScanningAlertLocation() => secretScanningAlertLocation != null ? secretScanningAlertLocation() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$mergeGroup() => mergeGroup != null ? mergeGroup() : orElse(value),
      DeploymentPerformedViaGithubAppEvents$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
