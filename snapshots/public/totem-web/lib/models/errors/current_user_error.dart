...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_totem_web/models/message.dart';sealed class CurrentUserError {const CurrentUserError();

factory CurrentUserError.fromResponse(ApiResponse response) {     try {
