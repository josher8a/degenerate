...
W when<W>({required W Function() desktop, required W Function() mobile, required W Function() $other, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByIpVersionDeviceType$desktop() => desktop(),
      RadarGetHttpTopAsesByIpVersionDeviceType$mobile() => mobile(),
      RadarGetHttpTopAsesByIpVersionDeviceType$$other() => $other(),
      RadarGetHttpTopAsesByIpVersionDeviceType$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? desktop, W Function()? mobile, W Function()? $other, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByIpVersionDeviceType$desktop() => desktop != null ? desktop() : orElse(value),
      RadarGetHttpTopAsesByIpVersionDeviceType$mobile() => mobile != null ? mobile() : orElse(value),
      RadarGetHttpTopAsesByIpVersionDeviceType$$other() => $other != null ? $other() : orElse(value),
      RadarGetHttpTopAsesByIpVersionDeviceType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
