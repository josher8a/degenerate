...
AigConfigPatchGatewayLogResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return AigConfigPatchGatewayLogResponse404(
...
@override String toString() => 'AigConfigPatchGatewayLogResponse404(errors: $errors, success: $success)';
