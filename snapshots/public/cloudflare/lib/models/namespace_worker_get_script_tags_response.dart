...
// Source: #/components/schemas/NamespaceWorkerGetScriptTagsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_messages2.dart';import 'package:pub_cloudflare/models/workers_tag.dart';@immutable final class NamespaceWorkerGetScriptTagsResponse {const NamespaceWorkerGetScriptTagsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'NamespaceWorkerGetScriptTagsResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
