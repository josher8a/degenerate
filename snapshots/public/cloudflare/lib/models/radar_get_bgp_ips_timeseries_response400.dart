...
RadarGetBgpIpsTimeseriesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetBgpIpsTimeseriesResponse400(
...
@override String toString() => 'RadarGetBgpIpsTimeseriesResponse400(errors: $errors, result: $result, success: $success)';
