...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/r2_add_custom_domain_request/min_tls.dart';import 'package:pub_cloudflare/models/r2_get_custom_domain_response/r2_get_custom_domain_response_status.dart';@immutable final class R2GetCustomDomainResponse {const R2GetCustomDomainResponse({required this.domain, required this.enabled, required this.status, this.ciphers, this.minTls, this.zoneId, this.zoneName, });
