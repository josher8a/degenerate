...
// Source: #/components/schemas/GetTagIndicatorsListResponse404

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class GetTagIndicatorsListResponse404 {const GetTagIndicatorsListResponse404({required this.errors, required this.result, required this.success, });
...
GetTagIndicatorsListResponse404 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetTagIndicatorsListResponse404(
...
@override String toString() => 'GetTagIndicatorsListResponse404(errors: $errors, result: $result, success: $success)';
