...
// Source: #/components/schemas/DestinationCreateResponse
...
@override String toString() => 'DestinationCreateResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
