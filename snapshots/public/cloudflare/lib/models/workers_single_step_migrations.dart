...
// Source: #/components/schemas/WorkersSingleStepMigrations

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_migration_step/renamed_classes.dart';import 'package:pub_cloudflare/models/workers_migration_step/transferred_classes.dart';/// A single set of migrations to apply.
...
WorkersSingleStepMigrations copyWith({String? Function()? newTag, String? Function()? oldTag, List<String>? Function()? deletedClasses, List<String>? Function()? newClasses, List<String>? Function()? newSqliteClasses, List<RenamedClasses>? Function()? renamedClasses, List<TransferredClasses>? Function()? transferredClasses, }) { return WorkersSingleStepMigrations(
...
@override int get hashCode => Object.hash(newTag, oldTag, Object.hashAll(deletedClasses ?? const []), Object.hashAll(newClasses ?? const []), Object.hashAll(newSqliteClasses ?? const []), Object.hashAll(renamedClasses ?? const []), Object.hashAll(transferredClasses ?? const []));

@override String toString() => 'WorkersSingleStepMigrations(newTag: $newTag, oldTag: $oldTag, deletedClasses: $deletedClasses, newClasses: $newClasses, newSqliteClasses: $newSqliteClasses, renamedClasses: $renamedClasses, transferredClasses: $transferredClasses)';
