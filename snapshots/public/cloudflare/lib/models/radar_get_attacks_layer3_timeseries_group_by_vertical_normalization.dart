...
W when<W>({required W Function() percentage, required W Function() min0Max, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetAttacksLayer3TimeseriesGroupByVerticalNormalization$percentage() => percentage(),
      RadarGetAttacksLayer3TimeseriesGroupByVerticalNormalization$min0Max() => min0Max(),
      RadarGetAttacksLayer3TimeseriesGroupByVerticalNormalization$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? percentage, W Function()? min0Max, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetAttacksLayer3TimeseriesGroupByVerticalNormalization$percentage() => percentage != null ? percentage() : orElse(value),
      RadarGetAttacksLayer3TimeseriesGroupByVerticalNormalization$min0Max() => min0Max != null ? min0Max() : orElse(value),
      RadarGetAttacksLayer3TimeseriesGroupByVerticalNormalization$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
