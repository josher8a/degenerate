...
WorDescribeWorkflowVersionsGraphResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorDescribeWorkflowVersionsGraphResponse404(
...
@override String toString() => 'WorDescribeWorkflowVersionsGraphResponse404(errors: $errors, messages: $messages, result: $result, success: $success)';
