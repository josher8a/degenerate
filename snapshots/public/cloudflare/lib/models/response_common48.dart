...
// Source: #/components/schemas/ResponseCommon48

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/magic_messages2.dart';import 'package:pub_cloudflare/models/response_common33/response_common33_result.dart';@immutable final class ResponseCommon48 {const ResponseCommon48({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommon48 copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, ResponseCommon33Result? result, bool? success, }) { return ResponseCommon48(
...
@override String toString() => 'ResponseCommon48(errors: $errors, messages: $messages, result: $result, success: $success)';
