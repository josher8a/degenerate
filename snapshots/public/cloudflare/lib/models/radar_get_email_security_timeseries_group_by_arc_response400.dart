...
RadarGetEmailSecurityTimeseriesGroupByArcResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetEmailSecurityTimeseriesGroupByArcResponse400(
...
@override String toString() => 'RadarGetEmailSecurityTimeseriesGroupByArcResponse400(errors: $errors, result: $result, success: $success)';
