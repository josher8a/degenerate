...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/firewall_messages2.dart';import 'package:pub_cloudflare/models/firewall_result_info.dart';@immutable final class UserAgentBlockingRulesListUserAgentBlockingRulesResponse4Xx {const UserAgentBlockingRulesListUserAgentBlockingRulesResponse4Xx({required this.result, required this.errors, required this.messages, required this.success, this.resultInfo, });
...
@override int get hashCode => Object.hash(result, Object.hashAll(errors), Object.hashAll(messages), success, resultInfo);

@override String toString() => 'UserAgentBlockingRulesListUserAgentBlockingRulesResponse4Xx(result: $result, errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)';
