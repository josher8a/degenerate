...
// Source: #/components/schemas/CachePurgeFlexPurgeByHostnames
...
@override int get hashCode => Object.hashAll(hosts ?? const []);

@override String toString() => 'CachePurgeFlexPurgeByHostnames(hosts: $hosts)';
