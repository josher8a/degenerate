...
W when<W>({required W Function() udp, required W Function() tcp, required W Function() https, required W Function() tls, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetDnsAs112SummaryProtocol$udp() => udp(),
      RadarGetDnsAs112SummaryProtocol$tcp() => tcp(),
      RadarGetDnsAs112SummaryProtocol$https() => https(),
      RadarGetDnsAs112SummaryProtocol$tls() => tls(),
      RadarGetDnsAs112SummaryProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? udp, W Function()? tcp, W Function()? https, W Function()? tls, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetDnsAs112SummaryProtocol$udp() => udp != null ? udp() : orElse(value),
      RadarGetDnsAs112SummaryProtocol$tcp() => tcp != null ? tcp() : orElse(value),
      RadarGetDnsAs112SummaryProtocol$https() => https != null ? https() : orElse(value),
      RadarGetDnsAs112SummaryProtocol$tls() => tls != null ? tls() : orElse(value),
      RadarGetDnsAs112SummaryProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
