...
// Source: #/components/schemas/CreatePortalsRequest (inline: Servers > UpdatedPrompts)
...
@override String toString() => 'UpdatedPrompts(description: $description, enabled: $enabled, name: $name)';
