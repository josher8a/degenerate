...
return errors; } 
Messages35 copyWith({double? Function()? frequencyPenalty, List<Messages10Functions>? Function()? functions, Map<String, dynamic>? Function()? guidedJson, int Function()? maxTokens, List<Messages28Messages>? messages, double? Function()? presencePenalty, bool Function()? raw, double? Function()? repetitionPenalty, int? Function()? seed, bool Function()? stream, double Function()? temperature, List<Messages10Tools>? Function()? tools, int? Function()? topK, double? Function()? topP, }) { return Messages35(
...
@override int get hashCode => Object.hash(frequencyPenalty, Object.hashAll(functions ?? const []), guidedJson, maxTokens, Object.hashAll(messages), presencePenalty, raw, repetitionPenalty, seed, stream, temperature, Object.hashAll(tools ?? const []), topK, topP);

@override String toString() => 'Messages35(frequencyPenalty: $frequencyPenalty, functions: $functions, guidedJson: $guidedJson, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)';
