...
W when<W>({required W Function() $100132, required W Function(int value) $unknown, }) { return switch (this) {
      WorkersErrorWorkerNameSubdomainLengthLimitCode$$100132() => $100132(),
      WorkersErrorWorkerNameSubdomainLengthLimitCode$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(int value) orElse, W Function()? $100132, W Function(int value)? $unknown, }) { return switch (this) {
      WorkersErrorWorkerNameSubdomainLengthLimitCode$$100132() => $100132 != null ? $100132() : orElse(value),
      WorkersErrorWorkerNameSubdomainLengthLimitCode$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
