...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/load_balancing_messages2.dart';import 'package:pub_cloudflare/models/load_balancing_result_info.dart';@immutable final class AccountLoadBalancerPoolsListPoolsResponse4Xx {const AccountLoadBalancerPoolsListPoolsResponse4Xx({required this.errors, required this.messages, required this.success, required this.resultInfo, required this.result, });
...
@override String toString() => 'AccountLoadBalancerPoolsListPoolsResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
