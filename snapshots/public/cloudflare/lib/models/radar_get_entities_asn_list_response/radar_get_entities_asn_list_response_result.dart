...
// Source: #/components/schemas/RadarGetEntitiesAsnListResponse (inline: Result)
...
@override int get hashCode => Object.hashAll(asns);

@override String toString() => 'RadarGetEntitiesAsnListResponseResult(asns: $asns)';
