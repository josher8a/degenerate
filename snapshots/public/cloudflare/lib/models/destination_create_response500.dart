...
DestinationCreateResponse500 copyWith({List<DestinationCreateResponse500Errors>? errors, List<DestinationCreateResponse400Messages>? messages, bool? success, }) { return DestinationCreateResponse500(
...
@override String toString() => 'DestinationCreateResponse500(errors: $errors, messages: $messages, success: $success)';
