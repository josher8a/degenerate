...
W when<W>({required W Function() http, required W Function() https, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpSummaryByPostQuantumHttpProtocol$http() => http(),
      RadarGetHttpSummaryByPostQuantumHttpProtocol$https() => https(),
      RadarGetHttpSummaryByPostQuantumHttpProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? http, W Function()? https, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpSummaryByPostQuantumHttpProtocol$http() => http != null ? http() : orElse(value),
      RadarGetHttpSummaryByPostQuantumHttpProtocol$https() => https != null ? https() : orElse(value),
      RadarGetHttpSummaryByPostQuantumHttpProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
