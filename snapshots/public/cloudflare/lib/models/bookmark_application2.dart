...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/access_app_launcher_visible.dart';import 'package:pub_cloudflare/models/access_app_policy_response.dart';import 'package:pub_cloudflare/models/access_apps_components_schemas_name.dart';import 'package:pub_cloudflare/models/access_logo_url.dart';import 'package:pub_cloudflare/models/access_schemas_aud.dart';import 'package:pub_cloudflare/models/access_timestamp.dart';import 'package:pub_cloudflare/models/access_type.dart';import 'package:pub_cloudflare/models/access_uuid.dart';/// The policies that Access applies to the application.
...
@override int get hashCode => Object.hash(aud, createdAt, id, updatedAt, appLauncherVisible, domain, logoUrl, name, Object.hashAll(tags ?? const []), type, Object.hashAll(policies ?? const []));

@override String toString() => 'BookmarkApplication2(\n  aud: $aud,\n  createdAt: $createdAt,\n  id: $id,\n  updatedAt: $updatedAt,\n  appLauncherVisible: $appLauncherVisible,\n  domain: $domain,\n  logoUrl: $logoUrl,\n  name: $name,\n  tags: $tags,\n  type: $type,\n  policies: $policies,\n)';
