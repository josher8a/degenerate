...
ListServersResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return ListServersResponse400(
...
@override String toString() => 'ListServersResponse400(errors: $errors, result: $result, success: $success)';
