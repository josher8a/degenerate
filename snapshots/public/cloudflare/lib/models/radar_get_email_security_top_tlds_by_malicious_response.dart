...
// Source: #/components/schemas/RadarGetEmailSecurityTopTldsByMaliciousResponse
...
@override String toString() => 'RadarGetEmailSecurityTopTldsByMaliciousResponse(result: $result, success: $success)';
