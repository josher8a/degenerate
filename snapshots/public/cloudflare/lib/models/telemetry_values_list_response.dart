...
// Source: #/components/schemas/TelemetryValuesListResponse
...
@override String toString() => 'TelemetryValuesListResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
