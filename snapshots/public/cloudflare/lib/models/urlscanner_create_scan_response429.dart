...
// Source: #/components/schemas/UrlscannerCreateScanResponse429

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';import 'package:pub_cloudflare/models/destination_create_response400/destination_create_response400_messages.dart';@immutable final class UrlscannerCreateScanResponse429 {const UrlscannerCreateScanResponse429({required this.errors, required this.messages, required this.success, });
...
UrlscannerCreateScanResponse429 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, List<DestinationCreateResponse400Messages>? messages, bool? success, }) { return UrlscannerCreateScanResponse429(
...
@override String toString() => 'UrlscannerCreateScanResponse429(errors: $errors, messages: $messages, success: $success)';
