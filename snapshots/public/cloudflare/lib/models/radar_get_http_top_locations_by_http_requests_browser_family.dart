...
W when<W>({required W Function() chrome, required W Function() edge, required W Function() firefox, required W Function() safari, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$chrome() => chrome(),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$edge() => edge(),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$firefox() => firefox(),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$safari() => safari(),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? chrome, W Function()? edge, W Function()? firefox, W Function()? safari, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$chrome() => chrome != null ? chrome() : orElse(value),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$edge() => edge != null ? edge() : orElse(value),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$firefox() => firefox != null ? firefox() : orElse(value),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$safari() => safari != null ? safari() : orElse(value),
      RadarGetHttpTopLocationsByHttpRequestsBrowserFamily$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
