...
W when<W>({required W Function() public, required W Function(String value) $unknown, }) { return switch (this) {
      PublicDestinationType$public() => public(),
      PublicDestinationType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? public, W Function(String value)? $unknown, }) { return switch (this) {
      PublicDestinationType$public() => public != null ? public() : orElse(value),
      PublicDestinationType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
