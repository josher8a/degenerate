...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';@immutable final class NotificationSilencesUpdateSilencesResponse4Xx {const NotificationSilencesUpdateSilencesResponse4Xx({required this.errors, required this.messages, required this.success, });
...
NotificationSilencesUpdateSilencesResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, }) { return NotificationSilencesUpdateSilencesResponse4Xx(
...
@override String toString() => 'NotificationSilencesUpdateSilencesResponse4Xx(errors: $errors, messages: $messages, success: $success)';
