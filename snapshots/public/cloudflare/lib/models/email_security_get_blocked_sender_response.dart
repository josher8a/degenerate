...
// Source: #/components/schemas/EmailSecurityGetBlockedSenderResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_create_blocked_sender_response/email_security_create_blocked_sender_response_result.dart';import 'package:pub_cloudflare/models/email_security_message.dart';@immutable final class EmailSecurityGetBlockedSenderResponse {const EmailSecurityGetBlockedSenderResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
EmailSecurityGetBlockedSenderResponse copyWith({List<EmailSecurityMessage>? errors, List<EmailSecurityMessage>? messages, bool? success, EmailSecurityCreateBlockedSenderResponseResult? result, }) { return EmailSecurityGetBlockedSenderResponse(
