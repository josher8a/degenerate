...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/response_single_id4/response_single_id4_result.dart';import 'package:pub_cloudflare/models/zones_messages2.dart';@immutable final class ResponseSingleId8 {const ResponseSingleId8({required this.errors, required this.messages, required this.success, this.result, });
...
ResponseSingleId8 copyWith({List<ZonesMessages2>? errors, List<ZonesMessages2>? messages, bool? success, ResponseSingleId4Result? Function()? result, }) { return ResponseSingleId8(
