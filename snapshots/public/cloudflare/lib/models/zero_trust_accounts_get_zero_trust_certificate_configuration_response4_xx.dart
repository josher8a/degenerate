...
// Source: #/components/schemas/ZeroTrustAccountsGetZeroTrustCertificateConfigurationResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_messages2.dart';/// Specify custom certificate settings for BYO-PKI. This field is deprecated; use `certificate` instead.
...
@override int get hashCode => Object.hash(bindingStatus, enabled, id, updatedAt, Object.hashAll(errors), Object.hashAll(messages), result, success);

@override String toString() => 'ZeroTrustAccountsGetZeroTrustCertificateConfigurationResponse4Xx(bindingStatus: $bindingStatus, enabled: $enabled, id: $id, updatedAt: $updatedAt, errors: $errors, messages: $messages, result: $result, success: $success)';
