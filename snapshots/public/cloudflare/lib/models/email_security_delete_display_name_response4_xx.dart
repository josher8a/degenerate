...
// Source: #/components/schemas/EmailSecurityDeleteDisplayNameResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_message.dart';@immutable final class EmailSecurityDeleteDisplayNameResponse4Xx {const EmailSecurityDeleteDisplayNameResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'EmailSecurityDeleteDisplayNameResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
