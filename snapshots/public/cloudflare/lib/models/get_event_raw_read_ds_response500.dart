...
GetEventRawReadDsResponse500 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetEventRawReadDsResponse500(
...
@override String toString() => 'GetEventRawReadDsResponse500(errors: $errors, result: $result, success: $success)';
