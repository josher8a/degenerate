...
// Source: #/components/schemas/AlexandriaGetCategoryResponse
...
@override String toString() => 'AlexandriaGetCategoryResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
