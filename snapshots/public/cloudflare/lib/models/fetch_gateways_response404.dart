...
FetchGatewaysResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return FetchGatewaysResponse404(
...
@override String toString() => 'FetchGatewaysResponse404(errors: $errors, success: $success)';
