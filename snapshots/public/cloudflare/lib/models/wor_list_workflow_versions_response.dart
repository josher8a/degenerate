...
// Source: #/components/schemas/WorListWorkflowVersionsResponse
...
@override String toString() => 'WorListWorkflowVersionsResponse(errors: $errors, messages: $messages, result: $result, resultInfo: $resultInfo, success: $success)';
