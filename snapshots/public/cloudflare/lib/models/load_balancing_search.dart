...
// Source: #/components/schemas/LoadBalancingSearch
...
@override int get hashCode => Object.hashAll(resources ?? const []);

@override String toString() => 'LoadBalancingSearch(resources: $resources)';
