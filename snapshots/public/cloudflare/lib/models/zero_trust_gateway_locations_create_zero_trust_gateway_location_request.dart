...
// Source: #/components/schemas/ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocationRequest

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_client_default.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_dns_destination_ips_id_write.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_ecs_support.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_endpoints.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_ipv4_network.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_schemas_name.dart';@immutable final class ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocationRequest {const ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocationRequest({required this.name, this.clientDefault, this.dnsDestinationIpsId, this.ecsSupport, this.endpoints, this.networks, });
...
@override String toString() => 'ZeroTrustGatewayLocationsCreateZeroTrustGatewayLocationRequest(clientDefault: $clientDefault, dnsDestinationIpsId: $dnsDestinationIpsId, ecsSupport: $ecsSupport, endpoints: $endpoints, name: $name, networks: $networks)';
