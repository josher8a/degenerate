...
// Source: #/components/schemas/AaaSchemasResponseCollection
...
@override String toString() => 'AaaSchemasResponseCollection(errors: $errors, messages: $messages, success: $success, result: $result)';
