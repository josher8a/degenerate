...
// Source: #/components/schemas/ResponseSingleObj

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/shield_messages2.dart';@immutable final class ResponseSingleObj {const ResponseSingleObj({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'ResponseSingleObj(errors: $errors, messages: $messages, success: $success, result: $result)';
