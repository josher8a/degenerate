...
W when<W>({required W Function() deep, required W Function() shallow, required W Function(String value) $unknown, }) { return switch (this) {
      InspectionMode$deep() => deep(),
      InspectionMode$shallow() => shallow(),
      InspectionMode$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? deep, W Function()? shallow, W Function(String value)? $unknown, }) { return switch (this) {
      InspectionMode$deep() => deep != null ? deep() : orElse(value),
      InspectionMode$shallow() => shallow != null ? shallow() : orElse(value),
      InspectionMode$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
