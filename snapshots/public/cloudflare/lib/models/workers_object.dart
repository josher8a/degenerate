...
// Source: #/components/schemas/WorkersObject
...
@override int get hashCode => Object.hash(hasStoredData, id);

@override String toString() => 'WorkersObject(hasStoredData: $hasStoredData, id: $id)';
