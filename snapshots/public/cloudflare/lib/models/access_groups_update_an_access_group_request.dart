...
// Source: #/components/schemas/AccessGroupsUpdateAnAccessGroupRequest
...
@override int get hashCode => Object.hash(Object.hashAll(exclude ?? const []), Object.hashAll(include), isDefault, name, Object.hashAll(require ?? const []));

@override String toString() => 'AccessGroupsUpdateAnAccessGroupRequest(exclude: $exclude, include: $include, isDefault: $isDefault, name: $name, require: $require)';
