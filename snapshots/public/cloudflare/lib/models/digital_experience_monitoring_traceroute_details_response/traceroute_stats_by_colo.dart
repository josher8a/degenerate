...
@override int get hashCode => Object.hash(availabilityPct, colo, hopsCount, packetLossPct, roundTripTimeMs, uniqueDevicesTotal);

@override String toString() => 'TracerouteStatsByColo(availabilityPct: $availabilityPct, colo: $colo, hopsCount: $hopsCount, packetLossPct: $packetLossPct, roundTripTimeMs: $roundTripTimeMs, uniqueDevicesTotal: $uniqueDevicesTotal)';
