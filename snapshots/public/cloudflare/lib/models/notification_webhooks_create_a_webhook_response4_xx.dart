...
// Source: #/components/schemas/NotificationWebhooksCreateAWebhookResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';import 'package:pub_cloudflare/models/aaa_id_response/aaa_id_response_result.dart';@immutable final class NotificationWebhooksCreateAWebhookResponse4Xx {const NotificationWebhooksCreateAWebhookResponse4Xx({required this.errors, required this.messages, required this.success, this.result, });
...
NotificationWebhooksCreateAWebhookResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, AaaIdResponseResult? Function()? result, }) { return NotificationWebhooksCreateAWebhookResponse4Xx(
...
@override String toString() => 'NotificationWebhooksCreateAWebhookResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)';
