...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';@immutable final class NotificationWebhooksCreateAWebhookResponse4Xx {const NotificationWebhooksCreateAWebhookResponse4Xx({required this.errors, required this.messages, required this.success, });
...
NotificationWebhooksCreateAWebhookResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, }) { return NotificationWebhooksCreateAWebhookResponse4Xx(
...
@override String toString() => 'NotificationWebhooksCreateAWebhookResponse4Xx(errors: $errors, messages: $messages, success: $success)';
