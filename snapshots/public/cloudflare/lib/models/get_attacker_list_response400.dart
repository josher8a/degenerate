...
GetAttackerListResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetAttackerListResponse400(
...
@override String toString() => 'GetAttackerListResponse400(errors: $errors, result: $result, success: $success)';
