...
// Source: #/components/schemas/DosTcpFlowProtectionRuleUpdate
...
@override int get hashCode => Object.hash(burstSensitivity, mode, rateSensitivity);

@override String toString() => 'DosTcpFlowProtectionRuleUpdate(burstSensitivity: $burstSensitivity, mode: $mode, rateSensitivity: $rateSensitivity)';
