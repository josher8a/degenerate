...
// Source: #/components/schemas/GetIndicatorReadResponse404

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class GetIndicatorReadResponse404 {const GetIndicatorReadResponse404({required this.errors, required this.result, required this.success, });
...
GetIndicatorReadResponse404 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetIndicatorReadResponse404(
...
@override String toString() => 'GetIndicatorReadResponse404(errors: $errors, result: $result, success: $success)';
