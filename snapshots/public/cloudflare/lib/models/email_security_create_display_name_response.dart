...
// Source: #/components/schemas/EmailSecurityCreateDisplayNameResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_create_display_name_response/email_security_create_display_name_response_result.dart';import 'package:pub_cloudflare/models/email_security_message.dart';@immutable final class EmailSecurityCreateDisplayNameResponse {const EmailSecurityCreateDisplayNameResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'EmailSecurityCreateDisplayNameResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
