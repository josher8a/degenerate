...
BrapiPostPdfResponse400 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? Function()? errors, bool? success, }) { return BrapiPostPdfResponse400(
...
@override String toString() => 'BrapiPostPdfResponse400(errors: $errors, success: $success)';
