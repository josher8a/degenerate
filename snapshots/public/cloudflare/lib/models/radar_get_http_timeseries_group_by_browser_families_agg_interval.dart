...
W when<W>({required W Function() $15m, required W Function() $1h, required W Function() $1d, required W Function() $1w, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$15m() => $15m(),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$1h() => $1h(),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$1d() => $1d(),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$1w() => $1w(),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $15m, W Function()? $1h, W Function()? $1d, W Function()? $1w, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$15m() => $15m != null ? $15m() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$1h() => $1h != null ? $1h() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$1d() => $1d != null ? $1d() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$$1w() => $1w != null ? $1w() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowserFamiliesAggInterval$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
