...
// Source: #/components/schemas/CloudflareImagesVariantsListVariantsResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/images_messages2.dart';@immutable final class CloudflareImagesVariantsListVariantsResponse4Xx {const CloudflareImagesVariantsListVariantsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'CloudflareImagesVariantsListVariantsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
