...
TelemetryValuesListResponse500 copyWith({List<DestinationCreateResponse500Errors>? errors, List<DestinationCreateResponse400Messages>? messages, bool? success, }) { return TelemetryValuesListResponse500(
...
@override String toString() => 'TelemetryValuesListResponse500(errors: $errors, messages: $messages, success: $success)';
