...
// Source: #/components/schemas/WorGetWorkflowDetailsResponse
...
@override String toString() => 'WorGetWorkflowDetailsResponse(errors: $errors, messages: $messages, result: $result, resultInfo: $resultInfo, success: $success)';
