...
W when<W>({required W Function() oauthbearertoken, required W Function(String value) $unknown, }) { return switch (this) {
      AccessSchemasScimConfigAuthenticationOauthBearerTokenScheme$oauthbearertoken() => oauthbearertoken(),
      AccessSchemasScimConfigAuthenticationOauthBearerTokenScheme$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? oauthbearertoken, W Function(String value)? $unknown, }) { return switch (this) {
      AccessSchemasScimConfigAuthenticationOauthBearerTokenScheme$oauthbearertoken() => oauthbearertoken != null ? oauthbearertoken() : orElse(value),
      AccessSchemasScimConfigAuthenticationOauthBearerTokenScheme$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
