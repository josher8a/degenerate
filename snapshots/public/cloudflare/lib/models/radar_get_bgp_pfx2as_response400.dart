...
// Source: #/components/schemas/RadarGetBgpPfx2asResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class RadarGetBgpPfx2asResponse400 {const RadarGetBgpPfx2asResponse400({required this.errors, required this.result, required this.success, });
...
RadarGetBgpPfx2asResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetBgpPfx2asResponse400(
...
@override String toString() => 'RadarGetBgpPfx2asResponse400(errors: $errors, result: $result, success: $success)';
