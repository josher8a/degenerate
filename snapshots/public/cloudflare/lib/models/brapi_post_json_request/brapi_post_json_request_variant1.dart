...
factory BrapiPostJsonRequestVariant1.fromJson(Map<String, dynamic> json) { return BrapiPostJsonRequestVariant1(
  ...
  customAi: (json['custom_ai'] as List<dynamic>?)?.map((e) => CustomAi.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  responseFormat: json['response_format'] != null ? Variant1ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final Variant1ResponseFormat? responseFormat;
