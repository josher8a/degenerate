...
// Source: #/components/schemas/RadarGetTldsResponse (inline: Result)
...
@override int get hashCode => Object.hashAll(tlds);

@override String toString() => 'RadarGetTldsResponseResult(tlds: $tlds)';
