...
// Source: #/components/schemas/RadarGetHttpTimeseriesGroupByHttpProtocolResponse
...
@override String toString() => 'RadarGetHttpTimeseriesGroupByHttpProtocolResponse(result: $result, success: $success)';
