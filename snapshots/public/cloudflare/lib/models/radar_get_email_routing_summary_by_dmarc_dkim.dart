...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailRoutingSummaryByDmarcDkim$pass() => pass(),
      RadarGetEmailRoutingSummaryByDmarcDkim$none() => none(),
      RadarGetEmailRoutingSummaryByDmarcDkim$fail() => fail(),
      RadarGetEmailRoutingSummaryByDmarcDkim$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailRoutingSummaryByDmarcDkim$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailRoutingSummaryByDmarcDkim$none() => none != null ? none() : orElse(value),
      RadarGetEmailRoutingSummaryByDmarcDkim$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailRoutingSummaryByDmarcDkim$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
