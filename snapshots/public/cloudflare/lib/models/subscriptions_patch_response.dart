...
// Source: #/components/schemas/SubscriptionsPatchResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/error_model22.dart';import 'package:pub_cloudflare/models/mq_event_subscription.dart';@immutable final class SubscriptionsPatchResponse {const SubscriptionsPatchResponse({this.errors, this.messages, this.success, this.result, });
...
@override String toString() => 'SubscriptionsPatchResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
