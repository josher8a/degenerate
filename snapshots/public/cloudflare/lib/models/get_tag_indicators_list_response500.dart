...
GetTagIndicatorsListResponse500 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetTagIndicatorsListResponse500(
...
@override String toString() => 'GetTagIndicatorsListResponse500(errors: $errors, result: $result, success: $success)';
