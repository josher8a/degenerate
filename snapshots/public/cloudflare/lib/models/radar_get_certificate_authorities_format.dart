...
W when<W>({required W Function() $json, required W Function() csv, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetCertificateAuthoritiesFormat$$json() => $json(),
      RadarGetCertificateAuthoritiesFormat$csv() => csv(),
      RadarGetCertificateAuthoritiesFormat$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $json, W Function()? csv, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetCertificateAuthoritiesFormat$$json() => $json != null ? $json() : orElse(value),
      RadarGetCertificateAuthoritiesFormat$csv() => csv != null ? csv() : orElse(value),
      RadarGetCertificateAuthoritiesFormat$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
