...
W when<W>({required W Function() $json, required W Function() csv, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetAiInferenceTimeseriesGroupByModelFormat$$json() => $json(),
      RadarGetAiInferenceTimeseriesGroupByModelFormat$csv() => csv(),
      RadarGetAiInferenceTimeseriesGroupByModelFormat$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $json, W Function()? csv, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetAiInferenceTimeseriesGroupByModelFormat$$json() => $json != null ? $json() : orElse(value),
      RadarGetAiInferenceTimeseriesGroupByModelFormat$csv() => csv != null ? csv() : orElse(value),
      RadarGetAiInferenceTimeseriesGroupByModelFormat$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
