...
// Source: #/components/schemas/ResponseCommonFailure65

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/smartshield_messages2.dart';@immutable final class ResponseCommonFailure65 {const ResponseCommonFailure65({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'ResponseCommonFailure65(errors: $errors, messages: $messages, result: $result, success: $success)';
