...
WorkersAiPostWebsocketRunCfPipecatAiSmartTurnResponse4002 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return WorkersAiPostWebsocketRunCfPipecatAiSmartTurnResponse4002(
...
@override String toString() => 'WorkersAiPostWebsocketRunCfPipecatAiSmartTurnResponse4002(errors: $errors, result: $result, success: $success)';
