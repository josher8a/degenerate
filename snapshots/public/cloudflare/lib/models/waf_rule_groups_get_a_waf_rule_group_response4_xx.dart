...
// Source: #/components/schemas/WafRuleGroupsGetAWafRuleGroupResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/waf_managed_rules_messages2.dart';@immutable final class WafRuleGroupsGetAWafRuleGroupResponse4Xx {const WafRuleGroupsGetAWafRuleGroupResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
WafRuleGroupsGetAWafRuleGroupResponse4Xx copyWith({List<WafManagedRulesMessages2>? errors, List<WafManagedRulesMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WafRuleGroupsGetAWafRuleGroupResponse4Xx(
...
@override String toString() => 'WafRuleGroupsGetAWafRuleGroupResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
