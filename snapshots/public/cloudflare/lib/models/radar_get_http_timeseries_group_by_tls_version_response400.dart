...
RadarGetHttpTimeseriesGroupByTlsVersionResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetHttpTimeseriesGroupByTlsVersionResponse400(
...
@override String toString() => 'RadarGetHttpTimeseriesGroupByTlsVersionResponse400(errors: $errors, result: $result, success: $success)';
