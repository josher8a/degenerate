...
W when<W>({required W Function() pull, required W Function() push, required W Function(String value) $unknown, }) { return switch (this) {
      CcImageRegistryPermissions$pull() => pull(),
      CcImageRegistryPermissions$push() => push(),
      CcImageRegistryPermissions$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pull, W Function()? push, W Function(String value)? $unknown, }) { return switch (this) {
      CcImageRegistryPermissions$pull() => pull != null ? pull() : orElse(value),
      CcImageRegistryPermissions$push() => push != null ? push() : orElse(value),
      CcImageRegistryPermissions$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
