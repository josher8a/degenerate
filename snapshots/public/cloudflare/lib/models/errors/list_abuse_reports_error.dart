...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/list_abuse_reports_response500.dart';sealed class ListAbuseReportsError {const ListAbuseReportsError();

factory ListAbuseReportsError.fromResponse(ApiResponse response) {     try {
