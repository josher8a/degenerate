...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/get_attacker_list_response400.dart';sealed class GetAttackerListError {const GetAttackerListError();

factory GetAttackerListError.fromResponse(ApiResponse response) {     try {
