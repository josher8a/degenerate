...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_get_to_markdown_supported_response400.dart';sealed class WorkersAiGetToMarkdownSupportedError {const WorkersAiGetToMarkdownSupportedError();

factory WorkersAiGetToMarkdownSupportedError.fromResponse(ApiResponse response) {     try {
...
final class WorkersAiGetToMarkdownSupportedError$400 extends WorkersAiGetToMarkdownSupportedError {const WorkersAiGetToMarkdownSupportedError$400(this.error);
