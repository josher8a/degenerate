...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/post_event_query_alert_update_response400.dart';import 'package:pub_cloudflare/models/post_event_query_alert_update_response404.dart';sealed class PostEventQueryAlertUpdateError {const PostEventQueryAlertUpdateError();

factory PostEventQueryAlertUpdateError.fromResponse(ApiResponse response) {     try {
