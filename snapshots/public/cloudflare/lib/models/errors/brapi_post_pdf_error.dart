...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/brapi_post_pdf_response400.dart';import 'package:pub_cloudflare/models/brapi_post_pdf_response422.dart';import 'package:pub_cloudflare/models/brapi_post_pdf_response429.dart';import 'package:pub_cloudflare/models/brapi_post_pdf_response500.dart';sealed class BrapiPostPdfError {const BrapiPostPdfError();

factory BrapiPostPdfError.fromResponse(ApiResponse response) {     try {
