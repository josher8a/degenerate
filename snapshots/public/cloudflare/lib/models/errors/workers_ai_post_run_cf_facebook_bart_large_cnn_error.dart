...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_run_cf_facebook_bart_large_cnn_response400.dart';sealed class WorkersAiPostRunCfFacebookBartLargeCnnError {const WorkersAiPostRunCfFacebookBartLargeCnnError();

factory WorkersAiPostRunCfFacebookBartLargeCnnError.fromResponse(ApiResponse response) {     try {
