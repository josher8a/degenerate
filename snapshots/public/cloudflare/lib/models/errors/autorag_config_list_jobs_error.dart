...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/autorag_config_list_jobs_response404.dart';import 'package:pub_cloudflare/models/autorag_config_list_jobs_response503.dart';sealed class AutoragConfigListJobsError {const AutoragConfigListJobsError();

factory AutoragConfigListJobsError.fromResponse(ApiResponse response) {     try {
...
final class AutoragConfigListJobsError$Unknown extends AutoragConfigListJobsError {const AutoragConfigListJobsError$Unknown(this.statusCode, this.rawBody, );
