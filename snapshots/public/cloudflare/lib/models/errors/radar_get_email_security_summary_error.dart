...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_email_security_summary_response400.dart';sealed class RadarGetEmailSecuritySummaryError {const RadarGetEmailSecuritySummaryError();

factory RadarGetEmailSecuritySummaryError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetEmailSecuritySummaryError$400 extends RadarGetEmailSecuritySummaryError {const RadarGetEmailSecuritySummaryError$400(this.error);
