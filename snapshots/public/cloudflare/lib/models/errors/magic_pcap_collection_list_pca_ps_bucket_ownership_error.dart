...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/magic_pcap_collection_list_pca_ps_bucket_ownership_responsedefault.dart';import 'package:pub_cloudflare/models/magic_visibility_pcaps_pcaps_ownership_collection.dart';import 'package:pub_cloudflare/models/response_common_failure49.dart';sealed class MagicPcapCollectionListPcaPsBucketOwnershipError {const MagicPcapCollectionListPcaPsBucketOwnershipError();

factory MagicPcapCollectionListPcaPsBucketOwnershipError.fromResponse(ApiResponse response) {     try {
