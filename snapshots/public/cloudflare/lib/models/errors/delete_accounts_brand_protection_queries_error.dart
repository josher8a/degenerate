...
import 'package:pub_cloudflare/models/error_model.dart';

sealed class DeleteAccountsBrandProtectionQueriesError {
  const DeleteAccountsBrandProtectionQueriesError();

  int get statusCode;

  factory DeleteAccountsBrandProtectionQueriesError.fromResponse(ApiResponse response) {
    try {
...
final class DeleteAccountsBrandProtectionQueriesError$422 extends DeleteAccountsBrandProtectionQueriesError {
  const DeleteAccountsBrandProtectionQueriesError$422(this.error);
  final ErrorModel error;
  @override
  int get statusCode => 422;
}

final class DeleteAccountsBrandProtectionQueriesError$Unknown extends DeleteAccountsBrandProtectionQueriesError {
  const DeleteAccountsBrandProtectionQueriesError$Unknown(this.statusCode, this.rawBody);
  @override
