...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aig_config_fetch_evaluations_response404.dart';sealed class AigConfigFetchEvaluationsError {const AigConfigFetchEvaluationsError();

factory AigConfigFetchEvaluationsError.fromResponse(ApiResponse response) {     try {
