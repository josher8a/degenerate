...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_run_cf_meta_llama3370b_instruct_fp8_fast_response400.dart';sealed class WorkersAiPostRunCfMetaLlama370bInstructFp8FastError {const WorkersAiPostRunCfMetaLlama370bInstructFp8FastError();

factory WorkersAiPostRunCfMetaLlama370bInstructFp8FastError.fromResponse(ApiResponse response) {     try {
...
final class WorkersAiPostRunCfMetaLlama370bInstructFp8FastError$400 extends WorkersAiPostRunCfMetaLlama370bInstructFp8FastError {const WorkersAiPostRunCfMetaLlama370bInstructFp8FastError$400(this.error);
