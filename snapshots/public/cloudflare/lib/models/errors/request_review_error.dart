...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/request_review_response500.dart';sealed class RequestReviewError {const RequestReviewError();

factory RequestReviewError.fromResponse(ApiResponse response) {     try {
