...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/realtimekit_generic_error_response.dart';sealed class GetActiveSessionError {const GetActiveSessionError();

factory GetActiveSessionError.fromResponse(ApiResponse response) {     try {
