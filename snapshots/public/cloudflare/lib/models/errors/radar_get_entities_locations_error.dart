...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_entities_locations_response400.dart';sealed class RadarGetEntitiesLocationsError {const RadarGetEntitiesLocationsError();

factory RadarGetEntitiesLocationsError.fromResponse(ApiResponse response) {     try {
