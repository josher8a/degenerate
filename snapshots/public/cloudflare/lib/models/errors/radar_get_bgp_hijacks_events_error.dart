...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_bgp_hijacks_events_response400.dart';sealed class RadarGetBgpHijacksEventsError {const RadarGetBgpHijacksEventsError();

factory RadarGetBgpHijacksEventsError.fromResponse(ApiResponse response) {     try {
