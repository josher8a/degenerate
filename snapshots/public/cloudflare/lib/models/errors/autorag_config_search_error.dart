...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/autorag_config_search_response404.dart';sealed class AutoragConfigSearchError {const AutoragConfigSearchError();

factory AutoragConfigSearchError.fromResponse(ApiResponse response) {     try {
