...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_list_tokens_response400.dart';sealed class AiSearchListTokensError {const AiSearchListTokensError();

factory AiSearchListTokensError.fromResponse(ApiResponse response) {     try {
