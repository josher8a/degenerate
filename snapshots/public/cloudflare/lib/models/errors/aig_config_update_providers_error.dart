...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aig_config_update_providers_response400.dart';import 'package:pub_cloudflare/models/aig_config_update_providers_response404.dart';sealed class AigConfigUpdateProvidersError {const AigConfigUpdateProvidersError();

factory AigConfigUpdateProvidersError.fromResponse(ApiResponse response) {     try {
...
final class AigConfigUpdateProvidersError$Unknown extends AigConfigUpdateProvidersError {const AigConfigUpdateProvidersError$Unknown(this.statusCode, this.rawBody, );
