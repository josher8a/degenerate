...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/post_event_move_to_new_ds_response400.dart';sealed class PostEventMoveToNewDsError {const PostEventMoveToNewDsError();

factory PostEventMoveToNewDsError.fromResponse(ApiResponse response) {     try {
