...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_http_top_ases_by_device_type_response404.dart';sealed class RadarGetHttpTopAsesByDeviceTypeError {const RadarGetHttpTopAsesByDeviceTypeError();

factory RadarGetHttpTopAsesByDeviceTypeError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetHttpTopAsesByDeviceTypeError$404 extends RadarGetHttpTopAsesByDeviceTypeError {const RadarGetHttpTopAsesByDeviceTypeError$404(this.error);
