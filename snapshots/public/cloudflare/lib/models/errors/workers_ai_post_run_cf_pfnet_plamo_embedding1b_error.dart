...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_run_cf_pfnet_plamo_embedding1b_response400.dart';sealed class WorkersAiPostRunCfPfnetPlamoEmbedding1bError {const WorkersAiPostRunCfPfnetPlamoEmbedding1bError();

factory WorkersAiPostRunCfPfnetPlamoEmbedding1bError.fromResponse(ApiResponse response) {     try {
