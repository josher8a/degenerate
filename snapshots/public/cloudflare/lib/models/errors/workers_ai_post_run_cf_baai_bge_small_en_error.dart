...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/n5_response4003.dart';sealed class WorkersAiPostRunCfBaaiBgeSmallEnError {const WorkersAiPostRunCfBaaiBgeSmallEnError();

factory WorkersAiPostRunCfBaaiBgeSmallEnError.fromResponse(ApiResponse response) {     try {
...
final class WorkersAiPostRunCfBaaiBgeSmallEnError$400 extends WorkersAiPostRunCfBaaiBgeSmallEnError {const WorkersAiPostRunCfBaaiBgeSmallEnError$400(this.error);
