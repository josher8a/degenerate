...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_run_cf_google_gemma7b_it_lora_response400.dart';sealed class WorkersAiPostRunCfGoogleGemma7bItLoraError {const WorkersAiPostRunCfGoogleGemma7bItLoraError();

factory WorkersAiPostRunCfGoogleGemma7bItLoraError.fromResponse(ApiResponse response) {     try {
...
final class WorkersAiPostRunCfGoogleGemma7bItLoraError$400 extends WorkersAiPostRunCfGoogleGemma7bItLoraError {const WorkersAiPostRunCfGoogleGemma7bItLoraError$400(this.error);
