...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/destination_create_response400.dart';import 'package:pub_cloudflare/models/destination_create_response401.dart';import 'package:pub_cloudflare/models/destination_create_response500.dart';sealed class DestinationCreateError {const DestinationCreateError();

factory DestinationCreateError.fromResponse(ApiResponse response) {     try {
...
final class DestinationCreateError$400 extends DestinationCreateError {const DestinationCreateError$400(this.error);
