...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aig_config_fetch_dataset_response404.dart';sealed class AigConfigFetchDatasetError {const AigConfigFetchDatasetError();

factory AigConfigFetchDatasetError.fromResponse(ApiResponse response) {     try {
