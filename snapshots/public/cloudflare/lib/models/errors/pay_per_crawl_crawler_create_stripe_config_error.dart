...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/error_response2.dart';sealed class PayPerCrawlCrawlerCreateStripeConfigError {const PayPerCrawlCrawlerCreateStripeConfigError();

factory PayPerCrawlCrawlerCreateStripeConfigError.fromResponse(ApiResponse response) {     try {
