...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_bgp_pfx2as_moas_response400.dart';sealed class RadarGetBgpPfx2asMoasError {const RadarGetBgpPfx2asMoasError();

factory RadarGetBgpPfx2asMoasError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetBgpPfx2asMoasError$400 extends RadarGetBgpPfx2asMoasError {const RadarGetBgpPfx2asMoasError$400(this.error);
