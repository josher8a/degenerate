...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_list_public_finetunes_response400.dart';sealed class WorkersAiListPublicFinetunesError {const WorkersAiListPublicFinetunesError();

factory WorkersAiListPublicFinetunesError.fromResponse(ApiResponse response) {     try {
