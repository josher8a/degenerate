...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/magic_pcap_collection_add_buckets_for_full_packet_captures_responsedefault.dart';import 'package:pub_cloudflare/models/response_common47.dart';import 'package:pub_cloudflare/models/response_common_failure49.dart';sealed class MagicPcapCollectionAddBucketsForFullPacketCapturesError {const MagicPcapCollectionAddBucketsForFullPacketCapturesError();

factory MagicPcapCollectionAddBucketsForFullPacketCapturesError.fromResponse(ApiResponse response) {     try {
