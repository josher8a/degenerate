...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/list_portals_response400.dart';sealed class ListPortalsError {const ListPortalsError();

factory ListPortalsError.fromResponse(ApiResponse response) {     try {
...
final class ListPortalsError$400 extends ListPortalsError {const ListPortalsError$400(this.error);
