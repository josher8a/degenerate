...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_crawlers_summary_response400.dart';sealed class RadarGetCrawlersSummaryError {const RadarGetCrawlersSummaryError();

factory RadarGetCrawlersSummaryError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetCrawlersSummaryError$400 extends RadarGetCrawlersSummaryError {const RadarGetCrawlersSummaryError$400(this.error);
