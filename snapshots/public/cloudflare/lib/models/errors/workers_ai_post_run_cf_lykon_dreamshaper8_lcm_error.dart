...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_run_cf_lykon_dreamshaper8_lcm_response400.dart';sealed class WorkersAiPostRunCfLykonDreamshaper8LcmError {const WorkersAiPostRunCfLykonDreamshaper8LcmError();

factory WorkersAiPostRunCfLykonDreamshaper8LcmError.fromResponse(ApiResponse response) {     try {
