...
import 'package:pub_cloudflare/models/builds_error_response.dart';

sealed class CancelBuildByUuidError {
  const CancelBuildByUuidError();

  int get statusCode;

  factory CancelBuildByUuidError.fromResponse(ApiResponse response) {
    try {
...
final class CancelBuildByUuidError$404 extends CancelBuildByUuidError {
  const CancelBuildByUuidError$404(this.error);
  final BuildsErrorResponse error;
  @override
  int get statusCode => 404;
}

final class CancelBuildByUuidError$Unknown extends CancelBuildByUuidError {
  const CancelBuildByUuidError$Unknown(this.statusCode, this.rawBody);
  @override
