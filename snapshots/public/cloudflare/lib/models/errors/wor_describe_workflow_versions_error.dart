...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/wor_describe_workflow_versions_response400.dart';import 'package:pub_cloudflare/models/wor_describe_workflow_versions_response404.dart';sealed class WorDescribeWorkflowVersionsError {const WorDescribeWorkflowVersionsError();

factory WorDescribeWorkflowVersionsError.fromResponse(ApiResponse response) {     try {
...
final class WorDescribeWorkflowVersionsError$Unknown extends WorDescribeWorkflowVersionsError {const WorDescribeWorkflowVersionsError$Unknown(this.statusCode, this.rawBody, );
