...
sealed class DeleteAccountsBrandProtectionBrandsError {
  const DeleteAccountsBrandProtectionBrandsError();

  int get statusCode;

  factory DeleteAccountsBrandProtectionBrandsError.fromResponse(ApiResponse response) {
    try {
...
final class DeleteAccountsBrandProtectionBrandsError$ErrorModel extends DeleteAccountsBrandProtectionBrandsError {
  const DeleteAccountsBrandProtectionBrandsError$ErrorModel(this.error, this.statusCode);
