...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aig_config_delete_gateway_response404.dart';sealed class AigConfigDeleteGatewayError {const AigConfigDeleteGatewayError();

factory AigConfigDeleteGatewayError.fromResponse(ApiResponse response) {     try {
