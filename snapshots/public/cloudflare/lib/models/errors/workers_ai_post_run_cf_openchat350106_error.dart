...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_run_cf_openchat_openchat350106_response400.dart';sealed class WorkersAiPostRunCfOpenchat350106Error {const WorkersAiPostRunCfOpenchat350106Error();

factory WorkersAiPostRunCfOpenchat350106Error.fromResponse(ApiResponse response) {     try {
