...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/mcn_bad_response.dart';sealed class ProvidersDiscoverAllError {const ProvidersDiscoverAllError();

factory ProvidersDiscoverAllError.fromResponse(ApiResponse response) {     try {
