...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/response_common_failure4.dart';sealed class AccessPolicyTestsError {const AccessPolicyTestsError();

factory AccessPolicyTestsError.fromResponse(ApiResponse response) {     try {
...
final class AccessPolicyTestsError$400 extends AccessPolicyTestsError {const AccessPolicyTestsError$400(this.error);
