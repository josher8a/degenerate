...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_quality_speed_histogram_response400.dart';sealed class RadarGetQualitySpeedHistogramError {const RadarGetQualitySpeedHistogramError();

factory RadarGetQualitySpeedHistogramError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetQualitySpeedHistogramError$400 extends RadarGetQualitySpeedHistogramError {const RadarGetQualitySpeedHistogramError$400(this.error);
