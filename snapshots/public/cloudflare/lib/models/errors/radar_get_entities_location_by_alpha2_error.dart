...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_entities_location_by_alpha2_response404.dart';sealed class RadarGetEntitiesLocationByAlpha2Error {const RadarGetEntitiesLocationByAlpha2Error();

factory RadarGetEntitiesLocationByAlpha2Error.fromResponse(ApiResponse response) {     try {
