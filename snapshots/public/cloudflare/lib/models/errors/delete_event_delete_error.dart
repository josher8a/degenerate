...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/delete_event_delete_response400.dart';sealed class DeleteEventDeleteError {const DeleteEventDeleteError();

factory DeleteEventDeleteError.fromResponse(ApiResponse response) {     try {
