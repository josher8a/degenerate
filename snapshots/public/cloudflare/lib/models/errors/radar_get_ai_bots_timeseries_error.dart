...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_ai_bots_timeseries_response400.dart';sealed class RadarGetAiBotsTimeseriesError {const RadarGetAiBotsTimeseriesError();

factory RadarGetAiBotsTimeseriesError.fromResponse(ApiResponse response) {     try {
