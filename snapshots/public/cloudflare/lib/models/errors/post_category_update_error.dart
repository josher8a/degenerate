...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/post_category_update_response400.dart';sealed class PostCategoryUpdateError {const PostCategoryUpdateError();

factory PostCategoryUpdateError.fromResponse(ApiResponse response) {     try {
