...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_entities_asn_list_response400.dart';sealed class RadarGetEntitiesAsnListError {const RadarGetEntitiesAsnListError();

factory RadarGetEntitiesAsnListError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetEntitiesAsnListError$400 extends RadarGetEntitiesAsnListError {const RadarGetEntitiesAsnListError$400(this.error);
