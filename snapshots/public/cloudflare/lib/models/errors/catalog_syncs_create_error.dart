...
sealed class CatalogSyncsCreateError {
  const CatalogSyncsCreateError();

  int get statusCode;

  factory CatalogSyncsCreateError.fromResponse(ApiResponse response) {
    try {
...
final class CatalogSyncsCreateError$400 extends CatalogSyncsCreateError {
  const CatalogSyncsCreateError$400(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 400;
}

final class CatalogSyncsCreateError$401 extends CatalogSyncsCreateError {
  const CatalogSyncsCreateError$401(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 401;
}

final class CatalogSyncsCreateError$403 extends CatalogSyncsCreateError {
  const CatalogSyncsCreateError$403(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 403;
}

final class CatalogSyncsCreateError$409 extends CatalogSyncsCreateError {
  const CatalogSyncsCreateError$409(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 409;
}

final class CatalogSyncsCreateError$422 extends CatalogSyncsCreateError {
  const CatalogSyncsCreateError$422(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 422;
}

final class CatalogSyncsCreateError$500 extends CatalogSyncsCreateError {
  const CatalogSyncsCreateError$500(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 500;
}

final class CatalogSyncsCreateError$Unknown extends CatalogSyncsCreateError {
  const CatalogSyncsCreateError$Unknown(this.statusCode, this.rawBody);
  @override
