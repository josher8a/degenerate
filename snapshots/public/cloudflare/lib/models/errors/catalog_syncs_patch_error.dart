...
sealed class CatalogSyncsPatchError {
  const CatalogSyncsPatchError();

  int get statusCode;

  factory CatalogSyncsPatchError.fromResponse(ApiResponse response) {
    try {
...
final class CatalogSyncsPatchError$400 extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$400(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 400;
}

final class CatalogSyncsPatchError$401 extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$401(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 401;
}

final class CatalogSyncsPatchError$403 extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$403(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 403;
}

final class CatalogSyncsPatchError$404 extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$404(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 404;
}

final class CatalogSyncsPatchError$409 extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$409(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 409;
}

final class CatalogSyncsPatchError$422 extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$422(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 422;
}

final class CatalogSyncsPatchError$500 extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$500(this.error);
  final McnBadResponse error;
  @override
  int get statusCode => 500;
}

final class CatalogSyncsPatchError$Unknown extends CatalogSyncsPatchError {
  const CatalogSyncsPatchError$Unknown(this.statusCode, this.rawBody);
  @override
