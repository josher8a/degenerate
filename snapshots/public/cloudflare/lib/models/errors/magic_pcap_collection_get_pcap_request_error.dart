...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/magic_pcap_collection_get_pcap_request_responsedefault.dart';import 'package:pub_cloudflare/models/magic_visibility_pcaps_pcaps_single_response.dart';import 'package:pub_cloudflare/models/response_common_failure49.dart';sealed class MagicPcapCollectionGetPcapRequestError {const MagicPcapCollectionGetPcapRequestError();

factory MagicPcapCollectionGetPcapRequestError.fromResponse(ApiResponse response) {     try {
