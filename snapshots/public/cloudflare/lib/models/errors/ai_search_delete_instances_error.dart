...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_delete_instances_response404.dart';sealed class AiSearchDeleteInstancesError {const AiSearchDeleteInstancesError();

factory AiSearchDeleteInstancesError.fromResponse(ApiResponse response) {     try {
...
final class AiSearchDeleteInstancesError$404 extends AiSearchDeleteInstancesError {const AiSearchDeleteInstancesError$404(this.error);
