...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/realtimekit_error_response.dart';sealed class AddWebhookError {const AddWebhookError();

factory AddWebhookError.fromResponse(ApiResponse response) {     try {
