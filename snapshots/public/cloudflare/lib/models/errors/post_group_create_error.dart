...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/post_group_create_response400.dart';sealed class PostGroupCreateError {const PostGroupCreateError();

factory PostGroupCreateError.fromResponse(ApiResponse response) {     try {
