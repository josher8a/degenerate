...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_get_model_schema_response400.dart';sealed class WorkersAiGetModelSchemaError {const WorkersAiGetModelSchemaError();

factory WorkersAiGetModelSchemaError.fromResponse(ApiResponse response) {     try {
