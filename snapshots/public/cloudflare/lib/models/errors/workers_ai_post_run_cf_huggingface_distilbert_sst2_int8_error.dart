...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_run_cf_huggingface_distilbert_sst2_int8_response400.dart';sealed class WorkersAiPostRunCfHuggingfaceDistilbertSst2Int8Error {const WorkersAiPostRunCfHuggingfaceDistilbertSst2Int8Error();

factory WorkersAiPostRunCfHuggingfaceDistilbertSst2Int8Error.fromResponse(ApiResponse response) {     try {
