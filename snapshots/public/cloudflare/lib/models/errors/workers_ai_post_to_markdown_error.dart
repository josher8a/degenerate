...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_to_markdown_response400.dart';sealed class WorkersAiPostToMarkdownError {const WorkersAiPostToMarkdownError();

factory WorkersAiPostToMarkdownError.fromResponse(ApiResponse response) {     try {
