...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/wor_get_workflow_details_response400.dart';import 'package:pub_cloudflare/models/wor_get_workflow_details_response404.dart';sealed class WorGetWorkflowDetailsError {const WorGetWorkflowDetailsError();

factory WorGetWorkflowDetailsError.fromResponse(ApiResponse response) {     try {
