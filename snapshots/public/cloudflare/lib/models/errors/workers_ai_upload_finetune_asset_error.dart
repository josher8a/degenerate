...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_upload_finetune_asset_response400.dart';sealed class WorkersAiUploadFinetuneAssetError {const WorkersAiUploadFinetuneAssetError();

factory WorkersAiUploadFinetuneAssetError.fromResponse(ApiResponse response) {     try {
