...
import 'package:pub_cloudflare/models/load_balancing_monitor_group_single_response.dart';

sealed class AccountLoadBalancerMonitorGroupsCreateMonitorGroupError {
  const AccountLoadBalancerMonitorGroupsCreateMonitorGroupError();

  int get statusCode;

  factory AccountLoadBalancerMonitorGroupsCreateMonitorGroupError.fromResponse(ApiResponse response) {
    try {
...
final class AccountLoadBalancerMonitorGroupsCreateMonitorGroupError$412 extends AccountLoadBalancerMonitorGroupsCreateMonitorGroupError {
  const AccountLoadBalancerMonitorGroupsCreateMonitorGroupError$412(this.error);
  final LoadBalancingMonitorGroupSingleResponse error;
  @override
  int get statusCode => 412;
}

final class AccountLoadBalancerMonitorGroupsCreateMonitorGroupError$Unknown extends AccountLoadBalancerMonitorGroupsCreateMonitorGroupError {
  const AccountLoadBalancerMonitorGroupsCreateMonitorGroupError$Unknown(this.statusCode, this.rawBody);
  @override
