...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/response_common_failure82.dart';sealed class CreateWorkerError {const CreateWorkerError();

factory CreateWorkerError.fromResponse(ApiResponse response) {     try {
