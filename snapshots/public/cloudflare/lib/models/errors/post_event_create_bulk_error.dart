...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/post_event_create_bulk_response400.dart';sealed class PostEventCreateBulkError {const PostEventCreateBulkError();

factory PostEventCreateBulkError.fromResponse(ApiResponse response) {     try {
...
final class PostEventCreateBulkError$400 extends PostEventCreateBulkError {const PostEventCreateBulkError$400(this.error);
