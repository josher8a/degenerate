...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_ai_post_websocket_run_cf_deepgram_aura1_internal_response400.dart';sealed class WorkersAiPostWebsocketRunCfDeepgramAura1InternalError {const WorkersAiPostWebsocketRunCfDeepgramAura1InternalError();

factory WorkersAiPostWebsocketRunCfDeepgramAura1InternalError.fromResponse(ApiResponse response) {     try {
...
final class WorkersAiPostWebsocketRunCfDeepgramAura1InternalError$Unknown extends WorkersAiPostWebsocketRunCfDeepgramAura1InternalError {const WorkersAiPostWebsocketRunCfDeepgramAura1InternalError$Unknown(this.statusCode, this.rawBody, );
