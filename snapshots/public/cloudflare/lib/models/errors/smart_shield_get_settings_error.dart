...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/response_common_failure65.dart';sealed class SmartShieldGetSettingsError {const SmartShieldGetSettingsError();

factory SmartShieldGetSettingsError.fromResponse(ApiResponse response) {     try {
