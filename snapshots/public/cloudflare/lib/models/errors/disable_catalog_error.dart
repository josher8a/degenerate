...
import 'package:pub_cloudflare/models/response_common_failure55.dart';

sealed class DisableCatalogError {
  const DisableCatalogError();

  int get statusCode;

  factory DisableCatalogError.fromResponse(ApiResponse response) {
    try {
...
final class DisableCatalogError$400 extends DisableCatalogError {
  const DisableCatalogError$400(this.error);
  final ResponseCommonFailure55 error;
  @override
  int get statusCode => 400;
}

final class DisableCatalogError$401 extends DisableCatalogError {
  const DisableCatalogError$401(this.error);
  final ResponseCommonFailure55 error;
  @override
  int get statusCode => 401;
}

final class DisableCatalogError$403 extends DisableCatalogError {
  const DisableCatalogError$403(this.error);
  final ResponseCommonFailure55 error;
  @override
  int get statusCode => 403;
}

final class DisableCatalogError$404 extends DisableCatalogError {
  const DisableCatalogError$404(this.error);
  final ResponseCommonFailure55 error;
  @override
  int get statusCode => 404;
}

final class DisableCatalogError$500 extends DisableCatalogError {
  const DisableCatalogError$500(this.error);
  final ResponseCommonFailure55 error;
  @override
  int get statusCode => 500;
}

final class DisableCatalogError$Unknown extends DisableCatalogError {
  const DisableCatalogError$Unknown(this.statusCode, this.rawBody);
  @override
