...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/mcn_bad_response.dart';sealed class ResourcesCatalogPolicyPreviewError {const ResourcesCatalogPolicyPreviewError();

factory ResourcesCatalogPolicyPreviewError.fromResponse(ApiResponse response) {     try {
