...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_tcp_resets_timeouts_timeseries_group_response400.dart';sealed class RadarGetTcpResetsTimeoutsTimeseriesGroupError {const RadarGetTcpResetsTimeoutsTimeseriesGroupError();

factory RadarGetTcpResetsTimeoutsTimeseriesGroupError.fromResponse(ApiResponse response) {     try {
