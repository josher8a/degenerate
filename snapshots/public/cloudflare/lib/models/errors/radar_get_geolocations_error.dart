...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_geolocations_response400.dart';sealed class RadarGetGeolocationsError {const RadarGetGeolocationsError();

factory RadarGetGeolocationsError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetGeolocationsError$400 extends RadarGetGeolocationsError {const RadarGetGeolocationsError$400(this.error);
