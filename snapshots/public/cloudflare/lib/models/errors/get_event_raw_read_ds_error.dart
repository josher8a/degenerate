...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/get_event_raw_read_ds_response404.dart';import 'package:pub_cloudflare/models/get_event_raw_read_ds_response500.dart';sealed class GetEventRawReadDsError {const GetEventRawReadDsError();

factory GetEventRawReadDsError.fromResponse(ApiResponse response) {     try {
