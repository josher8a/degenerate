...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_http_top_ases_by_operating_system_response404.dart';sealed class RadarGetHttpTopAsesByOperatingSystemError {const RadarGetHttpTopAsesByOperatingSystemError();

factory RadarGetHttpTopAsesByOperatingSystemError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetHttpTopAsesByOperatingSystemError$404 extends RadarGetHttpTopAsesByOperatingSystemError {const RadarGetHttpTopAsesByOperatingSystemError$404(this.error);
