...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/get_tag_list_response400.dart';sealed class GetTagListError {const GetTagListError();

factory GetTagListError.fromResponse(ApiResponse response) {     try {
