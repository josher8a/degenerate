...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_bgp_top_prefixes_response400.dart';sealed class RadarGetBgpTopPrefixesError {const RadarGetBgpTopPrefixesError();

factory RadarGetBgpTopPrefixesError.fromResponse(ApiResponse response) {     try {
...
final class RadarGetBgpTopPrefixesError$400 extends RadarGetBgpTopPrefixesError {const RadarGetBgpTopPrefixesError$400(this.error);
