...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aig_config_get_gateway_log_request_response404.dart';sealed class AigConfigGetGatewayLogRequestError {const AigConfigGetGatewayLogRequestError();

factory AigConfigGetGatewayLogRequestError.fromResponse(ApiResponse response) {     try {
...
final class AigConfigGetGatewayLogRequestError$404 extends AigConfigGetGatewayLogRequestError {const AigConfigGetGatewayLogRequestError$404(this.error);
