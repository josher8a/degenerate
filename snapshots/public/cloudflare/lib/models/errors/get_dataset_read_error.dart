...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/get_dataset_read_response400.dart';sealed class GetDatasetReadError {const GetDatasetReadError();

factory GetDatasetReadError.fromResponse(ApiResponse response) {     try {
