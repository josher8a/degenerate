...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aig_config_fetch_gateway_response404.dart';sealed class AigConfigFetchGatewayError {const AigConfigFetchGatewayError();

factory AigConfigFetchGatewayError.fromResponse(ApiResponse response) {     try {
...
final class AigConfigFetchGatewayError$404 extends AigConfigFetchGatewayError {const AigConfigFetchGatewayError$404(this.error);
