...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/magic_visibility_mnm_messages2.dart';import 'package:pub_cloudflare/models/magic_visibility_mnm_result_info.dart';@immutable final class MagicNetworkMonitoringRulesListRulesResponse4Xx {const MagicNetworkMonitoringRulesListRulesResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() => 'MagicNetworkMonitoringRulesListRulesResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)';
