...
// Source: #/components/schemas/NotificationWebhooksGetAWebhookResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';@immutable final class NotificationWebhooksGetAWebhookResponse4Xx {const NotificationWebhooksGetAWebhookResponse4Xx({required this.errors, required this.messages, required this.success, });
...
NotificationWebhooksGetAWebhookResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, }) { return NotificationWebhooksGetAWebhookResponse4Xx(
...
@override String toString() => 'NotificationWebhooksGetAWebhookResponse4Xx(errors: $errors, messages: $messages, success: $success)';
