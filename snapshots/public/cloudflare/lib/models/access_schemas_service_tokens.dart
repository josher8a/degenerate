...
@override String toString() => 'AccessSchemasServiceTokens(clientId: $clientId, createdAt: $createdAt, duration: $duration, expiresAt: $expiresAt, id: $id, lastSeenAt: $lastSeenAt, name: $name, updatedAt: $updatedAt)';
