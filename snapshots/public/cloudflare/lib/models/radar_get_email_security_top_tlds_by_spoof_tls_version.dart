...
W when<W>({required W Function() tlSv10, required W Function() tlSv11, required W Function() tlSv12, required W Function() tlSv13, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv10() => tlSv10(),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv11() => tlSv11(),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv12() => tlSv12(),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv13() => tlSv13(),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? tlSv10, W Function()? tlSv11, W Function()? tlSv12, W Function()? tlSv13, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv10() => tlSv10 != null ? tlSv10() : orElse(value),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv11() => tlSv11 != null ? tlSv11() : orElse(value),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv12() => tlSv12 != null ? tlSv12() : orElse(value),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$tlSv13() => tlSv13 != null ? tlSv13() : orElse(value),
      RadarGetEmailSecurityTopTldsBySpoofTlsVersion$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
