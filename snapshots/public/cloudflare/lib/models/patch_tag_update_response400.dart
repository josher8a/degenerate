...
PatchTagUpdateResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return PatchTagUpdateResponse400(
...
@override String toString() => 'PatchTagUpdateResponse400(errors: $errors, result: $result, success: $success)';
