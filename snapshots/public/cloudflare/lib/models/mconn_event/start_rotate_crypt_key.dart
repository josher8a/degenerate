...
W when<W>({required W Function() startRotateCryptKey, required W Function(String value) $unknown, }) { return switch (this) {
      StartRotateCryptKeyK$startRotateCryptKey() => startRotateCryptKey(),
      StartRotateCryptKeyK$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? startRotateCryptKey, W Function(String value)? $unknown, }) { return switch (this) {
      StartRotateCryptKeyK$startRotateCryptKey() => startRotateCryptKey != null ? startRotateCryptKey() : orElse(value),
      StartRotateCryptKeyK$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
