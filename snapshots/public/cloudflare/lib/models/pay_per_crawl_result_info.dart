...
// Source: #/components/schemas/PayPerCrawlResultInfo
...
@override String toString() => 'PayPerCrawlResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount, totalPages: $totalPages)';
