...
PostTagCreateResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return PostTagCreateResponse400(
...
@override String toString() => 'PostTagCreateResponse400(errors: $errors, result: $result, success: $success)';
