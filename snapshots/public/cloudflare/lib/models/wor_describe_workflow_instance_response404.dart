...
WorDescribeWorkflowInstanceResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorDescribeWorkflowInstanceResponse404(
...
@override String toString() => 'WorDescribeWorkflowInstanceResponse404(errors: $errors, messages: $messages, result: $result, success: $success)';
