...
FetchServersResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return FetchServersResponse404(
...
@override String toString() => 'FetchServersResponse404(errors: $errors, success: $success)';
