...
// Source: #/components/schemas/DevicesSetSplitTunnelIncludeListResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/teams_devices_messages2.dart';@immutable final class DevicesSetSplitTunnelIncludeListResponse4Xx {const DevicesSetSplitTunnelIncludeListResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
DevicesSetSplitTunnelIncludeListResponse4Xx copyWith({List<TeamsDevicesMessages2>? errors, List<TeamsDevicesMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return DevicesSetSplitTunnelIncludeListResponse4Xx(
...
@override String toString() => 'DevicesSetSplitTunnelIncludeListResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
