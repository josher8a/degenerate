...
W when<W>({required W Function() to, required W Function(String value) $unknown, }) { return switch (this) {
      Field$to() => to(),
      Field$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? to, W Function(String value)? $unknown, }) { return switch (this) {
      Field$to() => to != null ? to() : orElse(value),
      Field$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
/// Exhaustive match on the enum value.
W when<W>({required W Function() all, required W Function() literal, required W Function(String value) $unknown, }) { return switch (this) {
      EmailRuleMatcherType$all() => all(),
      EmailRuleMatcherType$literal() => literal(),
      EmailRuleMatcherType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? all, W Function()? literal, W Function(String value)? $unknown, }) { return switch (this) {
      EmailRuleMatcherType$all() => all != null ? all() : orElse(value),
      EmailRuleMatcherType$literal() => literal != null ? literal() : orElse(value),
      EmailRuleMatcherType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
final value$ = value;
if (value$ != null) {
  if (value$.runes.length > 90) { errors.add('value: length must be <= 90'); }
}
return errors; } 
