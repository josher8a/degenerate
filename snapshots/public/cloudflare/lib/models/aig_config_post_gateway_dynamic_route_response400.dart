...
// Source: #/components/schemas/AigConfigPostGatewayDynamicRouteResponse400
...
AigConfigPostGatewayDynamicRouteResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return AigConfigPostGatewayDynamicRouteResponse400(
...
@override String toString() => 'AigConfigPostGatewayDynamicRouteResponse400(errors: $errors, result: $result, success: $success)';
