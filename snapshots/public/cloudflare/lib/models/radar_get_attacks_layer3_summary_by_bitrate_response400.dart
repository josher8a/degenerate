...
RadarGetAttacksLayer3SummaryByBitrateResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetAttacksLayer3SummaryByBitrateResponse400(
...
@override String toString() => 'RadarGetAttacksLayer3SummaryByBitrateResponse400(errors: $errors, result: $result, success: $success)';
