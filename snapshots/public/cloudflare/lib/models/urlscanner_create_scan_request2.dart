...
// Source: #/components/schemas/UrlscannerCreateScanRequest2
...
if (customagent$ != null) {
  if (customagent$.runes.length > 4096) { errors.add('customagent: length must be <= 4096'); }
}
final referer$ = referer;
if (referer$ != null) {
  if (referer$.runes.length > 4096) { errors.add('referer: length must be <= 4096'); }
}
return errors; } 
