...
W when<W>({required W Function() workersBuildsWorker, required W Function(String value) $unknown, }) { return switch (this) {
      MqEventSourceWorkersBuildsWorkerType$workersBuildsWorker() => workersBuildsWorker(),
      MqEventSourceWorkersBuildsWorkerType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? workersBuildsWorker, W Function(String value)? $unknown, }) { return switch (this) {
      MqEventSourceWorkersBuildsWorkerType$workersBuildsWorker() => workersBuildsWorker != null ? workersBuildsWorker() : orElse(value),
      MqEventSourceWorkersBuildsWorkerType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
