...
// Source: #/components/schemas/UrlscannerGetScanResponse (inline: Result > Scan > Verdicts > Overall > Categories)
...
@override String toString() => 'OverallCategories(id: $id, name: $name, superCategoryId: $superCategoryId)';
