...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/firewall_messages2.dart';@immutable final class FirewallRulesCreateFirewallRulesResponse4Xx {const FirewallRulesCreateFirewallRulesResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
FirewallRulesCreateFirewallRulesResponse4Xx copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return FirewallRulesCreateFirewallRulesResponse4Xx(
...
@override String toString() => 'FirewallRulesCreateFirewallRulesResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
