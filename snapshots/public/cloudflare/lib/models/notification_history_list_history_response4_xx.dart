...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';@immutable final class NotificationHistoryListHistoryResponse4Xx {const NotificationHistoryListHistoryResponse4Xx({required this.errors, required this.messages, required this.success, });
...
NotificationHistoryListHistoryResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, }) { return NotificationHistoryListHistoryResponse4Xx(
...
@override String toString() => 'NotificationHistoryListHistoryResponse4Xx(errors: $errors, messages: $messages, success: $success)';
