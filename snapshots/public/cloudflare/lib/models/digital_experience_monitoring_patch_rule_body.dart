...
// Source: #/components/schemas/DigitalExperienceMonitoringPatchRuleBody
...
@override String toString() => 'DigitalExperienceMonitoringPatchRuleBody(description: $description, match: $match, name: $name)';
