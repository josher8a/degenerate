...
// Source: #/components/schemas/EmailSecurityGetMessageDetectionsResponse
...
@override String toString() => 'EmailSecurityGetMessageDetectionsResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
