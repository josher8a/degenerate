...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailSecuritySummaryByArcDkim$pass() => pass(),
      RadarGetEmailSecuritySummaryByArcDkim$none() => none(),
      RadarGetEmailSecuritySummaryByArcDkim$fail() => fail(),
      RadarGetEmailSecuritySummaryByArcDkim$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailSecuritySummaryByArcDkim$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailSecuritySummaryByArcDkim$none() => none != null ? none() : orElse(value),
      RadarGetEmailSecuritySummaryByArcDkim$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailSecuritySummaryByArcDkim$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
