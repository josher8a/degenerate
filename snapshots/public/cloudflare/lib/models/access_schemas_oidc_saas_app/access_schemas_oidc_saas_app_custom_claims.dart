...
// Source: #/components/schemas/AccessSchemasOidcSaasApp (inline: CustomClaims)
...
@override String toString() => 'AccessSchemasOidcSaasAppCustomClaims(name: $name, \$required: ${$required}, scope: $scope, source: $source)';
