...
// Source: #/components/schemas/Web3HostnameCreateIpfsUniversalPathGatewayContentListEntryResponse5Xx
...
Web3HostnameCreateIpfsUniversalPathGatewayContentListEntryResponse5Xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return Web3HostnameCreateIpfsUniversalPathGatewayContentListEntryResponse5Xx(
...
@override String toString() => 'Web3HostnameCreateIpfsUniversalPathGatewayContentListEntryResponse5Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
