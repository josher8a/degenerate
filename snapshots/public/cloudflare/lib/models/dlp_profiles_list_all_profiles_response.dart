...
factory DlpProfilesListAllProfilesResponse.fromJson(Map<String, dynamic> json) { return DlpProfilesListAllProfilesResponse(
  result: (json['result'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => IntegrationProfile.fromJson(v as Map<String, dynamic>), fromB: (v) => CustomProfile.fromJson(v as Map<String, dynamic>), fromC: (v) => PredefinedProfile.fromJson(v as Map<String, dynamic>),)).toList(),
); }
