...
BrapiPostMarkdownResponse500 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? Function()? errors, bool? success, }) { return BrapiPostMarkdownResponse500(
...
@override String toString() => 'BrapiPostMarkdownResponse500(errors: $errors, success: $success)';
