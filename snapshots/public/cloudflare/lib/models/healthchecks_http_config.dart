...
// Source: #/components/schemas/HealthchecksHttpConfig
...
@override String toString() => 'HealthchecksHttpConfig(allowInsecure: $allowInsecure, expectedBody: $expectedBody, expectedCodes: $expectedCodes, followRedirects: $followRedirects, header: $header, method: $method, path: $path, port: $port)';
