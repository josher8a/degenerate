...
// Source: #/components/schemas/RateLimitsForAZoneCreateARateLimitResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/firewall_messages2.dart';@immutable final class RateLimitsForAZoneCreateARateLimitResponse4Xx {const RateLimitsForAZoneCreateARateLimitResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'RateLimitsForAZoneCreateARateLimitResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
