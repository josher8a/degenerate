...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('id') && json['id'] == 'origin_max_http_version'; } 
...
@override String toString() => 'CacheRulesOriginMaxHttpVersion(id: $id, modifiedOn: $modifiedOn, value: $value)';
