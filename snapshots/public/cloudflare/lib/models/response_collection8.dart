...
ResponseCollection8 copyWith({List<CustomPagesMessages2>? errors, List<CustomPagesMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, }) { return ResponseCollection8(
...
@override String toString() => 'ResponseCollection8(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)';
