...
// Source: #/components/schemas/DnsRecordsForAnAccountGetUsageResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/dns_records_messages2.dart';@immutable final class DnsRecordsForAnAccountGetUsageResponse4Xx {const DnsRecordsForAnAccountGetUsageResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
DnsRecordsForAnAccountGetUsageResponse4Xx copyWith({List<DnsRecordsMessages2>? errors, List<DnsRecordsMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return DnsRecordsForAnAccountGetUsageResponse4Xx(
...
@override String toString() => 'DnsRecordsForAnAccountGetUsageResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
