...
EmailSecurityUpdateBlockedSenderResponse copyWith({List<EmailSecurityMessage>? errors, List<EmailSecurityMessage>? messages, bool? success, EmailSecurityCreateBlockedSenderResponseResult? result, }) { return EmailSecurityUpdateBlockedSenderResponse(
...
@override String toString() => 'EmailSecurityUpdateBlockedSenderResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
