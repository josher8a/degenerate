...
// Source: #/components/schemas/EmailSecurityGetAllowPolicyResponse
...
@override String toString() => 'EmailSecurityGetAllowPolicyResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
