...
W when<W>({required W Function() superSlurper, required W Function(String value) $unknown, }) { return switch (this) {
      MqEventSourceSuperSlurperType$superSlurper() => superSlurper(),
      MqEventSourceSuperSlurperType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? superSlurper, W Function(String value)? $unknown, }) { return switch (this) {
      MqEventSourceSuperSlurperType$superSlurper() => superSlurper != null ? superSlurper() : orElse(value),
      MqEventSourceSuperSlurperType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
