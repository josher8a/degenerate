...
@override int get hashCode => Object.hash(maskingLevel, publicKey, updatedAt);

@override String toString() => 'DlpPayloadLogSetting(maskingLevel: $maskingLevel, publicKey: $publicKey, updatedAt: $updatedAt)';
