...
@immutable final class DeviceEnrollmentPermissionsApplication2 {const DeviceEnrollmentPermissionsApplication2({this.aud, this.createdAt, this.id, this.updatedAt, this.policies, });
...
DeviceEnrollmentPermissionsApplication2 copyWith({AccessSchemasAud? Function()? aud, AccessTimestamp? Function()? createdAt, AccessUuid? Function()? id, AccessTimestamp? Function()? updatedAt, List<AccessAppPolicyResponse>? Function()? policies, }) { return DeviceEnrollmentPermissionsApplication2(
...
@override String toString() => 'DeviceEnrollmentPermissionsApplication2(aud: $aud, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, policies: $policies)';
