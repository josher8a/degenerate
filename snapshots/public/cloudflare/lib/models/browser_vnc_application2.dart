...
@immutable final class BrowserVncApplication2 {const BrowserVncApplication2({this.aud, this.createdAt, this.id, this.updatedAt, this.policies, });
...
BrowserVncApplication2 copyWith({AccessSchemasAud? Function()? aud, AccessTimestamp? Function()? createdAt, AccessUuid? Function()? id, AccessTimestamp? Function()? updatedAt, List<AccessAppPolicyResponse>? Function()? policies, }) { return BrowserVncApplication2(
...
@override String toString() => 'BrowserVncApplication2(aud: $aud, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, policies: $policies)';
