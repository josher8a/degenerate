...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/response_single_id4/response_single_id4_result.dart';import 'package:pub_cloudflare/models/spectrum_config_messages2.dart';@immutable final class ResponseSingleId5 {const ResponseSingleId5({required this.errors, required this.messages, required this.success, this.result, });
...
ResponseSingleId5 copyWith({List<SpectrumConfigMessages2>? errors, List<SpectrumConfigMessages2>? messages, bool? success, ResponseSingleId4Result? Function()? result, }) { return ResponseSingleId5(
