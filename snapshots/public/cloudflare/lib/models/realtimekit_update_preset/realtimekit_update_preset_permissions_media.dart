...
// Source: #/components/schemas/RealtimekitUpdatePreset (inline: Permissions > Media)
...
@override String toString() => 'RealtimekitUpdatePresetPermissionsMedia(audio: $audio, screenshare: $screenshare, video: $video)';
