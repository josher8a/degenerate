...
// Source: #/components/schemas/RealtimekitUpdatePreset (inline: Permissions > Media > Video)
...
@override String toString() => 'RealtimekitUpdatePresetPermissionsMediaVideo(canProduce: $canProduce)';
