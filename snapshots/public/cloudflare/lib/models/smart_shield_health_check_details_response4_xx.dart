...
// Source: #/components/schemas/SmartShieldHealthCheckDetailsResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/smartshield_messages2.dart';@immutable final class SmartShieldHealthCheckDetailsResponse4Xx {const SmartShieldHealthCheckDetailsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'SmartShieldHealthCheckDetailsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
