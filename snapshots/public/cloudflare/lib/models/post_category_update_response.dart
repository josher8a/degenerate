...
// Source: #/components/schemas/PostCategoryUpdateResponse
...
@override String toString() => 'PostCategoryUpdateResponse(killChain: $killChain, mitreAttack: $mitreAttack, name: $name, shortname: $shortname, uuid: $uuid)';
