...
// Source: #/components/schemas/AiSearchUpdateTokensResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_create_instances_response400/ai_search_create_instances_response400_errors.dart';@immutable final class AiSearchUpdateTokensResponse400 {const AiSearchUpdateTokensResponse400({required this.errors, required this.success, });
...
AiSearchUpdateTokensResponse400 copyWith({List<AiSearchCreateInstancesResponse400Errors>? errors, bool? success, }) { return AiSearchUpdateTokensResponse400(
