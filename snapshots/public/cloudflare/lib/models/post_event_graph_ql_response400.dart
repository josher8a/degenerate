...
PostEventGraphQlResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return PostEventGraphQlResponse400(
...
@override String toString() => 'PostEventGraphQlResponse400(errors: $errors, result: $result, success: $success)';
