...
// Source: #/components/schemas/PostZonesZoneIdLogpushJobsRequest

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/logpush_dataset.dart';import 'package:pub_cloudflare/models/logpush_destination_conf.dart';import 'package:pub_cloudflare/models/logpush_enabled.dart';import 'package:pub_cloudflare/models/logpush_filter.dart';import 'package:pub_cloudflare/models/logpush_frequency.dart';import 'package:pub_cloudflare/models/logpush_kind.dart';import 'package:pub_cloudflare/models/logpush_logpull_options.dart';import 'package:pub_cloudflare/models/logpush_max_upload_bytes.dart';import 'package:pub_cloudflare/models/logpush_max_upload_bytes/logpush_max_upload_bytes_variant1.dart';import 'package:pub_cloudflare/models/logpush_max_upload_interval_seconds.dart';import 'package:pub_cloudflare/models/logpush_max_upload_records.dart';import 'package:pub_cloudflare/models/logpush_name.dart';import 'package:pub_cloudflare/models/logpush_output_options.dart';import 'package:pub_cloudflare/models/logpush_ownership_challenge.dart';@immutable final class PostZonesZoneIdLogpushJobsRequest {const PostZonesZoneIdLogpushJobsRequest({required this.destinationConf, this.dataset, this.enabled, this.filter, this.frequency, this.kind, this.logpullOptions, this.maxUploadBytes, this.maxUploadIntervalSeconds, this.maxUploadRecords, this.name, this.outputOptions, this.ownershipChallenge, });
