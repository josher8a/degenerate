...
// Source: #/components/schemas/PageRulesListPageRulesResponse
...
@override String toString() => 'PageRulesListPageRulesResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
