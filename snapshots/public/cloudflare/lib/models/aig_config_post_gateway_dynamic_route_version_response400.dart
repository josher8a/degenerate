...
AigConfigPostGatewayDynamicRouteVersionResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return AigConfigPostGatewayDynamicRouteVersionResponse400(
...
@override String toString() => 'AigConfigPostGatewayDynamicRouteVersionResponse400(errors: $errors, result: $result, success: $success)';
