...
RadarGetEmailSecuritySummaryBySpoofResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetEmailSecuritySummaryBySpoofResponse400(
...
@override String toString() => 'RadarGetEmailSecuritySummaryBySpoofResponse400(errors: $errors, result: $result, success: $success)';
