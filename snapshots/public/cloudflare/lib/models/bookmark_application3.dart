...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/access_apps_components_schemas_name.dart';import 'package:pub_cloudflare/models/access_logo_url.dart';import 'package:pub_cloudflare/models/access_schemas_aud.dart';import 'package:pub_cloudflare/models/access_schemas_scim_config.dart';import 'package:pub_cloudflare/models/access_timestamp.dart';import 'package:pub_cloudflare/models/access_uuid.dart';@immutable final class BookmarkApplication3 {const BookmarkApplication3({required this.domain, required this.type, this.aud, this.createdAt, this.id, this.scimConfig, this.updatedAt, this.appLauncherVisible, this.logoUrl, this.name, });
...
@override int get hashCode => Object.hash(aud, createdAt, id, scimConfig, updatedAt, appLauncherVisible, domain, logoUrl, name, type);

@override String toString() => 'BookmarkApplication3(\n  aud: $aud,\n  createdAt: $createdAt,\n  id: $id,\n  scimConfig: $scimConfig,\n  updatedAt: $updatedAt,\n  appLauncherVisible: $appLauncherVisible,\n  domain: $domain,\n  logoUrl: $logoUrl,\n  name: $name,\n  type: $type,\n)';
