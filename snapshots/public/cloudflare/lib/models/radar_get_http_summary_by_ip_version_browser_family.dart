...
W when<W>({required W Function() chrome, required W Function() edge, required W Function() firefox, required W Function() safari, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpSummaryByIpVersionBrowserFamily$chrome() => chrome(),
      RadarGetHttpSummaryByIpVersionBrowserFamily$edge() => edge(),
      RadarGetHttpSummaryByIpVersionBrowserFamily$firefox() => firefox(),
      RadarGetHttpSummaryByIpVersionBrowserFamily$safari() => safari(),
      RadarGetHttpSummaryByIpVersionBrowserFamily$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? chrome, W Function()? edge, W Function()? firefox, W Function()? safari, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpSummaryByIpVersionBrowserFamily$chrome() => chrome != null ? chrome() : orElse(value),
      RadarGetHttpSummaryByIpVersionBrowserFamily$edge() => edge != null ? edge() : orElse(value),
      RadarGetHttpSummaryByIpVersionBrowserFamily$firefox() => firefox != null ? firefox() : orElse(value),
      RadarGetHttpSummaryByIpVersionBrowserFamily$safari() => safari != null ? safari() : orElse(value),
      RadarGetHttpSummaryByIpVersionBrowserFamily$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
