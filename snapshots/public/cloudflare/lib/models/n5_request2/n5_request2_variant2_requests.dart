...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/input_embedding/input_embedding2_text.dart';import 'package:pub_cloudflare/models/n5_request2/pooling.dart';@immutable final class $5Request2Variant2Requests {const $5Request2Variant2Requests({required this.text, this.pooling = Pooling.mean, });
...
$5Request2Variant2Requests copyWith({Pooling Function()? pooling, InputEmbedding2Text? text, }) { return $5Request2Variant2Requests(
