...
// Source: #/components/schemas/RadarGetEmailSecurityTimeseriesGroupByMaliciousResponse
...
@override String toString() => 'RadarGetEmailSecurityTimeseriesGroupByMaliciousResponse(result: $result, success: $success)';
