...
W when<W>({required W Function() $15m, required W Function() $1h, required W Function() $1d, required W Function() $1w, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$15m() => $15m(),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$1h() => $1h(),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$1d() => $1d(),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$1w() => $1w(),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $15m, W Function()? $1h, W Function()? $1d, W Function()? $1w, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$15m() => $15m != null ? $15m() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$1h() => $1h != null ? $1h() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$1d() => $1d != null ? $1d() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$$1w() => $1w != null ? $1w() : orElse(value),
      RadarGetHttpTimeseriesGroupByBrowsersAggInterval$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
