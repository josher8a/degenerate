...
// Source: #/components/schemas/SlurperAbortJobResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/error_model32.dart';@immutable final class SlurperAbortJobResponse {const SlurperAbortJobResponse({this.errors, this.messages, this.success, this.result, });
...
@override String toString() => 'SlurperAbortJobResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
