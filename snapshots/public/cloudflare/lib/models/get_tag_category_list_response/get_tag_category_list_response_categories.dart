...
// Source: #/components/schemas/GetTagCategoryListResponse (inline: Categories)
...
@override String toString() => 'GetTagCategoryListResponseCategories(createdAt: $createdAt, description: $description, name: $name, updatedAt: $updatedAt, uuid: $uuid)';
