...
W when<W>({required W Function() windows, required W Function() macosx, required W Function() ios, required W Function() android, required W Function() chromeos, required W Function() linux, required W Function() smartTv, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByTlsVersionOs$windows() => windows(),
      RadarGetHttpTopAsesByTlsVersionOs$macosx() => macosx(),
      RadarGetHttpTopAsesByTlsVersionOs$ios() => ios(),
      RadarGetHttpTopAsesByTlsVersionOs$android() => android(),
      RadarGetHttpTopAsesByTlsVersionOs$chromeos() => chromeos(),
      RadarGetHttpTopAsesByTlsVersionOs$linux() => linux(),
      RadarGetHttpTopAsesByTlsVersionOs$smartTv() => smartTv(),
      RadarGetHttpTopAsesByTlsVersionOs$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? windows, W Function()? macosx, W Function()? ios, W Function()? android, W Function()? chromeos, W Function()? linux, W Function()? smartTv, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByTlsVersionOs$windows() => windows != null ? windows() : orElse(value),
      RadarGetHttpTopAsesByTlsVersionOs$macosx() => macosx != null ? macosx() : orElse(value),
      RadarGetHttpTopAsesByTlsVersionOs$ios() => ios != null ? ios() : orElse(value),
      RadarGetHttpTopAsesByTlsVersionOs$android() => android != null ? android() : orElse(value),
      RadarGetHttpTopAsesByTlsVersionOs$chromeos() => chromeos != null ? chromeos() : orElse(value),
      RadarGetHttpTopAsesByTlsVersionOs$linux() => linux != null ? linux() : orElse(value),
      RadarGetHttpTopAsesByTlsVersionOs$smartTv() => smartTv != null ? smartTv() : orElse(value),
      RadarGetHttpTopAsesByTlsVersionOs$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
