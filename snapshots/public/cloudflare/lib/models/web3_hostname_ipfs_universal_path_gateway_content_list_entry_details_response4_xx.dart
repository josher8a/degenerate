...
// Source: #/components/schemas/Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/web3_messages2.dart';@immutable final class Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4Xx {const Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4Xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4Xx(
...
@override String toString() => 'Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
