...
W when<W>({required W Function() initializing, required W Function() pending, required W Function() active, required W Function() moved, required W Function(String value) $unknown, }) { return switch (this) {
      ZonesZoneStatus$initializing() => initializing(),
      ZonesZoneStatus$pending() => pending(),
      ZonesZoneStatus$active() => active(),
      ZonesZoneStatus$moved() => moved(),
      ZonesZoneStatus$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? initializing, W Function()? pending, W Function()? active, W Function()? moved, W Function(String value)? $unknown, }) { return switch (this) {
      ZonesZoneStatus$initializing() => initializing != null ? initializing() : orElse(value),
      ZonesZoneStatus$pending() => pending != null ? pending() : orElse(value),
      ZonesZoneStatus$active() => active != null ? active() : orElse(value),
      ZonesZoneStatus$moved() => moved != null ? moved() : orElse(value),
      ZonesZoneStatus$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
if (name.runes.length > 253) { errors.add('name: length must be <= 253'); }
...
if (originalDnshost$ != null) {
  if (originalDnshost$.runes.length > 50) { errors.add('originalDnshost: length must be <= 50'); }
}
return errors; } 
