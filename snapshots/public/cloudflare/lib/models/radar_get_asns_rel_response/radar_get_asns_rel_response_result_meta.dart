...
// Source: #/components/schemas/RadarGetAsnsRelResponse (inline: Result > Meta)
...
@override String toString() => 'RadarGetAsnsRelResponseResultMeta(dataTime: $dataTime, queryTime: $queryTime, totalPeers: $totalPeers)';
