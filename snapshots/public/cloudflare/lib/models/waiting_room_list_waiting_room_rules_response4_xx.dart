...
WaitingRoomListWaitingRoomRulesResponse4Xx copyWith({List<WaitingroomMessages2>? errors, List<WaitingroomMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, Map<String, dynamic>? Function()? result, }) { return WaitingRoomListWaitingRoomRulesResponse4Xx(
...
@override String toString() => 'WaitingRoomListWaitingRoomRulesResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
