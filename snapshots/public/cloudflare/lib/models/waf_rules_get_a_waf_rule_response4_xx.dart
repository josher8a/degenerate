...
// Source: #/components/schemas/WafRulesGetAWafRuleResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/waf_managed_rules_messages2.dart';@immutable final class WafRulesGetAWafRuleResponse4Xx {const WafRulesGetAWafRuleResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
WafRulesGetAWafRuleResponse4Xx copyWith({List<WafManagedRulesMessages2>? errors, List<WafManagedRulesMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WafRulesGetAWafRuleResponse4Xx(
...
@override String toString() => 'WafRulesGetAWafRuleResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
