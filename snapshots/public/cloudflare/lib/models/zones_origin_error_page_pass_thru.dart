...
W when<W>({required W Function() originErrorPagePassThru, required W Function(String value) $unknown, }) { return switch (this) {
      ZonesOriginErrorPagePassThruId$originErrorPagePassThru() => originErrorPagePassThru(),
      ZonesOriginErrorPagePassThruId$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? originErrorPagePassThru, W Function(String value)? $unknown, }) { return switch (this) {
      ZonesOriginErrorPagePassThruId$originErrorPagePassThru() => originErrorPagePassThru != null ? originErrorPagePassThru() : orElse(value),
      ZonesOriginErrorPagePassThruId$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
