...
DestinationListResponse500 copyWith({List<DestinationCreateResponse500Errors>? errors, List<DestinationCreateResponse400Messages>? messages, bool? success, }) { return DestinationListResponse500(
...
@override String toString() => 'DestinationListResponse500(errors: $errors, messages: $messages, success: $success)';
