...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/intel_messages2.dart';import 'package:pub_cloudflare/models/intel_result_info.dart';@immutable final class DomainIntelligenceGetMultipleDomainDetailsResponse4Xx {const DomainIntelligenceGetMultipleDomainDetailsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() => 'DomainIntelligenceGetMultipleDomainDetailsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)';
