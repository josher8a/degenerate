...
W when<W>({required W Function() active, required W Function() canceled, required W Function(String value) $unknown, }) { return switch (this) {
      MembersListStatus$active() => active(),
      MembersListStatus$canceled() => canceled(),
      MembersListStatus$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? active, W Function()? canceled, W Function(String value)? $unknown, }) { return switch (this) {
      MembersListStatus$active() => active != null ? active() : orElse(value),
      MembersListStatus$canceled() => canceled != null ? canceled() : orElse(value),
      MembersListStatus$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
