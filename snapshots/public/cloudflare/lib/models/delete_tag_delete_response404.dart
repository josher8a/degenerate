...
DeleteTagDeleteResponse404 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return DeleteTagDeleteResponse404(
...
@override String toString() => 'DeleteTagDeleteResponse404(errors: $errors, result: $result, success: $success)';
