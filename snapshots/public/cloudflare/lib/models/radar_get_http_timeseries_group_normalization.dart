...
W when<W>({required W Function() percentage, required W Function() min0Max, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupNormalization$percentage() => percentage(),
      RadarGetHttpTimeseriesGroupNormalization$min0Max() => min0Max(),
      RadarGetHttpTimeseriesGroupNormalization$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? percentage, W Function()? min0Max, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupNormalization$percentage() => percentage != null ? percentage() : orElse(value),
      RadarGetHttpTimeseriesGroupNormalization$min0Max() => min0Max != null ? min0Max() : orElse(value),
      RadarGetHttpTimeseriesGroupNormalization$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
