...
// Source: #/components/schemas/DestinationCreateResponse401

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/destination_create_response400/destination_create_response400_messages.dart';import 'package:pub_cloudflare/models/destination_create_response401/destination_create_response401_errors.dart';@immutable final class DestinationCreateResponse401 {const DestinationCreateResponse401({required this.errors, required this.messages, required this.success, });
...
DestinationCreateResponse401 copyWith({List<DestinationCreateResponse401Errors>? errors, List<DestinationCreateResponse400Messages>? messages, bool? success, }) { return DestinationCreateResponse401(
...
@override String toString() => 'DestinationCreateResponse401(errors: $errors, messages: $messages, success: $success)';
