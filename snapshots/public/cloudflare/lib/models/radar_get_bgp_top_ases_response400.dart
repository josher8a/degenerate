...
// Source: #/components/schemas/RadarGetBgpTopAsesResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class RadarGetBgpTopAsesResponse400 {const RadarGetBgpTopAsesResponse400({required this.errors, required this.result, required this.success, });
...
RadarGetBgpTopAsesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetBgpTopAsesResponse400(
...
@override String toString() => 'RadarGetBgpTopAsesResponse400(errors: $errors, result: $result, success: $success)';
