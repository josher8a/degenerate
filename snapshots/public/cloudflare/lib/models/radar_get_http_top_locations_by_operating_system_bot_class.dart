...
W when<W>({required W Function() likelyAutomated, required W Function() likelyHuman, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByOperatingSystemBotClass$likelyAutomated() => likelyAutomated(),
      RadarGetHttpTopLocationsByOperatingSystemBotClass$likelyHuman() => likelyHuman(),
      RadarGetHttpTopLocationsByOperatingSystemBotClass$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? likelyAutomated, W Function()? likelyHuman, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByOperatingSystemBotClass$likelyAutomated() => likelyAutomated != null ? likelyAutomated() : orElse(value),
      RadarGetHttpTopLocationsByOperatingSystemBotClass$likelyHuman() => likelyHuman != null ? likelyHuman() : orElse(value),
      RadarGetHttpTopLocationsByOperatingSystemBotClass$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
