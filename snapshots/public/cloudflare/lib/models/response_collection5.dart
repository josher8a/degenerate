...
ResponseCollection5 copyWith({List<AlexandriaMessages2>? errors, List<AlexandriaMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, }) { return ResponseCollection5(
...
@override String toString() => 'ResponseCollection5(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)';
