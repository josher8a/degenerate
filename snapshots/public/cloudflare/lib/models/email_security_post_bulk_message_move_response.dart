...
// Source: #/components/schemas/EmailSecurityPostBulkMessageMoveResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_message.dart';import 'package:pub_cloudflare/models/email_security_move_response_item.dart';@immutable final class EmailSecurityPostBulkMessageMoveResponse {const EmailSecurityPostBulkMessageMoveResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'EmailSecurityPostBulkMessageMoveResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
