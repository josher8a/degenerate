...
// Source: #/components/schemas/EmailSecurityListDomainsResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_message.dart';@immutable final class EmailSecurityListDomainsResponse4Xx {const EmailSecurityListDomainsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'EmailSecurityListDomainsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
