...
// Source: #/components/schemas/EmailSecurityGetTrustedDomainResponse (inline: Result)
...
/// }
/// ```
@immutable final class EmailSecurityGetTrustedDomainResponseResult {const EmailSecurityGetTrustedDomainResponseResult({required this.isRecent, required this.isRegex, required this.isSimilarity, required this.pattern, required this.createdAt, required this.id, required this.lastModified, this.comments, });
...
if (comments$ != null) {
  if (comments$.runes.length > 1024) { errors.add('comments: length must be <= 1024'); }
}
if (pattern.isEmpty) { errors.add('pattern: length must be >= 1'); }
if (pattern.runes.length > 1024) { errors.add('pattern: length must be <= 1024'); }
return errors; } 
...
@override String toString() => 'EmailSecurityGetTrustedDomainResponseResult(comments: $comments, isRecent: $isRecent, isRegex: $isRegex, isSimilarity: $isSimilarity, pattern: $pattern, createdAt: $createdAt, id: $id, lastModified: $lastModified)';
