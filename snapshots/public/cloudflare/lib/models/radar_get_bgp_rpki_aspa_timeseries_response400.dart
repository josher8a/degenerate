...
// Source: #/components/schemas/RadarGetBgpRpkiAspaTimeseriesResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class RadarGetBgpRpkiAspaTimeseriesResponse400 {const RadarGetBgpRpkiAspaTimeseriesResponse400({required this.errors, required this.result, required this.success, });
...
RadarGetBgpRpkiAspaTimeseriesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetBgpRpkiAspaTimeseriesResponse400(
...
@override String toString() => 'RadarGetBgpRpkiAspaTimeseriesResponse400(errors: $errors, result: $result, success: $success)';
