...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/tunnel_messages2.dart';import 'package:pub_cloudflare/models/tunnel_result_info.dart';@immutable final class TunnelVirtualNetworkListVirtualNetworksResponse4Xx {const TunnelVirtualNetworkListVirtualNetworksResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() => 'TunnelVirtualNetworkListVirtualNetworksResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)';
