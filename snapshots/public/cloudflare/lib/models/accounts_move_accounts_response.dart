...
// Source: #/components/schemas/AccountsMoveAccountsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/message3.dart';import 'package:pub_cloudflare/models/move_account_response.dart';@immutable final class AccountsMoveAccountsResponse {const AccountsMoveAccountsResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'AccountsMoveAccountsResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
