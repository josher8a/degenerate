...
// Source: #/components/schemas/AccountLoadBalancerPoolsCreatePoolRequest

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/load_balancing_enabled.dart';import 'package:pub_cloudflare/models/load_balancing_latitude.dart';import 'package:pub_cloudflare/models/load_balancing_load_shedding.dart';import 'package:pub_cloudflare/models/load_balancing_longitude.dart';import 'package:pub_cloudflare/models/load_balancing_minimum_origins.dart';import 'package:pub_cloudflare/models/load_balancing_monitor_group_id.dart';import 'package:pub_cloudflare/models/load_balancing_monitor_id.dart';import 'package:pub_cloudflare/models/load_balancing_name.dart';import 'package:pub_cloudflare/models/load_balancing_notification_email.dart';import 'package:pub_cloudflare/models/load_balancing_notification_filter.dart';import 'package:pub_cloudflare/models/load_balancing_origin.dart';import 'package:pub_cloudflare/models/load_balancing_origin_steering.dart';import 'package:pub_cloudflare/models/load_balancing_schemas_description.dart';@immutable final class AccountLoadBalancerPoolsCreatePoolRequest {const AccountLoadBalancerPoolsCreatePoolRequest({required this.name, required this.origins, this.description, this.enabled, this.latitude, this.loadShedding, this.longitude, this.minimumOrigins, this.monitor, this.monitorGroup, this.notificationEmail, this.notificationFilter, this.originSteering, });
