...
// Source: #/components/schemas/RadarGetAiBotsSummaryByUserAgentResponse400
...
RadarGetAiBotsSummaryByUserAgentResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetAiBotsSummaryByUserAgentResponse400(
...
@override String toString() => 'RadarGetAiBotsSummaryByUserAgentResponse400(errors: $errors, result: $result, success: $success)';
