...
BrapiPostScrapeResponse429 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? Function()? errors, bool? success, }) { return BrapiPostScrapeResponse429(
...
@override String toString() => 'BrapiPostScrapeResponse429(errors: $errors, success: $success)';
