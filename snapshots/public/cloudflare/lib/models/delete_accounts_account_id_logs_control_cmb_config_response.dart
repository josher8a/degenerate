...
// Source: #/components/schemas/DeleteAccountsAccountIdLogsControlCmbConfigResponse
...
@override String toString() => 'DeleteAccountsAccountIdLogsControlCmbConfigResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
