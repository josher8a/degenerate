...
W when<W>({required W Function() any, required W Function() all, required W Function(String value) $unknown, }) { return switch (this) {
      WafRuleGroupsListWafRuleGroupsMatch$any() => any(),
      WafRuleGroupsListWafRuleGroupsMatch$all() => all(),
      WafRuleGroupsListWafRuleGroupsMatch$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? any, W Function()? all, W Function(String value)? $unknown, }) { return switch (this) {
      WafRuleGroupsListWafRuleGroupsMatch$any() => any != null ? any() : orElse(value),
      WafRuleGroupsListWafRuleGroupsMatch$all() => all != null ? all() : orElse(value),
      WafRuleGroupsListWafRuleGroupsMatch$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
