...
// Source: #/components/schemas/RadarGetDnsTimeseriesGroupByProtocolResponse400
...
RadarGetDnsTimeseriesGroupByProtocolResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsTimeseriesGroupByProtocolResponse400(
...
@override String toString() => 'RadarGetDnsTimeseriesGroupByProtocolResponse400(errors: $errors, result: $result, success: $success)';
