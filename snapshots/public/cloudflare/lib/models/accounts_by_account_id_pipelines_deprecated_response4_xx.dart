...
AccountsByAccountIdPipelinesDeprecatedResponse4Xx copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, Map<String, dynamic>? Function()? results, CloudflarePipelinesWorkerPipelinesCommonSuccess? success, }) { return AccountsByAccountIdPipelinesDeprecatedResponse4Xx(
...
@override String toString() => 'AccountsByAccountIdPipelinesDeprecatedResponse4Xx(errors: $errors, results: $results, success: $success)';
