...
// Source: #/components/schemas/PerHostnameAuthenticatedOriginPullGetTheHostnameClientCertificateResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/tls_certificates_and_hostnames_messages2.dart';@immutable final class PerHostnameAuthenticatedOriginPullGetTheHostnameClientCertificateResponse4Xx {const PerHostnameAuthenticatedOriginPullGetTheHostnameClientCertificateResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'PerHostnameAuthenticatedOriginPullGetTheHostnameClientCertificateResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
