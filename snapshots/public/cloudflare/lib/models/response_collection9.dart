...
// Source: #/components/schemas/ResponseCollection9
...
ResponseCollection9 copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, }) { return ResponseCollection9(
...
@override String toString() => 'ResponseCollection9(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)';
