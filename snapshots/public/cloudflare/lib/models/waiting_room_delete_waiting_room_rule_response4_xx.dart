...
@override String toString() => 'WaitingRoomDeleteWaitingRoomRuleResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
