...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/waitingroom_messages2.dart';@immutable final class WaitingRoomDeleteWaitingRoomRuleResponse4Xx {const WaitingRoomDeleteWaitingRoomRuleResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
WaitingRoomDeleteWaitingRoomRuleResponse4Xx copyWith({List<WaitingroomMessages2>? errors, List<WaitingroomMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WaitingRoomDeleteWaitingRoomRuleResponse4Xx(
...
@override String toString() => 'WaitingRoomDeleteWaitingRoomRuleResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
