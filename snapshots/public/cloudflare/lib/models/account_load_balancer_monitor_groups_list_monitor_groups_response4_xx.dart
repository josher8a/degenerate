...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/load_balancing_messages2.dart';import 'package:pub_cloudflare/models/load_balancing_result_info.dart';@immutable final class AccountLoadBalancerMonitorGroupsListMonitorGroupsResponse4Xx {const AccountLoadBalancerMonitorGroupsListMonitorGroupsResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
...
@override int get hashCode => Object.hash(Object.hashAll(errors), Object.hashAll(messages), success, result, resultInfo);

@override String toString() => 'AccountLoadBalancerMonitorGroupsListMonitorGroupsResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result, resultInfo: $resultInfo)';
