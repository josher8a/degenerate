...
@override String toString() => 'PayPerCrawlQueryZonesCanBeEnabledResponse(errors: $errors, messages: $messages, result: $result, resultInfo: $resultInfo, success: $success)';
