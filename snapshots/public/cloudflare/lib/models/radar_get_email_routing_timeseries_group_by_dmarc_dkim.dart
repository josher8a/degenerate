...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$pass() => pass(),
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$none() => none(),
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$fail() => fail(),
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$none() => none != null ? none() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupByDmarcDkim$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
