...
W when<W>({required W Function() udp, required W Function() tcp, required W Function() https, required W Function() tls, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$udp() => udp(),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$tcp() => tcp(),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$https() => https(),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$tls() => tls(),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? udp, W Function()? tcp, W Function()? https, W Function()? tls, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$udp() => udp != null ? udp() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$tcp() => tcp != null ? tcp() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$https() => https != null ? https() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$tls() => tls != null ? tls() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByResponseCodesProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
