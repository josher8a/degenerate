...
@override Map<String, dynamic> toJson() => {...int32.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...int64.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...float32.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...float64.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...$bool.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...stringModel.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...binary.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...cloudflarePipelinesTimestampField.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...json.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...cloudflarePipelinesStructField.toJson(), 'type': type};
...
@override Map<String, dynamic> toJson() => {...cloudflarePipelinesListField.toJson(), 'type': type};
