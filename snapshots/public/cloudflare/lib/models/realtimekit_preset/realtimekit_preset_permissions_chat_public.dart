...
// Source: #/components/schemas/RealtimekitPreset (inline: Permissions > Chat > Public)
...
@override String toString() => 'RealtimekitPresetPermissionsChatPublic(canSend: $canSend, files: $files, text: $text)';
