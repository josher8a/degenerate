...
W when<W>({required W Function() thin, required W Function(String value) $unknown, }) { return switch (this) {
      BorderWidth$thin() => thin(),
      BorderWidth$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? thin, W Function(String value)? $unknown, }) { return switch (this) {
      BorderWidth$thin() => thin != null ? thin() : orElse(value),
      BorderWidth$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
