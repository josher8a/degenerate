...
W when<W>({required W Function() dark, required W Function(String value) $unknown, }) { return switch (this) {
      DesignTokensTheme$dark() => dark(),
      DesignTokensTheme$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? dark, W Function(String value)? $unknown, }) { return switch (this) {
      DesignTokensTheme$dark() => dark != null ? dark() : orElse(value),
      DesignTokensTheme$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
