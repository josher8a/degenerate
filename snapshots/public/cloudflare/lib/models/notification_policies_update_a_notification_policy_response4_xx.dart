...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';@immutable final class NotificationPoliciesUpdateANotificationPolicyResponse4Xx {const NotificationPoliciesUpdateANotificationPolicyResponse4Xx({required this.errors, required this.messages, required this.success, });
...
NotificationPoliciesUpdateANotificationPolicyResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, }) { return NotificationPoliciesUpdateANotificationPolicyResponse4Xx(
...
@override String toString() => 'NotificationPoliciesUpdateANotificationPolicyResponse4Xx(errors: $errors, messages: $messages, success: $success)';
