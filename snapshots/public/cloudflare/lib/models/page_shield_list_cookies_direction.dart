...
W when<W>({required W Function() asc, required W Function() desc, required W Function(String value) $unknown, }) { return switch (this) {
      PageShieldListCookiesDirection$asc() => asc(),
      PageShieldListCookiesDirection$desc() => desc(),
      PageShieldListCookiesDirection$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? asc, W Function()? desc, W Function(String value)? $unknown, }) { return switch (this) {
      PageShieldListCookiesDirection$asc() => asc != null ? asc() : orElse(value),
      PageShieldListCookiesDirection$desc() => desc != null ? desc() : orElse(value),
      PageShieldListCookiesDirection$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
