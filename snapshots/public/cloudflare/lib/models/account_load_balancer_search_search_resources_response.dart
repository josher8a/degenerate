...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/load_balancing_messages2.dart';import 'package:pub_cloudflare/models/load_balancing_result_info.dart';import 'package:pub_cloudflare/models/load_balancing_search.dart';@immutable final class AccountLoadBalancerSearchSearchResourcesResponse {const AccountLoadBalancerSearchSearchResourcesResponse({required this.errors, required this.messages, required this.success, required this.resultInfo, required this.result, });
...
@override String toString() => 'AccountLoadBalancerSearchSearchResourcesResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
