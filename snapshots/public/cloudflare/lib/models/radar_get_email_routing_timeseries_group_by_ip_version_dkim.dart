...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$pass() => pass(),
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$none() => none(),
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$fail() => fail(),
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$none() => none != null ? none() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupByIpVersionDkim$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
