...
GetTargetIndustryListCompleteResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetTargetIndustryListCompleteResponse400(
...
@override String toString() => 'GetTargetIndustryListCompleteResponse400(errors: $errors, result: $result, success: $success)';
