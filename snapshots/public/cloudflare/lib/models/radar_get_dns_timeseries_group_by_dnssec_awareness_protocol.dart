...
W when<W>({required W Function() udp, required W Function() tcp, required W Function() https, required W Function() tls, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$udp() => udp(),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$tcp() => tcp(),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$https() => https(),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$tls() => tls(),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? udp, W Function()? tcp, W Function()? https, W Function()? tls, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$udp() => udp != null ? udp() : orElse(value),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$tcp() => tcp != null ? tcp() : orElse(value),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$https() => https != null ? https() : orElse(value),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$tls() => tls != null ? tls() : orElse(value),
      RadarGetDnsTimeseriesGroupByDnssecAwarenessProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
