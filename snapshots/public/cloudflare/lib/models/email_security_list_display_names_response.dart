...
// Source: #/components/schemas/EmailSecurityListDisplayNamesResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_display_name.dart';import 'package:pub_cloudflare/models/email_security_message.dart';import 'package:pub_cloudflare/models/email_security_result_info.dart';@immutable final class EmailSecurityListDisplayNamesResponse {const EmailSecurityListDisplayNamesResponse({required this.errors, required this.messages, required this.success, required this.result, required this.resultInfo, });
...
@override String toString() => 'EmailSecurityListDisplayNamesResponse(errors: $errors, messages: $messages, success: $success, result: $result, resultInfo: $resultInfo)';
