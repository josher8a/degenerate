...
// Source: #/components/schemas/ListAbuseReportsResponse (inline: Result)
...
@override int get hashCode => Object.hashAll(reports);

@override String toString() => 'ListAbuseReportsResponseResult(reports: $reports)';
