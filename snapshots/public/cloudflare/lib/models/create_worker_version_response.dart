...
// Source: #/components/schemas/CreateWorkerVersionResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_messages2.dart';import 'package:pub_cloudflare/models/workers_version.dart';@immutable final class CreateWorkerVersionResponse {const CreateWorkerVersionResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'CreateWorkerVersionResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
