...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailRoutingSummaryByArcDmarc$pass() => pass(),
      RadarGetEmailRoutingSummaryByArcDmarc$none() => none(),
      RadarGetEmailRoutingSummaryByArcDmarc$fail() => fail(),
      RadarGetEmailRoutingSummaryByArcDmarc$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailRoutingSummaryByArcDmarc$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailRoutingSummaryByArcDmarc$none() => none != null ? none() : orElse(value),
      RadarGetEmailRoutingSummaryByArcDmarc$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailRoutingSummaryByArcDmarc$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
