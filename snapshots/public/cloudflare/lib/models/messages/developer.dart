...
W when<W>({required W Function() developer, required W Function(String value) $unknown, }) { return switch (this) {
      DeveloperRole$developer() => developer(),
      DeveloperRole$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? developer, W Function(String value)? $unknown, }) { return switch (this) {
      DeveloperRole$developer() => developer != null ? developer() : orElse(value),
      DeveloperRole$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('content') &&
      json.containsKey('role') && json['role'] == 'developer'; } 
