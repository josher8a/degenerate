...
@override String toString() => 'ZeroTrustGatewayCategoriesListCategoriesResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
