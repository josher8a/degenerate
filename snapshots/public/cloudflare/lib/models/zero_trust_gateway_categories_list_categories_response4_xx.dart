...
// Source: #/components/schemas/ZeroTrustGatewayCategoriesListCategoriesResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_messages2.dart';@immutable final class ZeroTrustGatewayCategoriesListCategoriesResponse4Xx {const ZeroTrustGatewayCategoriesListCategoriesResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
ZeroTrustGatewayCategoriesListCategoriesResponse4Xx copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return ZeroTrustGatewayCategoriesListCategoriesResponse4Xx(
...
@override String toString() => 'ZeroTrustGatewayCategoriesListCategoriesResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
