...
// Source: #/components/schemas/EnableCatalogResponse
...
@override String toString() => 'EnableCatalogResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
