...
GetIndicatorTagsListResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetIndicatorTagsListResponse400(
...
@override String toString() => 'GetIndicatorTagsListResponse400(errors: $errors, result: $result, success: $success)';
