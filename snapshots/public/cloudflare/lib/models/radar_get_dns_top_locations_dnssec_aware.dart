...
W when<W>({required W Function() supported, required W Function() notSupported, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetDnsTopLocationsDnssecAware$supported() => supported(),
      RadarGetDnsTopLocationsDnssecAware$notSupported() => notSupported(),
      RadarGetDnsTopLocationsDnssecAware$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? supported, W Function()? notSupported, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetDnsTopLocationsDnssecAware$supported() => supported != null ? supported() : orElse(value),
      RadarGetDnsTopLocationsDnssecAware$notSupported() => notSupported != null ? notSupported() : orElse(value),
      RadarGetDnsTopLocationsDnssecAware$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
