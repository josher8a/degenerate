...
@override int get hashCode => Object.hash(apiUrl, authUrl, clientId);

@override String toString() => 'TeamsDevicesWorkspaceOneConfigResponse(apiUrl: $apiUrl, authUrl: $authUrl, clientId: $clientId)';
