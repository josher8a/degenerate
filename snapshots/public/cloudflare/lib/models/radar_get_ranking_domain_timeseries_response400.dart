...
RadarGetRankingDomainTimeseriesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetRankingDomainTimeseriesResponse400(
...
@override String toString() => 'RadarGetRankingDomainTimeseriesResponse400(errors: $errors, result: $result, success: $success)';
