...
// Source: #/components/schemas/MconnCustomerSnapshotsGetResult
...
@override String toString() => 'MconnCustomerSnapshotsGetResult(count: $count, cursor: $cursor, items: $items)';
