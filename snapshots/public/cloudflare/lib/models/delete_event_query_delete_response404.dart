...
DeleteEventQueryDeleteResponse404 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return DeleteEventQueryDeleteResponse404(
...
@override String toString() => 'DeleteEventQueryDeleteResponse404(errors: $errors, result: $result, success: $success)';
