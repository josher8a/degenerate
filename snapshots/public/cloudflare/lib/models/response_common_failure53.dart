...
// Source: #/components/schemas/ResponseCommonFailure53

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/pages_messages2.dart';@immutable final class ResponseCommonFailure53 {const ResponseCommonFailure53({required this.errors, required this.messages, required this.result, required this.success, });
