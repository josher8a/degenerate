...
// Source: #/components/schemas/McpServerPortalApplication

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/access_app_policy_link.dart';import 'package:pub_cloudflare/models/access_app_req_embedded_policies/access_app_req_embedded_policies_policies.dart';import 'package:pub_cloudflare/models/access_app_req_embedded_policies/policies_variant3.dart';import 'package:pub_cloudflare/models/access_apps_components_schemas_name.dart';import 'package:pub_cloudflare/models/access_custom_deny_message.dart';import 'package:pub_cloudflare/models/access_custom_deny_url.dart';import 'package:pub_cloudflare/models/access_custom_non_identity_deny_url.dart';import 'package:pub_cloudflare/models/access_destinations2.dart';import 'package:pub_cloudflare/models/access_domain.dart';import 'package:pub_cloudflare/models/access_http_only_cookie_attribute.dart';import 'package:pub_cloudflare/models/access_logo_url.dart';import 'package:pub_cloudflare/models/access_oauth_configuration.dart';import 'package:pub_cloudflare/models/access_options_preflight_bypass.dart';import 'package:pub_cloudflare/models/access_same_site_cookie_attribute.dart';import 'package:pub_cloudflare/models/access_schemas_allow_authenticate_via_warp.dart';import 'package:pub_cloudflare/models/access_schemas_auto_redirect_to_identity.dart';import 'package:pub_cloudflare/models/access_schemas_session_duration.dart';import 'package:pub_cloudflare/models/access_schemas_uuid.dart';import 'package:pub_cloudflare/models/access_scim_config.dart';import 'package:pub_cloudflare/models/access_type.dart';import 'package:pub_cloudflare/models/private_destination.dart';import 'package:pub_cloudflare/models/public_destination.dart';import 'package:pub_cloudflare/models/via_mcp_server_portal_destination.dart';@immutable final class McpServerPortalApplication {const McpServerPortalApplication({required this.type, this.allowAuthenticateViaWarp, this.allowedIdps, this.autoRedirectToIdentity, this.customDenyMessage, this.customDenyUrl, this.customNonIdentityDenyUrl, this.customPages, this.destinations, this.domain, this.httpOnlyCookieAttribute, this.logoUrl, this.name, this.oauthConfiguration, this.optionsPreflightBypass, this.sameSiteCookieAttribute, this.scimConfig, this.sessionDuration, this.tags, this.policies, });
