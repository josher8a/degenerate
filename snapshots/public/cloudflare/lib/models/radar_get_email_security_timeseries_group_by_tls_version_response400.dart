...
RadarGetEmailSecurityTimeseriesGroupByTlsVersionResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetEmailSecurityTimeseriesGroupByTlsVersionResponse400(
...
@override String toString() => 'RadarGetEmailSecurityTimeseriesGroupByTlsVersionResponse400(errors: $errors, result: $result, success: $success)';
