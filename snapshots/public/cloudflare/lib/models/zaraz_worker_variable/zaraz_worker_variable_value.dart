...
// Source: #/components/schemas/ZarazWorkerVariable (inline: Value)
...
@override String toString() => 'ZarazWorkerVariableValue(escapedWorkerName: $escapedWorkerName, workerTag: $workerTag)';
