...
AigConfigFetchEvaluationsResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return AigConfigFetchEvaluationsResponse404(
...
@override String toString() => 'AigConfigFetchEvaluationsResponse404(errors: $errors, success: $success)';
