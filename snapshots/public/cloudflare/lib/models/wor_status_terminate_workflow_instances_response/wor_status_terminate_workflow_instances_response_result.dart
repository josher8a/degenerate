...
W when<W>({required W Function() running, required W Function() notRunning, required W Function(String value) $unknown, }) { return switch (this) {
      WorStatusTerminateWorkflowInstancesResponseResultStatus$running() => running(),
      WorStatusTerminateWorkflowInstancesResponseResultStatus$notRunning() => notRunning(),
      WorStatusTerminateWorkflowInstancesResponseResultStatus$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? running, W Function()? notRunning, W Function(String value)? $unknown, }) { return switch (this) {
      WorStatusTerminateWorkflowInstancesResponseResultStatus$running() => running != null ? running() : orElse(value),
      WorStatusTerminateWorkflowInstancesResponseResultStatus$notRunning() => notRunning != null ? notRunning() : orElse(value),
      WorStatusTerminateWorkflowInstancesResponseResultStatus$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
