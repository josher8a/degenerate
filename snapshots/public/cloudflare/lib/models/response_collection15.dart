...
// Source: #/components/schemas/ResponseCollection15

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/d1_list_databases_response/d1_list_databases_response_result_info.dart';import 'package:pub_cloudflare/models/dns_settings_messages2.dart';@immutable final class ResponseCollection15 {const ResponseCollection15({required this.errors, required this.messages, required this.success, this.resultInfo, });
...
ResponseCollection15 copyWith({List<DnsSettingsMessages2>? errors, List<DnsSettingsMessages2>? messages, bool? success, D1ListDatabasesResponseResultInfo? Function()? resultInfo, }) { return ResponseCollection15(
...
@override String toString() => 'ResponseCollection15(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)';
