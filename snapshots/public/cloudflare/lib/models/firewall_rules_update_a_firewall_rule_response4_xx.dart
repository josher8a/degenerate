...
// Source: #/components/schemas/FirewallRulesUpdateAFirewallRuleResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/firewall_messages2.dart';@immutable final class FirewallRulesUpdateAFirewallRuleResponse4Xx {const FirewallRulesUpdateAFirewallRuleResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'FirewallRulesUpdateAFirewallRuleResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
