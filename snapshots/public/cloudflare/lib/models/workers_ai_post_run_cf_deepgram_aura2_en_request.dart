...
@override String toString() => 'WorkersAiPostRunCfDeepgramAura2EnRequest(bitRate: $bitRate, container: $container, encoding: $encoding, sampleRate: $sampleRate, speaker: $speaker, text: $text)';
