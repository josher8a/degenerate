...
W when<W>({required W Function() $on, required W Function() off, required W Function(String value) $unknown, }) { return switch (this) {
      CacheRulesRegionalTieredCacheValue$$on() => $on(),
      CacheRulesRegionalTieredCacheValue$off() => off(),
      CacheRulesRegionalTieredCacheValue$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $on, W Function()? off, W Function(String value)? $unknown, }) { return switch (this) {
      CacheRulesRegionalTieredCacheValue$$on() => $on != null ? $on() : orElse(value),
      CacheRulesRegionalTieredCacheValue$off() => off != null ? off() : orElse(value),
      CacheRulesRegionalTieredCacheValue$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
