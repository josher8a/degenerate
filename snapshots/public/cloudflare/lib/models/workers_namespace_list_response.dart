...
// Source: #/components/schemas/WorkersNamespaceListResponse
...
@override String toString() => 'WorkersNamespaceListResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
