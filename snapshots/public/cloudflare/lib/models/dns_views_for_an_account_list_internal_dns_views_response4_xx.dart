...
DnsViewsForAnAccountListInternalDnsViewsResponse4Xx copyWith({List<DnsSettingsMessages2>? errors, List<DnsSettingsMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, Map<String, dynamic>? Function()? result, }) { return DnsViewsForAnAccountListInternalDnsViewsResponse4Xx(
...
@override String toString() => 'DnsViewsForAnAccountListInternalDnsViewsResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
