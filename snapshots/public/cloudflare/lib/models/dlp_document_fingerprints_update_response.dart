...
// Source: #/components/schemas/DlpDocumentFingerprintsUpdateResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/dlp_document_fingerprint.dart';@immutable final class DlpDocumentFingerprintsUpdateResponse {const DlpDocumentFingerprintsUpdateResponse({this.result});
...
@override String toString() => 'DlpDocumentFingerprintsUpdateResponse(result: $result)';
