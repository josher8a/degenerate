...
Web3HostnameWeb3HostnameDetailsResponse4Xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return Web3HostnameWeb3HostnameDetailsResponse4Xx(
...
@override String toString() => 'Web3HostnameWeb3HostnameDetailsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
