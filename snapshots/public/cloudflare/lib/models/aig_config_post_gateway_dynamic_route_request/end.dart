...
W when<W>({required W Function() end, required W Function(String value) $unknown, }) { return switch (this) {
      EndType$end() => end(),
      EndType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? end, W Function(String value)? $unknown, }) { return switch (this) {
      EndType$end() => end != null ? end() : orElse(value),
