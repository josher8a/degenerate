...
W when<W>({required W Function() start, required W Function(String value) $unknown, }) { return switch (this) {
      StartType$start() => start(),
      StartType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? start, W Function(String value)? $unknown, }) { return switch (this) {
      StartType$start() => start != null ? start() : orElse(value),
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('id') && json['id'] is String &&
      ...
      json.containsKey('type') && json['type'] == 'start'; } 
