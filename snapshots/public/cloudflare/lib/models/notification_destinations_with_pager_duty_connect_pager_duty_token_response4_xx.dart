...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';@immutable final class NotificationDestinationsWithPagerDutyConnectPagerDutyTokenResponse4Xx {const NotificationDestinationsWithPagerDutyConnectPagerDutyTokenResponse4Xx({required this.errors, required this.messages, required this.success, });
...
NotificationDestinationsWithPagerDutyConnectPagerDutyTokenResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, }) { return NotificationDestinationsWithPagerDutyConnectPagerDutyTokenResponse4Xx(
...
@override String toString() => 'NotificationDestinationsWithPagerDutyConnectPagerDutyTokenResponse4Xx(errors: $errors, messages: $messages, success: $success)';
