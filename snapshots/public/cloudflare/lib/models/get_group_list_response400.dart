...
GetGroupListResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetGroupListResponse400(
...
@override String toString() => 'GetGroupListResponse400(errors: $errors, result: $result, success: $success)';
