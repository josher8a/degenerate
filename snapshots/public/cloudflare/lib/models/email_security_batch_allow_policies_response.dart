...
// Source: #/components/schemas/EmailSecurityBatchAllowPoliciesResponse
...
@override String toString() => 'EmailSecurityBatchAllowPoliciesResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
