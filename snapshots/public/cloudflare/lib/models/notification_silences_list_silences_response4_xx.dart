...
// Source: #/components/schemas/NotificationSilencesListSilencesResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/aaa_components_schemas_messages2.dart';@immutable final class NotificationSilencesListSilencesResponse4Xx {const NotificationSilencesListSilencesResponse4Xx({required this.errors, required this.messages, required this.success, });
...
NotificationSilencesListSilencesResponse4Xx copyWith({List<AaaComponentsSchemasMessages2>? errors, List<AaaComponentsSchemasMessages2>? messages, bool? success, }) { return NotificationSilencesListSilencesResponse4Xx(
...
@override String toString() => 'NotificationSilencesListSilencesResponse4Xx(errors: $errors, messages: $messages, success: $success)';
