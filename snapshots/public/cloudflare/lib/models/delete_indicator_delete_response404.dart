...
DeleteIndicatorDeleteResponse404 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return DeleteIndicatorDeleteResponse404(
...
@override String toString() => 'DeleteIndicatorDeleteResponse404(errors: $errors, result: $result, success: $success)';
