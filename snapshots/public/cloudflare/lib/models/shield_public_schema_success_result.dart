...
// Source: #/components/schemas/ShieldPublicSchemaSuccessResult

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/shield_messages2.dart';import 'package:pub_cloudflare/models/shield_public_schema.dart';@immutable final class ShieldPublicSchemaSuccessResult {const ShieldPublicSchemaSuccessResult({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'ShieldPublicSchemaSuccessResult(errors: $errors, messages: $messages, success: $success, result: $result)';
