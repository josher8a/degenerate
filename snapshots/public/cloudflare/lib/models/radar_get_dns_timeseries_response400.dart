...
RadarGetDnsTimeseriesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsTimeseriesResponse400(
...
@override String toString() => 'RadarGetDnsTimeseriesResponse400(errors: $errors, result: $result, success: $success)';
