...
W when<W>({required W Function() $15m, required W Function() $1h, required W Function() $1d, required W Function() $1w, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$15m() => $15m(),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$1h() => $1h(),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$1d() => $1d(),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$1w() => $1w(),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $15m, W Function()? $1h, W Function()? $1d, W Function()? $1w, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$15m() => $15m != null ? $15m() : orElse(value),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$1h() => $1h != null ? $1h() : orElse(value),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$1d() => $1d != null ? $1d() : orElse(value),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$$1w() => $1w != null ? $1w() : orElse(value),
      RadarGetAttacksLayer7TimeseriesGroupByMitigationProductAggInterval$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
