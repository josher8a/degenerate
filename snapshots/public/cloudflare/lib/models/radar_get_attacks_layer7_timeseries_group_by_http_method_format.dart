...
W when<W>({required W Function() $json, required W Function() csv, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetAttacksLayer7TimeseriesGroupByHttpMethodFormat$$json() => $json(),
      RadarGetAttacksLayer7TimeseriesGroupByHttpMethodFormat$csv() => csv(),
      RadarGetAttacksLayer7TimeseriesGroupByHttpMethodFormat$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $json, W Function()? csv, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetAttacksLayer7TimeseriesGroupByHttpMethodFormat$$json() => $json != null ? $json() : orElse(value),
      RadarGetAttacksLayer7TimeseriesGroupByHttpMethodFormat$csv() => csv != null ? csv() : orElse(value),
      RadarGetAttacksLayer7TimeseriesGroupByHttpMethodFormat$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
