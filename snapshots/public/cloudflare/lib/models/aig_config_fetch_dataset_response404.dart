...
AigConfigFetchDatasetResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return AigConfigFetchDatasetResponse404(
...
@override String toString() => 'AigConfigFetchDatasetResponse404(errors: $errors, success: $success)';
