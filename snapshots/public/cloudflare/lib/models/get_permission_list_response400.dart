...
// Source: #/components/schemas/GetPermissionListResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class GetPermissionListResponse400 {const GetPermissionListResponse400({required this.errors, required this.result, required this.success, });
...
GetPermissionListResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetPermissionListResponse400(
...
@override String toString() => 'GetPermissionListResponse400(errors: $errors, result: $result, success: $success)';
