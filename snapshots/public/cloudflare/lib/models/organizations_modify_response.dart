...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/message3.dart';import 'package:pub_cloudflare/models/organization.dart';@immutable final class OrganizationsModifyResponse {const OrganizationsModifyResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'OrganizationsModifyResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
