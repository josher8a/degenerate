...
// Source: #/components/schemas/DnsAnalyticsReportBytime (inline: Data)
...
@override int get hashCode => Object.hashAll(metrics);

@override String toString() => 'DnsAnalyticsReportBytimeData(metrics: $metrics)';
