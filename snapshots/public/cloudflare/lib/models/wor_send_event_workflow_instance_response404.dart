...
// Source: #/components/schemas/WorSendEventWorkflowInstanceResponse404

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/accounts_by_account_id_pipelines_by_pipeline_name_deprecated_response404/accounts_by_account_id_pipelines_by_pipeline_name_deprecated_response404_errors.dart';@immutable final class WorSendEventWorkflowInstanceResponse404 {const WorSendEventWorkflowInstanceResponse404({required this.errors, required this.messages, required this.result, required this.success, });
...
WorSendEventWorkflowInstanceResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorSendEventWorkflowInstanceResponse404(
...
@override String toString() => 'WorSendEventWorkflowInstanceResponse404(errors: $errors, messages: $messages, result: $result, success: $success)';
