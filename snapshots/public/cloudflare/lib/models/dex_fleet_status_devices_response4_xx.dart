...
DexFleetStatusDevicesResponse4Xx copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return DexFleetStatusDevicesResponse4Xx(
...
@override String toString() => 'DexFleetStatusDevicesResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
