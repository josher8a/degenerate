...
// Source: #/components/schemas/ArgoAnalyticsForZoneArgoAnalyticsForAZoneResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/argo_analytics_messages2.dart';@immutable final class ArgoAnalyticsForZoneArgoAnalyticsForAZoneResponse4Xx {const ArgoAnalyticsForZoneArgoAnalyticsForAZoneResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'ArgoAnalyticsForZoneArgoAnalyticsForAZoneResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
