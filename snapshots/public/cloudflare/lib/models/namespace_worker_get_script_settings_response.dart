...
// Source: #/components/schemas/NamespaceWorkerGetScriptSettingsResponse
...
@override String toString() => 'NamespaceWorkerGetScriptSettingsResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
