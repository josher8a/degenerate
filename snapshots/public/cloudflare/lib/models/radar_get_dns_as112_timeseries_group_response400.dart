...
RadarGetDnsAs112TimeseriesGroupResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsAs112TimeseriesGroupResponse400(
...
@override String toString() => 'RadarGetDnsAs112TimeseriesGroupResponse400(errors: $errors, result: $result, success: $success)';
