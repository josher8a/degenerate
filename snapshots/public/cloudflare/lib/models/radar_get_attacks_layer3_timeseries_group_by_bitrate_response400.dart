...
RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse400(
...
@override String toString() => 'RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse400(errors: $errors, result: $result, success: $success)';
