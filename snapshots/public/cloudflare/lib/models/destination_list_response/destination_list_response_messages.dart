...
W when<W>({required W Function() successfulRequest, required W Function(String value) $unknown, }) { return switch (this) {
      DestinationListResponseMessagesMessage$successfulRequest() => successfulRequest(),
      DestinationListResponseMessagesMessage$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? successfulRequest, W Function(String value)? $unknown, }) { return switch (this) {
      DestinationListResponseMessagesMessage$successfulRequest() => successfulRequest != null ? successfulRequest() : orElse(value),
      DestinationListResponseMessagesMessage$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
