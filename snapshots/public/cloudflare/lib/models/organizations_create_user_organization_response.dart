...
// Source: #/components/schemas/OrganizationsCreateUserOrganizationResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/message3.dart';import 'package:pub_cloudflare/models/organization.dart';@immutable final class OrganizationsCreateUserOrganizationResponse {const OrganizationsCreateUserOrganizationResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'OrganizationsCreateUserOrganizationResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
