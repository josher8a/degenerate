...
W when<W>({required W Function() gcs, required W Function(String value) $unknown, }) { return switch (this) {
      R2EnableSippyGcsSourceProvider$gcs() => gcs(),
      R2EnableSippyGcsSourceProvider$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? gcs, W Function(String value)? $unknown, }) { return switch (this) {
      R2EnableSippyGcsSourceProvider$gcs() => gcs != null ? gcs() : orElse(value),
      R2EnableSippyGcsSourceProvider$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
