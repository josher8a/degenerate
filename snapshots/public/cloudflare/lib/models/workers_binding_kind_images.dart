...
// Source: #/components/schemas/WorkersBindingKindImages

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_binding_name.dart';@immutable final class WorkersBindingKindImages {const WorkersBindingKindImages({required this.name, required this.type, });
