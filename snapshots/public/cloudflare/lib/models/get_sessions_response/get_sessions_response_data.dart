...
// Source: #/components/schemas/GetSessionsResponse (inline: Data)
...
@override int get hashCode => Object.hashAll(sessions ?? const []);

@override String toString() => 'GetSessionsResponseData(sessions: $sessions)';
