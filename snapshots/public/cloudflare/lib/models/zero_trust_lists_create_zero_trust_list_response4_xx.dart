...
// Source: #/components/schemas/ZeroTrustListsCreateZeroTrustListResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_messages2.dart';@immutable final class ZeroTrustListsCreateZeroTrustListResponse4Xx {const ZeroTrustListsCreateZeroTrustListResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
ZeroTrustListsCreateZeroTrustListResponse4Xx copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return ZeroTrustListsCreateZeroTrustListResponse4Xx(
...
@override String toString() => 'ZeroTrustListsCreateZeroTrustListResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
