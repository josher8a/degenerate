...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_messages2.dart';@immutable final class ZeroTrustListsCreateZeroTrustListResponse4Xx {const ZeroTrustListsCreateZeroTrustListResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'ZeroTrustListsCreateZeroTrustListResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)';
