...
@override int get hashCode => Object.hash(Object.hashAll(errors), Object.hashAll(result ?? const []), success, resultInfo);

@override String toString() => 'ResponseCollection33(errors: $errors, result: $result, success: $success, resultInfo: $resultInfo)';
