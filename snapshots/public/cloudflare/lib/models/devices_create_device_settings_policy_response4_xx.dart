...
// Source: #/components/schemas/DevicesCreateDeviceSettingsPolicyResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/teams_devices_messages2.dart';@immutable final class DevicesCreateDeviceSettingsPolicyResponse4Xx {const DevicesCreateDeviceSettingsPolicyResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'DevicesCreateDeviceSettingsPolicyResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
