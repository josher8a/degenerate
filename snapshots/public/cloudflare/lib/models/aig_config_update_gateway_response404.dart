...
AigConfigUpdateGatewayResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return AigConfigUpdateGatewayResponse404(
...
@override String toString() => 'AigConfigUpdateGatewayResponse404(errors: $errors, success: $success)';
