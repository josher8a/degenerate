...
W when<W>({required W Function() ingest, required W Function(String value) $unknown, }) { return switch (this) {
      IngestAction$ingest() => ingest(),
      IngestAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? ingest, W Function(String value)? $unknown, }) { return switch (this) {
      IngestAction$ingest() => ingest != null ? ingest() : orElse(value),
      IngestAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
