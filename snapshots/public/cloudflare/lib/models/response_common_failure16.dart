...
// Source: #/components/schemas/ResponseCommonFailure16

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/calls_messages2.dart';@immutable final class ResponseCommonFailure16 {const ResponseCommonFailure16({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'ResponseCommonFailure16(errors: $errors, messages: $messages, result: $result, success: $success)';
