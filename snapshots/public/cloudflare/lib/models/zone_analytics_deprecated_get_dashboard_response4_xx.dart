...
@override String toString() => 'ZoneAnalyticsDeprecatedGetDashboardResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, query: $query)';
