...
// Source: #/components/schemas/AccountsTurnstileWidgetCreateRequest

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/turnstile_bot_fight_mode.dart';import 'package:pub_cloudflare/models/turnstile_clearance_level.dart';import 'package:pub_cloudflare/models/turnstile_ephemeral_id.dart';import 'package:pub_cloudflare/models/turnstile_name.dart';import 'package:pub_cloudflare/models/turnstile_offlabel.dart';import 'package:pub_cloudflare/models/turnstile_region.dart';import 'package:pub_cloudflare/models/turnstile_widget_mode.dart';@immutable final class AccountsTurnstileWidgetCreateRequest {const AccountsTurnstileWidgetCreateRequest({required this.domains, required this.mode, required this.name, this.botFightMode, this.clearanceLevel, this.ephemeralId, this.offlabel, this.region, });
...
@override String toString() => 'AccountsTurnstileWidgetCreateRequest(botFightMode: $botFightMode, clearanceLevel: $clearanceLevel, domains: $domains, ephemeralId: $ephemeralId, mode: $mode, name: $name, offlabel: $offlabel, region: $region)';
