...
WorDescribeWorkflowVersionsDagResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorDescribeWorkflowVersionsDagResponse404(
...
@override String toString() => 'WorDescribeWorkflowVersionsDagResponse404(errors: $errors, messages: $messages, result: $result, success: $success)';
