...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/custom_pages_messages2.dart';@immutable final class CustomPagesForAZoneGetACustomPageResponse4xx {const CustomPagesForAZoneGetACustomPageResponse4xx({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'CustomPagesForAZoneGetACustomPageResponse4xx(errors: $errors, messages: $messages, success: $success, result: $result)';
