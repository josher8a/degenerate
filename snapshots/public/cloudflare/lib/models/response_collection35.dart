...
ResponseCollection35 copyWith({List<SecretsStoreMessages2>? errors, List<SecretsStoreMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, }) { return ResponseCollection35(
...
@override String toString() => 'ResponseCollection35(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)';
