...
@override int get hashCode => Object.hash(Object.hashAll(errors ?? const []), Object.hashAll(record ?? const []));

@override String toString() => 'EmailEmailRoutingDnsQueryResponseResult(errors: $errors, record: $record)';
