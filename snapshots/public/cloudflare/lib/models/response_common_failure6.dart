...
// Source: #/components/schemas/ResponseCommonFailure6

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/alexandria_messages2.dart';@immutable final class ResponseCommonFailure6 {const ResponseCommonFailure6({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'ResponseCommonFailure6(errors: $errors, messages: $messages, result: $result, success: $success)';
