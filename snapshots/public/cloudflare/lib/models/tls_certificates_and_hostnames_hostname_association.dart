...
// Source: #/components/schemas/TlsCertificatesAndHostnamesHostnameAssociation
...
if (mtlsCertificateId$ != null) {
  if (mtlsCertificateId$.runes.length < 36) { errors.add('mtlsCertificateId: length must be >= 36'); }
  if (mtlsCertificateId$.runes.length > 36) { errors.add('mtlsCertificateId: length must be <= 36'); }
}
return errors; } 
