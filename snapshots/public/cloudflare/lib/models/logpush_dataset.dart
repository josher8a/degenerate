...
W when<W>({required W Function() accessRequests, required W Function() auditLogs, required W Function() auditLogsV2, required W Function() bisoUserActions, required W Function() casbFindings, required W Function() devicePostureResults, required W Function() dexApplicationTests, required W Function() dexDeviceStateEvents, required W Function() dlpForensicCopies, required W Function() dnsFirewallLogs, required W Function() dnsLogs, required W Function() emailSecurityAlerts, required W Function() firewallEvents, required W Function() gatewayDns, required W Function() gatewayHttp, required W Function() gatewayNetwork, required W Function() httpRequests, required W Function() ipsecLogs, required W Function() magicIdsDetections, required W Function() nelReports, required W Function() networkAnalyticsLogs, required W Function() pageShieldEvents, required W Function() sinkholeHttpLogs, required W Function() spectrumEvents, required W Function() sshLogs, required W Function() warpConfigChanges, required W Function() warpToggleChanges, required W Function() workersTraceEvents, required W Function() zarazEvents, required W Function() zeroTrustNetworkSessions, required W Function(String value) $unknown, }) { return switch (this) {
      LogpushDataset$accessRequests() => accessRequests(),
      LogpushDataset$auditLogs() => auditLogs(),
      LogpushDataset$auditLogsV2() => auditLogsV2(),
      LogpushDataset$bisoUserActions() => bisoUserActions(),
      LogpushDataset$casbFindings() => casbFindings(),
      LogpushDataset$devicePostureResults() => devicePostureResults(),
      LogpushDataset$dexApplicationTests() => dexApplicationTests(),
      LogpushDataset$dexDeviceStateEvents() => dexDeviceStateEvents(),
      LogpushDataset$dlpForensicCopies() => dlpForensicCopies(),
      LogpushDataset$dnsFirewallLogs() => dnsFirewallLogs(),
      LogpushDataset$dnsLogs() => dnsLogs(),
      LogpushDataset$emailSecurityAlerts() => emailSecurityAlerts(),
      LogpushDataset$firewallEvents() => firewallEvents(),
      LogpushDataset$gatewayDns() => gatewayDns(),
      LogpushDataset$gatewayHttp() => gatewayHttp(),
      LogpushDataset$gatewayNetwork() => gatewayNetwork(),
      LogpushDataset$httpRequests() => httpRequests(),
      LogpushDataset$ipsecLogs() => ipsecLogs(),
      LogpushDataset$magicIdsDetections() => magicIdsDetections(),
      LogpushDataset$nelReports() => nelReports(),
      LogpushDataset$networkAnalyticsLogs() => networkAnalyticsLogs(),
      LogpushDataset$pageShieldEvents() => pageShieldEvents(),
      LogpushDataset$sinkholeHttpLogs() => sinkholeHttpLogs(),
      LogpushDataset$spectrumEvents() => spectrumEvents(),
      LogpushDataset$sshLogs() => sshLogs(),
      LogpushDataset$warpConfigChanges() => warpConfigChanges(),
      LogpushDataset$warpToggleChanges() => warpToggleChanges(),
      LogpushDataset$workersTraceEvents() => workersTraceEvents(),
      LogpushDataset$zarazEvents() => zarazEvents(),
      LogpushDataset$zeroTrustNetworkSessions() => zeroTrustNetworkSessions(),
      LogpushDataset$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? accessRequests, W Function()? auditLogs, W Function()? auditLogsV2, W Function()? bisoUserActions, W Function()? casbFindings, W Function()? devicePostureResults, W Function()? dexApplicationTests, W Function()? dexDeviceStateEvents, W Function()? dlpForensicCopies, W Function()? dnsFirewallLogs, W Function()? dnsLogs, W Function()? emailSecurityAlerts, W Function()? firewallEvents, W Function()? gatewayDns, W Function()? gatewayHttp, W Function()? gatewayNetwork, W Function()? httpRequests, W Function()? ipsecLogs, W Function()? magicIdsDetections, W Function()? nelReports, W Function()? networkAnalyticsLogs, W Function()? pageShieldEvents, W Function()? sinkholeHttpLogs, W Function()? spectrumEvents, W Function()? sshLogs, W Function()? warpConfigChanges, W Function()? warpToggleChanges, W Function()? workersTraceEvents, W Function()? zarazEvents, W Function()? zeroTrustNetworkSessions, W Function(String value)? $unknown, }) { return switch (this) {
      LogpushDataset$accessRequests() => accessRequests != null ? accessRequests() : orElse(value),
      LogpushDataset$auditLogs() => auditLogs != null ? auditLogs() : orElse(value),
      LogpushDataset$auditLogsV2() => auditLogsV2 != null ? auditLogsV2() : orElse(value),
      LogpushDataset$bisoUserActions() => bisoUserActions != null ? bisoUserActions() : orElse(value),
      LogpushDataset$casbFindings() => casbFindings != null ? casbFindings() : orElse(value),
      LogpushDataset$devicePostureResults() => devicePostureResults != null ? devicePostureResults() : orElse(value),
      LogpushDataset$dexApplicationTests() => dexApplicationTests != null ? dexApplicationTests() : orElse(value),
      LogpushDataset$dexDeviceStateEvents() => dexDeviceStateEvents != null ? dexDeviceStateEvents() : orElse(value),
      LogpushDataset$dlpForensicCopies() => dlpForensicCopies != null ? dlpForensicCopies() : orElse(value),
      LogpushDataset$dnsFirewallLogs() => dnsFirewallLogs != null ? dnsFirewallLogs() : orElse(value),
      LogpushDataset$dnsLogs() => dnsLogs != null ? dnsLogs() : orElse(value),
      LogpushDataset$emailSecurityAlerts() => emailSecurityAlerts != null ? emailSecurityAlerts() : orElse(value),
      LogpushDataset$firewallEvents() => firewallEvents != null ? firewallEvents() : orElse(value),
      LogpushDataset$gatewayDns() => gatewayDns != null ? gatewayDns() : orElse(value),
      LogpushDataset$gatewayHttp() => gatewayHttp != null ? gatewayHttp() : orElse(value),
      LogpushDataset$gatewayNetwork() => gatewayNetwork != null ? gatewayNetwork() : orElse(value),
      LogpushDataset$httpRequests() => httpRequests != null ? httpRequests() : orElse(value),
      LogpushDataset$ipsecLogs() => ipsecLogs != null ? ipsecLogs() : orElse(value),
      LogpushDataset$magicIdsDetections() => magicIdsDetections != null ? magicIdsDetections() : orElse(value),
      LogpushDataset$nelReports() => nelReports != null ? nelReports() : orElse(value),
      LogpushDataset$networkAnalyticsLogs() => networkAnalyticsLogs != null ? networkAnalyticsLogs() : orElse(value),
      LogpushDataset$pageShieldEvents() => pageShieldEvents != null ? pageShieldEvents() : orElse(value),
      LogpushDataset$sinkholeHttpLogs() => sinkholeHttpLogs != null ? sinkholeHttpLogs() : orElse(value),
      LogpushDataset$spectrumEvents() => spectrumEvents != null ? spectrumEvents() : orElse(value),
      LogpushDataset$sshLogs() => sshLogs != null ? sshLogs() : orElse(value),
      LogpushDataset$warpConfigChanges() => warpConfigChanges != null ? warpConfigChanges() : orElse(value),
      LogpushDataset$warpToggleChanges() => warpToggleChanges != null ? warpToggleChanges() : orElse(value),
      LogpushDataset$workersTraceEvents() => workersTraceEvents != null ? workersTraceEvents() : orElse(value),
      LogpushDataset$zarazEvents() => zarazEvents != null ? zarazEvents() : orElse(value),
      LogpushDataset$zeroTrustNetworkSessions() => zeroTrustNetworkSessions != null ? zeroTrustNetworkSessions() : orElse(value),
      LogpushDataset$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
