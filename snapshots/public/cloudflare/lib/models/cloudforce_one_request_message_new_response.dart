...
// Source: #/components/schemas/CloudforceOneRequestMessageNewResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/cloudforce_one_requests_messages2.dart';import 'package:pub_cloudflare/models/cloudforce_one_requests_request_message_item.dart';@immutable final class CloudforceOneRequestMessageNewResponse {const CloudforceOneRequestMessageNewResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'CloudforceOneRequestMessageNewResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
