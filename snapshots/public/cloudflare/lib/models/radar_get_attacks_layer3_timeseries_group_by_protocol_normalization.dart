...
W when<W>({required W Function() percentage, required W Function() min0Max, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetAttacksLayer3TimeseriesGroupByProtocolNormalization$percentage() => percentage(),
      RadarGetAttacksLayer3TimeseriesGroupByProtocolNormalization$min0Max() => min0Max(),
      RadarGetAttacksLayer3TimeseriesGroupByProtocolNormalization$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? percentage, W Function()? min0Max, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetAttacksLayer3TimeseriesGroupByProtocolNormalization$percentage() => percentage != null ? percentage() : orElse(value),
      RadarGetAttacksLayer3TimeseriesGroupByProtocolNormalization$min0Max() => min0Max != null ? min0Max() : orElse(value),
      RadarGetAttacksLayer3TimeseriesGroupByProtocolNormalization$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
