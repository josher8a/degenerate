...
// Source: #/components/schemas/CloudflareTunnelDeleteACloudflareTunnelResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/tunnel_messages2.dart';@immutable final class CloudflareTunnelDeleteACloudflareTunnelResponse4Xx {const CloudflareTunnelDeleteACloudflareTunnelResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'CloudflareTunnelDeleteACloudflareTunnelResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
