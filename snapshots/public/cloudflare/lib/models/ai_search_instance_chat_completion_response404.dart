...
AiSearchInstanceChatCompletionResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return AiSearchInstanceChatCompletionResponse404(
...
@override String toString() => 'AiSearchInstanceChatCompletionResponse404(errors: $errors, success: $success)';
