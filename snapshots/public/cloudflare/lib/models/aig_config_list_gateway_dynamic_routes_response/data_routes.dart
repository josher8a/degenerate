...
DataRoutes copyWith({String? accountTag, DateTime? createdAt, Deployment? deployment, List<AigConfigPostGatewayDynamicRouteRequestElements>? elements, String? gatewayId, String? id, DateTime? modifiedAt, String? name, ResultVersion? version, }) { return DataRoutes(
...
@override String toString() { return 'DataRoutes(accountTag: $accountTag, createdAt: $createdAt, deployment: $deployment, elements: $elements, gatewayId: $gatewayId, id: $id, modifiedAt: $modifiedAt, name: $name, version: $version)'; } 
 }
