...
W when<W>({required W Function() desc, required W Function() asc, required W Function(String value) $unknown, }) { return switch (this) {
      AuditLogsGetAccountAuditLogsDirection$desc() => desc(),
      AuditLogsGetAccountAuditLogsDirection$asc() => asc(),
      AuditLogsGetAccountAuditLogsDirection$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? desc, W Function()? asc, W Function(String value)? $unknown, }) { return switch (this) {
      AuditLogsGetAccountAuditLogsDirection$desc() => desc != null ? desc() : orElse(value),
      AuditLogsGetAccountAuditLogsDirection$asc() => asc != null ? asc() : orElse(value),
      AuditLogsGetAccountAuditLogsDirection$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
