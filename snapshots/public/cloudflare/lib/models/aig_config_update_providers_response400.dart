...
// Source: #/components/schemas/AigConfigUpdateProvidersResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_create_instances_response400/ai_search_create_instances_response400_errors.dart';@immutable final class AigConfigUpdateProvidersResponse400 {const AigConfigUpdateProvidersResponse400({required this.errors, required this.success, });
...
AigConfigUpdateProvidersResponse400 copyWith({List<AiSearchCreateInstancesResponse400Errors>? errors, bool? success, }) { return AigConfigUpdateProvidersResponse400(
...
@override String toString() => 'AigConfigUpdateProvidersResponse400(errors: $errors, success: $success)';
