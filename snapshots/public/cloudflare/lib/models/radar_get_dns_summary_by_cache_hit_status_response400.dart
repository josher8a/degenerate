...
// Source: #/components/schemas/RadarGetDnsSummaryByCacheHitStatusResponse400
...
RadarGetDnsSummaryByCacheHitStatusResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsSummaryByCacheHitStatusResponse400(
...
@override String toString() => 'RadarGetDnsSummaryByCacheHitStatusResponse400(errors: $errors, result: $result, success: $success)';
