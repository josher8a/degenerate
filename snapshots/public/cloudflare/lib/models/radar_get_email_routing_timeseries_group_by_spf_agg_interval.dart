...
W when<W>({required W Function() $15m, required W Function() $1h, required W Function() $1d, required W Function() $1w, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$15m() => $15m(),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$1h() => $1h(),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$1d() => $1d(),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$1w() => $1w(),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $15m, W Function()? $1h, W Function()? $1d, W Function()? $1w, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$15m() => $15m != null ? $15m() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$1h() => $1h != null ? $1h() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$1d() => $1d != null ? $1d() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$$1w() => $1w != null ? $1w() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupBySpfAggInterval$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
