...
// Source: #/components/schemas/IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/addressing_messages2.dart';@immutable final class IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4Xx {const IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4Xx copyWith({List<AddressingMessages2>? errors, List<AddressingMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4Xx(
...
@override String toString() => 'IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
