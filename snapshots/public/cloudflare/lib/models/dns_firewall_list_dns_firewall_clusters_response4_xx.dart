...
DnsFirewallListDnsFirewallClustersResponse4Xx copyWith({List<DnsFirewallMessages2>? errors, List<DnsFirewallMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, Map<String, dynamic>? Function()? result, }) { return DnsFirewallListDnsFirewallClustersResponse4Xx(
...
@override String toString() => 'DnsFirewallListDnsFirewallClustersResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
