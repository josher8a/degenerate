...
BrapiPostPdfResponse500 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? Function()? errors, bool? success, }) { return BrapiPostPdfResponse500(
...
@override String toString() => 'BrapiPostPdfResponse500(errors: $errors, success: $success)';
