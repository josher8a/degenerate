...
W when<W>({required W Function() likelyAutomated, required W Function() likelyHuman, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByHttpProtocolBotClass$likelyAutomated() => likelyAutomated(),
      RadarGetHttpTopAsesByHttpProtocolBotClass$likelyHuman() => likelyHuman(),
      RadarGetHttpTopAsesByHttpProtocolBotClass$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? likelyAutomated, W Function()? likelyHuman, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByHttpProtocolBotClass$likelyAutomated() => likelyAutomated != null ? likelyAutomated() : orElse(value),
      RadarGetHttpTopAsesByHttpProtocolBotClass$likelyHuman() => likelyHuman != null ? likelyHuman() : orElse(value),
      RadarGetHttpTopAsesByHttpProtocolBotClass$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
