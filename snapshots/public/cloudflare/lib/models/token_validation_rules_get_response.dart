...
// Source: #/components/schemas/TokenValidationRulesGetResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/shield_messages2.dart';import 'package:pub_cloudflare/models/shield_rule.dart';@immutable final class TokenValidationRulesGetResponse {const TokenValidationRulesGetResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'TokenValidationRulesGetResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
