...
// Source: #/components/schemas/RadarGetSearchGlobalResponse (inline: Result)
...
@override int get hashCode => Object.hashAll(search);

@override String toString() => 'RadarGetSearchGlobalResponseResult(search: $search)';
