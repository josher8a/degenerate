...
// Source: #/components/schemas/DosMessages

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/access_messages/access_messages_source.dart';@immutable final class DosMessages2 {const DosMessages2({required this.code, required this.message, this.documentationUrl, this.source, });
...
return errors; } 
DosMessages2 copyWith({int? code, String? Function()? documentationUrl, String? message, AccessMessagesSource? Function()? source, }) { return DosMessages2(
  code: code ?? this.code,
