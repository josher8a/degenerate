...
// Source: #/components/schemas/DnsViewsForAnAccountCreateInternalDnsViewsResponse4Xx
...
DnsViewsForAnAccountCreateInternalDnsViewsResponse4Xx copyWith({List<DnsSettingsMessages2>? errors, List<DnsSettingsMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return DnsViewsForAnAccountCreateInternalDnsViewsResponse4Xx(
...
@override String toString() => 'DnsViewsForAnAccountCreateInternalDnsViewsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
