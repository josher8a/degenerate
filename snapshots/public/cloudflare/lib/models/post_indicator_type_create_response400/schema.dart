...
Schema copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return Schema(
...
@override String toString() => 'Schema(errors: $errors, result: $result, success: $success)';
