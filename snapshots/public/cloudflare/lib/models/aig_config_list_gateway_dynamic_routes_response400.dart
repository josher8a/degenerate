...
// Source: #/components/schemas/AigConfigListGatewayDynamicRoutesResponse400
...
AigConfigListGatewayDynamicRoutesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return AigConfigListGatewayDynamicRoutesResponse400(
...
@override String toString() => 'AigConfigListGatewayDynamicRoutesResponse400(errors: $errors, result: $result, success: $success)';
