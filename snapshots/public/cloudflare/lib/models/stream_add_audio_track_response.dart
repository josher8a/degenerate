...
// Source: #/components/schemas/StreamAddAudioTrackResponse
...
@override String toString() => 'StreamAddAudioTrackResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
