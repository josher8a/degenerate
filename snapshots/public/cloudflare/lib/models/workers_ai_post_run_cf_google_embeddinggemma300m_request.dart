...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/input_embedding/input_embedding2_text.dart';@immutable final class WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest {const WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest({required this.text});
...
WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest copyWith({InputEmbedding2Text? text}) { return WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest(
  text: text ?? this.text,
); } 
