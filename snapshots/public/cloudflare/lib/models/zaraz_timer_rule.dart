...
W when<W>({required W Function() timer, required W Function(String value) $unknown, }) { return switch (this) {
      ZarazTimerRuleAction$timer() => timer(),
      ZarazTimerRuleAction$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? timer, W Function(String value)? $unknown, }) { return switch (this) {
      ZarazTimerRuleAction$timer() => timer != null ? timer() : orElse(value),
      ZarazTimerRuleAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
