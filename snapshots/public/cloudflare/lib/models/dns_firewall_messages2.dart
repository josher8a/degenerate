...
return errors; } 
DnsFirewallMessages2 copyWith({int? code, String? Function()? documentationUrl, String? message, AccessMessagesSource? Function()? source, }) { return DnsFirewallMessages2(
  code: code ?? this.code,
...
@override String toString() => 'DnsFirewallMessages2(code: $code, documentationUrl: $documentationUrl, message: $message, source: $source)';
