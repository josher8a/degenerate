...
W when<W>({required W Function() immediate, required W Function() daily, required W Function(String value) $unknown, }) { return switch (this) {
      GetEventQueryAlertListResponseFrequency$immediate() => immediate(),
      GetEventQueryAlertListResponseFrequency$daily() => daily(),
      GetEventQueryAlertListResponseFrequency$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? immediate, W Function()? daily, W Function(String value)? $unknown, }) { return switch (this) {
      GetEventQueryAlertListResponseFrequency$immediate() => immediate != null ? immediate() : orElse(value),
      GetEventQueryAlertListResponseFrequency$daily() => daily != null ? daily() : orElse(value),
      GetEventQueryAlertListResponseFrequency$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
