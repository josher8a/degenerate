...
GetEventReadResponse404 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetEventReadResponse404(
...
@override String toString() => 'GetEventReadResponse404(errors: $errors, result: $result, success: $success)';
