...
RadarGetAiInferenceSummaryByTaskResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetAiInferenceSummaryByTaskResponse400(
...
@override String toString() => 'RadarGetAiInferenceSummaryByTaskResponse400(errors: $errors, result: $result, success: $success)';
