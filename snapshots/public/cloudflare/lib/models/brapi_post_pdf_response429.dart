...
BrapiPostPdfResponse429 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? Function()? errors, bool? success, }) { return BrapiPostPdfResponse429(
...
@override String toString() => 'BrapiPostPdfResponse429(errors: $errors, success: $success)';
