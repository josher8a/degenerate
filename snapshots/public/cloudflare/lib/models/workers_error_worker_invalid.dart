...
W when<W>({required W Function() $10021, required W Function(int value) $unknown, }) { return switch (this) {
      WorkersErrorWorkerInvalidCode$$10021() => $10021(),
      WorkersErrorWorkerInvalidCode$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(int value) orElse, W Function()? $10021, W Function(int value)? $unknown, }) { return switch (this) {
      WorkersErrorWorkerInvalidCode$$10021() => $10021 != null ? $10021() : orElse(value),
      WorkersErrorWorkerInvalidCode$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('code') && json['code'] == 10021 &&
