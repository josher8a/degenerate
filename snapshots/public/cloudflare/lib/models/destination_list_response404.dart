...
// Source: #/components/schemas/DestinationListResponse404
...
DestinationListResponse404 copyWith({List<DestinationListResponse404Errors>? errors, List<DestinationCreateResponse400Messages>? messages, bool? success, }) { return DestinationListResponse404(
...
@override String toString() => 'DestinationListResponse404(errors: $errors, messages: $messages, success: $success)';
