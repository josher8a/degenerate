...
@immutable final class BrowserSshApplication2 {const BrowserSshApplication2({this.aud, this.createdAt, this.id, this.updatedAt, this.policies, });
...
BrowserSshApplication2 copyWith({AccessSchemasAud? Function()? aud, AccessTimestamp? Function()? createdAt, AccessUuid? Function()? id, AccessTimestamp? Function()? updatedAt, List<AccessAppPolicyResponse>? Function()? policies, }) { return BrowserSshApplication2(
...
@override String toString() => 'BrowserSshApplication2(aud: $aud, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, policies: $policies)';
