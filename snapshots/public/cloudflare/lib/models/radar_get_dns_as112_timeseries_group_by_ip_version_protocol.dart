...
W when<W>({required W Function() udp, required W Function() tcp, required W Function() https, required W Function() tls, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$udp() => udp(),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$tcp() => tcp(),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$https() => https(),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$tls() => tls(),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? udp, W Function()? tcp, W Function()? https, W Function()? tls, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$udp() => udp != null ? udp() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$tcp() => tcp != null ? tcp() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$https() => https != null ? https() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$tls() => tls != null ? tls() : orElse(value),
      RadarGetDnsAs112TimeseriesGroupByIpVersionProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
