...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/firewall_messages2.dart';import 'package:pub_cloudflare/models/firewall_result_info.dart';@immutable final class FiltersUpdateFiltersResponse4Xx {const FiltersUpdateFiltersResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() => 'FiltersUpdateFiltersResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)';
