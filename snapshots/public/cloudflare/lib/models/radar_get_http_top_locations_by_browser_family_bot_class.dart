...
W when<W>({required W Function() likelyAutomated, required W Function() likelyHuman, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByBrowserFamilyBotClass$likelyAutomated() => likelyAutomated(),
      RadarGetHttpTopLocationsByBrowserFamilyBotClass$likelyHuman() => likelyHuman(),
      RadarGetHttpTopLocationsByBrowserFamilyBotClass$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? likelyAutomated, W Function()? likelyHuman, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByBrowserFamilyBotClass$likelyAutomated() => likelyAutomated != null ? likelyAutomated() : orElse(value),
      RadarGetHttpTopLocationsByBrowserFamilyBotClass$likelyHuman() => likelyHuman != null ? likelyHuman() : orElse(value),
      RadarGetHttpTopLocationsByBrowserFamilyBotClass$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
