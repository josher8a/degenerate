...
// Source: #/components/schemas/EmailSecurityUpdateDomainResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_get_domain_response/email_security_get_domain_response_result.dart';import 'package:pub_cloudflare/models/email_security_message.dart';@immutable final class EmailSecurityUpdateDomainResponse {const EmailSecurityUpdateDomainResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
EmailSecurityUpdateDomainResponse copyWith({List<EmailSecurityMessage>? errors, List<EmailSecurityMessage>? messages, bool? success, EmailSecurityGetDomainResponseResult? result, }) { return EmailSecurityUpdateDomainResponse(
...
@override String toString() => 'EmailSecurityUpdateDomainResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
