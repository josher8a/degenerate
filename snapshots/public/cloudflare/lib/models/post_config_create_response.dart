...
// Source: #/components/schemas/PostConfigCreateResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/messages22.dart';import 'package:pub_cloudflare/models/scan_config.dart';@immutable final class PostConfigCreateResponse {const PostConfigCreateResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'PostConfigCreateResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
