...
W when<W>({required W Function() http, required W Function() https, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByDeviceTypeHttpProtocol$http() => http(),
      RadarGetHttpTopAsesByDeviceTypeHttpProtocol$https() => https(),
      RadarGetHttpTopAsesByDeviceTypeHttpProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? http, W Function()? https, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopAsesByDeviceTypeHttpProtocol$http() => http != null ? http() : orElse(value),
      RadarGetHttpTopAsesByDeviceTypeHttpProtocol$https() => https != null ? https() : orElse(value),
      RadarGetHttpTopAsesByDeviceTypeHttpProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
