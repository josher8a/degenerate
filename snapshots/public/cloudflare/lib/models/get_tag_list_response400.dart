...
GetTagListResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetTagListResponse400(
...
@override String toString() => 'GetTagListResponse400(errors: $errors, result: $result, success: $success)';
