...
// Source: #/components/schemas/Web3HostnameWeb3HostnameDetailsResponse5Xx
...
Web3HostnameWeb3HostnameDetailsResponse5Xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, ResponseSingle57ResultInfo? Function()? resultInfo, }) { return Web3HostnameWeb3HostnameDetailsResponse5Xx(
...
@override String toString() => 'Web3HostnameWeb3HostnameDetailsResponse5Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)';
