...
W when<W>({required W Function() waitForEvent, required W Function(String value) $unknown, }) { return switch (this) {
      WaitForEventType$waitForEvent() => waitForEvent(),
      WaitForEventType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? waitForEvent, W Function(String value)? $unknown, }) { return switch (this) {
      WaitForEventType$waitForEvent() => waitForEvent != null ? waitForEvent() : orElse(value),
      WaitForEventType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
factory WaitForEvent.fromJson(Map<String, dynamic> json) { return WaitForEvent(
  ...
  output: OneOf4.parse(json['output'], fromA: (v) => v as Map<String, dynamic>, fromB: (v) => v as String, fromC: (v) => (v as num).toDouble(), fromD: (v) => v as bool, greedy: const {0},),
