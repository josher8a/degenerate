...
ListPortalsResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return ListPortalsResponse400(
...
@override String toString() => 'ListPortalsResponse400(errors: $errors, result: $result, success: $success)';
