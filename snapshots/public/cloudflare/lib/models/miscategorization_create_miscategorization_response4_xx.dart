...
MiscategorizationCreateMiscategorizationResponse4Xx copyWith({List<IntelMessages2>? errors, List<IntelMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return MiscategorizationCreateMiscategorizationResponse4Xx(
...
@override String toString() => 'MiscategorizationCreateMiscategorizationResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
