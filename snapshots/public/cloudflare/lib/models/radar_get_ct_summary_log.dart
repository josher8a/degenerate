...
W when<W>({required W Function() rfc6962, required W Function() $static, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetCtSummaryLog$rfc6962() => rfc6962(),
      RadarGetCtSummaryLog$$static() => $static(),
      RadarGetCtSummaryLog$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? rfc6962, W Function()? $static, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetCtSummaryLog$rfc6962() => rfc6962 != null ? rfc6962() : orElse(value),
      RadarGetCtSummaryLog$$static() => $static != null ? $static() : orElse(value),
      RadarGetCtSummaryLog$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
