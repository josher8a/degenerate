...
// Source: #/components/schemas/GetSecurityCenterInsightsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/get_security_center_insights_response/get_security_center_insights_response_result_variant1.dart';import 'package:pub_cloudflare/models/security_center_messages2.dart';@immutable final class GetSecurityCenterInsightsResponse {const GetSecurityCenterInsightsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'GetSecurityCenterInsightsResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
