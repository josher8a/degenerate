...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/realtimekit_livestream_base/realtimekit_livestream_base_status.dart';@immutable final class Livestreams {const Livestreams({this.createdAt, this.disabled, this.id, this.ingestServer, this.meetingId, this.name, this.playbackUrl, this.status, this.streamKey, this.updatedAt, });

factory Livestreams.fromJson(Map<String, dynamic> json) { return Livestreams(
...
Livestreams copyWith({DateTime Function()? createdAt, bool Function()? disabled, String Function()? id, String Function()? ingestServer, String Function()? meetingId, String? Function()? name, String Function()? playbackUrl, RealtimekitLivestreamBaseStatus Function()? status, String Function()? streamKey, DateTime Function()? updatedAt, }) { return Livestreams(
...
@override String toString() { return 'Livestreams(createdAt: $createdAt, disabled: $disabled, id: $id, ingestServer: $ingestServer, meetingId: $meetingId, name: $name, playbackUrl: $playbackUrl, status: $status, streamKey: $streamKey, updatedAt: $updatedAt)'; } 
 }
