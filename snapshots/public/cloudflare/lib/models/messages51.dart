...
factory Messages51.fromJson(Map<String, dynamic> json) { return Messages51(
  ...
  messages: (json['messages'] as List<dynamic>).map((e) => OneOf6.parse(e, fromA: (v) => Tool.fromJson(v as Map<String, dynamic>), fromB: (v) => MessagesFunction.fromJson(v as Map<String, dynamic>), fromC: (v) => Developer.fromJson(v as Map<String, dynamic>), fromD: (v) => MessagesSystem.fromJson(v as Map<String, dynamic>), fromE: (v) => MessagesUser.fromJson(v as Map<String, dynamic>), fromF: (v) => Assistant.fromJson(v as Map<String, dynamic>),)).toList(),
