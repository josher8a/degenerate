...
// Source: #/components/schemas/EmailSecurityGetMessageTraceResponse
...
@override String toString() => 'EmailSecurityGetMessageTraceResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
