...
// Source: #/components/schemas/RadarGetDnsTimeseriesGroupByDnssecResponse (inline: Result)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_ai_bots_timeseries_group_by_user_agent_response/radar_get_ai_bots_timeseries_group_by_user_agent_response_result_meta.dart';import 'package:pub_cloudflare/models/radar_get_dns_timeseries_group_by_dnssec_response/radar_get_dns_timeseries_group_by_dnssec_response_result_serie0.dart';@immutable final class RadarGetDnsTimeseriesGroupByDnssecResponseResult {const RadarGetDnsTimeseriesGroupByDnssecResponseResult({required this.meta, required this.serie0, });
...
RadarGetDnsTimeseriesGroupByDnssecResponseResult copyWith({RadarGetAiBotsTimeseriesGroupByUserAgentResponseResultMeta? meta, RadarGetDnsTimeseriesGroupByDnssecResponseResultSerie0? serie0, }) { return RadarGetDnsTimeseriesGroupByDnssecResponseResult(
  meta: meta ?? this.meta,
