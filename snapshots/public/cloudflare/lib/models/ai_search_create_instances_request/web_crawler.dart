...
@override String toString() { return 'ParseType($value)'; } 
 }
...
@override String toString() { return 'WebCrawler(crawlOptions: $crawlOptions, parseOptions: $parseOptions, parseType: $parseType, storeOptions: $storeOptions)'; } 
 }
