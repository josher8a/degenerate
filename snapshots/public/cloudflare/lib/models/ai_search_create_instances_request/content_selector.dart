...
// Source: #/components/schemas/AiSearchCreateInstancesRequest (inline: SourceParams > WebCrawler > ParseOptions > ContentSelector)
...
if (path.runes.length > 200) { errors.add('path: length must be <= 200'); }
if (selector.runes.length > 200) { errors.add('selector: length must be <= 200'); }
return errors; } 
