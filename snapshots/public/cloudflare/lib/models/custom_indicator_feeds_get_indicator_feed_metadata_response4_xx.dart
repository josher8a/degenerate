...
CustomIndicatorFeedsGetIndicatorFeedMetadataResponse4Xx copyWith({List<CustomIndicatorFeedsMessages2>? errors, List<CustomIndicatorFeedsMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return CustomIndicatorFeedsGetIndicatorFeedMetadataResponse4Xx(
...
@override String toString() => 'CustomIndicatorFeedsGetIndicatorFeedMetadataResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
