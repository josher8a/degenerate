...
RadarGetAnnotationsOutagesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetAnnotationsOutagesResponse400(
...
@override String toString() => 'RadarGetAnnotationsOutagesResponse400(errors: $errors, result: $result, success: $success)';
