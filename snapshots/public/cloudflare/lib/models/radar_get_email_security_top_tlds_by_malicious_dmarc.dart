...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$pass() => pass(),
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$none() => none(),
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$fail() => fail(),
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$none() => none != null ? none() : orElse(value),
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailSecurityTopTldsByMaliciousDmarc$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
