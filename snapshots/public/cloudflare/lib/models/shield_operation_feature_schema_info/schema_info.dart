...
W when<W>({required W Function() none, required W Function() log, required W Function() block, required W Function(String value) $unknown, }) { return switch (this) {
      SchemaInfoMitigationAction$none() => none(),
      SchemaInfoMitigationAction$log() => log(),
      SchemaInfoMitigationAction$block() => block(),
      SchemaInfoMitigationAction$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? none, W Function()? log, W Function()? block, W Function(String value)? $unknown, }) { return switch (this) {
      SchemaInfoMitigationAction$none() => none != null ? none() : orElse(value),
      SchemaInfoMitigationAction$log() => log != null ? log() : orElse(value),
      SchemaInfoMitigationAction$block() => block != null ? block() : orElse(value),
      SchemaInfoMitigationAction$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
