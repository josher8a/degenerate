...
// Source: #/components/schemas/SmartShieldPatchSettingsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/response_common33/response_common33_result.dart';import 'package:pub_cloudflare/models/smartshield_messages2.dart';@immutable final class SmartShieldPatchSettingsResponse {const SmartShieldPatchSettingsResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
SmartShieldPatchSettingsResponse copyWith({List<SmartshieldMessages2>? errors, List<SmartshieldMessages2>? messages, ResponseCommon33Result? result, bool? success, }) { return SmartShieldPatchSettingsResponse(
...
@override String toString() => 'SmartShieldPatchSettingsResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
