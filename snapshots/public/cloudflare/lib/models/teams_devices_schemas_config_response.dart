...
// Source: #/components/schemas/TeamsDevicesSchemasConfigResponse
...
factory TeamsDevicesSchemasConfigResponse.fromJson(Object? json) {   if (json is Map<String, dynamic> && TeamsDevicesTlsConfigResponse.canParse(json)) {
