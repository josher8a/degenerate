...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'smartshield_cache_reserve_clear_end_ts.dart';import 'smartshield_cache_reserve_clear_start_ts.dart';import 'smartshield_cache_reserve_clear_state.dart';@immutable final class SmartShieldSettingsGetCacheReserveClearResponseResult {const SmartShieldSettingsGetCacheReserveClearResponseResult({required this.startTs, required this.state, this.endTs, });
...
SmartShieldSettingsGetCacheReserveClearResponseResult copyWith({SmartshieldCacheReserveClearEndTs Function()? endTs, SmartshieldCacheReserveClearStartTs? startTs, SmartshieldCacheReserveClearState? state, }) { return SmartShieldSettingsGetCacheReserveClearResponseResult(
...
@override String toString() { return 'SmartShieldSettingsGetCacheReserveClearResponseResult(endTs: $endTs, startTs: $startTs, state: $state)'; } 
 }
