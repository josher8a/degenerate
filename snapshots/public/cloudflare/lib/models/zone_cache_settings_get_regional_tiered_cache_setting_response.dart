...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/cache_rules_cache_reserve_response_value/cache_rules_cache_reserve_response_value_result.dart';import 'package:pub_cloudflare/models/cache_rules_messages2.dart';@immutable final class ZoneCacheSettingsGetRegionalTieredCacheSettingResponse {const ZoneCacheSettingsGetRegionalTieredCacheSettingResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZoneCacheSettingsGetRegionalTieredCacheSettingResponse copyWith({List<CacheRulesMessages2>? errors, List<CacheRulesMessages2>? messages, bool? success, CacheRulesCacheReserveResponseValueResult? Function()? result, }) { return ZoneCacheSettingsGetRegionalTieredCacheSettingResponse(
...
@override String toString() => 'ZoneCacheSettingsGetRegionalTieredCacheSettingResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
