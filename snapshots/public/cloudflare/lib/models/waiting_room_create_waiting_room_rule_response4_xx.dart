...
WaitingRoomCreateWaitingRoomRuleResponse4Xx copyWith({List<WaitingroomMessages2>? errors, List<WaitingroomMessages2>? messages, bool? success, AccountLevelCustomNameserversDeleteAccountCustomNameserverResponse4XxResultInfo? Function()? resultInfo, Map<String, dynamic>? Function()? result, }) { return WaitingRoomCreateWaitingRoomRuleResponse4Xx(
...
@override String toString() => 'WaitingRoomCreateWaitingRoomRuleResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
