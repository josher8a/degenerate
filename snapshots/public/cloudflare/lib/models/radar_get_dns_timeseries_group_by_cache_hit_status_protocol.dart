...
W when<W>({required W Function() udp, required W Function() tcp, required W Function() https, required W Function() tls, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$udp() => udp(),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$tcp() => tcp(),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$https() => https(),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$tls() => tls(),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? udp, W Function()? tcp, W Function()? https, W Function()? tls, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$udp() => udp != null ? udp() : orElse(value),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$tcp() => tcp != null ? tcp() : orElse(value),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$https() => https != null ? https() : orElse(value),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$tls() => tls != null ? tls() : orElse(value),
      RadarGetDnsTimeseriesGroupByCacheHitStatusProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
