...
// Source: #/components/schemas/AccountsTurnstileWidgetGetResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/turnstile_messages2.dart';import 'package:pub_cloudflare/models/turnstile_widget_detail.dart';@immutable final class AccountsTurnstileWidgetGetResponse {const AccountsTurnstileWidgetGetResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'AccountsTurnstileWidgetGetResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
