...
ZeroTrustCertificatesZeroTrustCertificateDetailsResponse4Xx copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return ZeroTrustCertificatesZeroTrustCertificateDetailsResponse4Xx(
...
@override String toString() => 'ZeroTrustCertificatesZeroTrustCertificateDetailsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
