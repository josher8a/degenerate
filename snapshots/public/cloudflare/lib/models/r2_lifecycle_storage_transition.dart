...
W when<W>({required W Function() infrequentAccess, required W Function(String value) $unknown, }) { return switch (this) {
      StorageClass$infrequentAccess() => infrequentAccess(),
      StorageClass$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? infrequentAccess, W Function(String value)? $unknown, }) { return switch (this) {
      StorageClass$infrequentAccess() => infrequentAccess != null ? infrequentAccess() : orElse(value),
      StorageClass$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
