...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/load_balancing_messages2.dart';@immutable final class LoadBalancerMonitorsListMonitorsResponse4Xx {const LoadBalancerMonitorsListMonitorsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
LoadBalancerMonitorsListMonitorsResponse4Xx copyWith({List<LoadBalancingMessages2>? errors, List<LoadBalancingMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return LoadBalancerMonitorsListMonitorsResponse4Xx(
...
@override String toString() => 'LoadBalancerMonitorsListMonitorsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
