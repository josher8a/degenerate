...
// Source: #/components/schemas/WorkerScriptDeleteSubdomainResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/workers_messages2.dart';import 'package:pub_cloudflare/models/workers_subdomain.dart';@immutable final class WorkerScriptDeleteSubdomainResponse {const WorkerScriptDeleteSubdomainResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'WorkerScriptDeleteSubdomainResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
