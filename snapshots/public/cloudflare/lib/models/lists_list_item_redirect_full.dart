...
// Source: #/components/schemas/ListsListItemRedirectFull

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/lists_created_on.dart';import 'package:pub_cloudflare/models/lists_item_comment.dart';import 'package:pub_cloudflare/models/lists_item_id.dart';import 'package:pub_cloudflare/models/lists_item_redirect.dart';import 'package:pub_cloudflare/models/lists_modified_on.dart';/// Example:
/// ```json
/// {
...
/// }
/// ```
@immutable final class ListsListItemRedirectFull {const ListsListItemRedirectFull({required this.redirect, required this.createdOn, required this.id, required this.modifiedOn, this.comment, });
...
@override int get hashCode => Object.hash(redirect, comment, createdOn, id, modifiedOn);

@override String toString() => 'ListsListItemRedirectFull(redirect: $redirect, comment: $comment, createdOn: $createdOn, id: $id, modifiedOn: $modifiedOn)';
