...
UpdatePortalsResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return UpdatePortalsResponse404(
...
@override String toString() => 'UpdatePortalsResponse404(errors: $errors, success: $success)';
