...
// Source: #/components/schemas/EmailSecurityBatchBlockedSendersRequest
...
@override String toString() => 'EmailSecurityBatchBlockedSendersRequest(deletes: $deletes, patches: $patches, posts: $posts, puts: $puts)';
