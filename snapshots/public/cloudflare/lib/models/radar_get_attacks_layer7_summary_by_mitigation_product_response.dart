...
// Source: #/components/schemas/RadarGetAttacksLayer7SummaryByMitigationProductResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/radar_get_ai_bots_summary_by_user_agent_response/radar_get_ai_bots_summary_by_user_agent_response_result.dart';@immutable final class RadarGetAttacksLayer7SummaryByMitigationProductResponse {const RadarGetAttacksLayer7SummaryByMitigationProductResponse({required this.result, required this.success, });
...
RadarGetAttacksLayer7SummaryByMitigationProductResponse copyWith({RadarGetAiBotsSummaryByUserAgentResponseResult? result, bool? success, }) { return RadarGetAttacksLayer7SummaryByMitigationProductResponse(
...
@override String toString() => 'RadarGetAttacksLayer7SummaryByMitigationProductResponse(result: $result, success: $success)';
