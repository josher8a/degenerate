...
// Source: #/components/schemas/PostEventCreateResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class PostEventCreateResponse400 {const PostEventCreateResponse400({required this.errors, required this.result, required this.success, });
...
PostEventCreateResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return PostEventCreateResponse400(
...
@override String toString() => 'PostEventCreateResponse400(errors: $errors, result: $result, success: $success)';
