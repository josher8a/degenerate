...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/load_balancing_messages2.dart';@immutable final class AccountLoadBalancerPoolsPoolHealthDetailsResponse4Xx {const AccountLoadBalancerPoolsPoolHealthDetailsResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() => 'AccountLoadBalancerPoolsPoolHealthDetailsResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)';
