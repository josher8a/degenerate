...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$pass() => pass(),
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$none() => none(),
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$fail() => fail(),
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$none() => none != null ? none() : orElse(value),
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailSecurityTimeseriesGroupByThreatCategoryDmarc$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
