...
RadarGetDnsSummaryByDnssecAwarenessResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsSummaryByDnssecAwarenessResponse400(
...
@override String toString() => 'RadarGetDnsSummaryByDnssecAwarenessResponse400(errors: $errors, result: $result, success: $success)';
