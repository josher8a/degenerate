...
UpdateServersResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return UpdateServersResponse404(
...
@override String toString() => 'UpdateServersResponse404(errors: $errors, success: $success)';
