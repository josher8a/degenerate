...
@immutable final class BrowserRdpApplication2 {const BrowserRdpApplication2({this.aud, this.createdAt, this.id, this.updatedAt, this.policies, });
...
BrowserRdpApplication2 copyWith({AccessSchemasAud? Function()? aud, AccessTimestamp? Function()? createdAt, AccessUuid? Function()? id, AccessTimestamp? Function()? updatedAt, List<AccessAppPolicyResponse>? Function()? policies, }) { return BrowserRdpApplication2(
...
@override String toString() => 'BrowserRdpApplication2(aud: $aud, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, policies: $policies)';
