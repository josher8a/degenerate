...
return errors$; } 
ListZoneRulesetsResponse copyWith({dynamic Function()? errors, List<RulesetsMessage>? messages, List<ListAccountEntrypointRulesetVersionsResponseResult>? result, dynamic Function()? success, RulesetsResultInfo? Function()? resultInfo, }) { return ListZoneRulesetsResponse(
...
@override String toString() => 'ListZoneRulesetsResponse(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)';
