...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/cache_rules_aegis.dart';import 'package:pub_cloudflare/models/cache_rules_messages2.dart';@immutable final class ZoneCacheSettingsChangeAegisSettingResponse {const ZoneCacheSettingsChangeAegisSettingResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'ZoneCacheSettingsChangeAegisSettingResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
