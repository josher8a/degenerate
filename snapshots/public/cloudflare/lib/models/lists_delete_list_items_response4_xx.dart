...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/lists_messages2.dart';@immutable final class ListsDeleteListItemsResponse4Xx {const ListsDeleteListItemsResponse4Xx({required this.result, required this.errors, required this.messages, required this.success, });
...
@override String toString() => 'ListsDeleteListItemsResponse4Xx(result: $result, errors: $errors, messages: $messages, success: $success)';
