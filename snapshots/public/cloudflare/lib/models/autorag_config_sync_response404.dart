...
AutoragConfigSyncResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return AutoragConfigSyncResponse404(
...
@override String toString() => 'AutoragConfigSyncResponse404(errors: $errors, success: $success)';
