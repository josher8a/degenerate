...
factory WorkersObservabilityTelemetryEvent.fromJson(Map<String, dynamic> json) { return WorkersObservabilityTelemetryEvent(
  ...
  $workers: json[r'$workers'] != null ? OneOf2.parse(json[r'$workers'], fromA: (v) => WorkersVariant2.fromJson(v as Map<String, dynamic>), fromB: (v) => WorkersVariant1.fromJson(v as Map<String, dynamic>),) : null,
