...
// Source: #/components/schemas/EmailSecurityDeleteAllowPolicyResponse (inline: Result)
...
@override String toString() => 'EmailSecurityDeleteAllowPolicyResponseResult(id: $id)';
