...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/digital_experience_monitoring_messages2.dart';@immutable final class DeviceDexTestCreateDeviceDexTestResponse4Xx {const DeviceDexTestCreateDeviceDexTestResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
DeviceDexTestCreateDeviceDexTestResponse4Xx copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return DeviceDexTestCreateDeviceDexTestResponse4Xx(
...
@override String toString() => 'DeviceDexTestCreateDeviceDexTestResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
