...
// Source: #/components/schemas/WorDescribeWorkflowVersionsResponse400
...
WorDescribeWorkflowVersionsResponse400 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorDescribeWorkflowVersionsResponse400(
...
@override String toString() => 'WorDescribeWorkflowVersionsResponse400(errors: $errors, messages: $messages, result: $result, success: $success)';
