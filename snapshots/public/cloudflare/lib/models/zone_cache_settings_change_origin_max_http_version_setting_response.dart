...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/cache_rules_messages2.dart';import 'package:pub_cloudflare/models/cache_rules_origin_max_http_version.dart';@immutable final class ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse {const ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() => 'ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
