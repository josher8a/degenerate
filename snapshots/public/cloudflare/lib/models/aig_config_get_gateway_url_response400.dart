...
AigConfigGetGatewayUrlResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return AigConfigGetGatewayUrlResponse400(
...
@override String toString() => 'AigConfigGetGatewayUrlResponse400(errors: $errors, result: $result, success: $success)';
