...
ZeroTrustGatewayPacfilesListResponse4Xx copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return ZeroTrustGatewayPacfilesListResponse4Xx(
...
@override String toString() => 'ZeroTrustGatewayPacfilesListResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
