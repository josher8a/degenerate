...
AccessComponentsSchemasIdResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessAppPoliciesComponentsSchemasIdResponseResult? Function()? result, }) { return AccessComponentsSchemasIdResponse(
...
@override String toString() => 'AccessComponentsSchemasIdResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
