...
W when<W>({required W Function() disableApps, required W Function(String value) $unknown, }) { return switch (this) {
      ZonesDisableAppsId$disableApps() => disableApps(),
      ZonesDisableAppsId$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? disableApps, W Function(String value)? $unknown, }) { return switch (this) {
      ZonesDisableAppsId$disableApps() => disableApps != null ? disableApps() : orElse(value),
      ZonesDisableAppsId$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
