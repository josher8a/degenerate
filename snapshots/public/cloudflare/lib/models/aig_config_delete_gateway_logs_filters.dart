...
// Source: #/components/schemas/AigConfigDeleteGatewayLogsFilters
...
@override String toString() => 'AigConfigDeleteGatewayLogsFilters(key: $key, \$operator: ${$operator}, value: $value)';
