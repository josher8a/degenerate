...
// Source: #/components/schemas/EmailSecurityCreateTrustedDomainResponse
...
@override String toString() => 'EmailSecurityCreateTrustedDomainResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
