...
W when<W>({required W Function() windows, required W Function() macosx, required W Function() ios, required W Function() android, required W Function() chromeos, required W Function() linux, required W Function() smartTv, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupByHttpVersionOs$windows() => windows(),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$macosx() => macosx(),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$ios() => ios(),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$android() => android(),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$chromeos() => chromeos(),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$linux() => linux(),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$smartTv() => smartTv(),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? windows, W Function()? macosx, W Function()? ios, W Function()? android, W Function()? chromeos, W Function()? linux, W Function()? smartTv, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTimeseriesGroupByHttpVersionOs$windows() => windows != null ? windows() : orElse(value),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$macosx() => macosx != null ? macosx() : orElse(value),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$ios() => ios != null ? ios() : orElse(value),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$android() => android != null ? android() : orElse(value),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$chromeos() => chromeos != null ? chromeos() : orElse(value),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$linux() => linux != null ? linux() : orElse(value),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$smartTv() => smartTv != null ? smartTv() : orElse(value),
      RadarGetHttpTimeseriesGroupByHttpVersionOs$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
