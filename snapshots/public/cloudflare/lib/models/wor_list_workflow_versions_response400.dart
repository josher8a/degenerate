...
WorListWorkflowVersionsResponse400 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorListWorkflowVersionsResponse400(
...
@override String toString() => 'WorListWorkflowVersionsResponse400(errors: $errors, messages: $messages, result: $result, success: $success)';
