...
RadarGetPostQuantumTlsSupportResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetPostQuantumTlsSupportResponse400(
...
@override String toString() => 'RadarGetPostQuantumTlsSupportResponse400(errors: $errors, result: $result, success: $success)';
