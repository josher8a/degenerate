...
// Source: #/components/schemas/RadarGetAiInferenceTimeseriesGroupResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class RadarGetAiInferenceTimeseriesGroupResponse400 {const RadarGetAiInferenceTimeseriesGroupResponse400({required this.errors, required this.result, required this.success, });
...
RadarGetAiInferenceTimeseriesGroupResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetAiInferenceTimeseriesGroupResponse400(
...
@override String toString() => 'RadarGetAiInferenceTimeseriesGroupResponse400(errors: $errors, result: $result, success: $success)';
