...
@override String toString() => 'CustomOriginTrustStoreListDetailsResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';
