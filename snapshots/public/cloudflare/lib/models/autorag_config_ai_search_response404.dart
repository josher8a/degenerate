...
AutoragConfigAiSearchResponse404 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, bool? success, }) { return AutoragConfigAiSearchResponse404(
...
@override String toString() => 'AutoragConfigAiSearchResponse404(errors: $errors, success: $success)';
