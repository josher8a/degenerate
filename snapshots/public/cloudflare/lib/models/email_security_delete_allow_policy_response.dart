...
// Source: #/components/schemas/EmailSecurityDeleteAllowPolicyResponse
...
@override String toString() => 'EmailSecurityDeleteAllowPolicyResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
