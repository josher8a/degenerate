...
// Source: #/components/schemas/LoadBalancingMonitorReferencesResponse
...
LoadBalancingMonitorReferencesResponse copyWith({List<LoadBalancingMessages2>? errors, List<LoadBalancingMessages2>? messages, bool? success, List<LoadBalancingMonitorGroupReferencesResponseResult>? result, }) { return LoadBalancingMonitorReferencesResponse(
...
@override String toString() => 'LoadBalancingMonitorReferencesResponse(errors: $errors, messages: $messages, success: $success, result: $result)';
