...
W when<W>({required W Function() polling, required W Function(String value) $unknown, }) { return switch (this) {
      OutputFormat$polling() => polling(),
      OutputFormat$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? polling, W Function(String value)? $unknown, }) { return switch (this) {
      OutputFormat$polling() => polling != null ? polling() : orElse(value),
      OutputFormat$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
