...
W when<W>({required W Function() asn, required W Function(String value) $unknown, }) { return switch (this) {
      FirewallAsnConfigurationTarget$asn() => asn(),
      FirewallAsnConfigurationTarget$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? asn, W Function(String value)? $unknown, }) { return switch (this) {
      FirewallAsnConfigurationTarget$asn() => asn != null ? asn() : orElse(value),
      FirewallAsnConfigurationTarget$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
