...
PostEventUpdateResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return PostEventUpdateResponse400(
...
@override String toString() => 'PostEventUpdateResponse400(errors: $errors, result: $result, success: $success)';
