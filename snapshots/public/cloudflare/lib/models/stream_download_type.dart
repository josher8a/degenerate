...
W when<W>({required W Function() $default, required W Function() audio, required W Function(String value) $unknown, }) { return switch (this) {
      StreamDownloadType$$default() => $default(),
      StreamDownloadType$audio() => audio(),
      StreamDownloadType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $default, W Function()? audio, W Function(String value)? $unknown, }) { return switch (this) {
      StreamDownloadType$$default() => $default != null ? $default() : orElse(value),
      StreamDownloadType$audio() => audio != null ? audio() : orElse(value),
      StreamDownloadType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
