...
// Source: #/components/schemas/RadarGetHttpSummaryByTlsVersionResponse (inline: Result > Summary0)
...
if (!RegExp(r'^\d+$').hasMatch(tlsQuic)) { errors.add(r'tlsQuic: must match pattern ^\d+$'); }
return errors; } 
