...
// Source: #/components/schemas/RadarGetDnsAs112TimeseriesGroupByResponseCodesResponse400

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/ai_search_instance_change_job_status_response400/ai_search_instance_change_job_status_response400_errors.dart';@immutable final class RadarGetDnsAs112TimeseriesGroupByResponseCodesResponse400 {const RadarGetDnsAs112TimeseriesGroupByResponseCodesResponse400({required this.errors, required this.result, required this.success, });
...
RadarGetDnsAs112TimeseriesGroupByResponseCodesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsAs112TimeseriesGroupByResponseCodesResponse400(
...
@override String toString() => 'RadarGetDnsAs112TimeseriesGroupByResponseCodesResponse400(errors: $errors, result: $result, success: $success)';
