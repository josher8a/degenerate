...
Web3HostnameEditWeb3HostnameResponse5Xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return Web3HostnameEditWeb3HostnameResponse5Xx(
...
@override String toString() => 'Web3HostnameEditWeb3HostnameResponse5Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
