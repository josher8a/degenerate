...
W when<W>({required W Function() http, required W Function() https, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByHttpRequestsHttpProtocol$http() => http(),
      RadarGetHttpTopLocationsByHttpRequestsHttpProtocol$https() => https(),
      RadarGetHttpTopLocationsByHttpRequestsHttpProtocol$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? http, W Function()? https, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetHttpTopLocationsByHttpRequestsHttpProtocol$http() => http != null ? http() : orElse(value),
      RadarGetHttpTopLocationsByHttpRequestsHttpProtocol$https() => https != null ? https() : orElse(value),
      RadarGetHttpTopLocationsByHttpRequestsHttpProtocol$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
