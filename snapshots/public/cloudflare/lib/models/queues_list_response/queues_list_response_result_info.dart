...
// Source: #/components/schemas/QueuesListResponse (inline: ResultInfo)
...
@override String toString() => 'QueuesListResponseResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount, totalPages: $totalPages)';
