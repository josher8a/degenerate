...
// Source: #/components/schemas/WorkersVersionItemShort
...
@override int get hashCode => Object.hash(id, metadata, number);

@override String toString() => 'WorkersVersionItemShort(id: $id, metadata: $metadata, number: $number)';
