...
// Source: #/components/schemas/ResponseCollection16

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/d1_list_databases_response/d1_list_databases_response_result_info.dart';import 'package:pub_cloudflare/models/dos_messages2.dart';@immutable final class ResponseCollection16 {const ResponseCollection16({required this.errors, required this.messages, required this.success, this.resultInfo, });
...
ResponseCollection16 copyWith({List<DosMessages2>? errors, List<DosMessages2>? messages, bool? success, D1ListDatabasesResponseResultInfo? Function()? resultInfo, }) { return ResponseCollection16(
...
@override String toString() => 'ResponseCollection16(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)';
