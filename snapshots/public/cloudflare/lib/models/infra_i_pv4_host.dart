...
// Source: #/components/schemas/InfraIPv4Host
...
@override int get hashCode => Object.hash(ipv4, network);

@override String toString() => 'InfraIPv4Host(ipv4: $ipv4, network: $network)';
