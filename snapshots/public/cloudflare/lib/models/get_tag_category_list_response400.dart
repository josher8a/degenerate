...
GetTagCategoryListResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return GetTagCategoryListResponse400(
...
@override String toString() => 'GetTagCategoryListResponse400(errors: $errors, result: $result, success: $success)';
