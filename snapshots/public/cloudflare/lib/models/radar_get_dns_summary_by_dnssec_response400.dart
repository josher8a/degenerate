...
RadarGetDnsSummaryByDnssecResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsSummaryByDnssecResponse400(
...
@override String toString() => 'RadarGetDnsSummaryByDnssecResponse400(errors: $errors, result: $result, success: $success)';
