...
RadarGetTrafficAnomaliesResponse400 copyWith({List<AiSearchInstanceChangeJobStatusResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetTrafficAnomaliesResponse400(
...
@override String toString() => 'RadarGetTrafficAnomaliesResponse400(errors: $errors, result: $result, success: $success)';
