...
// Source: #/components/schemas/ResponseCommonFailure72

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/tunnel_messages2.dart';@immutable final class ResponseCommonFailure72 {const ResponseCommonFailure72({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'ResponseCommonFailure72(errors: $errors, messages: $messages, result: $result, success: $success)';
