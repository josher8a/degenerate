...
WorListWorkflowsResponse400 copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse404Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorListWorkflowsResponse400(
...
@override String toString() => 'WorListWorkflowsResponse400(errors: $errors, messages: $messages, result: $result, success: $success)';
