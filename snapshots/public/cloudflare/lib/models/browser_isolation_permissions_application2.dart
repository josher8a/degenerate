...
@immutable final class BrowserIsolationPermissionsApplication2 {const BrowserIsolationPermissionsApplication2({this.aud, this.createdAt, this.id, this.updatedAt, this.policies, });
...
BrowserIsolationPermissionsApplication2 copyWith({AccessSchemasAud? Function()? aud, AccessTimestamp? Function()? createdAt, AccessUuid? Function()? id, AccessTimestamp? Function()? updatedAt, List<AccessAppPolicyResponse>? Function()? policies, }) { return BrowserIsolationPermissionsApplication2(
...
@override String toString() => 'BrowserIsolationPermissionsApplication2(aud: $aud, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, policies: $policies)';
