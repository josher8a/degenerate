...
W when<W>({required W Function() $on, required W Function() off, required W Function(String value) $unknown, }) { return switch (this) {
      ZonesSettingToggle$$on() => $on(),
      ZonesSettingToggle$off() => off(),
      ZonesSettingToggle$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $on, W Function()? off, W Function(String value)? $unknown, }) { return switch (this) {
      ZonesSettingToggle$$on() => $on != null ? $on() : orElse(value),
      ZonesSettingToggle$off() => off != null ? off() : orElse(value),
      ZonesSettingToggle$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
