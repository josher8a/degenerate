...
// Source: #/components/schemas/EmailSecurityDeleteBlockedSenderResponse4Xx

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/email_security_message.dart';@immutable final class EmailSecurityDeleteBlockedSenderResponse4Xx {const EmailSecurityDeleteBlockedSenderResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() => 'EmailSecurityDeleteBlockedSenderResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)';
