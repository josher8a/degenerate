...
W when<W>({required W Function() pass, required W Function() none, required W Function() fail, required W Function(String value) $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupSpf$pass() => pass(),
      RadarGetEmailRoutingTimeseriesGroupSpf$none() => none(),
      RadarGetEmailRoutingTimeseriesGroupSpf$fail() => fail(),
      RadarGetEmailRoutingTimeseriesGroupSpf$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? pass, W Function()? none, W Function()? fail, W Function(String value)? $unknown, }) { return switch (this) {
      RadarGetEmailRoutingTimeseriesGroupSpf$pass() => pass != null ? pass() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupSpf$none() => none != null ? none() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupSpf$fail() => fail != null ? fail() : orElse(value),
      RadarGetEmailRoutingTimeseriesGroupSpf$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
