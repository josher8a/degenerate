...
Future<ApiResult<List<DlsAccountRegionalHostnamesAccountListRegionsResponseResult>?, DlsAccountRegionalHostnamesAccountCreateHostnameError>> dlsAccountRegionalHostnamesAccountListRegions({required DlsIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: DlsAccountRegionalHostnamesAccountCreateHostnameError.fromResponse,
);
 } 
...
Future<ApiResult<List<DlsRegionalHostnameResponse>?, DlsAccountRegionalHostnamesAccountCreateHostnameError>> dlsAccountRegionalHostnamesAccountListHostnames({required DlsIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<DlsRegionalHostnameResponse?, DlsAccountRegionalHostnamesAccountCreateHostnameError>> dlsAccountRegionalHostnamesAccountCreateHostname({required DlsIdentifier zoneId, DlsAccountRegionalHostnamesAccountCreateHostnameRequest? body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<DlsRegionalHostnameResponse?, DlsAccountRegionalHostnamesAccountCreateHostnameError>> dlsAccountRegionalHostnamesAccountFetchHostname({required DlsIdentifier zoneId, required DlsHostname hostname, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<DlsRegionalHostnameResponse?, DlsAccountRegionalHostnamesAccountCreateHostnameError>> dlsAccountRegionalHostnamesAccountPatchHostname({required DlsIdentifier zoneId, required DlsHostname hostname, DlsAccountRegionalHostnamesAccountPatchHostnameRequest? body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<ResponseCommon21, DlsAccountRegionalHostnamesAccountCreateHostnameError>> dlsAccountRegionalHostnamesAccountDeleteHostname({required DlsIdentifier zoneId, required DlsHostname hostname, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
