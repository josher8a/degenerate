...
// Source: tag "ValuesApi" (1 operation)

import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/errors/telemetry_values_list_error.dart';import 'package:pub_cloudflare/models/telemetry_values_list_request.dart';import 'package:pub_cloudflare/models/telemetry_values_list_response/telemetry_values_list_response_result.dart';/// ValuesApi operations.
///
...
return execute(
  ...
  onError: TelemetryValuesListError.fromResponse,
);
 } 
 }
