...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/errors/zero_trust_gateway_application_and_application_type_mappings_list_application_and_application_type_mappings_error.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_app_types.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_application.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_application_type.dart';import 'package:pub_cloudflare/models/zero_trust_gateway_components_schemas_identifier.dart';/// ZeroTrustGatewayApplicationAndApplicationTypeMappingsApi operations.
///
...
Future<ApiResult<List<ZeroTrustGatewayAppTypes>?, ZeroTrustGatewayApplicationAndApplicationTypeMappingsListApplicationAndApplicationTypeMappingsError>> zeroTrustGatewayApplicationAndApplicationTypeMappingsListApplicationAndApplicationTypeMappings({required ZeroTrustGatewayComponentsSchemasIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: ZeroTrustGatewayApplicationAndApplicationTypeMappingsListApplicationAndApplicationTypeMappingsError.fromResponse,
);
 } 
 }
