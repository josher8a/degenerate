...
final request = ApiRequest(
  method: 'GET',
  path: '/accounts/${Uri.encodeComponent(accountId.toJson())}/gateway/audit_ssh_settings',
  headers: headers,
  options: options,
);
...
final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId.toJson())}/gateway/audit_ssh_settings/rotate_seed',
  headers: headers,
  options: options,
);
