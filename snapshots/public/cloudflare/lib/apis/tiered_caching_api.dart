...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/cache_rules_cache_reserve_response_value/cache_rules_cache_reserve_response_value_result.dart';import 'package:pub_cloudflare/models/cache_rules_identifier.dart';import 'package:pub_cloudflare/models/cache_rules_patch.dart';/// TieredCachingApi operations.
///
...
Future<ApiResult<CacheRulesCacheReserveResponseValueResult?, Never>> tieredCachingGetTieredCachingSetting({required CacheRulesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<CacheRulesCacheReserveResponseValueResult?, Never>> tieredCachingPatchTieredCachingSetting({required CacheRulesIdentifier zoneId, required CacheRulesPatch body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
