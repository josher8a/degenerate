...
final request = ApiRequest(
  method: 'GET',
  path: '/zones/${Uri.encodeComponent(zoneId.toString())}/hostnames/settings/${Uri.encodeComponent('${settingId.toJson()}')}',
  headers: headers,
  options: options,
);
...
final request = ApiRequest(
  method: 'GET',
  path: '/zones/${Uri.encodeComponent(zoneId.toString())}/hostnames/settings/${Uri.encodeComponent('${settingId.toJson()}')}/${Uri.encodeComponent(hostname.toString())}',
  headers: headers,
  options: options,
);
