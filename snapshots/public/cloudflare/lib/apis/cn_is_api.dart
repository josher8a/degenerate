...
// Source: tag "CnIsApi" (5 operations)

import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/nsc_account_tag.dart';import 'package:pub_cloudflare/models/nsc_cni.dart';import 'package:pub_cloudflare/models/nsc_cni_create.dart';import 'package:pub_cloudflare/models/nsc_cni_list.dart';/// CnIsApi operations.
///
...
final request = ApiRequest(
  method: 'GET',
  path: '/accounts/${Uri.encodeComponent(accountId.toJson())}/cni/cnis',
  headers: headers,
...
final request = ApiRequest(
  method: 'GET',
  path: '/accounts/${Uri.encodeComponent(accountId.toJson())}/cni/cnis/${Uri.encodeComponent(cni)}',
  headers: headers,
  options: options,
);
