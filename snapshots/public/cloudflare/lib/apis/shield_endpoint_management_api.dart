...
Future<ApiResult<List<ShieldOperation>, DiscoveryRetrieveDiscoveredOperationsOnAZoneError>> apiShieldEndpointManagementAddOperationsToAZone({required ShieldIdentifier zoneId, required List<ShieldBasicOperation> body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ResponseCommon6, DiscoveryRetrieveDiscoveredOperationsOnAZoneError>> apiShieldEndpointManagementDeleteMultipleOperations({required ShieldIdentifier zoneId, required List<ShieldObjectWithOperationId> body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<ShieldOperation, DiscoveryRetrieveDiscoveredOperationsOnAZoneError>> apiShieldEndpointManagementRetrieveInformationAboutAnOperation({required ShieldIdentifier zoneId, required ShieldUuid operationId, List<ShieldEndpointManagementRetrieveInformationAboutAnOperationFeature>? feature, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (feature != null) {
for (final item in feature) {
  queryParametersList.add(ApiQueryParameter(name: 'feature', value: item.toJson()));
...
Future<ApiResult<ResponseCommon6, DiscoveryRetrieveDiscoveredOperationsOnAZoneError>> apiShieldEndpointManagementDeleteAnOperation({required ShieldIdentifier zoneId, required ShieldUuid operationId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ShieldOperation, DiscoveryRetrieveDiscoveredOperationsOnAZoneError>> apiShieldEndpointManagementAddOperationToAZone({required ShieldIdentifier zoneId, required ShieldBasicOperation body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<ShieldSchemaResponseWithThresholdsResult, DiscoveryRetrieveDiscoveredOperationsOnAZoneError>> apiShieldEndpointManagementRetrieveOperationsAndFeaturesAsOpenApiSchemas({required ShieldIdentifier zoneId, List<String>? host, List<SchemasFeature>? feature, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (host != null) {
for (final item in host) {
  queryParametersList.add(ApiQueryParameter(name: 'host', value: item));
