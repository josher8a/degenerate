...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/errors/disable_catalog_error.dart';import 'package:pub_cloudflare/models/r2_data_catalog_account_id.dart';import 'package:pub_cloudflare/models/r2_data_catalog_bucket_name.dart';import 'package:pub_cloudflare/models/r2_data_catalog_maintenance_update_params.dart';import 'package:pub_cloudflare/models/r2_data_catalog_table_maintenance_config.dart';import 'package:pub_cloudflare/models/r2_data_catalog_table_maintenance_config_response.dart';/// TableMaintenanceConfigurationApi operations.
///
...
Future<ApiResult<R2DataCatalogTableMaintenanceConfigResponse?, DisableCatalogError>> getTableMaintenanceConfig({required R2DataCatalogAccountId accountId, required R2DataCatalogBucketName bucketName, required String namespace, required String tableName, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};

final request = ApiRequest(
  method: 'GET',
  path: '/accounts/${Uri.encodeComponent(accountId.toJson())}/r2-catalog/${Uri.encodeComponent(bucketName.toJson())}/namespaces/${Uri.encodeComponent(namespace)}/tables/${Uri.encodeComponent(tableName)}/maintenance-configs',
  headers: headers,
  options: options,
);
