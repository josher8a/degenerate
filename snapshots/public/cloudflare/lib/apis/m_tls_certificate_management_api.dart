...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_cloudflare/models/errors/m_tls_certificate_management_delete_m_tls_certificate_error.dart';import 'package:pub_cloudflare/models/errors/m_tls_certificate_management_get_m_tls_certificate_error.dart';import 'package:pub_cloudflare/models/errors/m_tls_certificate_management_list_m_tls_certificate_associations_error.dart';import 'package:pub_cloudflare/models/errors/m_tls_certificate_management_list_m_tls_certificates_error.dart';import 'package:pub_cloudflare/models/errors/m_tls_certificate_management_upload_m_tls_certificate_error.dart';import 'package:pub_cloudflare/models/m_tls_certificate_management_upload_m_tls_certificate_request.dart';import 'package:pub_cloudflare/models/tls_certificates_and_hostnames_association_object.dart';import 'package:pub_cloudflare/models/tls_certificates_and_hostnames_certificate_object_post.dart';import 'package:pub_cloudflare/models/tls_certificates_and_hostnames_components_schemas_certificate_object.dart';import 'package:pub_cloudflare/models/tls_certificates_and_hostnames_identifier.dart';/// MTlsCertificateManagementApi operations.
///
...
Future<ApiResult<List<TlsCertificatesAndHostnamesComponentsSchemasCertificateObject>?, MTlsCertificateManagementListMTlsCertificatesError>> mTlsCertificateManagementListMTlsCertificates({required TlsCertificatesAndHostnamesIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: MTlsCertificateManagementListMTlsCertificatesError.fromResponse,
);
 } 
...
return execute(
  ...
  onError: MTlsCertificateManagementUploadMTlsCertificateError.fromResponse,
);
 } 
...
return execute(
  ...
  onError: MTlsCertificateManagementGetMTlsCertificateError.fromResponse,
);
 } 
...
return execute(
  ...
  onError: MTlsCertificateManagementDeleteMTlsCertificateError.fromResponse,
);
 } 
...
return execute(
  ...
  onError: MTlsCertificateManagementListMTlsCertificateAssociationsError.fromResponse,
);
 } 
 }
