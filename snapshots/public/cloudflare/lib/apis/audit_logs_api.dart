...
return execute(
  request,
  onSuccess: (response) {
    return OneOf2.parse(jsonDecode(response.body), fromA: (v) => ResponseCommon.fromJson(v as Map<String, dynamic>), fromB: (v) => AaaAuditLogsResponseCollectionVariant1.fromJson(v as Map<String, dynamic>),);
  },
);
 } 
