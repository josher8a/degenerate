...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'pub_kubernetes_api_v1_openapi_security.dart';import '../apis/core_api.dart';/// Root SDK client providing access to all API groups.
///
/// ```dart
