...
// Source: #/components/schemas/PostPaymentLinksPaymentLinkRequest (inline: AfterCompletion > HostedConfirmation)
...
if (customMessage$ != null) {
  if (customMessage$.runes.length > 500) { errors.add('customMessage: length must be <= 500'); }
}
return errors; } 
