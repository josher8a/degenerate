...
// Source: #/components/schemas/PaymentFlowsPaymentIntentPresentmentDetails
...
if (presentmentCurrency.runes.length > 5000) { errors.add('presentmentCurrency: length must be <= 5000'); }
return errors; } 
