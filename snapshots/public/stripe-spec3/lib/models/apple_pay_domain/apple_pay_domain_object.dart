...
W when<W>({required W Function() applePayDomain, required W Function(String value) $unknown, }) { return switch (this) {
      ApplePayDomainObject$applePayDomain() => applePayDomain(),
      ApplePayDomainObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? applePayDomain, W Function(String value)? $unknown, }) { return switch (this) {
      ApplePayDomainObject$applePayDomain() => applePayDomain != null ? applePayDomain() : orElse(value),
      ApplePayDomainObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
