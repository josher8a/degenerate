...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('amount') && json['amount'] is num &&
      ...
      json.containsKey('object') && json['object'] == 'credit_note' &&
...
final memo$ = memo;
if (memo$ != null) {
  if (memo$.runes.length > 5000) { errors.add('memo: length must be <= 5000'); }
}
if (number.runes.length > 5000) { errors.add('number: length must be <= 5000'); }
if (pdf.runes.length > 5000) { errors.add('pdf: length must be <= 5000'); }
return errors; } 
