...
// Source: #/components/schemas/GetReviewsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/get_accounts_account_capabilities_response/get_accounts_account_capabilities_response_object.dart';import 'package:pub_stripe_spec3/models/review.dart';/// 
...
return errors; } 
GetReviewsResponse copyWith({List<Review>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetReviewsResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetReviewsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
