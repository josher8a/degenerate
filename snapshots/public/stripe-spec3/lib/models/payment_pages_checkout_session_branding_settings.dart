...
if (backgroundColor.runes.length > 5000) { errors.add('backgroundColor: length must be <= 5000'); }
if (buttonColor.runes.length > 5000) { errors.add('buttonColor: length must be <= 5000'); }
if (displayName.runes.length > 5000) { errors.add('displayName: length must be <= 5000'); }
if (fontFamily.runes.length > 5000) { errors.add('fontFamily: length must be <= 5000'); }
return errors; } 
