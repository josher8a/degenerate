...
// Source: #/components/schemas/DisputeEvidence
...
if (accessActivityLog$ != null) {
  if (accessActivityLog$.runes.length > 150000) { errors.add('accessActivityLog: length must be <= 150000'); }
}
final billingAddress$ = billingAddress;
if (billingAddress$ != null) {
  if (billingAddress$.runes.length > 5000) { errors.add('billingAddress: length must be <= 5000'); }
}
final cancellationPolicyDisclosure$ = cancellationPolicyDisclosure;
if (cancellationPolicyDisclosure$ != null) {
  if (cancellationPolicyDisclosure$.runes.length > 150000) { errors.add('cancellationPolicyDisclosure: length must be <= 150000'); }
}
final cancellationRebuttal$ = cancellationRebuttal;
if (cancellationRebuttal$ != null) {
  if (cancellationRebuttal$.runes.length > 150000) { errors.add('cancellationRebuttal: length must be <= 150000'); }
}
final customerEmailAddress$ = customerEmailAddress;
if (customerEmailAddress$ != null) {
  if (customerEmailAddress$.runes.length > 5000) { errors.add('customerEmailAddress: length must be <= 5000'); }
}
final customerName$ = customerName;
if (customerName$ != null) {
  if (customerName$.runes.length > 5000) { errors.add('customerName: length must be <= 5000'); }
}
final customerPurchaseIp$ = customerPurchaseIp;
if (customerPurchaseIp$ != null) {
  if (customerPurchaseIp$.runes.length > 5000) { errors.add('customerPurchaseIp: length must be <= 5000'); }
}
final duplicateChargeExplanation$ = duplicateChargeExplanation;
if (duplicateChargeExplanation$ != null) {
  if (duplicateChargeExplanation$.runes.length > 150000) { errors.add('duplicateChargeExplanation: length must be <= 150000'); }
}
final duplicateChargeId$ = duplicateChargeId;
if (duplicateChargeId$ != null) {
  if (duplicateChargeId$.runes.length > 5000) { errors.add('duplicateChargeId: length must be <= 5000'); }
}
final productDescription$ = productDescription;
if (productDescription$ != null) {
  if (productDescription$.runes.length > 150000) { errors.add('productDescription: length must be <= 150000'); }
}
final refundPolicyDisclosure$ = refundPolicyDisclosure;
if (refundPolicyDisclosure$ != null) {
  if (refundPolicyDisclosure$.runes.length > 150000) { errors.add('refundPolicyDisclosure: length must be <= 150000'); }
}
final refundRefusalExplanation$ = refundRefusalExplanation;
if (refundRefusalExplanation$ != null) {
  if (refundRefusalExplanation$.runes.length > 150000) { errors.add('refundRefusalExplanation: length must be <= 150000'); }
}
final serviceDate$ = serviceDate;
if (serviceDate$ != null) {
  if (serviceDate$.runes.length > 5000) { errors.add('serviceDate: length must be <= 5000'); }
}
final shippingAddress$ = shippingAddress;
if (shippingAddress$ != null) {
  if (shippingAddress$.runes.length > 5000) { errors.add('shippingAddress: length must be <= 5000'); }
}
final shippingCarrier$ = shippingCarrier;
if (shippingCarrier$ != null) {
  if (shippingCarrier$.runes.length > 5000) { errors.add('shippingCarrier: length must be <= 5000'); }
}
final shippingDate$ = shippingDate;
if (shippingDate$ != null) {
  if (shippingDate$.runes.length > 5000) { errors.add('shippingDate: length must be <= 5000'); }
}
final shippingTrackingNumber$ = shippingTrackingNumber;
if (shippingTrackingNumber$ != null) {
  if (shippingTrackingNumber$.runes.length > 5000) { errors.add('shippingTrackingNumber: length must be <= 5000'); }
}
final uncategorizedText$ = uncategorizedText;
if (uncategorizedText$ != null) {
  if (uncategorizedText$.runes.length > 150000) { errors.add('uncategorizedText: length must be <= 150000'); }
}
return errors; } 
