...
factory InvoicePaymentMethodOptionsParam14.fromJson(Map<String, dynamic> json) { return InvoicePaymentMethodOptionsParam14(
  financialConnections: json['financial_connections'] != null ? InvoicePaymentMethodOptionsParamFinancialConnections.fromJson(json['financial_connections'] as Map<String, dynamic>) : null,
...
final InvoicePaymentMethodOptionsParamFinancialConnections? financialConnections;
...
InvoicePaymentMethodOptionsParam14 copyWith({InvoicePaymentMethodOptionsParamFinancialConnections? Function()? financialConnections, CheckoutAcssDebitPaymentMethodOptionsVerificationMethod? Function()? verificationMethod, }) { return InvoicePaymentMethodOptionsParam14(
