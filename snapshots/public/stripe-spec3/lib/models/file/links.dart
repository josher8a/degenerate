...
factory Links.fromJson(Map<String, dynamic> json) { return Links(
...
if (!RegExp('^/v1/file_links').hasMatch(url)) errors.add('url: must match pattern ^/v1/file_links');
return errors; } 
Links copyWith({List<FileLink>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return Links(
  data: data ?? this.data,
