...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/get_payment_method_configurations_application/get_payment_method_configurations_application_variant2.dart';import 'package:pub_stripe_spec3/models/payment_details/customer_reference.dart';import 'package:pub_stripe_spec3/models/payment_details/order_reference.dart';@immutable final class Payment_details {const Payment_details({this.customerReference, this.orderReference, });

factory Payment_details.fromJson(Map<String, dynamic> json) { return Payment_details(
...
Payment_details copyWith({CustomerReference Function()? customerReference, OrderReference Function()? orderReference, }) { return Payment_details(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Payment_details &&
          customerReference == other.customerReference &&
          orderReference == other.orderReference; } 
@override int get hashCode { return Object.hash(customerReference, orderReference); } 
@override String toString() { return 'Payment_details(customerReference: $customerReference, orderReference: $orderReference)'; } 
 }
