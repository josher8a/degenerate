...
// Source: #/components/schemas/PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit
...
if (referencePrefix$ != null) {
  if (referencePrefix$.runes.length > 5000) { errors.add('referencePrefix: length must be <= 5000'); }
}
return errors; } 
...
@override String toString() => 'PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit(referencePrefix: $referencePrefix)';
