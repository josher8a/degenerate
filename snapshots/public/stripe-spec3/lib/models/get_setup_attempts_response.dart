...
// Source: #/components/schemas/GetSetupAttemptsResponse
...
if (!RegExp('^/v1/setup_attempts').hasMatch(url)) { errors.add('url: must match pattern ^/v1/setup_attempts'); }
return errors; } 
...
@override String toString() => 'GetSetupAttemptsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
