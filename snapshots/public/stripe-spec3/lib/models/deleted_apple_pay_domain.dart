...
// Source: #/components/schemas/DeletedApplePayDomain
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('deleted') && json['deleted'] is bool &&
      ...
      json.containsKey('object') && json['object'] == 'apple_pay_domain'; } 
...
@override String toString() => 'DeletedApplePayDomain(deleted: $deleted, id: $id, object: $object)';
