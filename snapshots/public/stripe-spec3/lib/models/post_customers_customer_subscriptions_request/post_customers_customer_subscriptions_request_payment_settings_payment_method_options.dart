...
factory PostCustomersCustomerSubscriptionsRequestPaymentSettingsPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSubscriptionsRequestPaymentSettingsPaymentMethodOptions(
  ...
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => Subscription_payment_method_options_param.fromJson(v as Map<String, dynamic>), fromB: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String),) : null,
