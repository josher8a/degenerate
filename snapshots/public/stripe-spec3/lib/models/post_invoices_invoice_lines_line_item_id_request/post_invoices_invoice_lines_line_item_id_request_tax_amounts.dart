...
/// - `.a` → [List<PostInvoicesInvoiceLinesLineItemIdRequestTaxAmountsVariant1>]
/// - `.b` → [GetPaymentMethodConfigurationsApplicationVariant2]
typedef PostInvoicesInvoiceLinesLineItemIdRequestTaxAmounts = OneOf2<List<PostInvoicesInvoiceLinesLineItemIdRequestTaxAmountsVariant1>,GetPaymentMethodConfigurationsApplicationVariant2>;
