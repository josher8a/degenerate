...
// Source: #/components/schemas/TerminalLocation
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('address') &&
      ...
      json.containsKey('object') && json['object'] == 'terminal.location'; } 
/// Constraint violations for this value (empty when valid).
List<String> validate() { final errors = <String>[];
final configurationOverrides$ = configurationOverrides;
if (configurationOverrides$ != null) {
  if (configurationOverrides$.runes.length > 5000) { errors.add('configurationOverrides: length must be <= 5000'); }
}
...
if (displayNameKana$ != null) {
  if (displayNameKana$.runes.length > 5000) { errors.add('displayNameKana: length must be <= 5000'); }
}
final displayNameKanji$ = displayNameKanji;
if (displayNameKanji$ != null) {
  if (displayNameKanji$.runes.length > 5000) { errors.add('displayNameKanji: length must be <= 5000'); }
}
