...
// Source: #/components/schemas/PostAccountsAccountRequest (inline: Company > OwnershipDeclaration)
...
@override String toString() => 'OwnershipDeclaration(date: $date, ip: $ip, userAgent: $userAgent)';
