...
// Source: #/components/schemas/PostAccountsAccountRequest (inline: Settings > Payments)
...
if (statementDescriptorKana$ != null) {
  if (statementDescriptorKana$.runes.length > 22) { errors.add('statementDescriptorKana: length must be <= 22'); }
}
final statementDescriptorKanji$ = statementDescriptorKanji;
if (statementDescriptorKanji$ != null) {
  if (statementDescriptorKanji$.runes.length > 22) { errors.add('statementDescriptorKanji: length must be <= 22'); }
}
return errors; } 
