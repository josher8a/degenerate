...
// Source: #/components/schemas/PostAccountsAccountRequest (inline: Settings > Branding)
...
final icon$ = icon;
if (icon$ != null) {
  if (icon$.runes.length > 5000) { errors.add('icon: length must be <= 5000'); }
}
final logo$ = logo;
if (logo$ != null) {
  if (logo$.runes.length > 5000) { errors.add('logo: length must be <= 5000'); }
}
final primaryColor$ = primaryColor;
if (primaryColor$ != null) {
  if (primaryColor$.runes.length > 5000) { errors.add('primaryColor: length must be <= 5000'); }
}
final secondaryColor$ = secondaryColor;
if (secondaryColor$ != null) {
  if (secondaryColor$.runes.length > 5000) { errors.add('secondaryColor: length must be <= 5000'); }
}
return errors; } 
