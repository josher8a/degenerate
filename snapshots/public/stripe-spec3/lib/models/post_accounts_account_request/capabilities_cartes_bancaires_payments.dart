...
// Source: #/components/schemas/PostAccountsAccountRequest (inline: Capabilities > CartesBancairesPayments)
...
@override String toString() => 'CapabilitiesCartesBancairesPayments(requested: $requested)';
