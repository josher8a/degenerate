...
// Source: #/components/schemas/PostAccountsAccountRequest (inline: Individual)
...
if (firstName$ != null) {
  if (firstName$.runes.length > 100) { errors.add('firstName: length must be <= 100'); }
}
...
if (lastName$ != null) {
  if (lastName$.runes.length > 100) { errors.add('lastName: length must be <= 100'); }
}
...
if (ssnLast4$ != null) {
  if (ssnLast4$.runes.length > 5000) { errors.add('ssnLast4: length must be <= 5000'); }
}
return errors; } 
