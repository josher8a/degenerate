...
factory SupportAddress.fromJson(Map<String, dynamic> json) { return SupportAddress(
...
final city$ = city;
if (city$ != null) {
  if (city$.runes.length > 100) { errors.add('city: length must be <= 100'); }
}
...
final line1$ = line1;
if (line1$ != null) {
  if (line1$.runes.length > 200) { errors.add('line1: length must be <= 200'); }
}
final line2$ = line2;
if (line2$ != null) {
  if (line2$.runes.length > 200) { errors.add('line2: length must be <= 200'); }
}
...
return errors; } 
SupportAddress copyWith({String? Function()? city, String? Function()? country, String? Function()? line1, String? Function()? line2, String? Function()? postalCode, String? Function()? state, }) { return SupportAddress(
...
@override String toString() => 'SupportAddress(city: $city, country: $country, line1: $line1, line2: $line2, postalCode: $postalCode, state: $state)';
