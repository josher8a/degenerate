...
// Source: #/components/schemas/PostAccountsAccountRequest (inline: Company)
...
if (exportLicenseId$ != null) {
  if (exportLicenseId$.runes.length > 5000) { errors.add('exportLicenseId: length must be <= 5000'); }
}
final exportPurposeCode$ = exportPurposeCode;
if (exportPurposeCode$ != null) {
  if (exportPurposeCode$.runes.length > 5000) { errors.add('exportPurposeCode: length must be <= 5000'); }
}
final name$ = name;
if (name$ != null) {
...
if (nameKana$ != null) {
  if (nameKana$.runes.length > 100) { errors.add('nameKana: length must be <= 100'); }
}
final nameKanji$ = nameKanji;
if (nameKanji$ != null) {
  if (nameKanji$.runes.length > 100) { errors.add('nameKanji: length must be <= 100'); }
}
final phone$ = phone;
if (phone$ != null) {
...
if (registrationNumber$ != null) {
  if (registrationNumber$.runes.length > 5000) { errors.add('registrationNumber: length must be <= 5000'); }
}
final taxId$ = taxId;
if (taxId$ != null) {
  if (taxId$.runes.length > 5000) { errors.add('taxId: length must be <= 5000'); }
}
final taxIdRegistrar$ = taxIdRegistrar;
if (taxIdRegistrar$ != null) {
  if (taxIdRegistrar$.runes.length > 5000) { errors.add('taxIdRegistrar: length must be <= 5000'); }
}
final vatId$ = vatId;
if (vatId$ != null) {
  if (vatId$.runes.length > 5000) { errors.add('vatId: length must be <= 5000'); }
}
return errors; } 
