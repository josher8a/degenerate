...
// Source: #/components/schemas/GetAppsSecretsResponse
...
if (!RegExp('^/v1/apps/secrets').hasMatch(url)) { errors.add('url: must match pattern ^/v1/apps/secrets'); }
return errors; } 
...
@override String toString() => 'GetAppsSecretsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
