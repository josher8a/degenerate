...
@override int get hashCode => Object.hash(Object.hashAll(expand ?? const []), settings);

@override String toString() => 'PostCustomersCustomerCashBalanceRequest(expand: $expand, settings: $settings)';
