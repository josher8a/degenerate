...
if (debitReversal$ != null) {
  if (debitReversal$.runes.length > 5000) { errors.add('debitReversal: length must be <= 5000'); }
}
final inboundTransfer$ = inboundTransfer;
if (inboundTransfer$ != null) {
  if (inboundTransfer$.runes.length > 5000) { errors.add('inboundTransfer: length must be <= 5000'); }
}
...
final payout$ = payout;
if (payout$ != null) {
  if (payout$.runes.length > 5000) { errors.add('payout: length must be <= 5000'); }
}
final topup$ = topup;
if (topup$ != null) {
  if (topup$.runes.length > 5000) { errors.add('topup: length must be <= 5000'); }
}
return errors; } 
