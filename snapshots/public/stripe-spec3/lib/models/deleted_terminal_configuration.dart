...
// Source: #/components/schemas/DeletedTerminalConfiguration

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/deleted_terminal_configuration/deleted_terminal_configuration_object.dart';/// 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('deleted') && json['deleted'] is bool &&
      ...
      json.containsKey('object') && json['object'] == 'terminal.configuration'; } 
...
@override String toString() => 'DeletedTerminalConfiguration(deleted: $deleted, id: $id, object: $object)';
