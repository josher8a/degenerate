...
// Source: #/components/schemas/GetCustomersSearchResponse
...
@override String toString() => 'GetCustomersSearchResponse(data: $data, hasMore: $hasMore, nextPage: $nextPage, object: $object, totalCount: $totalCount, url: $url)';
