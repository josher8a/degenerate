...
// Source: #/components/schemas/PaymentIntentParam
...
if (cvcToken$ != null) {
  if (cvcToken$.runes.length > 5000) { errors.add('cvcToken: length must be <= 5000'); }
}
return errors; } 
