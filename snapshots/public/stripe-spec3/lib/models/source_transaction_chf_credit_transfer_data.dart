...
// Source: #/components/schemas/SourceTransactionChfCreditTransferData
...
if (senderAddressCountry$ != null) {
  if (senderAddressCountry$.runes.length > 5000) { errors.add('senderAddressCountry: length must be <= 5000'); }
}
final senderAddressLine1$ = senderAddressLine1;
if (senderAddressLine1$ != null) {
  if (senderAddressLine1$.runes.length > 5000) { errors.add('senderAddressLine1: length must be <= 5000'); }
}
final senderIban$ = senderIban;
if (senderIban$ != null) {
  if (senderIban$.runes.length > 5000) { errors.add('senderIban: length must be <= 5000'); }
}
final senderName$ = senderName;
if (senderName$ != null) {
  if (senderName$.runes.length > 5000) { errors.add('senderName: length must be <= 5000'); }
}
return errors; } 
