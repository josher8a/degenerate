...
// Source: #/components/schemas/PostEphemeralKeysRequest
...
if (issuingCard$ != null) {
  if (issuingCard$.runes.length > 5000) { errors.add('issuingCard: length must be <= 5000'); }
}
final nonce$ = nonce;
if (nonce$ != null) {
  if (nonce$.runes.length > 5000) { errors.add('nonce: length must be <= 5000'); }
}
