...
// Source: #/components/schemas/GetShippingRatesResponse
...
if (!RegExp('^/v1/shipping_rates').hasMatch(url)) { errors.add('url: must match pattern ^/v1/shipping_rates'); }
return errors; } 
...
@override String toString() => 'GetShippingRatesResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
