...
W when<W>({required W Function() taxCode, required W Function(String value) $unknown, }) { return switch (this) {
      TaxCodeObject$taxCode() => taxCode(),
      TaxCodeObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? taxCode, W Function(String value)? $unknown, }) { return switch (this) {
      TaxCodeObject$taxCode() => taxCode != null ? taxCode() : orElse(value),
      TaxCodeObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
