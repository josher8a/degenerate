...
// Source: #/components/schemas/GetAccountsAccountPeopleResponse
...
return errors; } 
GetAccountsAccountPeopleResponse copyWith({List<Person>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetAccountsAccountPeopleResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetAccountsAccountPeopleResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
