...
// Source: #/components/schemas/Tipping (inline: Chf)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Chf {const Chf({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Chf.fromJson(Map<String, dynamic> json) { return Chf(
...
Chf copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Chf(
...
@override String toString() => 'Chf(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
