...
// Source: #/components/schemas/Tipping (inline: Myr)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Myr {const Myr({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Myr.fromJson(Map<String, dynamic> json) { return Myr(
...
Myr copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Myr(
...
@override String toString() => 'Myr(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
