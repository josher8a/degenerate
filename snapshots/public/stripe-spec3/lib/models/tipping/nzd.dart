...
// Source: #/components/schemas/Tipping (inline: Nzd)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Nzd {const Nzd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Nzd.fromJson(Map<String, dynamic> json) { return Nzd(
...
Nzd copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Nzd(
...
@override String toString() => 'Nzd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
