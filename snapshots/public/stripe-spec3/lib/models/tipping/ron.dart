...
// Source: #/components/schemas/Tipping (inline: Ron)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Ron {const Ron({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Ron.fromJson(Map<String, dynamic> json) { return Ron(
...
Ron copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Ron(
...
@override String toString() => 'Ron(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
