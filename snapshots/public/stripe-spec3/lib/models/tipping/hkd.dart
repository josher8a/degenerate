...
// Source: #/components/schemas/Tipping (inline: Hkd)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Hkd {const Hkd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Hkd.fromJson(Map<String, dynamic> json) { return Hkd(
...
Hkd copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Hkd(
...
@override String toString() => 'Hkd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
