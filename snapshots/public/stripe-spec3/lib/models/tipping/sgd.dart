...
// Source: #/components/schemas/Tipping (inline: Sgd)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Sgd {const Sgd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Sgd.fromJson(Map<String, dynamic> json) { return Sgd(
...
Sgd copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Sgd(
...
@override String toString() => 'Sgd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
