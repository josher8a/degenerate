...
// Source: #/components/schemas/Tipping (inline: Gip)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Gip {const Gip({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Gip.fromJson(Map<String, dynamic> json) { return Gip(
...
Gip copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Gip(
