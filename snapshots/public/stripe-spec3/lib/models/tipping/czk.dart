...
// Source: #/components/schemas/Tipping (inline: Czk)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Czk {const Czk({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Czk.fromJson(Map<String, dynamic> json) { return Czk(
...
Czk copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Czk(
...
@override String toString() => 'Czk(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
