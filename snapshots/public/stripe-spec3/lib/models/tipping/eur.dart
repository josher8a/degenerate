...
// Source: #/components/schemas/Tipping (inline: Eur)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Eur {const Eur({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Eur.fromJson(Map<String, dynamic> json) { return Eur(
...
Eur copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Eur(
...
@override String toString() => 'Eur(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
