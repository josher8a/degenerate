...
// Source: #/components/schemas/Tipping (inline: Gbp)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Gbp {const Gbp({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Gbp.fromJson(Map<String, dynamic> json) { return Gbp(
...
Gbp copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Gbp(
...
@override String toString() => 'Gbp(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
