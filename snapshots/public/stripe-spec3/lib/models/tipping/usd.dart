...
// Source: #/components/schemas/Tipping (inline: Usd)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Usd {const Usd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Usd.fromJson(Map<String, dynamic> json) { return Usd(
...
Usd copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Usd(
...
@override String toString() => 'Usd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
