...
// Source: #/components/schemas/Tipping (inline: Cad)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Cad {const Cad({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Cad.fromJson(Map<String, dynamic> json) { return Cad(
...
Cad copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Cad(
...
@override String toString() => 'Cad(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
