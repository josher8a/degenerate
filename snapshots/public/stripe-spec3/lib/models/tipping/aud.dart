...
// Source: #/components/schemas/Tipping (inline: Aud)

import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Aud {const Aud({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Aud.fromJson(Map<String, dynamic> json) { return Aud(
...
Aud copyWith({List<int>? Function()? fixedAmounts, List<int>? Function()? percentages, int? Function()? smartTipThreshold, }) { return Aud(
...
@override String toString() => 'Aud(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)';
