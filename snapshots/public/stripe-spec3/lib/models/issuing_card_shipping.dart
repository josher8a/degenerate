...
if (phoneNumber$ != null) {
  if (phoneNumber$.runes.length > 5000) { errors.add('phoneNumber: length must be <= 5000'); }
}
...
if (trackingUrl$ != null) {
  if (trackingUrl$.runes.length > 5000) { errors.add('trackingUrl: length must be <= 5000'); }
}
return errors; } 
