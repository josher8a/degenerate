...
// Source: #/components/schemas/PostIssuingTransactionsTransactionRequest

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/get_payment_method_configurations_application/get_payment_method_configurations_application_variant2.dart';import 'package:pub_stripe_spec3/models/post_accounts_account_bank_accounts_id_request/metadata.dart';@immutable final class PostIssuingTransactionsTransactionRequest {const PostIssuingTransactionsTransactionRequest({this.expand, this.metadata, });
...
PostIssuingTransactionsTransactionRequest copyWith({List<String>? Function()? expand, Metadata? Function()? metadata, }) { return PostIssuingTransactionsTransactionRequest(
...
@override String toString() => 'PostIssuingTransactionsTransactionRequest(expand: $expand, metadata: $metadata)';
