...
factory PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptions(
  ...
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => InvoicePaymentMethodOptionsParam17.fromJson(v as Map<String, dynamic>),) : null,
