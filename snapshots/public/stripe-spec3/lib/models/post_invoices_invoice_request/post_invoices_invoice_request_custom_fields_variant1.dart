...
// Source: #/components/schemas/PostInvoicesInvoiceRequest (inline: CustomFields > Variant1)
...
if (name.runes.length > 40) { errors.add('name: length must be <= 40'); }
if (value.runes.length > 140) { errors.add('value: length must be <= 140'); }
return errors; } 
