...
// Source: #/components/schemas/PaymentLinksResourceCompletionBehaviorConfirmationPage
...
if (customMessage$ != null) {
  if (customMessage$.runes.length > 5000) { errors.add('customMessage: length must be <= 5000'); }
}
return errors; } 
