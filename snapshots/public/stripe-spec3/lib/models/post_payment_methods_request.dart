...
W when<W>({required W Function() acssDebit, required W Function() affirm, required W Function() afterpayClearpay, required W Function() alipay, required W Function() alma, required W Function() amazonPay, required W Function() auBecsDebit, required W Function() bacsDebit, required W Function() bancontact, required W Function() billie, required W Function() blik, required W Function() boleto, required W Function() card, required W Function() cashapp, required W Function() crypto, required W Function() custom, required W Function() customerBalance, required W Function() eps, required W Function() fpx, required W Function() giropay, required W Function() grabpay, required W Function() ideal, required W Function() kakaoPay, required W Function() klarna, required W Function() konbini, required W Function() krCard, required W Function() link, required W Function() mbWay, required W Function() mobilepay, required W Function() multibanco, required W Function() naverPay, required W Function() nzBankAccount, required W Function() oxxo, required W Function() p24, required W Function() payByBank, required W Function() payco, required W Function() paynow, required W Function() paypal, required W Function() payto, required W Function() pix, required W Function() promptpay, required W Function() revolutPay, required W Function() samsungPay, required W Function() satispay, required W Function() sepaDebit, required W Function() sofort, required W Function() swish, required W Function() twint, required W Function() usBankAccount, required W Function() wechatPay, required W Function() zip, required W Function(String value) $unknown, }) { return switch (this) {
      PostPaymentMethodsRequestType$acssDebit() => acssDebit(),
      PostPaymentMethodsRequestType$affirm() => affirm(),
      PostPaymentMethodsRequestType$afterpayClearpay() => afterpayClearpay(),
      PostPaymentMethodsRequestType$alipay() => alipay(),
      PostPaymentMethodsRequestType$alma() => alma(),
      PostPaymentMethodsRequestType$amazonPay() => amazonPay(),
      PostPaymentMethodsRequestType$auBecsDebit() => auBecsDebit(),
      PostPaymentMethodsRequestType$bacsDebit() => bacsDebit(),
      PostPaymentMethodsRequestType$bancontact() => bancontact(),
      PostPaymentMethodsRequestType$billie() => billie(),
      PostPaymentMethodsRequestType$blik() => blik(),
      PostPaymentMethodsRequestType$boleto() => boleto(),
      PostPaymentMethodsRequestType$card() => card(),
      PostPaymentMethodsRequestType$cashapp() => cashapp(),
      PostPaymentMethodsRequestType$crypto() => crypto(),
      PostPaymentMethodsRequestType$custom() => custom(),
      PostPaymentMethodsRequestType$customerBalance() => customerBalance(),
      PostPaymentMethodsRequestType$eps() => eps(),
      PostPaymentMethodsRequestType$fpx() => fpx(),
      PostPaymentMethodsRequestType$giropay() => giropay(),
      PostPaymentMethodsRequestType$grabpay() => grabpay(),
      PostPaymentMethodsRequestType$ideal() => ideal(),
      PostPaymentMethodsRequestType$kakaoPay() => kakaoPay(),
      PostPaymentMethodsRequestType$klarna() => klarna(),
      PostPaymentMethodsRequestType$konbini() => konbini(),
      PostPaymentMethodsRequestType$krCard() => krCard(),
      PostPaymentMethodsRequestType$link() => link(),
      PostPaymentMethodsRequestType$mbWay() => mbWay(),
      PostPaymentMethodsRequestType$mobilepay() => mobilepay(),
      PostPaymentMethodsRequestType$multibanco() => multibanco(),
      PostPaymentMethodsRequestType$naverPay() => naverPay(),
      PostPaymentMethodsRequestType$nzBankAccount() => nzBankAccount(),
      PostPaymentMethodsRequestType$oxxo() => oxxo(),
      PostPaymentMethodsRequestType$p24() => p24(),
      PostPaymentMethodsRequestType$payByBank() => payByBank(),
      PostPaymentMethodsRequestType$payco() => payco(),
      PostPaymentMethodsRequestType$paynow() => paynow(),
      PostPaymentMethodsRequestType$paypal() => paypal(),
      PostPaymentMethodsRequestType$payto() => payto(),
      PostPaymentMethodsRequestType$pix() => pix(),
      PostPaymentMethodsRequestType$promptpay() => promptpay(),
      PostPaymentMethodsRequestType$revolutPay() => revolutPay(),
      PostPaymentMethodsRequestType$samsungPay() => samsungPay(),
      PostPaymentMethodsRequestType$satispay() => satispay(),
      PostPaymentMethodsRequestType$sepaDebit() => sepaDebit(),
      PostPaymentMethodsRequestType$sofort() => sofort(),
      PostPaymentMethodsRequestType$swish() => swish(),
      PostPaymentMethodsRequestType$twint() => twint(),
      PostPaymentMethodsRequestType$usBankAccount() => usBankAccount(),
      PostPaymentMethodsRequestType$wechatPay() => wechatPay(),
      PostPaymentMethodsRequestType$zip() => zip(),
      PostPaymentMethodsRequestType$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? acssDebit, W Function()? affirm, W Function()? afterpayClearpay, W Function()? alipay, W Function()? alma, W Function()? amazonPay, W Function()? auBecsDebit, W Function()? bacsDebit, W Function()? bancontact, W Function()? billie, W Function()? blik, W Function()? boleto, W Function()? card, W Function()? cashapp, W Function()? crypto, W Function()? custom, W Function()? customerBalance, W Function()? eps, W Function()? fpx, W Function()? giropay, W Function()? grabpay, W Function()? ideal, W Function()? kakaoPay, W Function()? klarna, W Function()? konbini, W Function()? krCard, W Function()? link, W Function()? mbWay, W Function()? mobilepay, W Function()? multibanco, W Function()? naverPay, W Function()? nzBankAccount, W Function()? oxxo, W Function()? p24, W Function()? payByBank, W Function()? payco, W Function()? paynow, W Function()? paypal, W Function()? payto, W Function()? pix, W Function()? promptpay, W Function()? revolutPay, W Function()? samsungPay, W Function()? satispay, W Function()? sepaDebit, W Function()? sofort, W Function()? swish, W Function()? twint, W Function()? usBankAccount, W Function()? wechatPay, W Function()? zip, W Function(String value)? $unknown, }) { return switch (this) {
      PostPaymentMethodsRequestType$acssDebit() => acssDebit != null ? acssDebit() : orElse(value),
      PostPaymentMethodsRequestType$affirm() => affirm != null ? affirm() : orElse(value),
      PostPaymentMethodsRequestType$afterpayClearpay() => afterpayClearpay != null ? afterpayClearpay() : orElse(value),
      PostPaymentMethodsRequestType$alipay() => alipay != null ? alipay() : orElse(value),
      PostPaymentMethodsRequestType$alma() => alma != null ? alma() : orElse(value),
      PostPaymentMethodsRequestType$amazonPay() => amazonPay != null ? amazonPay() : orElse(value),
      PostPaymentMethodsRequestType$auBecsDebit() => auBecsDebit != null ? auBecsDebit() : orElse(value),
      PostPaymentMethodsRequestType$bacsDebit() => bacsDebit != null ? bacsDebit() : orElse(value),
      PostPaymentMethodsRequestType$bancontact() => bancontact != null ? bancontact() : orElse(value),
      PostPaymentMethodsRequestType$billie() => billie != null ? billie() : orElse(value),
      PostPaymentMethodsRequestType$blik() => blik != null ? blik() : orElse(value),
      PostPaymentMethodsRequestType$boleto() => boleto != null ? boleto() : orElse(value),
      PostPaymentMethodsRequestType$card() => card != null ? card() : orElse(value),
      PostPaymentMethodsRequestType$cashapp() => cashapp != null ? cashapp() : orElse(value),
      PostPaymentMethodsRequestType$crypto() => crypto != null ? crypto() : orElse(value),
      PostPaymentMethodsRequestType$custom() => custom != null ? custom() : orElse(value),
      PostPaymentMethodsRequestType$customerBalance() => customerBalance != null ? customerBalance() : orElse(value),
      PostPaymentMethodsRequestType$eps() => eps != null ? eps() : orElse(value),
      PostPaymentMethodsRequestType$fpx() => fpx != null ? fpx() : orElse(value),
      PostPaymentMethodsRequestType$giropay() => giropay != null ? giropay() : orElse(value),
      PostPaymentMethodsRequestType$grabpay() => grabpay != null ? grabpay() : orElse(value),
      PostPaymentMethodsRequestType$ideal() => ideal != null ? ideal() : orElse(value),
      PostPaymentMethodsRequestType$kakaoPay() => kakaoPay != null ? kakaoPay() : orElse(value),
      PostPaymentMethodsRequestType$klarna() => klarna != null ? klarna() : orElse(value),
      PostPaymentMethodsRequestType$konbini() => konbini != null ? konbini() : orElse(value),
      PostPaymentMethodsRequestType$krCard() => krCard != null ? krCard() : orElse(value),
      PostPaymentMethodsRequestType$link() => link != null ? link() : orElse(value),
      PostPaymentMethodsRequestType$mbWay() => mbWay != null ? mbWay() : orElse(value),
      PostPaymentMethodsRequestType$mobilepay() => mobilepay != null ? mobilepay() : orElse(value),
      PostPaymentMethodsRequestType$multibanco() => multibanco != null ? multibanco() : orElse(value),
      PostPaymentMethodsRequestType$naverPay() => naverPay != null ? naverPay() : orElse(value),
      PostPaymentMethodsRequestType$nzBankAccount() => nzBankAccount != null ? nzBankAccount() : orElse(value),
      PostPaymentMethodsRequestType$oxxo() => oxxo != null ? oxxo() : orElse(value),
      PostPaymentMethodsRequestType$p24() => p24 != null ? p24() : orElse(value),
      PostPaymentMethodsRequestType$payByBank() => payByBank != null ? payByBank() : orElse(value),
      PostPaymentMethodsRequestType$payco() => payco != null ? payco() : orElse(value),
      PostPaymentMethodsRequestType$paynow() => paynow != null ? paynow() : orElse(value),
      PostPaymentMethodsRequestType$paypal() => paypal != null ? paypal() : orElse(value),
      PostPaymentMethodsRequestType$payto() => payto != null ? payto() : orElse(value),
      PostPaymentMethodsRequestType$pix() => pix != null ? pix() : orElse(value),
      PostPaymentMethodsRequestType$promptpay() => promptpay != null ? promptpay() : orElse(value),
      PostPaymentMethodsRequestType$revolutPay() => revolutPay != null ? revolutPay() : orElse(value),
      PostPaymentMethodsRequestType$samsungPay() => samsungPay != null ? samsungPay() : orElse(value),
      PostPaymentMethodsRequestType$satispay() => satispay != null ? satispay() : orElse(value),
      PostPaymentMethodsRequestType$sepaDebit() => sepaDebit != null ? sepaDebit() : orElse(value),
      PostPaymentMethodsRequestType$sofort() => sofort != null ? sofort() : orElse(value),
      PostPaymentMethodsRequestType$swish() => swish != null ? swish() : orElse(value),
      PostPaymentMethodsRequestType$twint() => twint != null ? twint() : orElse(value),
      PostPaymentMethodsRequestType$usBankAccount() => usBankAccount != null ? usBankAccount() : orElse(value),
      PostPaymentMethodsRequestType$wechatPay() => wechatPay != null ? wechatPay() : orElse(value),
      PostPaymentMethodsRequestType$zip() => zip != null ? zip() : orElse(value),
      PostPaymentMethodsRequestType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
if (customer$ != null) {
  if (customer$.runes.length > 5000) { errors.add('customer: length must be <= 5000'); }
}
