...
// Source: #/components/schemas/GetLinkedAccountsResponse
...
return errors; } 
GetLinkedAccountsResponse copyWith({List<FinancialConnectionsAccount>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetLinkedAccountsResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetLinkedAccountsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
