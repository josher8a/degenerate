...
// Source: #/components/schemas/PostCustomersCustomerSourcesRequest
...
if (alipayAccount$ != null) {
  if (alipayAccount$.runes.length > 5000) { errors.add('alipayAccount: length must be <= 5000'); }
}
final source$ = source;
if (source$ != null) {
...
@override String toString() => 'PostCustomersCustomerSourcesRequest(alipayAccount: $alipayAccount, bankAccount: $bankAccount, card: $card, expand: $expand, metadata: $metadata, source: $source)';
