...
// Source: #/components/schemas/GetQuotesQuoteComputedUpfrontLineItemsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/get_accounts_account_capabilities_response/get_accounts_account_capabilities_response_object.dart';import 'package:pub_stripe_spec3/models/item.dart';/// 
...
return errors; } 
GetQuotesQuoteComputedUpfrontLineItemsResponse copyWith({List<Item>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetQuotesQuoteComputedUpfrontLineItemsResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetQuotesQuoteComputedUpfrontLineItemsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
