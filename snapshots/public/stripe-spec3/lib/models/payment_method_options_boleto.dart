...
// Source: #/components/schemas/PaymentMethodOptionsBoleto
...
PaymentMethodOptionsBoleto copyWith({int? expiresAfterDays, CheckoutAcssDebitPaymentMethodOptionsSetupFutureUsage? Function()? setupFutureUsage, }) { return PaymentMethodOptionsBoleto(
...
@override String toString() => 'PaymentMethodOptionsBoleto(expiresAfterDays: $expiresAfterDays, setupFutureUsage: $setupFutureUsage)';
