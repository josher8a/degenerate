...
// Source: #/components/schemas/TreasuryReceivedDebitsResourceDebitReversalLinkedFlows
...
if (issuingDispute$ != null) {
  if (issuingDispute$.runes.length > 5000) { errors.add('issuingDispute: length must be <= 5000'); }
}
return errors; } 
