...
W when<W>({required W Function() financialAccount, required W Function() paymentMethod, required W Function(String value) $unknown, }) { return switch (this) {
      ForwardingSettingsType$financialAccount() => financialAccount(),
      ForwardingSettingsType$paymentMethod() => paymentMethod(),
      ForwardingSettingsType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? financialAccount, W Function()? paymentMethod, W Function(String value)? $unknown, }) { return switch (this) {
      ForwardingSettingsType$financialAccount() => financialAccount != null ? financialAccount() : orElse(value),
      ForwardingSettingsType$paymentMethod() => paymentMethod != null ? paymentMethod() : orElse(value),
      ForwardingSettingsType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
