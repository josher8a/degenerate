...
W when<W>({required W Function() priceDetails, required W Function(String value) $unknown, }) { return switch (this) {
      BillingBillResourceInvoicingPricingPricingType$priceDetails() => priceDetails(),
      BillingBillResourceInvoicingPricingPricingType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? priceDetails, W Function(String value)? $unknown, }) { return switch (this) {
      BillingBillResourceInvoicingPricingPricingType$priceDetails() => priceDetails != null ? priceDetails() : orElse(value),
      BillingBillResourceInvoicingPricingPricingType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
