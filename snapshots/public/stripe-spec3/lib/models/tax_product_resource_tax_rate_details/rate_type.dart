...
W when<W>({required W Function() flatAmount, required W Function() percentage, required W Function(String value) $unknown, }) { return switch (this) {
      RateType$flatAmount() => flatAmount(),
      RateType$percentage() => percentage(),
      RateType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? flatAmount, W Function()? percentage, W Function(String value)? $unknown, }) { return switch (this) {
      RateType$flatAmount() => flatAmount != null ? flatAmount() : orElse(value),
      RateType$percentage() => percentage != null ? percentage() : orElse(value),
      RateType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
