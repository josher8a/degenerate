...
// Source: #/components/schemas/PostTestHelpersTreasuryOutboundPaymentsIdRequest (inline: TrackingDetails > Ach)
...
if (traceId.runes.length > 5000) { errors.add('traceId: length must be <= 5000'); }
return errors; } 
