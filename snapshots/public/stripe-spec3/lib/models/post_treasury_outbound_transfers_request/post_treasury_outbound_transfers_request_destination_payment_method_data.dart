...
W when<W>({required W Function() financialAccount, required W Function(String value) $unknown, }) { return switch (this) {
      DestinationPaymentMethodDataType$financialAccount() => financialAccount(),
      DestinationPaymentMethodDataType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? financialAccount, W Function(String value)? $unknown, }) { return switch (this) {
      DestinationPaymentMethodDataType$financialAccount() => financialAccount != null ? financialAccount() : orElse(value),
      DestinationPaymentMethodDataType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
