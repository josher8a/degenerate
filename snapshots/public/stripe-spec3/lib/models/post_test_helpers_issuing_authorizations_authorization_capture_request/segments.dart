...
if (arrivalAirportCode$ != null) {
  if (arrivalAirportCode$.runes.length > 3) { errors.add('arrivalAirportCode: length must be <= 3'); }
}
...
if (departureAirportCode$ != null) {
  if (departureAirportCode$.runes.length > 3) { errors.add('departureAirportCode: length must be <= 3'); }
}
