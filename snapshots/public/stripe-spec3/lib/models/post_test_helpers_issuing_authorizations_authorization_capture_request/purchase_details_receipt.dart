...
// Source: #/components/schemas/PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequest (inline: PurchaseDetails > Receipt)
...
if (description$ != null) {
  if (description$.runes.length > 26) { errors.add('description: length must be <= 26'); }
}
return errors; } 
