...
// Source: #/components/schemas/PostSetupIntentsIntentVerifyMicrodepositsRequest
...
if (descriptorCode$ != null) {
  if (descriptorCode$.runes.length > 5000) { errors.add('descriptorCode: length must be <= 5000'); }
}
return errors; } 
