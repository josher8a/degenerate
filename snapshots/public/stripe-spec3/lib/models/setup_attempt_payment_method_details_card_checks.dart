...
// Source: #/components/schemas/SetupAttemptPaymentMethodDetailsCardChecks
...
if (addressPostalCodeCheck$ != null) {
  if (addressPostalCodeCheck$.runes.length > 5000) { errors.add('addressPostalCodeCheck: length must be <= 5000'); }
}
...
@override String toString() => 'SetupAttemptPaymentMethodDetailsCardChecks(addressLine1Check: $addressLine1Check, addressPostalCodeCheck: $addressPostalCodeCheck, cvcCheck: $cvcCheck)';
