...
W when<W>({required W Function() billingCreditBalanceSummary, required W Function(String value) $unknown, }) { return switch (this) {
      BillingCreditBalanceSummaryObject$billingCreditBalanceSummary() => billingCreditBalanceSummary(),
      BillingCreditBalanceSummaryObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? billingCreditBalanceSummary, W Function(String value)? $unknown, }) { return switch (this) {
      BillingCreditBalanceSummaryObject$billingCreditBalanceSummary() => billingCreditBalanceSummary != null ? billingCreditBalanceSummary() : orElse(value),
      BillingCreditBalanceSummaryObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
