...
// Source: #/components/schemas/PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode
...
if (mobileAuthUrl.runes.length > 5000) { errors.add('mobileAuthUrl: length must be <= 5000'); }
return errors; } 
