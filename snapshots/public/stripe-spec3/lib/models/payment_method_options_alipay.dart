...
// Source: #/components/schemas/PaymentMethodOptionsAlipay

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/checkout_amazon_pay_payment_method_options/checkout_amazon_pay_payment_method_options_setup_future_usage.dart';/// 
...
PaymentMethodOptionsAlipay copyWith({CheckoutAmazonPayPaymentMethodOptionsSetupFutureUsage? Function()? setupFutureUsage}) { return PaymentMethodOptionsAlipay(
...
@override String toString() => 'PaymentMethodOptionsAlipay(setupFutureUsage: $setupFutureUsage)';
