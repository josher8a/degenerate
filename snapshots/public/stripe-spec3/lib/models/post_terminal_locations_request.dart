...
if (configurationOverrides$ != null) {
  if (configurationOverrides$.runes.length > 500) { errors.add('configurationOverrides: length must be <= 500'); }
}
final displayName$ = displayName;
if (displayName$ != null) {
  if (displayName$.runes.length > 1000) { errors.add('displayName: length must be <= 1000'); }
}
final displayNameKana$ = displayNameKana;
if (displayNameKana$ != null) {
  if (displayNameKana$.runes.length > 1000) { errors.add('displayNameKana: length must be <= 1000'); }
}
final displayNameKanji$ = displayNameKanji;
if (displayNameKanji$ != null) {
  if (displayNameKanji$.runes.length > 1000) { errors.add('displayNameKanji: length must be <= 1000'); }
}
return errors; } 
