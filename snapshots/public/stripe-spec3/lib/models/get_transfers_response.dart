...
// Source: #/components/schemas/GetTransfersResponse
...
if (!RegExp('^/v1/transfers').hasMatch(url)) { errors.add('url: must match pattern ^/v1/transfers'); }
return errors; } 
...
@override String toString() => 'GetTransfersResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
