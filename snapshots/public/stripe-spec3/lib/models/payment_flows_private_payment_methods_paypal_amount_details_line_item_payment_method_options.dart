...
// Source: #/components/schemas/PaymentFlowsPrivatePaymentMethodsPaypalAmountDetailsLineItemPaymentMethodOptions
...
final soldBy$ = soldBy;
if (soldBy$ != null) {
  if (soldBy$.runes.length > 5000) { errors.add('soldBy: length must be <= 5000'); }
}
return errors; } 
