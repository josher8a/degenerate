...
// Source: #/components/schemas/PaymentMethodTwint
...
@override bool operator ==(Object other) => identical(this, other) || other is PaymentMethodTwint;

@override int get hashCode => runtimeType.hashCode;

@override String toString() => 'PaymentMethodTwint()';
