...
// Source: #/components/schemas/PostTaxRegistrationsRequest (inline: CountryOptions > Lu)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/post_tax_registrations_request/at_standard.dart';import 'package:pub_stripe_spec3/models/tax_product_registrations_resource_country_options_europe/tax_product_registrations_resource_country_options_europe_type.dart';@immutable final class Lu {const Lu({required this.type, this.standard, });

factory Lu.fromJson(Map<String, dynamic> json) { return Lu(
...
@override String toString() => 'Lu(standard: $standard, type: $type)';
