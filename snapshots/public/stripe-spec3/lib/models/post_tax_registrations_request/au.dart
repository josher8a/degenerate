...
Au copyWith({AeStandard? Function()? standard, TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsType? type, }) { return Au(
...
@override String toString() => 'Au(standard: $standard, type: $type)';
