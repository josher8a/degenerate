...
// Source: #/components/schemas/PostTaxRegistrationsRequest (inline: CountryOptions > Us > StateSalesTax > Elections)
...
if (jurisdiction$ != null) {
  if (jurisdiction$.runes.length > 5000) { errors.add('jurisdiction: length must be <= 5000'); }
}
return errors; } 
