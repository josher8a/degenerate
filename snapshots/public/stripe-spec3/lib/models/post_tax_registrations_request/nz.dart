...
Nz copyWith({AeStandard? Function()? standard, TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsType? type, }) { return Nz(
...
@override String toString() => 'Nz(standard: $standard, type: $type)';
