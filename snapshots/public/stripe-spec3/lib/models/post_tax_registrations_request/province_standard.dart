...
// Source: #/components/schemas/PostTaxRegistrationsRequest (inline: CountryOptions > Ca > ProvinceStandard)
...
if (province.runes.length > 5000) { errors.add('province: length must be <= 5000'); }
return errors; } 
