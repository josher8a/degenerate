...
// Source: #/components/schemas/PostIssuingAuthorizationsAuthorizationRequest

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/get_payment_method_configurations_application/get_payment_method_configurations_application_variant2.dart';import 'package:pub_stripe_spec3/models/post_accounts_account_bank_accounts_id_request/metadata.dart';@immutable final class PostIssuingAuthorizationsAuthorizationRequest {const PostIssuingAuthorizationsAuthorizationRequest({this.expand, this.metadata, });
...
PostIssuingAuthorizationsAuthorizationRequest copyWith({List<String>? Function()? expand, Metadata? Function()? metadata, }) { return PostIssuingAuthorizationsAuthorizationRequest(
...
@override String toString() => 'PostIssuingAuthorizationsAuthorizationRequest(expand: $expand, metadata: $metadata)';
