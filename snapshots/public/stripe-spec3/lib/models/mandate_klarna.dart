...
// Source: #/components/schemas/MandateKlarna
...
@override bool operator ==(Object other) => identical(this, other) || other is MandateKlarna;

@override int get hashCode => runtimeType.hashCode;

@override String toString() => 'MandateKlarna()';
