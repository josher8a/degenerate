...
if (unitLabel$ != null) {
  if (unitLabel$.runes.length > 12) { errors.add('unitLabel: length must be <= 12'); }
}
return errors; } 
...
@override String toString() => 'PostPricesRequestProductData(active: $active, id: $id, metadata: $metadata, name: $name, statementDescriptor: $statementDescriptor, taxCode: $taxCode, unitLabel: $unitLabel)';
