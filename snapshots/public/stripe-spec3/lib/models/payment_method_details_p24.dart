...
@override int get hashCode => Object.hash(bank, reference, verifiedName);

@override String toString() => 'PaymentMethodDetailsP24(bank: $bank, reference: $reference, verifiedName: $verifiedName)';
