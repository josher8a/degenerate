...
// Source: #/components/schemas/PostAccountSessionsRequest (inline: Components > TaxRegistrations)
...
@override String toString() => 'TaxRegistrations(enabled: $enabled, features: $features)';
