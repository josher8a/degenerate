...
// Source: #/components/schemas/PostAccountSessionsRequest (inline: Components > PayoutsList)
...
@override String toString() => 'PayoutsList(enabled: $enabled, features: $features)';
