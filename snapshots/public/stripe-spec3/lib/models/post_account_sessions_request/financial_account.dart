...
// Source: #/components/schemas/PostAccountSessionsRequest (inline: Components > FinancialAccount)
...
@override String toString() => 'FinancialAccount(enabled: $enabled, features: $features)';
