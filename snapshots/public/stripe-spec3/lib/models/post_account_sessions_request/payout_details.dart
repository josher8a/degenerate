...
// Source: #/components/schemas/PostAccountSessionsRequest (inline: Components > PayoutDetails)
...
@override String toString() => 'PayoutDetails(enabled: $enabled, features: $features)';
