...
// Source: #/components/schemas/ChargeFraudDetails
...
if (stripeReport$ != null) {
  if (stripeReport$.runes.length > 5000) { errors.add('stripeReport: length must be <= 5000'); }
}
final userReport$ = userReport;
if (userReport$ != null) {
  if (userReport$.runes.length > 5000) { errors.add('userReport: length must be <= 5000'); }
}
return errors; } 
