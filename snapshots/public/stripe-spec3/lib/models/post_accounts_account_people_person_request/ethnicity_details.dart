...
// Source: #/components/schemas/PostAccountsAccountPeoplePersonRequest (inline: UsCfpbData > EthnicityDetails)
...
if (ethnicityOther$ != null) {
  if (ethnicityOther$.runes.length > 5000) { errors.add('ethnicityOther: length must be <= 5000'); }
}
return errors; } 
