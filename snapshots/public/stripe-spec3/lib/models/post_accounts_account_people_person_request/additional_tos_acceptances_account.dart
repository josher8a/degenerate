...
// Source: #/components/schemas/PostAccountsAccountPeoplePersonRequest (inline: AdditionalTosAcceptances > Account)
...
@override String toString() => 'AdditionalTosAcceptancesAccount(date: $date, ip: $ip, userAgent: $userAgent)';
