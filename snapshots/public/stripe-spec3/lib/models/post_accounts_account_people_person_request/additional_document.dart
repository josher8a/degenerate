...
// Source: #/components/schemas/PostAccountsAccountPeoplePersonRequest (inline: Verification > AdditionalDocument)
...
final back$ = back;
if (back$ != null) {
  if (back$.runes.length > 500) { errors.add('back: length must be <= 500'); }
}
final front$ = front;
if (front$ != null) {
  if (front$.runes.length > 500) { errors.add('front: length must be <= 500'); }
}
return errors; } 
