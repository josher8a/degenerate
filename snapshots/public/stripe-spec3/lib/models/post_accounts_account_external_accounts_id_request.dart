...
if (expMonth$ != null) {
  if (expMonth$.runes.length > 5000) { errors.add('expMonth: length must be <= 5000'); }
}
final expYear$ = expYear;
if (expYear$ != null) {
  if (expYear$.runes.length > 5000) { errors.add('expYear: length must be <= 5000'); }
}
final name$ = name;
if (name$ != null) {
...
return errors; } 
PostAccountsAccountExternalAccountsIdRequest copyWith({String? Function()? accountHolderName, PostAccountsAccountBankAccountsIdRequestAccountHolderType? Function()? accountHolderType, ExternalAccountPayoutBankAccountAccountType? Function()? accountType, String? Function()? addressCity, String? Function()? addressCountry, String? Function()? addressLine1, String? Function()? addressLine2, String? Function()? addressState, String? Function()? addressZip, bool? Function()? defaultForCurrency, ExternalAccountPayoutBankAccountDocuments? Function()? documents, String? Function()? expMonth, String? Function()? expYear, List<String>? Function()? expand, Metadata? Function()? metadata, String? Function()? name, }) { return PostAccountsAccountExternalAccountsIdRequest(
