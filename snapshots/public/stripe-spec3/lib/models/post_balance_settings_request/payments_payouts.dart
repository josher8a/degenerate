...
// Source: #/components/schemas/PostBalanceSettingsRequest (inline: Payments > Payouts)
...
factory PaymentsPayouts.fromJson(Map<String, dynamic> json) { return PaymentsPayouts(
  minimumBalanceByCurrency: json['minimum_balance_by_currency'] != null ? OneOf2.parse(json['minimum_balance_by_currency'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, OneOf2.parse(v, fromA: (v) => (v as num).toInt(), fromB: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String),))), fromB: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), greedy: const {0},) : null,
