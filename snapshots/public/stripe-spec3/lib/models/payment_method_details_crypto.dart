...
if (buyerAddress$ != null) {
  if (buyerAddress$.runes.length > 5000) { errors.add('buyerAddress: length must be <= 5000'); }
}
final transactionHash$ = transactionHash;
if (transactionHash$ != null) {
  if (transactionHash$.runes.length > 5000) { errors.add('transactionHash: length must be <= 5000'); }
}
return errors; } 
