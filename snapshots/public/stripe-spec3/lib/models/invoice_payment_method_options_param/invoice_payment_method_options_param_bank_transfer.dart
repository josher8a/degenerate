...
// Source: #/components/schemas/InvoicePaymentMethodOptionsParam (inline: BankTransfer)
...
@override String toString() => 'InvoicePaymentMethodOptionsParamBankTransfer(euBankTransfer: $euBankTransfer, type: $type)';
