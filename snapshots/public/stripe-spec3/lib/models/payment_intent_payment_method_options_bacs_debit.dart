...
if (targetDate$ != null) {
  if (targetDate$.runes.length > 5000) { errors.add('targetDate: length must be <= 5000'); }
}
return errors; } 
PaymentIntentPaymentMethodOptionsBacsDebit copyWith({PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit? Function()? mandateOptions, CheckoutAcssDebitPaymentMethodOptionsSetupFutureUsage? Function()? setupFutureUsage, String? Function()? targetDate, }) { return PaymentIntentPaymentMethodOptionsBacsDebit(
...
@override String toString() => 'PaymentIntentPaymentMethodOptionsBacsDebit(mandateOptions: $mandateOptions, setupFutureUsage: $setupFutureUsage, targetDate: $targetDate)';
