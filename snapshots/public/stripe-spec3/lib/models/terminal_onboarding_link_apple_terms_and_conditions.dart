...
// Source: #/components/schemas/TerminalOnboardingLinkAppleTermsAndConditions
...
if (merchantDisplayName.runes.length > 5000) { errors.add('merchantDisplayName: length must be <= 5000'); }
return errors; } 
