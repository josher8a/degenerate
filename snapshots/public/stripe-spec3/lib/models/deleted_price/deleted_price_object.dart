...
W when<W>({required W Function() price, required W Function(String value) $unknown, }) { return switch (this) {
      DeletedPriceObject$price() => price(),
      DeletedPriceObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? price, W Function(String value)? $unknown, }) { return switch (this) {
      DeletedPriceObject$price() => price != null ? price() : orElse(value),
      DeletedPriceObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
