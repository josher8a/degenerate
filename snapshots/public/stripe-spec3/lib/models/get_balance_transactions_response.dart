...
// Source: #/components/schemas/GetBalanceTransactionsResponse
...
return errors; } 
GetBalanceTransactionsResponse copyWith({List<BalanceTransaction>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetBalanceTransactionsResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetBalanceTransactionsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
