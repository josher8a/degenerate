...
// Source: #/components/schemas/GetPaymentIntentsSearchResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/get_charges_search_response/get_charges_search_response_object.dart';import 'package:pub_stripe_spec3/models/payment_intent.dart';/// 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('data') &&
      ...
      json.containsKey('object') && json['object'] == 'search_result' &&
      json.containsKey('url') && json['url'] is String; } 
/// Constraint violations for this value (empty when valid).
List<String> validate() { final errors = <String>[];
final nextPage$ = nextPage;
if (nextPage$ != null) {
  if (nextPage$.runes.length > 5000) { errors.add('nextPage: length must be <= 5000'); }
}
if (url.runes.length > 5000) { errors.add('url: length must be <= 5000'); }
return errors; } 
GetPaymentIntentsSearchResponse copyWith({List<PaymentIntent>? data, bool? hasMore, String? Function()? nextPage, GetChargesSearchResponseObject? object, int? Function()? totalCount, String? url, }) { return GetPaymentIntentsSearchResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetPaymentIntentsSearchResponse(data: $data, hasMore: $hasMore, nextPage: $nextPage, object: $object, totalCount: $totalCount, url: $url)';
