...
if (merchantCurrency.runes.length > 5000) { errors.add('merchantCurrency: length must be <= 5000'); }
final reasonMessage$ = reasonMessage;
if (reasonMessage$ != null) {
  if (reasonMessage$.runes.length > 5000) { errors.add('reasonMessage: length must be <= 5000'); }
}
return errors; } 
