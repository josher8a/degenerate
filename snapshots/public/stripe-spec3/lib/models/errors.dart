...
if (adviceCode$ != null) {
  if (adviceCode$.runes.length > 5000) { errors.add('adviceCode: length must be <= 5000'); }
}
final charge$ = charge;
if (charge$ != null) {
  if (charge$.runes.length > 5000) { errors.add('charge: length must be <= 5000'); }
}
final code$ = code;
if (code$ != null) {
...
if (declineCode$ != null) {
  if (declineCode$.runes.length > 5000) { errors.add('declineCode: length must be <= 5000'); }
}
final docUrl$ = docUrl;
if (docUrl$ != null) {
  if (docUrl$.runes.length > 5000) { errors.add('docUrl: length must be <= 5000'); }
}
final message$ = message;
if (message$ != null) {
  if (message$.runes.length > 40000) { errors.add('message: length must be <= 40000'); }
}
final networkAdviceCode$ = networkAdviceCode;
if (networkAdviceCode$ != null) {
  if (networkAdviceCode$.runes.length > 5000) { errors.add('networkAdviceCode: length must be <= 5000'); }
}
final networkDeclineCode$ = networkDeclineCode;
if (networkDeclineCode$ != null) {
  if (networkDeclineCode$.runes.length > 5000) { errors.add('networkDeclineCode: length must be <= 5000'); }
}
final param$ = param;
if (param$ != null) {
  if (param$.runes.length > 5000) { errors.add('param: length must be <= 5000'); }
}
final paymentMethodType$ = paymentMethodType;
if (paymentMethodType$ != null) {
  if (paymentMethodType$.runes.length > 5000) { errors.add('paymentMethodType: length must be <= 5000'); }
}
final requestLogUrl$ = requestLogUrl;
if (requestLogUrl$ != null) {
  if (requestLogUrl$.runes.length > 5000) { errors.add('requestLogUrl: length must be <= 5000'); }
}
return errors; } 
