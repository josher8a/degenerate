...
W when<W>({required W Function() euBankTransfer, required W Function() jpBankTransfer, required W Function(String value) $unknown, }) { return switch (this) {
      FundingInstructionsBankTransferType$euBankTransfer() => euBankTransfer(),
      FundingInstructionsBankTransferType$jpBankTransfer() => jpBankTransfer(),
      FundingInstructionsBankTransferType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? euBankTransfer, W Function()? jpBankTransfer, W Function(String value)? $unknown, }) { return switch (this) {
      FundingInstructionsBankTransferType$euBankTransfer() => euBankTransfer != null ? euBankTransfer() : orElse(value),
      FundingInstructionsBankTransferType$jpBankTransfer() => jpBankTransfer != null ? jpBankTransfer() : orElse(value),
      FundingInstructionsBankTransferType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
