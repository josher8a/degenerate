...
if (firstNameKana$ != null) {
  if (firstNameKana$.runes.length > 5000) { errors.add('firstNameKana: length must be <= 5000'); }
}
final firstNameKanji$ = firstNameKanji;
if (firstNameKanji$ != null) {
  if (firstNameKanji$.runes.length > 5000) { errors.add('firstNameKanji: length must be <= 5000'); }
}
...
if (idNumberSecondary$ != null) {
  if (idNumberSecondary$.runes.length > 5000) { errors.add('idNumberSecondary: length must be <= 5000'); }
}
...
if (lastNameKana$ != null) {
  if (lastNameKana$.runes.length > 5000) { errors.add('lastNameKana: length must be <= 5000'); }
}
final lastNameKanji$ = lastNameKanji;
if (lastNameKanji$ != null) {
  if (lastNameKanji$.runes.length > 5000) { errors.add('lastNameKanji: length must be <= 5000'); }
}
final maidenName$ = maidenName;
if (maidenName$ != null) {
  if (maidenName$.runes.length > 5000) { errors.add('maidenName: length must be <= 5000'); }
}
final nationality$ = nationality;
if (nationality$ != null) {
  if (nationality$.runes.length > 5000) { errors.add('nationality: length must be <= 5000'); }
}
final personToken$ = personToken;
if (personToken$ != null) {
  if (personToken$.runes.length > 5000) { errors.add('personToken: length must be <= 5000'); }
}
return errors; } 
PostAccountsAccountPersonsPersonRequest copyWith({AdditionalTosAcceptances? Function()? additionalTosAcceptances, PostAccountsAccountPeoplePersonRequestAddress? Function()? address, AddressKana? Function()? addressKana, AddressKanji? Function()? addressKanji, PostAccountsAccountPeoplePersonRequestDob? Function()? dob, PostAccountsAccountPeoplePersonRequestDocuments? Function()? documents, String? Function()? email, List<String>? Function()? expand, String? Function()? firstName, String? Function()? firstNameKana, String? Function()? firstNameKanji, PostAccountsAccountPeoplePersonRequestFullNameAliases? Function()? fullNameAliases, String? Function()? gender, String? Function()? idNumber, String? Function()? idNumberSecondary, String? Function()? lastName, String? Function()? lastNameKana, String? Function()? lastNameKanji, String? Function()? maidenName, Metadata? Function()? metadata, String? Function()? nationality, String? Function()? personToken, String? Function()? phone, PoliticalExposure? Function()? politicalExposure, RegisteredAddress? Function()? registeredAddress, PostAccountsAccountPeoplePersonRequestRelationship? Function()? relationship, String? Function()? ssnLast4, UsCfpbData? Function()? usCfpbData, PostAccountsAccountPeoplePersonRequestVerification? Function()? verification, }) { return PostAccountsAccountPersonsPersonRequest(
