...
if (connectedAccount$ != null) {
  if (connectedAccount$.runes.length > 5000) { errors.add('connectedAccount: length must be <= 5000'); }
}
final payout$ = payout;
if (payout$ != null) {
...
if (reportingCategory$ != null) {
  if (reportingCategory$.runes.length > 5000) { errors.add('reportingCategory: length must be <= 5000'); }
}
final timezone$ = timezone;
if (timezone$ != null) {
  if (timezone$.runes.length > 5000) { errors.add('timezone: length must be <= 5000'); }
}
return errors; } 
