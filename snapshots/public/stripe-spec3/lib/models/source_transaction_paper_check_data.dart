...
// Source: #/components/schemas/SourceTransactionPaperCheckData
...
if (availableAt$ != null) {
  if (availableAt$.runes.length > 5000) { errors.add('availableAt: length must be <= 5000'); }
}
final invoices$ = invoices;
if (invoices$ != null) {
  if (invoices$.runes.length > 5000) { errors.add('invoices: length must be <= 5000'); }
}
return errors; } 
