...
// Source: #/components/schemas/PostQuotesRequest
...
if (testClock$ != null) {
  if (testClock$.runes.length > 5000) { errors.add('testClock: length must be <= 5000'); }
}
return errors; } 
