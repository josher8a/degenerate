...
if (arrivalAirportCode$ != null) {
  if (arrivalAirportCode$.runes.length > 5000) { errors.add('arrivalAirportCode: length must be <= 5000'); }
}
...
if (departureAirportCode$ != null) {
  if (departureAirportCode$.runes.length > 5000) { errors.add('departureAirportCode: length must be <= 5000'); }
}
final flightNumber$ = flightNumber;
if (flightNumber$ != null) {
  if (flightNumber$.runes.length > 5000) { errors.add('flightNumber: length must be <= 5000'); }
}
final serviceClass$ = serviceClass;
if (serviceClass$ != null) {
  if (serviceClass$.runes.length > 5000) { errors.add('serviceClass: length must be <= 5000'); }
}
return errors; } 
