...
// Source: #/components/schemas/PostSubscriptionSchedulesRequest (inline: Phases > Duration)
...
@override String toString() => 'PhasesDuration(interval: $interval, intervalCount: $intervalCount)';
