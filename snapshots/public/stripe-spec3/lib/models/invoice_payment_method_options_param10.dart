...
factory InvoicePaymentMethodOptionsParam10.fromJson(Map<String, dynamic> json) { return InvoicePaymentMethodOptionsParam10(
  bankTransfer: json['bank_transfer'] != null ? InvoicePaymentMethodOptionsParamBankTransfer.fromJson(json['bank_transfer'] as Map<String, dynamic>) : null,
  fundingType: json['funding_type'] as String?,
); }

final InvoicePaymentMethodOptionsParamBankTransfer? bankTransfer;
...
InvoicePaymentMethodOptionsParam10 copyWith({InvoicePaymentMethodOptionsParamBankTransfer Function()? bankTransfer, String Function()? fundingType, }) { return InvoicePaymentMethodOptionsParam10(
