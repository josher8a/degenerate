...
// Source: #/components/schemas/GetPaymentLinksResponse
...
if (!RegExp('^/v1/payment_links').hasMatch(url)) { errors.add('url: must match pattern ^/v1/payment_links'); }
return errors; } 
...
@override String toString() => 'GetPaymentLinksResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
