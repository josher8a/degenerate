...
// Source: #/components/schemas/Card
...
if (addressLine1Check$ != null) {
  if (addressLine1Check$.runes.length > 5000) { errors.add('addressLine1Check: length must be <= 5000'); }
}
...
if (addressZipCheck$ != null) {
  if (addressZipCheck$.runes.length > 5000) { errors.add('addressZipCheck: length must be <= 5000'); }
}
...
if (cvcCheck$ != null) {
  if (cvcCheck$.runes.length > 5000) { errors.add('cvcCheck: length must be <= 5000'); }
}
final dynamicLast4$ = dynamicLast4;
if (dynamicLast4$ != null) {
  if (dynamicLast4$.runes.length > 5000) { errors.add('dynamicLast4: length must be <= 5000'); }
}
...
final iin$ = iin;
if (iin$ != null) {
  if (iin$.runes.length > 5000) { errors.add('iin: length must be <= 5000'); }
}
...
if (tokenizationMethod$ != null) {
  if (tokenizationMethod$.runes.length > 5000) { errors.add('tokenizationMethod: length must be <= 5000'); }
}
return errors; } 
