...
if (caCertificateFile$ != null) {
  if (caCertificateFile$.runes.length > 5000) { errors.add('caCertificateFile: length must be <= 5000'); }
}
if (clientCertificateFile.runes.length > 5000) { errors.add('clientCertificateFile: length must be <= 5000'); }
if (privateKeyFile.runes.length > 5000) { errors.add('privateKeyFile: length must be <= 5000'); }
final privateKeyFilePassword$ = privateKeyFilePassword;
if (privateKeyFilePassword$ != null) {
  if (privateKeyFilePassword$.runes.length > 5000) { errors.add('privateKeyFilePassword: length must be <= 5000'); }
}
if (ssid.runes.length > 5000) { errors.add('ssid: length must be <= 5000'); }
return errors; } 
