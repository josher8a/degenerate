...
W when<W>({required W Function() connectCollectionTransfer, required W Function(String value) $unknown, }) { return switch (this) {
      ConnectCollectionTransferObject$connectCollectionTransfer() => connectCollectionTransfer(),
      ConnectCollectionTransferObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? connectCollectionTransfer, W Function(String value)? $unknown, }) { return switch (this) {
      ConnectCollectionTransferObject$connectCollectionTransfer() => connectCollectionTransfer != null ? connectCollectionTransfer() : orElse(value),
      ConnectCollectionTransferObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('amount') && json['amount'] is num &&
      ...
      json.containsKey('object') && json['object'] == 'connect_collection_transfer'; } 
