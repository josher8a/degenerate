...
factory IndividualDob.fromJson(Map<String, dynamic> json) { return IndividualDob(
...
IndividualDob copyWith({int? day, int? month, int? year, }) { return IndividualDob(
  day: day ?? this.day,
  month: month ?? this.month,
  year: year ?? this.year,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is IndividualDob &&
          day == other.day &&
          month == other.month &&
          year == other.year; } 
@override int get hashCode { return Object.hash(day, month, year); } 
@override String toString() { return 'IndividualDob(day: $day, month: $month, year: $year)'; } 
 }
