...
if (cardholder$ != null) {
  if (cardholder$.runes.length > 5000) { errors.add('cardholder: length must be <= 5000'); }
}
final personalizationDesign$ = personalizationDesign;
if (personalizationDesign$ != null) {
  if (personalizationDesign$.runes.length > 5000) { errors.add('personalizationDesign: length must be <= 5000'); }
}
final replacementFor$ = replacementFor;
if (replacementFor$ != null) {
  if (replacementFor$.runes.length > 5000) { errors.add('replacementFor: length must be <= 5000'); }
}
return errors; } 
