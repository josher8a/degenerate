...
factory PostInvoicesInvoiceRequest.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceRequest(
  ...
  customFields: json['custom_fields'] != null ? OneOf2.parse(json['custom_fields'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceRequestCustomFieldsVariant1.fromJson(e as Map<String, dynamic>)).toList(),) : null,
  ...
  shippingCost: json['shipping_cost'] != null ? OneOf2.parse(json['shipping_cost'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => ShippingCost.fromJson(v as Map<String, dynamic>),) : null,
  shippingDetails: json['shipping_details'] != null ? OneOf2.parse(json['shipping_details'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => RecipientShippingWithOptionalFieldsAddress.fromJson(v as Map<String, dynamic>),) : null,
  statementDescriptor: json['statement_descriptor'] as String?,
  transferData: json['transfer_data'] != null ? OneOf2.parse(json['transfer_data'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => TransferDataSpecs2.fromJson(v as Map<String, dynamic>),) : null,
); }
