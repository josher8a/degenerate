...
W when<W>({required W Function() balanceSettings, required W Function(String value) $unknown, }) { return switch (this) {
      BalanceSettingsObject$balanceSettings() => balanceSettings(),
      BalanceSettingsObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? balanceSettings, W Function(String value)? $unknown, }) { return switch (this) {
      BalanceSettingsObject$balanceSettings() => balanceSettings != null ? balanceSettings() : orElse(value),
      BalanceSettingsObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
