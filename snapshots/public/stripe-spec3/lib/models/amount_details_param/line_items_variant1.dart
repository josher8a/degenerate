...
if (productCode$ != null) {
  if (productCode$.runes.length > 12) { errors.add('productCode: length must be <= 12'); }
}
if (productName.runes.length > 1024) { errors.add('productName: length must be <= 1024'); }
final unitOfMeasure$ = unitOfMeasure;
if (unitOfMeasure$ != null) {
  if (unitOfMeasure$.runes.length > 12) { errors.add('unitOfMeasure: length must be <= 12'); }
}
return errors; } 
