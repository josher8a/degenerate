...
// Source: #/components/schemas/AmountDetailsParam (inline: LineItems > Variant1 > PaymentMethodOptions > Card)
...
if (commodityCode$ != null) {
  if (commodityCode$.runes.length > 12) { errors.add('commodityCode: length must be <= 12'); }
}
return errors; } 
