...
// Source: #/components/schemas/AmountDetailsParam (inline: LineItems > Variant1 > PaymentMethodOptions > Paypal)
...
if (description$ != null) {
  if (description$.runes.length > 127) { errors.add('description: length must be <= 127'); }
}
final soldBy$ = soldBy;
if (soldBy$ != null) {
  if (soldBy$.runes.length > 127) { errors.add('soldBy: length must be <= 127'); }
}
return errors; } 
