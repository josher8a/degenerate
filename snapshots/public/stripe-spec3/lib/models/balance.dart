...
W when<W>({required W Function() balance, required W Function(String value) $unknown, }) { return switch (this) {
      BalanceObject$balance() => balance(),
      BalanceObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? balance, W Function(String value)? $unknown, }) { return switch (this) {
      BalanceObject$balance() => balance != null ? balance() : orElse(value),
      BalanceObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
