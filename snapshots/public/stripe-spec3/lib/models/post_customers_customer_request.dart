...
factory PostCustomersCustomerRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerRequest(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => OptionalFieldsCustomerAddress.fromJson(v as Map<String, dynamic>),) : null,
  balance: json['balance'] != null ? (json['balance'] as num).toInt() : null,
  bankAccount: json['bank_account'] != null ? OneOf2.parse(json['bank_account'], fromA: (v) => v as String, fromB: (v) => CustomerPaymentSourceBankAccount.fromJson(v as Map<String, dynamic>),) : null,
  ...
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => v as String, fromB: (v) => CustomerPaymentSourceCard.fromJson(v as Map<String, dynamic>),) : null,
