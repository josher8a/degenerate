...
if (defaultAlipayAccount$ != null) {
  if (defaultAlipayAccount$.runes.length > 500) { errors.add('defaultAlipayAccount: length must be <= 500'); }
}
final defaultBankAccount$ = defaultBankAccount;
if (defaultBankAccount$ != null) {
  if (defaultBankAccount$.runes.length > 500) { errors.add('defaultBankAccount: length must be <= 500'); }
}
final defaultCard$ = defaultCard;
if (defaultCard$ != null) {
  if (defaultCard$.runes.length > 500) { errors.add('defaultCard: length must be <= 500'); }
}
final defaultSource$ = defaultSource;
if (defaultSource$ != null) {
  if (defaultSource$.runes.length > 500) { errors.add('defaultSource: length must be <= 500'); }
}
...
final email$ = email;
if (email$ != null) {
  if (email$.runes.length > 512) { errors.add('email: length must be <= 512'); }
}
final invoicePrefix$ = invoicePrefix;
if (invoicePrefix$ != null) {
  if (invoicePrefix$.runes.length > 5000) { errors.add('invoicePrefix: length must be <= 5000'); }
}
final name$ = name;
if (name$ != null) {
...
final phone$ = phone;
if (phone$ != null) {
  if (phone$.runes.length > 20) { errors.add('phone: length must be <= 20'); }
}
final source$ = source;
if (source$ != null) {
