...
// Source: #/components/schemas/PaymentMethodDetailsCashapp
...
if (cashtag$ != null) {
  if (cashtag$.runes.length > 5000) { errors.add('cashtag: length must be <= 5000'); }
}
...
@override String toString() => 'PaymentMethodDetailsCashapp(buyerId: $buyerId, cashtag: $cashtag, transactionId: $transactionId)';
