...
// Source: #/components/schemas/PostPaymentIntentsRequest
...
if (mandate$ != null) {
  if (mandate$.runes.length > 5000) { errors.add('mandate: length must be <= 5000'); }
}
...
if (statementDescriptorSuffix$ != null) {
  if (statementDescriptorSuffix$.runes.length > 22) { errors.add('statementDescriptorSuffix: length must be <= 22'); }
}
return errors; } 
