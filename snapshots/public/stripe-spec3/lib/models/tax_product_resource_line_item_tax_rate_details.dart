...
// Source: #/components/schemas/TaxProductResourceLineItemTaxRateDetails
...
if (percentageDecimal.runes.length > 5000) { errors.add('percentageDecimal: length must be <= 5000'); }
return errors; } 
