...
// Source: #/components/schemas/GetCountrySpecsResponse
...
if (!RegExp('^/v1/country_specs').hasMatch(url)) { errors.add('url: must match pattern ^/v1/country_specs'); }
return errors; } 
...
@override String toString() => 'GetCountrySpecsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
