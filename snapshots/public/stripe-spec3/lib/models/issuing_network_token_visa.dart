...
// Source: #/components/schemas/IssuingNetworkTokenVisa
...
if (cardReferenceId.runes.length > 5000) { errors.add('cardReferenceId: length must be <= 5000'); }
if (tokenReferenceId.runes.length > 5000) { errors.add('tokenReferenceId: length must be <= 5000'); }
if (tokenRequestorId.runes.length > 5000) { errors.add('tokenRequestorId: length must be <= 5000'); }
final tokenRiskScore$ = tokenRiskScore;
if (tokenRiskScore$ != null) {
  if (tokenRiskScore$.runes.length > 5000) { errors.add('tokenRiskScore: length must be <= 5000'); }
}
return errors; } 
