...
W when<W>({required W Function() restricted, required W Function() unrestricted, required W Function(String value) $unknown, }) { return switch (this) {
      ...
      TreasuryFinancialAccountsResourcePlatformRestrictionsInboundFlows$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? restricted, W Function()? unrestricted, W Function(String value)? $unknown, }) { return switch (this) {
      TreasuryFinancialAccountsResourcePlatformRestrictionsInboundFlows$restricted() => restricted != null ? restricted() : orElse(value),
      TreasuryFinancialAccountsResourcePlatformRestrictionsInboundFlows$unrestricted() => unrestricted != null ? unrestricted() : orElse(value),
      TreasuryFinancialAccountsResourcePlatformRestrictionsInboundFlows$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
W when<W>({required W Function() restricted, required W Function() unrestricted, required W Function(String value) $unknown, }) { return switch (this) {
      ...
      TreasuryFinancialAccountsResourcePlatformRestrictionsOutboundFlows$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? restricted, W Function()? unrestricted, W Function(String value)? $unknown, }) { return switch (this) {
      TreasuryFinancialAccountsResourcePlatformRestrictionsOutboundFlows$restricted() => restricted != null ? restricted() : orElse(value),
      TreasuryFinancialAccountsResourcePlatformRestrictionsOutboundFlows$unrestricted() => unrestricted != null ? unrestricted() : orElse(value),
      TreasuryFinancialAccountsResourcePlatformRestrictionsOutboundFlows$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
