...
W when<W>({required W Function() adNrt, required W Function() aeTrn, required W Function() alTin, required W Function() amTin, required W Function() aoTin, required W Function() arCuit, required W Function() auAbn, required W Function() auArn, required W Function() awTin, required W Function() azTin, required W Function() baTin, required W Function() bbTin, required W Function() bdBin, required W Function() bfIfu, required W Function() bgUic, required W Function() bhVat, required W Function() bjIfu, required W Function() boTin, required W Function() brCnpj, required W Function() brCpf, required W Function() bsTin, required W Function() byTin, required W Function() caBn, required W Function() caGstHst, required W Function() caPstBc, required W Function() caPstMb, required W Function() caPstSk, required W Function() caQst, required W Function() cdNif, required W Function() chUid, required W Function() chVat, required W Function() clTin, required W Function() cmNiu, required W Function() cnTin, required W Function() coNit, required W Function() crTin, required W Function() cvNif, required W Function() deStn, required W Function() doRcn, required W Function() ecRuc, required W Function() egTin, required W Function() esCif, required W Function() etTin, required W Function() euOssVat, required W Function() euVat, required W Function() gbVat, required W Function() geVat, required W Function() gnNif, required W Function() hkBr, required W Function() hrOib, required W Function() huTin, required W Function() idNpwp, required W Function() ilVat, required W Function() inGst, required W Function() isVat, required W Function() jpCn, required W Function() jpRn, required W Function() jpTrn, required W Function() kePin, required W Function() kgTin, required W Function() khTin, required W Function() krBrn, required W Function() kzBin, required W Function() laTin, required W Function() liUid, required W Function() liVat, required W Function() lkVat, required W Function() maVat, required W Function() mdVat, required W Function() mePib, required W Function() mkVat, required W Function() mrNif, required W Function() mxRfc, required W Function() myFrp, required W Function() myItn, required W Function() mySst, required W Function() ngTin, required W Function() noVat, required W Function() noVoec, required W Function() npPan, required W Function() nzGst, required W Function() omVat, required W Function() peRuc, required W Function() phTin, required W Function() plNip, required W Function() roTin, required W Function() rsPib, required W Function() ruInn, required W Function() ruKpp, required W Function() saVat, required W Function() sgGst, required W Function() sgUen, required W Function() siTin, required W Function() snNinea, required W Function() srFin, required W Function() svNit, required W Function() thVat, required W Function() tjTin, required W Function() trTin, required W Function() twVat, required W Function() tzVat, required W Function() uaVat, required W Function() ugTin, required W Function() unknown, required W Function() usEin, required W Function() uyRuc, required W Function() uzTin, required W Function() uzVat, required W Function() veRif, required W Function() vnTin, required W Function() zaVat, required W Function() zmTin, required W Function() zwTin, required W Function(String value) $unknown, }) { return switch (this) {
      InvoicesResourceInvoiceTaxIdType$adNrt() => adNrt(),
      InvoicesResourceInvoiceTaxIdType$aeTrn() => aeTrn(),
      InvoicesResourceInvoiceTaxIdType$alTin() => alTin(),
      InvoicesResourceInvoiceTaxIdType$amTin() => amTin(),
      InvoicesResourceInvoiceTaxIdType$aoTin() => aoTin(),
      InvoicesResourceInvoiceTaxIdType$arCuit() => arCuit(),
      InvoicesResourceInvoiceTaxIdType$auAbn() => auAbn(),
      InvoicesResourceInvoiceTaxIdType$auArn() => auArn(),
      InvoicesResourceInvoiceTaxIdType$awTin() => awTin(),
      InvoicesResourceInvoiceTaxIdType$azTin() => azTin(),
      InvoicesResourceInvoiceTaxIdType$baTin() => baTin(),
      InvoicesResourceInvoiceTaxIdType$bbTin() => bbTin(),
      InvoicesResourceInvoiceTaxIdType$bdBin() => bdBin(),
      InvoicesResourceInvoiceTaxIdType$bfIfu() => bfIfu(),
      InvoicesResourceInvoiceTaxIdType$bgUic() => bgUic(),
      InvoicesResourceInvoiceTaxIdType$bhVat() => bhVat(),
      InvoicesResourceInvoiceTaxIdType$bjIfu() => bjIfu(),
      InvoicesResourceInvoiceTaxIdType$boTin() => boTin(),
      InvoicesResourceInvoiceTaxIdType$brCnpj() => brCnpj(),
      InvoicesResourceInvoiceTaxIdType$brCpf() => brCpf(),
      InvoicesResourceInvoiceTaxIdType$bsTin() => bsTin(),
      InvoicesResourceInvoiceTaxIdType$byTin() => byTin(),
      InvoicesResourceInvoiceTaxIdType$caBn() => caBn(),
      InvoicesResourceInvoiceTaxIdType$caGstHst() => caGstHst(),
      InvoicesResourceInvoiceTaxIdType$caPstBc() => caPstBc(),
      InvoicesResourceInvoiceTaxIdType$caPstMb() => caPstMb(),
      InvoicesResourceInvoiceTaxIdType$caPstSk() => caPstSk(),
      InvoicesResourceInvoiceTaxIdType$caQst() => caQst(),
      InvoicesResourceInvoiceTaxIdType$cdNif() => cdNif(),
      InvoicesResourceInvoiceTaxIdType$chUid() => chUid(),
      InvoicesResourceInvoiceTaxIdType$chVat() => chVat(),
      InvoicesResourceInvoiceTaxIdType$clTin() => clTin(),
      InvoicesResourceInvoiceTaxIdType$cmNiu() => cmNiu(),
      InvoicesResourceInvoiceTaxIdType$cnTin() => cnTin(),
      InvoicesResourceInvoiceTaxIdType$coNit() => coNit(),
      InvoicesResourceInvoiceTaxIdType$crTin() => crTin(),
      InvoicesResourceInvoiceTaxIdType$cvNif() => cvNif(),
      InvoicesResourceInvoiceTaxIdType$deStn() => deStn(),
      InvoicesResourceInvoiceTaxIdType$doRcn() => doRcn(),
      InvoicesResourceInvoiceTaxIdType$ecRuc() => ecRuc(),
      InvoicesResourceInvoiceTaxIdType$egTin() => egTin(),
      InvoicesResourceInvoiceTaxIdType$esCif() => esCif(),
      InvoicesResourceInvoiceTaxIdType$etTin() => etTin(),
      InvoicesResourceInvoiceTaxIdType$euOssVat() => euOssVat(),
      InvoicesResourceInvoiceTaxIdType$euVat() => euVat(),
      InvoicesResourceInvoiceTaxIdType$gbVat() => gbVat(),
      InvoicesResourceInvoiceTaxIdType$geVat() => geVat(),
      InvoicesResourceInvoiceTaxIdType$gnNif() => gnNif(),
      InvoicesResourceInvoiceTaxIdType$hkBr() => hkBr(),
      InvoicesResourceInvoiceTaxIdType$hrOib() => hrOib(),
      InvoicesResourceInvoiceTaxIdType$huTin() => huTin(),
      InvoicesResourceInvoiceTaxIdType$idNpwp() => idNpwp(),
      InvoicesResourceInvoiceTaxIdType$ilVat() => ilVat(),
      InvoicesResourceInvoiceTaxIdType$inGst() => inGst(),
      InvoicesResourceInvoiceTaxIdType$isVat() => isVat(),
      InvoicesResourceInvoiceTaxIdType$jpCn() => jpCn(),
      InvoicesResourceInvoiceTaxIdType$jpRn() => jpRn(),
      InvoicesResourceInvoiceTaxIdType$jpTrn() => jpTrn(),
      InvoicesResourceInvoiceTaxIdType$kePin() => kePin(),
      InvoicesResourceInvoiceTaxIdType$kgTin() => kgTin(),
      InvoicesResourceInvoiceTaxIdType$khTin() => khTin(),
      InvoicesResourceInvoiceTaxIdType$krBrn() => krBrn(),
      InvoicesResourceInvoiceTaxIdType$kzBin() => kzBin(),
      InvoicesResourceInvoiceTaxIdType$laTin() => laTin(),
      InvoicesResourceInvoiceTaxIdType$liUid() => liUid(),
      InvoicesResourceInvoiceTaxIdType$liVat() => liVat(),
      InvoicesResourceInvoiceTaxIdType$lkVat() => lkVat(),
      InvoicesResourceInvoiceTaxIdType$maVat() => maVat(),
      InvoicesResourceInvoiceTaxIdType$mdVat() => mdVat(),
      InvoicesResourceInvoiceTaxIdType$mePib() => mePib(),
      InvoicesResourceInvoiceTaxIdType$mkVat() => mkVat(),
      InvoicesResourceInvoiceTaxIdType$mrNif() => mrNif(),
      InvoicesResourceInvoiceTaxIdType$mxRfc() => mxRfc(),
      InvoicesResourceInvoiceTaxIdType$myFrp() => myFrp(),
      InvoicesResourceInvoiceTaxIdType$myItn() => myItn(),
      InvoicesResourceInvoiceTaxIdType$mySst() => mySst(),
      InvoicesResourceInvoiceTaxIdType$ngTin() => ngTin(),
      InvoicesResourceInvoiceTaxIdType$noVat() => noVat(),
      InvoicesResourceInvoiceTaxIdType$noVoec() => noVoec(),
      InvoicesResourceInvoiceTaxIdType$npPan() => npPan(),
      InvoicesResourceInvoiceTaxIdType$nzGst() => nzGst(),
      InvoicesResourceInvoiceTaxIdType$omVat() => omVat(),
      InvoicesResourceInvoiceTaxIdType$peRuc() => peRuc(),
      InvoicesResourceInvoiceTaxIdType$phTin() => phTin(),
      InvoicesResourceInvoiceTaxIdType$plNip() => plNip(),
      InvoicesResourceInvoiceTaxIdType$roTin() => roTin(),
      InvoicesResourceInvoiceTaxIdType$rsPib() => rsPib(),
      InvoicesResourceInvoiceTaxIdType$ruInn() => ruInn(),
      InvoicesResourceInvoiceTaxIdType$ruKpp() => ruKpp(),
      InvoicesResourceInvoiceTaxIdType$saVat() => saVat(),
      InvoicesResourceInvoiceTaxIdType$sgGst() => sgGst(),
      InvoicesResourceInvoiceTaxIdType$sgUen() => sgUen(),
      InvoicesResourceInvoiceTaxIdType$siTin() => siTin(),
      InvoicesResourceInvoiceTaxIdType$snNinea() => snNinea(),
      InvoicesResourceInvoiceTaxIdType$srFin() => srFin(),
      InvoicesResourceInvoiceTaxIdType$svNit() => svNit(),
      InvoicesResourceInvoiceTaxIdType$thVat() => thVat(),
      InvoicesResourceInvoiceTaxIdType$tjTin() => tjTin(),
      InvoicesResourceInvoiceTaxIdType$trTin() => trTin(),
      InvoicesResourceInvoiceTaxIdType$twVat() => twVat(),
      InvoicesResourceInvoiceTaxIdType$tzVat() => tzVat(),
      InvoicesResourceInvoiceTaxIdType$uaVat() => uaVat(),
      InvoicesResourceInvoiceTaxIdType$ugTin() => ugTin(),
      InvoicesResourceInvoiceTaxIdType$unknown() => unknown(),
      InvoicesResourceInvoiceTaxIdType$usEin() => usEin(),
      InvoicesResourceInvoiceTaxIdType$uyRuc() => uyRuc(),
      InvoicesResourceInvoiceTaxIdType$uzTin() => uzTin(),
      InvoicesResourceInvoiceTaxIdType$uzVat() => uzVat(),
      InvoicesResourceInvoiceTaxIdType$veRif() => veRif(),
      InvoicesResourceInvoiceTaxIdType$vnTin() => vnTin(),
      InvoicesResourceInvoiceTaxIdType$zaVat() => zaVat(),
      InvoicesResourceInvoiceTaxIdType$zmTin() => zmTin(),
      InvoicesResourceInvoiceTaxIdType$zwTin() => zwTin(),
      InvoicesResourceInvoiceTaxIdType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? adNrt, W Function()? aeTrn, W Function()? alTin, W Function()? amTin, W Function()? aoTin, W Function()? arCuit, W Function()? auAbn, W Function()? auArn, W Function()? awTin, W Function()? azTin, W Function()? baTin, W Function()? bbTin, W Function()? bdBin, W Function()? bfIfu, W Function()? bgUic, W Function()? bhVat, W Function()? bjIfu, W Function()? boTin, W Function()? brCnpj, W Function()? brCpf, W Function()? bsTin, W Function()? byTin, W Function()? caBn, W Function()? caGstHst, W Function()? caPstBc, W Function()? caPstMb, W Function()? caPstSk, W Function()? caQst, W Function()? cdNif, W Function()? chUid, W Function()? chVat, W Function()? clTin, W Function()? cmNiu, W Function()? cnTin, W Function()? coNit, W Function()? crTin, W Function()? cvNif, W Function()? deStn, W Function()? doRcn, W Function()? ecRuc, W Function()? egTin, W Function()? esCif, W Function()? etTin, W Function()? euOssVat, W Function()? euVat, W Function()? gbVat, W Function()? geVat, W Function()? gnNif, W Function()? hkBr, W Function()? hrOib, W Function()? huTin, W Function()? idNpwp, W Function()? ilVat, W Function()? inGst, W Function()? isVat, W Function()? jpCn, W Function()? jpRn, W Function()? jpTrn, W Function()? kePin, W Function()? kgTin, W Function()? khTin, W Function()? krBrn, W Function()? kzBin, W Function()? laTin, W Function()? liUid, W Function()? liVat, W Function()? lkVat, W Function()? maVat, W Function()? mdVat, W Function()? mePib, W Function()? mkVat, W Function()? mrNif, W Function()? mxRfc, W Function()? myFrp, W Function()? myItn, W Function()? mySst, W Function()? ngTin, W Function()? noVat, W Function()? noVoec, W Function()? npPan, W Function()? nzGst, W Function()? omVat, W Function()? peRuc, W Function()? phTin, W Function()? plNip, W Function()? roTin, W Function()? rsPib, W Function()? ruInn, W Function()? ruKpp, W Function()? saVat, W Function()? sgGst, W Function()? sgUen, W Function()? siTin, W Function()? snNinea, W Function()? srFin, W Function()? svNit, W Function()? thVat, W Function()? tjTin, W Function()? trTin, W Function()? twVat, W Function()? tzVat, W Function()? uaVat, W Function()? ugTin, W Function()? unknown, W Function()? usEin, W Function()? uyRuc, W Function()? uzTin, W Function()? uzVat, W Function()? veRif, W Function()? vnTin, W Function()? zaVat, W Function()? zmTin, W Function()? zwTin, W Function(String value)? $unknown, }) { return switch (this) {
      InvoicesResourceInvoiceTaxIdType$adNrt() => adNrt != null ? adNrt() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$aeTrn() => aeTrn != null ? aeTrn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$alTin() => alTin != null ? alTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$amTin() => amTin != null ? amTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$aoTin() => aoTin != null ? aoTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$arCuit() => arCuit != null ? arCuit() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$auAbn() => auAbn != null ? auAbn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$auArn() => auArn != null ? auArn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$awTin() => awTin != null ? awTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$azTin() => azTin != null ? azTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$baTin() => baTin != null ? baTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$bbTin() => bbTin != null ? bbTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$bdBin() => bdBin != null ? bdBin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$bfIfu() => bfIfu != null ? bfIfu() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$bgUic() => bgUic != null ? bgUic() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$bhVat() => bhVat != null ? bhVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$bjIfu() => bjIfu != null ? bjIfu() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$boTin() => boTin != null ? boTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$brCnpj() => brCnpj != null ? brCnpj() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$brCpf() => brCpf != null ? brCpf() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$bsTin() => bsTin != null ? bsTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$byTin() => byTin != null ? byTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$caBn() => caBn != null ? caBn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$caGstHst() => caGstHst != null ? caGstHst() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$caPstBc() => caPstBc != null ? caPstBc() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$caPstMb() => caPstMb != null ? caPstMb() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$caPstSk() => caPstSk != null ? caPstSk() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$caQst() => caQst != null ? caQst() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$cdNif() => cdNif != null ? cdNif() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$chUid() => chUid != null ? chUid() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$chVat() => chVat != null ? chVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$clTin() => clTin != null ? clTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$cmNiu() => cmNiu != null ? cmNiu() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$cnTin() => cnTin != null ? cnTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$coNit() => coNit != null ? coNit() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$crTin() => crTin != null ? crTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$cvNif() => cvNif != null ? cvNif() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$deStn() => deStn != null ? deStn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$doRcn() => doRcn != null ? doRcn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$ecRuc() => ecRuc != null ? ecRuc() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$egTin() => egTin != null ? egTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$esCif() => esCif != null ? esCif() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$etTin() => etTin != null ? etTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$euOssVat() => euOssVat != null ? euOssVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$euVat() => euVat != null ? euVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$gbVat() => gbVat != null ? gbVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$geVat() => geVat != null ? geVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$gnNif() => gnNif != null ? gnNif() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$hkBr() => hkBr != null ? hkBr() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$hrOib() => hrOib != null ? hrOib() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$huTin() => huTin != null ? huTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$idNpwp() => idNpwp != null ? idNpwp() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$ilVat() => ilVat != null ? ilVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$inGst() => inGst != null ? inGst() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$isVat() => isVat != null ? isVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$jpCn() => jpCn != null ? jpCn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$jpRn() => jpRn != null ? jpRn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$jpTrn() => jpTrn != null ? jpTrn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$kePin() => kePin != null ? kePin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$kgTin() => kgTin != null ? kgTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$khTin() => khTin != null ? khTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$krBrn() => krBrn != null ? krBrn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$kzBin() => kzBin != null ? kzBin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$laTin() => laTin != null ? laTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$liUid() => liUid != null ? liUid() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$liVat() => liVat != null ? liVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$lkVat() => lkVat != null ? lkVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$maVat() => maVat != null ? maVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$mdVat() => mdVat != null ? mdVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$mePib() => mePib != null ? mePib() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$mkVat() => mkVat != null ? mkVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$mrNif() => mrNif != null ? mrNif() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$mxRfc() => mxRfc != null ? mxRfc() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$myFrp() => myFrp != null ? myFrp() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$myItn() => myItn != null ? myItn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$mySst() => mySst != null ? mySst() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$ngTin() => ngTin != null ? ngTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$noVat() => noVat != null ? noVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$noVoec() => noVoec != null ? noVoec() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$npPan() => npPan != null ? npPan() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$nzGst() => nzGst != null ? nzGst() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$omVat() => omVat != null ? omVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$peRuc() => peRuc != null ? peRuc() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$phTin() => phTin != null ? phTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$plNip() => plNip != null ? plNip() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$roTin() => roTin != null ? roTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$rsPib() => rsPib != null ? rsPib() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$ruInn() => ruInn != null ? ruInn() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$ruKpp() => ruKpp != null ? ruKpp() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$saVat() => saVat != null ? saVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$sgGst() => sgGst != null ? sgGst() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$sgUen() => sgUen != null ? sgUen() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$siTin() => siTin != null ? siTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$snNinea() => snNinea != null ? snNinea() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$srFin() => srFin != null ? srFin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$svNit() => svNit != null ? svNit() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$thVat() => thVat != null ? thVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$tjTin() => tjTin != null ? tjTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$trTin() => trTin != null ? trTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$twVat() => twVat != null ? twVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$tzVat() => tzVat != null ? tzVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$uaVat() => uaVat != null ? uaVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$ugTin() => ugTin != null ? ugTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$unknown() => unknown != null ? unknown() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$usEin() => usEin != null ? usEin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$uyRuc() => uyRuc != null ? uyRuc() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$uzTin() => uzTin != null ? uzTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$uzVat() => uzVat != null ? uzVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$veRif() => veRif != null ? veRif() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$vnTin() => vnTin != null ? vnTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$zaVat() => zaVat != null ? zaVat() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$zmTin() => zmTin != null ? zmTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$zwTin() => zwTin != null ? zwTin() : orElse(value),
      InvoicesResourceInvoiceTaxIdType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
