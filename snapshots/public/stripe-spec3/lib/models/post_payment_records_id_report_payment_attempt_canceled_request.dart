...
// Source: #/components/schemas/PostPaymentRecordsIdReportPaymentAttemptCanceledRequest
...
@override int get hashCode => Object.hash(canceledAt, Object.hashAll(expand ?? const []), metadata);

@override String toString() => 'PostPaymentRecordsIdReportPaymentAttemptCanceledRequest(canceledAt: $canceledAt, expand: $expand, metadata: $metadata)';
