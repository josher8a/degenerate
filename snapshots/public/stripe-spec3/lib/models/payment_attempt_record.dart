...
W when<W>({required W Function() paymentAttemptRecord, required W Function(String value) $unknown, }) { return switch (this) {
      PaymentAttemptRecordObject$paymentAttemptRecord() => paymentAttemptRecord(),
      PaymentAttemptRecordObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? paymentAttemptRecord, W Function(String value)? $unknown, }) { return switch (this) {
      PaymentAttemptRecordObject$paymentAttemptRecord() => paymentAttemptRecord != null ? paymentAttemptRecord() : orElse(value),
      PaymentAttemptRecordObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('amount') &&
      ...
      json.containsKey('object') && json['object'] == 'payment_attempt_record' &&
...
if (paymentRecord$ != null) {
  if (paymentRecord$.runes.length > 5000) { errors.add('paymentRecord: length must be <= 5000'); }
}
return errors; } 
