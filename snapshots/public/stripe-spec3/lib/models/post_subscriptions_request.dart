...
// Source: #/components/schemas/PostSubscriptionsRequest
...
if (description$ != null) {
  if (description$.runes.length > 500) { errors.add('description: length must be <= 500'); }
}
return errors; } 
