...
return errors; } 
GetSourcesSourceSourceTransactionsResponse copyWith({List<SourceTransaction>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetSourcesSourceSourceTransactionsResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetSourcesSourceSourceTransactionsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
