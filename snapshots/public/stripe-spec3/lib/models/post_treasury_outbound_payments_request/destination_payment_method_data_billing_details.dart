...
factory DestinationPaymentMethodDataBillingDetails.fromJson(Map<String, dynamic> json) { return DestinationPaymentMethodDataBillingDetails(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => BillingDetailsAddress.fromJson(v as Map<String, dynamic>),) : null,
