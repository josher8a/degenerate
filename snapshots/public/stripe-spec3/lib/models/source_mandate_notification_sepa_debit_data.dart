...
// Source: #/components/schemas/SourceMandateNotificationSepaDebitData
...
if (creditorIdentifier$ != null) {
  if (creditorIdentifier$.runes.length > 5000) { errors.add('creditorIdentifier: length must be <= 5000'); }
}
final last4$ = last4;
if (last4$ != null) {
...
if (mandateReference$ != null) {
  if (mandateReference$.runes.length > 5000) { errors.add('mandateReference: length must be <= 5000'); }
}
return errors; } 
