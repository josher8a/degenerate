...
return errors; } 
GetTreasuryDebitReversalsResponse copyWith({List<TreasuryDebitReversal>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetTreasuryDebitReversalsResponse(
  data: data ?? this.data,
...
@override String toString() => 'GetTreasuryDebitReversalsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
