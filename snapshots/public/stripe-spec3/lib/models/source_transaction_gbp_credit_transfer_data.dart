...
if (fundingMethod$ != null) {
  if (fundingMethod$.runes.length > 5000) { errors.add('fundingMethod: length must be <= 5000'); }
}
final last4$ = last4;
if (last4$ != null) {
...
if (senderAccountNumber$ != null) {
  if (senderAccountNumber$.runes.length > 5000) { errors.add('senderAccountNumber: length must be <= 5000'); }
}
...
if (senderSortCode$ != null) {
  if (senderSortCode$.runes.length > 5000) { errors.add('senderSortCode: length must be <= 5000'); }
}
return errors; } 
