...
if (accountId$ != null) {
  if (accountId$.runes.length > 5000) { errors.add('accountId: length must be <= 5000'); }
}
...
if (hashedAccountEmailAddress$ != null) {
  if (hashedAccountEmailAddress$.runes.length > 5000) { errors.add('hashedAccountEmailAddress: length must be <= 5000'); }
}
final suggestedDecisionVersion$ = suggestedDecisionVersion;
if (suggestedDecisionVersion$ != null) {
  if (suggestedDecisionVersion$.runes.length > 5000) { errors.add('suggestedDecisionVersion: length must be <= 5000'); }
}
return errors; } 
