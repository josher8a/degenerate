...
// Source: #/components/schemas/PostSetupIntentsIntentConfirmRequest (inline: PaymentMethodOptions > Paypal)
...
if (billingAgreementId$ != null) {
  if (billingAgreementId$.runes.length > 5000) { errors.add('billingAgreementId: length must be <= 5000'); }
}
return errors; } 
