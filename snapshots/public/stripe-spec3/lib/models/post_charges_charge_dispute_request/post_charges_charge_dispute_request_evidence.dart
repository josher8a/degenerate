...
// Source: #/components/schemas/PostChargesChargeDisputeRequest (inline: Evidence)
...
if (accessActivityLog$ != null) {
  if (accessActivityLog$.runes.length > 20000) { errors.add('accessActivityLog: length must be <= 20000'); }
}
...
if (cancellationPolicyDisclosure$ != null) {
  if (cancellationPolicyDisclosure$.runes.length > 20000) { errors.add('cancellationPolicyDisclosure: length must be <= 20000'); }
}
final cancellationRebuttal$ = cancellationRebuttal;
if (cancellationRebuttal$ != null) {
  if (cancellationRebuttal$.runes.length > 20000) { errors.add('cancellationRebuttal: length must be <= 20000'); }
}
...
if (duplicateChargeExplanation$ != null) {
  if (duplicateChargeExplanation$.runes.length > 20000) { errors.add('duplicateChargeExplanation: length must be <= 20000'); }
}
...
if (productDescription$ != null) {
  if (productDescription$.runes.length > 20000) { errors.add('productDescription: length must be <= 20000'); }
}
final refundPolicyDisclosure$ = refundPolicyDisclosure;
if (refundPolicyDisclosure$ != null) {
  if (refundPolicyDisclosure$.runes.length > 20000) { errors.add('refundPolicyDisclosure: length must be <= 20000'); }
}
final refundRefusalExplanation$ = refundRefusalExplanation;
if (refundRefusalExplanation$ != null) {
  if (refundRefusalExplanation$.runes.length > 20000) { errors.add('refundRefusalExplanation: length must be <= 20000'); }
}
...
if (uncategorizedText$ != null) {
  if (uncategorizedText$.runes.length > 20000) { errors.add('uncategorizedText: length must be <= 20000'); }
}
return errors; } 
