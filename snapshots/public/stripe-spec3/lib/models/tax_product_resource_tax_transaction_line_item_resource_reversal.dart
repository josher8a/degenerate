...
// Source: #/components/schemas/TaxProductResourceTaxTransactionLineItemResourceReversal
...
if (originalLineItem.runes.length > 5000) { errors.add('originalLineItem: length must be <= 5000'); }
return errors; } 
