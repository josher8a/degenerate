...
@override String toString() => 'Refund(amount: $amount, balanceTransaction: $balanceTransaction, charge: $charge, created: $created, currency: $currency, description: $description, destinationDetails: $destinationDetails, failureBalanceTransaction: $failureBalanceTransaction, failureReason: $failureReason, id: $id, instructionsEmail: $instructionsEmail, metadata: $metadata, nextAction: $nextAction, object: $object, paymentIntent: $paymentIntent, pendingReason: $pendingReason, presentmentDetails: $presentmentDetails, reason: $reason, receiptNumber: $receiptNumber, sourceTransferReversal: $sourceTransferReversal, status: $status, transferReversal: $transferReversal)';
