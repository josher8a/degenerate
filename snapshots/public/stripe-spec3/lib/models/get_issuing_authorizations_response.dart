...
// Source: #/components/schemas/GetIssuingAuthorizationsResponse
...
if (!RegExp('^/v1/issuing/authorizations').hasMatch(url)) { errors.add('url: must match pattern ^/v1/issuing/authorizations'); }
return errors; } 
...
@override String toString() => 'GetIssuingAuthorizationsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
