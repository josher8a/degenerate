...
factory PostCheckoutSessionsRequestInvoiceCreationInvoiceData.fromJson(Map<String, dynamic> json) { return PostCheckoutSessionsRequestInvoiceCreationInvoiceData(
  ...
  renderingOptions: json['rendering_options'] != null ? OneOf2.parse(json['rendering_options'], fromA: (v) => checkout_rendering_options_param.fromJson(v as Map<String, dynamic>), fromB: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String),) : null,
); }
...
PostCheckoutSessionsRequestInvoiceCreationInvoiceData copyWith({PostInvoicesInvoiceRequestAccountTaxIds Function()? accountTaxIds, PostInvoicesInvoiceRequestCustomFields Function()? customFields, String Function()? description, String Function()? footer, Issuer Function()? issuer, Map<String, String> Function()? metadata, RenderingOptions Function()? renderingOptions, }) { return PostCheckoutSessionsRequestInvoiceCreationInvoiceData(
