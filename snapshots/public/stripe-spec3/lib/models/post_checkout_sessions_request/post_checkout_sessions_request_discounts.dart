...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: Discounts)
...
final coupon$ = coupon;
if (coupon$ != null) {
  if (coupon$.runes.length > 5000) { errors.add('coupon: length must be <= 5000'); }
}
final promotionCode$ = promotionCode;
if (promotionCode$ != null) {
  if (promotionCode$.runes.length > 5000) { errors.add('promotionCode: length must be <= 5000'); }
}
return errors; } 
