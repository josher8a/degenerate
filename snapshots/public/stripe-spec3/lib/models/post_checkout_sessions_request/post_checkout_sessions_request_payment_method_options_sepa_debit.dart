...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentMethodOptions > SepaDebit)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/checkout_acss_debit_payment_method_options/checkout_acss_debit_payment_method_options_setup_future_usage.dart';import 'package:pub_stripe_spec3/models/payment_intent_payment_method_options_param/payment_intent_payment_method_options_param12_mandate_options.dart';@immutable final class PostCheckoutSessionsRequestPaymentMethodOptionsSepaDebit {const PostCheckoutSessionsRequestPaymentMethodOptionsSepaDebit({this.mandateOptions, this.setupFutureUsage, this.targetDate, });
...
@override String toString() => 'PostCheckoutSessionsRequestPaymentMethodOptionsSepaDebit(mandateOptions: $mandateOptions, setupFutureUsage: $setupFutureUsage, targetDate: $targetDate)';
