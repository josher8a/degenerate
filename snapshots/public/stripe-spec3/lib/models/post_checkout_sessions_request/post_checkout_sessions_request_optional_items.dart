...
return errors; } 
PostCheckoutSessionsRequestOptionalItems copyWith({AdjustableQuantity? Function()? adjustableQuantity, String? price, int? quantity, }) { return PostCheckoutSessionsRequestOptionalItems(
...
@override String toString() => 'PostCheckoutSessionsRequestOptionalItems(adjustableQuantity: $adjustableQuantity, price: $price, quantity: $quantity)';
