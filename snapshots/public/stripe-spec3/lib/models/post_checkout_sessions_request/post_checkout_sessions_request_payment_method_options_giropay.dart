...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentMethodOptions > Giropay)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/checkout_affirm_payment_method_options/checkout_affirm_payment_method_options_setup_future_usage.dart';@immutable final class PostCheckoutSessionsRequestPaymentMethodOptionsGiropay {const PostCheckoutSessionsRequestPaymentMethodOptionsGiropay({this.setupFutureUsage});
...
PostCheckoutSessionsRequestPaymentMethodOptionsGiropay copyWith({CheckoutAffirmPaymentMethodOptionsSetupFutureUsage? Function()? setupFutureUsage}) { return PostCheckoutSessionsRequestPaymentMethodOptionsGiropay(
...
@override String toString() => 'PostCheckoutSessionsRequestPaymentMethodOptionsGiropay(setupFutureUsage: $setupFutureUsage)';
