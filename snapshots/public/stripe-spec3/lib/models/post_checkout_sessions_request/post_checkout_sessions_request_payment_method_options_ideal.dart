...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentMethodOptions > Ideal)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/checkout_affirm_payment_method_options/checkout_affirm_payment_method_options_setup_future_usage.dart';@immutable final class PostCheckoutSessionsRequestPaymentMethodOptionsIdeal {const PostCheckoutSessionsRequestPaymentMethodOptionsIdeal({this.setupFutureUsage});
...
PostCheckoutSessionsRequestPaymentMethodOptionsIdeal copyWith({CheckoutAffirmPaymentMethodOptionsSetupFutureUsage? Function()? setupFutureUsage}) { return PostCheckoutSessionsRequestPaymentMethodOptionsIdeal(
...
@override String toString() => 'PostCheckoutSessionsRequestPaymentMethodOptionsIdeal(setupFutureUsage: $setupFutureUsage)';
