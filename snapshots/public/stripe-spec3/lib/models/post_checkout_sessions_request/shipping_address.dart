...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentIntentData > Shipping > Address)
...
@override String toString() => 'ShippingAddress(city: $city, country: $country, line1: $line1, line2: $line2, postalCode: $postalCode, state: $state)';
