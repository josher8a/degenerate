...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentMethodOptions > AcssDebit > MandateOptions)
...
if (intervalDescription$ != null) {
  if (intervalDescription$.runes.length > 500) { errors.add('intervalDescription: length must be <= 500'); }
}
return errors; } 
