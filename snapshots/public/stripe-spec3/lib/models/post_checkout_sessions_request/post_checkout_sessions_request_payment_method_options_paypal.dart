...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentMethodOptions > Paypal)
...
if (reference$ != null) {
  if (reference$.runes.length > 127) { errors.add('reference: length must be <= 127'); }
}
final riskCorrelationId$ = riskCorrelationId;
if (riskCorrelationId$ != null) {
  if (riskCorrelationId$.runes.length > 32) { errors.add('riskCorrelationId: length must be <= 32'); }
}
return errors; } 
...
@override String toString() => 'PostCheckoutSessionsRequestPaymentMethodOptionsPaypal(captureMethod: $captureMethod, preferredLocale: $preferredLocale, reference: $reference, riskCorrelationId: $riskCorrelationId, setupFutureUsage: $setupFutureUsage)';
