...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: CustomFields > Numeric)
...
if (defaultValue$ != null) {
  if (defaultValue$.runes.length > 255) { errors.add('defaultValue: length must be <= 255'); }
}
return errors; } 
...
@override String toString() => 'Numeric(defaultValue: $defaultValue, maximumLength: $maximumLength, minimumLength: $minimumLength)';
