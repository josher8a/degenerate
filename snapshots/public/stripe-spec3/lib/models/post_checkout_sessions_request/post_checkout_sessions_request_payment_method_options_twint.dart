...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentMethodOptions > Twint)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/checkout_affirm_payment_method_options/checkout_affirm_payment_method_options_setup_future_usage.dart';@immutable final class PostCheckoutSessionsRequestPaymentMethodOptionsTwint {const PostCheckoutSessionsRequestPaymentMethodOptionsTwint({this.setupFutureUsage});
...
PostCheckoutSessionsRequestPaymentMethodOptionsTwint copyWith({CheckoutAffirmPaymentMethodOptionsSetupFutureUsage? Function()? setupFutureUsage}) { return PostCheckoutSessionsRequestPaymentMethodOptionsTwint(
...
@override String toString() => 'PostCheckoutSessionsRequestPaymentMethodOptionsTwint(setupFutureUsage: $setupFutureUsage)';
