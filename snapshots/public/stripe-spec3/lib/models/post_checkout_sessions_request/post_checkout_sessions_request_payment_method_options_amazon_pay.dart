...
// Source: #/components/schemas/PostCheckoutSessionsRequest (inline: PaymentMethodOptions > AmazonPay)

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/checkout_affirm_payment_method_options/checkout_affirm_payment_method_options_capture_method.dart';import 'package:pub_stripe_spec3/models/checkout_amazon_pay_payment_method_options/checkout_amazon_pay_payment_method_options_setup_future_usage.dart';@immutable final class PostCheckoutSessionsRequestPaymentMethodOptionsAmazonPay {const PostCheckoutSessionsRequestPaymentMethodOptionsAmazonPay({this.captureMethod, this.setupFutureUsage, });
...
PostCheckoutSessionsRequestPaymentMethodOptionsAmazonPay copyWith({CheckoutAffirmPaymentMethodOptionsCaptureMethod? Function()? captureMethod, CheckoutAmazonPayPaymentMethodOptionsSetupFutureUsage? Function()? setupFutureUsage, }) { return PostCheckoutSessionsRequestPaymentMethodOptionsAmazonPay(
...
@override String toString() => 'PostCheckoutSessionsRequestPaymentMethodOptionsAmazonPay(captureMethod: $captureMethod, setupFutureUsage: $setupFutureUsage)';
