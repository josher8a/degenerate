...
if (appId.runes.length > 5000) { errors.add('appId: length must be <= 5000'); }
if (nonceStr.runes.length > 5000) { errors.add('nonceStr: length must be <= 5000'); }
if (package.runes.length > 5000) { errors.add('package: length must be <= 5000'); }
if (partnerId.runes.length > 5000) { errors.add('partnerId: length must be <= 5000'); }
if (prepayId.runes.length > 5000) { errors.add('prepayId: length must be <= 5000'); }
if (sign.runes.length > 5000) { errors.add('sign: length must be <= 5000'); }
if (timestamp.runes.length > 5000) { errors.add('timestamp: length must be <= 5000'); }
return errors; } 
