...
return errors; } 
InvoiceLines copyWith({List<LineItem>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return InvoiceLines(
  data: data ?? this.data,
...
@override String toString() => 'InvoiceLines(data: $data, hasMore: $hasMore, object: $object, url: $url)';
