...
// Source: #/components/schemas/GetTaxRatesResponse
...
if (!RegExp('^/v1/tax_rates').hasMatch(url)) { errors.add('url: must match pattern ^/v1/tax_rates'); }
return errors; } 
...
@override String toString() => 'GetTaxRatesResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
