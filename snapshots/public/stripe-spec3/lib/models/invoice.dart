...
factory Invoice.fromJson(Map<String, dynamic> json) { return Invoice(
  ...
  discounts: (json['discounts'] as List<dynamic>).map((e) => OneOf3.parse(e, fromA: (v) => v as String, fromB: (v) => DeletedDiscount.fromJson(v as Map<String, dynamic>), fromC: (v) => Discount.fromJson(v as Map<String, dynamic>),)).toList(),
