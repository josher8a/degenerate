...
W when<W>({required W Function() auto, required W Function() bg, required W Function() cs, required W Function() da, required W Function() de, required W Function() el, required W Function() en, required W Function() enAu, required W Function() enCa, required W Function() enGb, required W Function() enIe, required W Function() enIn, required W Function() enNz, required W Function() enSg, required W Function() es, required W Function() es419, required W Function() et, required W Function() fi, required W Function() fil, required W Function() fr, required W Function() frCa, required W Function() hr, required W Function() hu, required W Function() id, required W Function() it, required W Function() ja, required W Function() ko, required W Function() lt, required W Function() lv, required W Function() ms, required W Function() mt, required W Function() nb, required W Function() nl, required W Function() pl, required W Function() pt, required W Function() ptBr, required W Function() ro, required W Function() ru, required W Function() sk, required W Function() sl, required W Function() sv, required W Function() th, required W Function() tr, required W Function() vi, required W Function() zh, required W Function() zhHk, required W Function() zhTw, required W Function(String value) $unknown, }) { return switch (this) {
      PostBillingPortalSessionsRequestLocale$auto() => auto(),
      PostBillingPortalSessionsRequestLocale$bg() => bg(),
      PostBillingPortalSessionsRequestLocale$cs() => cs(),
      PostBillingPortalSessionsRequestLocale$da() => da(),
      PostBillingPortalSessionsRequestLocale$de() => de(),
      PostBillingPortalSessionsRequestLocale$el() => el(),
      PostBillingPortalSessionsRequestLocale$en() => en(),
      PostBillingPortalSessionsRequestLocale$enAu() => enAu(),
      PostBillingPortalSessionsRequestLocale$enCa() => enCa(),
      PostBillingPortalSessionsRequestLocale$enGb() => enGb(),
      PostBillingPortalSessionsRequestLocale$enIe() => enIe(),
      PostBillingPortalSessionsRequestLocale$enIn() => enIn(),
      PostBillingPortalSessionsRequestLocale$enNz() => enNz(),
      PostBillingPortalSessionsRequestLocale$enSg() => enSg(),
      PostBillingPortalSessionsRequestLocale$es() => es(),
      PostBillingPortalSessionsRequestLocale$es419() => es419(),
      PostBillingPortalSessionsRequestLocale$et() => et(),
      PostBillingPortalSessionsRequestLocale$fi() => fi(),
      PostBillingPortalSessionsRequestLocale$fil() => fil(),
      PostBillingPortalSessionsRequestLocale$fr() => fr(),
      PostBillingPortalSessionsRequestLocale$frCa() => frCa(),
      PostBillingPortalSessionsRequestLocale$hr() => hr(),
      PostBillingPortalSessionsRequestLocale$hu() => hu(),
      PostBillingPortalSessionsRequestLocale$id() => id(),
      PostBillingPortalSessionsRequestLocale$it() => it(),
      PostBillingPortalSessionsRequestLocale$ja() => ja(),
      PostBillingPortalSessionsRequestLocale$ko() => ko(),
      PostBillingPortalSessionsRequestLocale$lt() => lt(),
      PostBillingPortalSessionsRequestLocale$lv() => lv(),
      PostBillingPortalSessionsRequestLocale$ms() => ms(),
      PostBillingPortalSessionsRequestLocale$mt() => mt(),
      PostBillingPortalSessionsRequestLocale$nb() => nb(),
      PostBillingPortalSessionsRequestLocale$nl() => nl(),
      PostBillingPortalSessionsRequestLocale$pl() => pl(),
      PostBillingPortalSessionsRequestLocale$pt() => pt(),
      PostBillingPortalSessionsRequestLocale$ptBr() => ptBr(),
      PostBillingPortalSessionsRequestLocale$ro() => ro(),
      PostBillingPortalSessionsRequestLocale$ru() => ru(),
      PostBillingPortalSessionsRequestLocale$sk() => sk(),
      PostBillingPortalSessionsRequestLocale$sl() => sl(),
      PostBillingPortalSessionsRequestLocale$sv() => sv(),
      PostBillingPortalSessionsRequestLocale$th() => th(),
      PostBillingPortalSessionsRequestLocale$tr() => tr(),
      PostBillingPortalSessionsRequestLocale$vi() => vi(),
      PostBillingPortalSessionsRequestLocale$zh() => zh(),
      PostBillingPortalSessionsRequestLocale$zhHk() => zhHk(),
      PostBillingPortalSessionsRequestLocale$zhTw() => zhTw(),
      PostBillingPortalSessionsRequestLocale$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? auto, W Function()? bg, W Function()? cs, W Function()? da, W Function()? de, W Function()? el, W Function()? en, W Function()? enAu, W Function()? enCa, W Function()? enGb, W Function()? enIe, W Function()? enIn, W Function()? enNz, W Function()? enSg, W Function()? es, W Function()? es419, W Function()? et, W Function()? fi, W Function()? fil, W Function()? fr, W Function()? frCa, W Function()? hr, W Function()? hu, W Function()? id, W Function()? it, W Function()? ja, W Function()? ko, W Function()? lt, W Function()? lv, W Function()? ms, W Function()? mt, W Function()? nb, W Function()? nl, W Function()? pl, W Function()? pt, W Function()? ptBr, W Function()? ro, W Function()? ru, W Function()? sk, W Function()? sl, W Function()? sv, W Function()? th, W Function()? tr, W Function()? vi, W Function()? zh, W Function()? zhHk, W Function()? zhTw, W Function(String value)? $unknown, }) { return switch (this) {
      PostBillingPortalSessionsRequestLocale$auto() => auto != null ? auto() : orElse(value),
      PostBillingPortalSessionsRequestLocale$bg() => bg != null ? bg() : orElse(value),
      PostBillingPortalSessionsRequestLocale$cs() => cs != null ? cs() : orElse(value),
      PostBillingPortalSessionsRequestLocale$da() => da != null ? da() : orElse(value),
      PostBillingPortalSessionsRequestLocale$de() => de != null ? de() : orElse(value),
      PostBillingPortalSessionsRequestLocale$el() => el != null ? el() : orElse(value),
      PostBillingPortalSessionsRequestLocale$en() => en != null ? en() : orElse(value),
      PostBillingPortalSessionsRequestLocale$enAu() => enAu != null ? enAu() : orElse(value),
      PostBillingPortalSessionsRequestLocale$enCa() => enCa != null ? enCa() : orElse(value),
      PostBillingPortalSessionsRequestLocale$enGb() => enGb != null ? enGb() : orElse(value),
      PostBillingPortalSessionsRequestLocale$enIe() => enIe != null ? enIe() : orElse(value),
      PostBillingPortalSessionsRequestLocale$enIn() => enIn != null ? enIn() : orElse(value),
      PostBillingPortalSessionsRequestLocale$enNz() => enNz != null ? enNz() : orElse(value),
      PostBillingPortalSessionsRequestLocale$enSg() => enSg != null ? enSg() : orElse(value),
      PostBillingPortalSessionsRequestLocale$es() => es != null ? es() : orElse(value),
      PostBillingPortalSessionsRequestLocale$es419() => es419 != null ? es419() : orElse(value),
      PostBillingPortalSessionsRequestLocale$et() => et != null ? et() : orElse(value),
      PostBillingPortalSessionsRequestLocale$fi() => fi != null ? fi() : orElse(value),
      PostBillingPortalSessionsRequestLocale$fil() => fil != null ? fil() : orElse(value),
      PostBillingPortalSessionsRequestLocale$fr() => fr != null ? fr() : orElse(value),
      PostBillingPortalSessionsRequestLocale$frCa() => frCa != null ? frCa() : orElse(value),
      PostBillingPortalSessionsRequestLocale$hr() => hr != null ? hr() : orElse(value),
      PostBillingPortalSessionsRequestLocale$hu() => hu != null ? hu() : orElse(value),
      PostBillingPortalSessionsRequestLocale$id() => id != null ? id() : orElse(value),
      PostBillingPortalSessionsRequestLocale$it() => it != null ? it() : orElse(value),
      PostBillingPortalSessionsRequestLocale$ja() => ja != null ? ja() : orElse(value),
      PostBillingPortalSessionsRequestLocale$ko() => ko != null ? ko() : orElse(value),
      PostBillingPortalSessionsRequestLocale$lt() => lt != null ? lt() : orElse(value),
      PostBillingPortalSessionsRequestLocale$lv() => lv != null ? lv() : orElse(value),
      PostBillingPortalSessionsRequestLocale$ms() => ms != null ? ms() : orElse(value),
      PostBillingPortalSessionsRequestLocale$mt() => mt != null ? mt() : orElse(value),
      PostBillingPortalSessionsRequestLocale$nb() => nb != null ? nb() : orElse(value),
      PostBillingPortalSessionsRequestLocale$nl() => nl != null ? nl() : orElse(value),
      PostBillingPortalSessionsRequestLocale$pl() => pl != null ? pl() : orElse(value),
      PostBillingPortalSessionsRequestLocale$pt() => pt != null ? pt() : orElse(value),
      PostBillingPortalSessionsRequestLocale$ptBr() => ptBr != null ? ptBr() : orElse(value),
      PostBillingPortalSessionsRequestLocale$ro() => ro != null ? ro() : orElse(value),
      PostBillingPortalSessionsRequestLocale$ru() => ru != null ? ru() : orElse(value),
      PostBillingPortalSessionsRequestLocale$sk() => sk != null ? sk() : orElse(value),
      PostBillingPortalSessionsRequestLocale$sl() => sl != null ? sl() : orElse(value),
      PostBillingPortalSessionsRequestLocale$sv() => sv != null ? sv() : orElse(value),
      PostBillingPortalSessionsRequestLocale$th() => th != null ? th() : orElse(value),
      PostBillingPortalSessionsRequestLocale$tr() => tr != null ? tr() : orElse(value),
      PostBillingPortalSessionsRequestLocale$vi() => vi != null ? vi() : orElse(value),
      PostBillingPortalSessionsRequestLocale$zh() => zh != null ? zh() : orElse(value),
      PostBillingPortalSessionsRequestLocale$zhHk() => zhHk != null ? zhHk() : orElse(value),
      PostBillingPortalSessionsRequestLocale$zhTw() => zhTw != null ? zhTw() : orElse(value),
      PostBillingPortalSessionsRequestLocale$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
if (configuration$ != null) {
  if (configuration$.runes.length > 5000) { errors.add('configuration: length must be <= 5000'); }
}
...
if (customerAccount$ != null) {
  if (customerAccount$.runes.length > 5000) { errors.add('customerAccount: length must be <= 5000'); }
}
return errors; } 
