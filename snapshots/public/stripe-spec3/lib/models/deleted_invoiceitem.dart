...
// Source: #/components/schemas/DeletedInvoiceitem
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('deleted') && json['deleted'] is bool &&
      ...
      json.containsKey('object') && json['object'] == 'invoiceitem'; } 
...
@override String toString() => 'DeletedInvoiceitem(deleted: $deleted, id: $id, object: $object)';
