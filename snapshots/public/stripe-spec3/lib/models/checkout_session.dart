...
if (cancelUrl$ != null) {
  if (cancelUrl$.runes.length > 5000) { errors.add('cancelUrl: length must be <= 5000'); }
}
...
if (recoveredFrom$ != null) {
  if (recoveredFrom$.runes.length > 5000) { errors.add('recoveredFrom: length must be <= 5000'); }
}
...
if (successUrl$ != null) {
  if (successUrl$.runes.length > 5000) { errors.add('successUrl: length must be <= 5000'); }
}
final url$ = url;
if (url$ != null) {
