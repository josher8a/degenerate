...
// Source: #/components/schemas/GetSubscriptionsResponse
...
if (!RegExp('^/v1/subscriptions').hasMatch(url)) { errors.add('url: must match pattern ^/v1/subscriptions'); }
return errors; } 
GetSubscriptionsResponse copyWith({List<Subscription>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetSubscriptionsResponse(
  data: data ?? this.data,
