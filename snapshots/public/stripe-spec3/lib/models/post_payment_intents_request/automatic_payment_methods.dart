...
// Source: #/components/schemas/PostPaymentIntentsRequest (inline: AutomaticPaymentMethods)
...
@override String toString() => 'AutomaticPaymentMethods(allowRedirects: $allowRedirects, enabled: $enabled)';
