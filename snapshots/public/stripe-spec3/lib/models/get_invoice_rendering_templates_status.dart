...
W when<W>({required W Function() active, required W Function() archived, required W Function(String value) $unknown, }) { return switch (this) {
      GetInvoiceRenderingTemplatesStatus$active() => active(),
      GetInvoiceRenderingTemplatesStatus$archived() => archived(),
      GetInvoiceRenderingTemplatesStatus$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? active, W Function()? archived, W Function(String value)? $unknown, }) { return switch (this) {
      GetInvoiceRenderingTemplatesStatus$active() => active != null ? active() : orElse(value),
      GetInvoiceRenderingTemplatesStatus$archived() => archived != null ? archived() : orElse(value),
      GetInvoiceRenderingTemplatesStatus$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
