...
factory PostPaymentLinksPaymentLinkRequest.fromJson(Map<String, dynamic> json) { return PostPaymentLinksPaymentLinkRequest(
  ...
  customFields: json['custom_fields'] != null ? OneOf2.parse(json['custom_fields'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => (v as List<dynamic>).map((e) => PostPaymentLinksPaymentLinkRequestCustomFieldsVariant1.fromJson(e as Map<String, dynamic>)).toList(),) : null,
  ...
  nameCollection: json['name_collection'] != null ? OneOf2.parse(json['name_collection'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => NameCollectionParams.fromJson(v as Map<String, dynamic>),) : null,
  optionalItems: json['optional_items'] != null ? OneOf2.parse(json['optional_items'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => (v as List<dynamic>).map((e) => OptionalItemsVariant1.fromJson(e as Map<String, dynamic>)).toList(),) : null,
  ...
  restrictions: json['restrictions'] != null ? OneOf2.parse(json['restrictions'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => RestrictionsParams.fromJson(v as Map<String, dynamic>),) : null,
  shippingAddressCollection: json['shipping_address_collection'] != null ? OneOf2.parse(json['shipping_address_collection'], fromA: (v) => GetPaymentMethodConfigurationsApplicationVariant2.fromJson(v as String), fromB: (v) => ShippingAddressCollectionParams.fromJson(v as Map<String, dynamic>),) : null,
