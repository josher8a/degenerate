...
// Source: #/components/schemas/GetPaymentAttemptRecordsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_stripe_spec3/models/get_accounts_account_capabilities_response/get_accounts_account_capabilities_response_object.dart';import 'package:pub_stripe_spec3/models/payment_attempt_record.dart';/// A list of PaymentAttemptRecords.
...
return errors; } 
GetPaymentAttemptRecordsResponse copyWith({List<PaymentAttemptRecord>? data, bool? hasMore, GetAccountsAccountCapabilitiesResponseObject? object, String? url, }) { return GetPaymentAttemptRecordsResponse(
  data: data ?? this.data,
