...
W when<W>({required W Function() acssDebit, required W Function() affirm, required W Function() afterpayClearpay, required W Function() alipay, required W Function() alma, required W Function() amazonPay, required W Function() auBecsDebit, required W Function() bacsDebit, required W Function() bancontact, required W Function() billie, required W Function() blik, required W Function() boleto, required W Function() cashapp, required W Function() crypto, required W Function() customerBalance, required W Function() eps, required W Function() fpx, required W Function() giropay, required W Function() grabpay, required W Function() ideal, required W Function() kakaoPay, required W Function() klarna, required W Function() konbini, required W Function() krCard, required W Function() link, required W Function() mbWay, required W Function() mobilepay, required W Function() multibanco, required W Function() naverPay, required W Function() nzBankAccount, required W Function() oxxo, required W Function() p24, required W Function() payByBank, required W Function() payco, required W Function() paynow, required W Function() paypal, required W Function() payto, required W Function() pix, required W Function() promptpay, required W Function() revolutPay, required W Function() samsungPay, required W Function() satispay, required W Function() sepaDebit, required W Function() sofort, required W Function() swish, required W Function() twint, required W Function() usBankAccount, required W Function() wechatPay, required W Function() zip, required W Function(String value) $unknown, }) { return switch (this) {
      PaymentMethodDataType$acssDebit() => acssDebit(),
      PaymentMethodDataType$affirm() => affirm(),
      PaymentMethodDataType$afterpayClearpay() => afterpayClearpay(),
      PaymentMethodDataType$alipay() => alipay(),
      PaymentMethodDataType$alma() => alma(),
      PaymentMethodDataType$amazonPay() => amazonPay(),
      PaymentMethodDataType$auBecsDebit() => auBecsDebit(),
      PaymentMethodDataType$bacsDebit() => bacsDebit(),
      PaymentMethodDataType$bancontact() => bancontact(),
      PaymentMethodDataType$billie() => billie(),
      PaymentMethodDataType$blik() => blik(),
      PaymentMethodDataType$boleto() => boleto(),
      PaymentMethodDataType$cashapp() => cashapp(),
      PaymentMethodDataType$crypto() => crypto(),
      PaymentMethodDataType$customerBalance() => customerBalance(),
      PaymentMethodDataType$eps() => eps(),
      PaymentMethodDataType$fpx() => fpx(),
      PaymentMethodDataType$giropay() => giropay(),
      PaymentMethodDataType$grabpay() => grabpay(),
      PaymentMethodDataType$ideal() => ideal(),
      PaymentMethodDataType$kakaoPay() => kakaoPay(),
      PaymentMethodDataType$klarna() => klarna(),
      PaymentMethodDataType$konbini() => konbini(),
      PaymentMethodDataType$krCard() => krCard(),
      PaymentMethodDataType$link() => link(),
      PaymentMethodDataType$mbWay() => mbWay(),
      PaymentMethodDataType$mobilepay() => mobilepay(),
      PaymentMethodDataType$multibanco() => multibanco(),
      PaymentMethodDataType$naverPay() => naverPay(),
      PaymentMethodDataType$nzBankAccount() => nzBankAccount(),
      PaymentMethodDataType$oxxo() => oxxo(),
      PaymentMethodDataType$p24() => p24(),
      PaymentMethodDataType$payByBank() => payByBank(),
      PaymentMethodDataType$payco() => payco(),
      PaymentMethodDataType$paynow() => paynow(),
      PaymentMethodDataType$paypal() => paypal(),
      PaymentMethodDataType$payto() => payto(),
      PaymentMethodDataType$pix() => pix(),
      PaymentMethodDataType$promptpay() => promptpay(),
      PaymentMethodDataType$revolutPay() => revolutPay(),
      PaymentMethodDataType$samsungPay() => samsungPay(),
      PaymentMethodDataType$satispay() => satispay(),
      PaymentMethodDataType$sepaDebit() => sepaDebit(),
      PaymentMethodDataType$sofort() => sofort(),
      PaymentMethodDataType$swish() => swish(),
      PaymentMethodDataType$twint() => twint(),
      PaymentMethodDataType$usBankAccount() => usBankAccount(),
      PaymentMethodDataType$wechatPay() => wechatPay(),
      PaymentMethodDataType$zip() => zip(),
      PaymentMethodDataType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? acssDebit, W Function()? affirm, W Function()? afterpayClearpay, W Function()? alipay, W Function()? alma, W Function()? amazonPay, W Function()? auBecsDebit, W Function()? bacsDebit, W Function()? bancontact, W Function()? billie, W Function()? blik, W Function()? boleto, W Function()? cashapp, W Function()? crypto, W Function()? customerBalance, W Function()? eps, W Function()? fpx, W Function()? giropay, W Function()? grabpay, W Function()? ideal, W Function()? kakaoPay, W Function()? klarna, W Function()? konbini, W Function()? krCard, W Function()? link, W Function()? mbWay, W Function()? mobilepay, W Function()? multibanco, W Function()? naverPay, W Function()? nzBankAccount, W Function()? oxxo, W Function()? p24, W Function()? payByBank, W Function()? payco, W Function()? paynow, W Function()? paypal, W Function()? payto, W Function()? pix, W Function()? promptpay, W Function()? revolutPay, W Function()? samsungPay, W Function()? satispay, W Function()? sepaDebit, W Function()? sofort, W Function()? swish, W Function()? twint, W Function()? usBankAccount, W Function()? wechatPay, W Function()? zip, W Function(String value)? $unknown, }) { return switch (this) {
      PaymentMethodDataType$acssDebit() => acssDebit != null ? acssDebit() : orElse(value),
      PaymentMethodDataType$affirm() => affirm != null ? affirm() : orElse(value),
      PaymentMethodDataType$afterpayClearpay() => afterpayClearpay != null ? afterpayClearpay() : orElse(value),
      PaymentMethodDataType$alipay() => alipay != null ? alipay() : orElse(value),
      PaymentMethodDataType$alma() => alma != null ? alma() : orElse(value),
      PaymentMethodDataType$amazonPay() => amazonPay != null ? amazonPay() : orElse(value),
      PaymentMethodDataType$auBecsDebit() => auBecsDebit != null ? auBecsDebit() : orElse(value),
      PaymentMethodDataType$bacsDebit() => bacsDebit != null ? bacsDebit() : orElse(value),
      PaymentMethodDataType$bancontact() => bancontact != null ? bancontact() : orElse(value),
      PaymentMethodDataType$billie() => billie != null ? billie() : orElse(value),
      PaymentMethodDataType$blik() => blik != null ? blik() : orElse(value),
      PaymentMethodDataType$boleto() => boleto != null ? boleto() : orElse(value),
      PaymentMethodDataType$cashapp() => cashapp != null ? cashapp() : orElse(value),
      PaymentMethodDataType$crypto() => crypto != null ? crypto() : orElse(value),
      PaymentMethodDataType$customerBalance() => customerBalance != null ? customerBalance() : orElse(value),
      PaymentMethodDataType$eps() => eps != null ? eps() : orElse(value),
      PaymentMethodDataType$fpx() => fpx != null ? fpx() : orElse(value),
      PaymentMethodDataType$giropay() => giropay != null ? giropay() : orElse(value),
      PaymentMethodDataType$grabpay() => grabpay != null ? grabpay() : orElse(value),
      PaymentMethodDataType$ideal() => ideal != null ? ideal() : orElse(value),
      PaymentMethodDataType$kakaoPay() => kakaoPay != null ? kakaoPay() : orElse(value),
      PaymentMethodDataType$klarna() => klarna != null ? klarna() : orElse(value),
      PaymentMethodDataType$konbini() => konbini != null ? konbini() : orElse(value),
      PaymentMethodDataType$krCard() => krCard != null ? krCard() : orElse(value),
      PaymentMethodDataType$link() => link != null ? link() : orElse(value),
      PaymentMethodDataType$mbWay() => mbWay != null ? mbWay() : orElse(value),
      PaymentMethodDataType$mobilepay() => mobilepay != null ? mobilepay() : orElse(value),
      PaymentMethodDataType$multibanco() => multibanco != null ? multibanco() : orElse(value),
      PaymentMethodDataType$naverPay() => naverPay != null ? naverPay() : orElse(value),
      PaymentMethodDataType$nzBankAccount() => nzBankAccount != null ? nzBankAccount() : orElse(value),
      PaymentMethodDataType$oxxo() => oxxo != null ? oxxo() : orElse(value),
      PaymentMethodDataType$p24() => p24 != null ? p24() : orElse(value),
      PaymentMethodDataType$payByBank() => payByBank != null ? payByBank() : orElse(value),
      PaymentMethodDataType$payco() => payco != null ? payco() : orElse(value),
      PaymentMethodDataType$paynow() => paynow != null ? paynow() : orElse(value),
      PaymentMethodDataType$paypal() => paypal != null ? paypal() : orElse(value),
      PaymentMethodDataType$payto() => payto != null ? payto() : orElse(value),
      PaymentMethodDataType$pix() => pix != null ? pix() : orElse(value),
      PaymentMethodDataType$promptpay() => promptpay != null ? promptpay() : orElse(value),
      PaymentMethodDataType$revolutPay() => revolutPay != null ? revolutPay() : orElse(value),
      PaymentMethodDataType$samsungPay() => samsungPay != null ? samsungPay() : orElse(value),
      PaymentMethodDataType$satispay() => satispay != null ? satispay() : orElse(value),
      PaymentMethodDataType$sepaDebit() => sepaDebit != null ? sepaDebit() : orElse(value),
      PaymentMethodDataType$sofort() => sofort != null ? sofort() : orElse(value),
      PaymentMethodDataType$swish() => swish != null ? swish() : orElse(value),
      PaymentMethodDataType$twint() => twint != null ? twint() : orElse(value),
      PaymentMethodDataType$usBankAccount() => usBankAccount != null ? usBankAccount() : orElse(value),
      PaymentMethodDataType$wechatPay() => wechatPay != null ? wechatPay() : orElse(value),
      PaymentMethodDataType$zip() => zip != null ? zip() : orElse(value),
      PaymentMethodDataType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
