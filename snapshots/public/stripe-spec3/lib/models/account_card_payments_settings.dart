...
// Source: #/components/schemas/AccountCardPaymentsSettings
...
if (statementDescriptorPrefix$ != null) {
  if (statementDescriptorPrefix$.runes.length > 5000) { errors.add('statementDescriptorPrefix: length must be <= 5000'); }
}
final statementDescriptorPrefixKana$ = statementDescriptorPrefixKana;
if (statementDescriptorPrefixKana$ != null) {
  if (statementDescriptorPrefixKana$.runes.length > 5000) { errors.add('statementDescriptorPrefixKana: length must be <= 5000'); }
}
final statementDescriptorPrefixKanji$ = statementDescriptorPrefixKanji;
if (statementDescriptorPrefixKanji$ != null) {
  if (statementDescriptorPrefixKanji$.runes.length > 5000) { errors.add('statementDescriptorPrefixKanji: length must be <= 5000'); }
}
return errors; } 
