...
// Source: #/components/schemas/PostTerminalReadersReaderCollectInputsRequest (inline: Inputs > CustomText)
...
if (skipButton$ != null) {
  if (skipButton$.runes.length > 14) { errors.add('skipButton: length must be <= 14'); }
}
final submitButton$ = submitButton;
if (submitButton$ != null) {
  if (submitButton$.runes.length > 30) { errors.add('submitButton: length must be <= 30'); }
}
if (title.runes.length > 40) { errors.add('title: length must be <= 40'); }
return errors; } 
