...
// Source: #/components/schemas/PostTerminalReadersReaderCollectInputsRequest (inline: Inputs > Selection)
...
@override int get hashCode => Object.hashAll(choices);

@override String toString() => 'Selection(choices: $choices)';
