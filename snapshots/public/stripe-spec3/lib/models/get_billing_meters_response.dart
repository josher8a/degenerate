...
// Source: #/components/schemas/GetBillingMetersResponse
...
if (!RegExp('^/v1/billing/meters').hasMatch(url)) { errors.add('url: must match pattern ^/v1/billing/meters'); }
return errors; } 
...
@override String toString() => 'GetBillingMetersResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
