...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';final class PubStripeSpec3Security {const PubStripeSpec3Security._();

static final securitySchemes = <String, ApiSecurityScheme>{'basicAuth': const ApiSecurityScheme(name: 'basicAuth', type: ApiSecuritySchemeType.http, scheme: 'basic'), 'bearerAuth': const ApiSecurityScheme(name: 'bearerAuth', type: ApiSecuritySchemeType.http, scheme: 'bearer', bearerFormat: 'auth-scheme')};
