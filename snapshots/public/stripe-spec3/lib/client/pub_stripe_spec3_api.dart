...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'pub_stripe_spec3_security.dart';import '../apis/default_api.dart';/// Root SDK client providing access to all API groups.
///
/// ```dart
