...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_speakeasy/models/one_of_collection_enum.dart';import 'package:pub_speakeasy/models/simple_object2.dart';@immutable final class OneOfCollectionEnumResponse {const OneOfCollectionEnumResponse({this.json});

factory OneOfCollectionEnumResponse.fromJson(Map<String, dynamic> json) { return OneOfCollectionEnumResponse(
  json: json['json'] != null ? OneOf3.parse(json['json'], fromA: (v) => v as String, fromB: (v) => SimpleObject2.fromJson(v as Map<String, dynamic>), fromC: (v) => (v as List<dynamic>).map((e) => OneOfCollectionEnumVariant3.fromJson(e as String)).toList(),) : null,
); }
