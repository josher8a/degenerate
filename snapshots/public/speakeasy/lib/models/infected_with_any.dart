...
factory InfectedWithAny.fromJson(Map<String, dynamic> json) { return InfectedWithAny(
  data: OneOf3.parse(json['data'], fromA: (v) => SimpleObject.fromJson(v as Map<String, dynamic>), fromB: (v) => DeepObject.fromJson(v as Map<String, dynamic>), fromC: (v) => v as Map<String, dynamic>, greedy: const {2},),
); }
