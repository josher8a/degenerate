...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_speakeasy/models/deep_object/any.dart';import 'package:pub_speakeasy/models/simple_object.dart';@immutable final class DeepObject {const DeepObject({required this.str, required this.$bool, required this.$int, required this.$num, required this.obj, required this.map, required this.arr, required this.any, this.type, });
...
DeepObject copyWith({String? str, bool? $bool, int? $int, double? $num, SimpleObject? obj, Map<String,SimpleObject>? map, List<SimpleObject>? arr, Any? any, String? Function()? type, }) { return DeepObject(
  str: str ?? this.str,
  $bool: $bool ?? this.$bool,
  $int: $int ?? this.$int,
  $num: $num ?? this.$num,
