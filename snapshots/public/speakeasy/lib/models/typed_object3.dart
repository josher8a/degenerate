...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TypedObject3Type {const TypedObject3Type._(this.value);

factory TypedObject3Type.fromJson(String json) { return switch (json) {
  'obj3' => obj3,
  _ => TypedObject3Type._(json),
}; }

static const TypedObject3Type obj3 = TypedObject3Type._('obj3');
...
@override bool operator ==(Object other) => identical(this, other) ||
    other is TypedObject3Type && other.value == value;
