...
DeepObject2 copyWith({String? str, bool? $bool, int? $int, double? $num, SimpleObject2? obj, Map<String,SimpleObject2>? map, List<SimpleObject2>? arr, Any? any, String? Function()? type, }) { return DeepObject2(
  str: str ?? this.str,
  $bool: $bool ?? this.$bool,
  $int: $int ?? this.$int,
  $num: $num ?? this.$num,
...
@override String toString() => 'DeepObject2(\n  str: $str,\n  \$bool: ${$bool},\n  \$int: ${$int},\n  \$num: ${$num},\n  obj: $obj,\n  map: $map,\n  arr: $arr,\n  any: $any,\n  type: $type,\n)';
