...
// Source: #/components/schemas/JsonQueryParamsObjectResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_speakeasy/models/json_query_params_object_response/json_query_params_object_response_args.dart';@immutable final class JsonQueryParamsObjectResponse {const JsonQueryParamsObjectResponse({required this.url, required this.args, });

factory JsonQueryParamsObjectResponse.fromJson(Map<String, dynamic> json) { return JsonQueryParamsObjectResponse(
...
JsonQueryParamsObjectResponse copyWith({String? url, JsonQueryParamsObjectResponseArgs? args, }) { return JsonQueryParamsObjectResponse(
  url: url ?? this.url,
  args: args ?? this.args,
); } 
@override bool operator ==(Object other) => identical(this, other) ||
      other is JsonQueryParamsObjectResponse &&
          url == other.url &&
          args == other.args;

@override int get hashCode => Object.hash(url, args);

@override String toString() => 'JsonQueryParamsObjectResponse(url: $url, args: $args)';
