...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_speakeasy/models/enum2.dart';@immutable final class NestedEnumMap {const NestedEnumMap({required this.tags, required this.enums, });
...
NestedEnumMap copyWith({String? tags, Map<String,Enum2>? enums, }) { return NestedEnumMap(
  tags: tags ?? this.tags,
