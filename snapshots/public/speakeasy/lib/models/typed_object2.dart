...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_speakeasy/models/typed_object22/typed_object22_type.dart';@immutable final class TypedObject2 {const TypedObject2({required this.type, required this.value, });
...
TypedObject2 copyWith({TypedObject22Type? type, String? value, }) { return TypedObject2(
  type: type ?? this.type,
