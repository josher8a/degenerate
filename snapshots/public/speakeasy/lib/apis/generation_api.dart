...
return execute(
  ...
  onSuccess: (response) {
    ...
    return json.map((e) => ArrayCircularReferenceObject3.fromJson(e as Map<String, dynamic>)).toList();
  },
);
 } 
///
