...
W when<W>({required W Function() $empty, required W Function() $empty2, required W Function(String value) $unknown, }) { return switch (this) {
      TestEnumParametersEnumHeaderStringArray$$empty() => $empty(),
      TestEnumParametersEnumHeaderStringArray$$empty2() => $empty2(),
      TestEnumParametersEnumHeaderStringArray$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? $empty, W Function()? $empty2, W Function(String value)? $unknown, }) { return switch (this) {
      TestEnumParametersEnumHeaderStringArray$$empty() => $empty != null ? $empty() : orElse(value),
      TestEnumParametersEnumHeaderStringArray$$empty2() => $empty2 != null ? $empty2() : orElse(value),
      TestEnumParametersEnumHeaderStringArray$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
