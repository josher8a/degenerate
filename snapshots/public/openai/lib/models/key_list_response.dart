...
// Source: #/components/schemas/KeyListResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_openai/models/container_file_list_resource/container_file_list_resource_object.dart';import 'package:pub_openai/models/key3.dart';@immutable final class KeyListResponse {const KeyListResponse({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
...
KeyListResponse copyWith({ContainerFileListResourceObject? object, List<Key3>? data, String? firstId, String? lastId, bool? hasMore, }) { return KeyListResponse(
