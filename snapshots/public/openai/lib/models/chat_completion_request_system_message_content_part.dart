...
factory ChatCompletionRequestSystemMessageContentPart.fromJson(Object? json) {   if (json is Map<String, dynamic> && ChatCompletionRequestMessageContentPartText.canParse(json)) {
