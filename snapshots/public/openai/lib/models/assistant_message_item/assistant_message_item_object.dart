...
W when<W>({required W Function() chatkitThreadItem, required W Function(String value) $unknown, }) { return switch (this) {
      AssistantMessageItemObject$chatkitThreadItem() => chatkitThreadItem(),
      AssistantMessageItemObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? chatkitThreadItem, W Function(String value)? $unknown, }) { return switch (this) {
      AssistantMessageItemObject$chatkitThreadItem() => chatkitThreadItem != null ? chatkitThreadItem() : orElse(value),
      AssistantMessageItemObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
