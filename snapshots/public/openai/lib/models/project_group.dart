...
W when<W>({required W Function() projectGroup, required W Function(String value) $unknown, }) { return switch (this) {
      ProjectGroupObject$projectGroup() => projectGroup(),
      ProjectGroupObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? projectGroup, W Function(String value)? $unknown, }) { return switch (this) {
      ProjectGroupObject$projectGroup() => projectGroup != null ? projectGroup() : orElse(value),
      ProjectGroupObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
