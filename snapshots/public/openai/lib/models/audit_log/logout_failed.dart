...
// Source: #/components/schemas/AuditLog (inline: LogoutFailed)

import 'package:degenerate_runtime/degenerate_runtime.dart';/// The details for events with this `type`.
@immutable final class LogoutFailed {const LogoutFailed({this.errorCode, this.errorMessage, });

factory LogoutFailed.fromJson(Map<String, dynamic> json) { return LogoutFailed(
...
LogoutFailed copyWith({String? Function()? errorCode, String? Function()? errorMessage, }) { return LogoutFailed(
