...
// Source: #/components/schemas/ListAuditLogsResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_openai/models/audit_log.dart';import 'package:pub_openai/models/container_file_list_resource/container_file_list_resource_object.dart';@immutable final class ListAuditLogsResponse {const ListAuditLogsResponse({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
...
ListAuditLogsResponse copyWith({ContainerFileListResourceObject? object, List<AuditLog>? data, String? firstId, String? lastId, bool? hasMore, }) { return ListAuditLogsResponse(
...
@override String toString() => 'ListAuditLogsResponse(object: $object, data: $data, firstId: $firstId, lastId: $lastId, hasMore: $hasMore)';
