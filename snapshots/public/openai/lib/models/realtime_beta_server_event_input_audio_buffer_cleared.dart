...
W when<W>({required W Function() inputAudioBufferCleared, required W Function(String value) $unknown, }) { return switch (this) {
      RealtimeBetaServerEventInputAudioBufferClearedType$inputAudioBufferCleared() => inputAudioBufferCleared(),
      RealtimeBetaServerEventInputAudioBufferClearedType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? inputAudioBufferCleared, W Function(String value)? $unknown, }) { return switch (this) {
      RealtimeBetaServerEventInputAudioBufferClearedType$inputAudioBufferCleared() => inputAudioBufferCleared != null ? inputAudioBufferCleared() : orElse(value),
      RealtimeBetaServerEventInputAudioBufferClearedType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event_id') && json['event_id'] is String &&
      json.containsKey('type') && json['type'] == 'input_audio_buffer.cleared'; } 
