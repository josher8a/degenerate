...
W when<W>({required W Function() textCompletion, required W Function(String value) $unknown, }) { return switch (this) {
      CreateCompletionResponseObject$textCompletion() => textCompletion(),
      CreateCompletionResponseObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? textCompletion, W Function(String value)? $unknown, }) { return switch (this) {
      CreateCompletionResponseObject$textCompletion() => textCompletion != null ? textCompletion() : orElse(value),
      CreateCompletionResponseObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
