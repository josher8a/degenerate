...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'wandb' &&
...
@override String toString() => 'FineTuningIntegration(type: $type, wandb: $wandb)';
