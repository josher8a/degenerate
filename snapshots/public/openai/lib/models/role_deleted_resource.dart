...
W when<W>({required W Function() roleDeleted, required W Function(String value) $unknown, }) { return switch (this) {
      RoleDeletedResourceObject$roleDeleted() => roleDeleted(),
      RoleDeletedResourceObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? roleDeleted, W Function(String value)? $unknown, }) { return switch (this) {
      RoleDeletedResourceObject$roleDeleted() => roleDeleted != null ? roleDeleted() : orElse(value),
      RoleDeletedResourceObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
