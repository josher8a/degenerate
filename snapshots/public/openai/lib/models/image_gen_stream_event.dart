...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'image_gen_completed_event.dart';import 'image_gen_partial_image_event.dart';import 'images_usage.dart';sealed class ImageGenStreamEvent {const ImageGenStreamEvent();
...
factory ImageGenStreamEvent.imageGenerationPartialImage({required String b64Json, required int createdAt, required ImageGenPartialImageEventSize size, required ImageGenPartialImageEventQuality quality, required ImageGenPartialImageEventBackground background, required ImageGenPartialImageEventOutputFormat outputFormat, required int partialImageIndex, }) { return ImageGenStreamEventImageGenerationPartialImage(ImageGenPartialImageEvent(type: 'image_generation.partial_image', b64Json: b64Json, createdAt: createdAt, size: size, quality: quality, background: background, outputFormat: outputFormat, partialImageIndex: partialImageIndex)); }

/// Build the `image_generation.completed` variant.
factory ImageGenStreamEvent.imageGenerationCompleted({required String b64Json, required int createdAt, required ImageGenCompletedEventSize size, required ImageGenCompletedEventQuality quality, required ImageGenCompletedEventBackground background, required ImageGenCompletedEventOutputFormat outputFormat, required ImagesUsage usage, }) { return ImageGenStreamEventImageGenerationCompleted(ImageGenCompletedEvent(type: 'image_generation.completed', b64Json: b64Json, createdAt: createdAt, size: size, quality: quality, background: background, outputFormat: outputFormat, usage: usage)); }
