...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'log_prob_properties.dart';import 'realtime_conversation_item.dart';import 'realtime_response.dart';import 'realtime_server_event_conversation_created.dart';import 'realtime_server_event_conversation_created_conversation.dart';import 'realtime_server_event_conversation_item_added.dart';import 'realtime_server_event_conversation_item_created.dart';import 'realtime_server_event_conversation_item_deleted.dart';import 'realtime_server_event_conversation_item_done.dart';import 'realtime_server_event_conversation_item_input_audio_transcription_completed.dart';import 'realtime_server_event_conversation_item_input_audio_transcription_completed_usage.dart';import 'realtime_server_event_conversation_item_input_audio_transcription_delta.dart';import 'realtime_server_event_conversation_item_input_audio_transcription_failed.dart';import 'realtime_server_event_conversation_item_input_audio_transcription_failed_error.dart';import 'realtime_server_event_conversation_item_input_audio_transcription_segment.dart';import 'realtime_server_event_conversation_item_retrieved.dart';import 'realtime_server_event_conversation_item_truncated.dart';import 'realtime_server_event_error.dart';import 'realtime_server_event_error_error.dart';import 'realtime_server_event_input_audio_buffer_cleared.dart';import 'realtime_server_event_input_audio_buffer_committed.dart';import 'realtime_server_event_input_audio_buffer_dtmf_event_received.dart';import 'realtime_server_event_input_audio_buffer_speech_started.dart';import 'realtime_server_event_input_audio_buffer_speech_stopped.dart';import 'realtime_server_event_input_audio_buffer_timeout_triggered.dart';import 'realtime_server_event_mcp_list_tools_completed.dart';import 'realtime_server_event_mcp_list_tools_failed.dart';import 'realtime_server_event_mcp_list_tools_in_progress.dart';import 'realtime_server_event_output_audio_buffer_cleared.dart';import 'realtime_server_event_output_audio_buffer_started.dart';import 'realtime_server_event_output_audio_buffer_stopped.dart';import 'realtime_server_event_rate_limits_updated.dart';import 'realtime_server_event_rate_limits_updated_rate_limits.dart';import 'realtime_server_event_response_audio_delta.dart';import 'realtime_server_event_response_audio_done.dart';import 'realtime_server_event_response_audio_transcript_delta.dart';import 'realtime_server_event_response_audio_transcript_done.dart';import 'realtime_server_event_response_content_part_added.dart';import 'realtime_server_event_response_content_part_added_part.dart';import 'realtime_server_event_response_content_part_done.dart';import 'realtime_server_event_response_content_part_done_part.dart';import 'realtime_server_event_response_created.dart';import 'realtime_server_event_response_done.dart';import 'realtime_server_event_response_function_call_arguments_delta.dart';import 'realtime_server_event_response_function_call_arguments_done.dart';import 'realtime_server_event_response_mcp_call_arguments_delta.dart';import 'realtime_server_event_response_mcp_call_arguments_done.dart';import 'realtime_server_event_response_mcp_call_completed.dart';import 'realtime_server_event_response_mcp_call_failed.dart';import 'realtime_server_event_response_mcp_call_in_progress.dart';import 'realtime_server_event_response_output_item_added.dart';import 'realtime_server_event_response_output_item_done.dart';import 'realtime_server_event_response_text_delta.dart';import 'realtime_server_event_response_text_done.dart';import 'realtime_server_event_session_created.dart';import 'realtime_server_event_session_created_session.dart';import 'realtime_server_event_session_updated.dart';import 'realtime_server_event_session_updated_session.dart';/// A realtime server event.
/// 
...
factory RealtimeServerEvent.error({required String eventId, required RealtimeServerEventErrorError error, }) { return RealtimeServerEventError$Variant(RealtimeServerEventError(type: 'error', eventId: eventId, error: error)); }
...
factory RealtimeServerEvent.rateLimitsUpdated({required String eventId, required List<RealtimeServerEventRateLimitsUpdatedRateLimits> rateLimits, }) { return RealtimeServerEventRateLimitsUpdated$Variant(RealtimeServerEventRateLimitsUpdated(type: 'rate_limits.updated', eventId: eventId, rateLimits: rateLimits)); }
...
factory RealtimeServerEvent.responseContentPartAdded({required String eventId, required String responseId, required String itemId, required int outputIndex, required int contentIndex, required RealtimeServerEventResponseContentPartAddedPart $part, }) { return RealtimeServerEventResponseContentPartAdded$Variant(RealtimeServerEventResponseContentPartAdded(type: 'response.content_part.added', eventId: eventId, responseId: responseId, itemId: itemId, outputIndex: outputIndex, contentIndex: contentIndex, $part: $part)); }

/// Build the `response.content_part.done` variant.
factory RealtimeServerEvent.responseContentPartDone({required String eventId, required String responseId, required String itemId, required int outputIndex, required int contentIndex, required RealtimeServerEventResponseContentPartDonePart $part, }) { return RealtimeServerEventResponseContentPartDone$Variant(RealtimeServerEventResponseContentPartDone(type: 'response.content_part.done', eventId: eventId, responseId: responseId, itemId: itemId, outputIndex: outputIndex, contentIndex: contentIndex, $part: $part)); }
...
factory RealtimeServerEvent.sessionCreated({required String eventId, required RealtimeServerEventSessionCreatedSession session, }) { return RealtimeServerEventSessionCreated$Variant(RealtimeServerEventSessionCreated(type: 'session.created', eventId: eventId, session: session)); }

/// Build the `session.updated` variant.
factory RealtimeServerEvent.sessionUpdated({required String eventId, required RealtimeServerEventSessionUpdatedSession session, }) { return RealtimeServerEventSessionUpdated$Variant(RealtimeServerEventSessionUpdated(type: 'session.updated', eventId: eventId, session: session)); }
