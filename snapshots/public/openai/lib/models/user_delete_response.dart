...
W when<W>({required W Function() organizationUserDeleted, required W Function(String value) $unknown, }) { return switch (this) {
      UserDeleteResponseObject$organizationUserDeleted() => organizationUserDeleted(),
      UserDeleteResponseObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? organizationUserDeleted, W Function(String value)? $unknown, }) { return switch (this) {
      UserDeleteResponseObject$organizationUserDeleted() => organizationUserDeleted != null ? organizationUserDeleted() : orElse(value),
      UserDeleteResponseObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('object') && json['object'] == 'organization.user.deleted' &&
