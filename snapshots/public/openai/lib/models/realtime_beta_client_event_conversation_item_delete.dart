...
W when<W>({required W Function() conversationItemDelete, required W Function(String value) $unknown, }) { return switch (this) {
      RealtimeBetaClientEventConversationItemDeleteType$conversationItemDelete() => conversationItemDelete(),
      RealtimeBetaClientEventConversationItemDeleteType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? conversationItemDelete, W Function(String value)? $unknown, }) { return switch (this) {
      RealtimeBetaClientEventConversationItemDeleteType$conversationItemDelete() => conversationItemDelete != null ? conversationItemDelete() : orElse(value),
      RealtimeBetaClientEventConversationItemDeleteType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
