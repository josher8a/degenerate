...
// Source: #/components/schemas/RealtimeServerEventSessionCreated
...
@override String toString() => 'RealtimeServerEventSessionCreated(eventId: $eventId, type: $type, session: $session)';
