...
W when<W>({required W Function() threadRunStepDelta, required W Function(String value) $unknown, }) { return switch (this) {
      RunStepDeltaObjectObject$threadRunStepDelta() => threadRunStepDelta(),
      RunStepDeltaObjectObject$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? threadRunStepDelta, W Function(String value)? $unknown, }) { return switch (this) {
      RunStepDeltaObjectObject$threadRunStepDelta() => threadRunStepDelta != null ? threadRunStepDelta() : orElse(value),
      RunStepDeltaObjectObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
