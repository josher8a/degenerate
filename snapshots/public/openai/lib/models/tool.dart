...
factory Tool.imageGeneration({ImageGenToolModel? model, ImageEditCompletedEventQuality? quality, ImageEditCompletedEventSize? size, ImageEditCompletedEventOutputFormat? outputFormat, int? outputCompression, ImageGenToolModeration? moderation, ImageEditCompletedEventBackground? background, InputFidelity? inputFidelity, InputImageMask? inputImageMask, int? partialImages, ImageGenActionEnum? action, }) { return ToolImageGeneration(ImageGenTool(type: 'image_generation', model: model, quality: quality, size: size, outputFormat: outputFormat, outputCompression: outputCompression, moderation: moderation, background: background, inputFidelity: inputFidelity, inputImageMask: inputImageMask, partialImages: partialImages, action: action)); }
