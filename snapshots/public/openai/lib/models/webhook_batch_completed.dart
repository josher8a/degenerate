...
W when<W>({required W Function() batchCompleted, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookBatchCompletedType$batchCompleted() => batchCompleted(),
      WebhookBatchCompletedType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? batchCompleted, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookBatchCompletedType$batchCompleted() => batchCompleted != null ? batchCompleted() : orElse(value),
      WebhookBatchCompletedType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('created_at') && json['created_at'] is num &&
      ...
      json.containsKey('type') && json['type'] == 'batch.completed'; } 
