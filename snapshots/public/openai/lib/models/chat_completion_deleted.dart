...
W when<W>({required W Function() chatCompletionDeleted, required W Function(String value) $unknown, }) { return switch (this) {
      ChatCompletionDeletedObject$chatCompletionDeleted() => chatCompletionDeleted(),
      ChatCompletionDeletedObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? chatCompletionDeleted, W Function(String value)? $unknown, }) { return switch (this) {
      ChatCompletionDeletedObject$chatCompletionDeleted() => chatCompletionDeleted != null ? chatCompletionDeleted() : orElse(value),
      ChatCompletionDeletedObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('object') && json['object'] == 'chat.completion.deleted' &&
