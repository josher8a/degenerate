...
W when<W>({required W Function() responseCancel, required W Function(String value) $unknown, }) { return switch (this) {
      RealtimeBetaClientEventResponseCancelType$responseCancel() => responseCancel(),
      RealtimeBetaClientEventResponseCancelType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? responseCancel, W Function(String value)? $unknown, }) { return switch (this) {
      RealtimeBetaClientEventResponseCancelType$responseCancel() => responseCancel != null ? responseCancel() : orElse(value),
      RealtimeBetaClientEventResponseCancelType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'response.cancel'; } 
