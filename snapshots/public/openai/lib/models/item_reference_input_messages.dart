...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('type') && json['type'] == 'item_reference' &&
...
@override String toString() => 'ItemReferenceInputMessages(type: $type, itemReference: $itemReference)';
