...
// Source: #/components/schemas/RealtimeTranscriptionSessionCreateRequestGa (inline: Audio)
...
@override String toString() => 'RealtimeTranscriptionSessionCreateRequestGaAudio(input: $input)';
