...
W when<W>({required W Function() skillDeleted, required W Function(String value) $unknown, }) { return switch (this) {
      DeletedSkillResourceObject$skillDeleted() => skillDeleted(),
      DeletedSkillResourceObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? skillDeleted, W Function(String value)? $unknown, }) { return switch (this) {
      DeletedSkillResourceObject$skillDeleted() => skillDeleted != null ? skillDeleted() : orElse(value),
      DeletedSkillResourceObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
