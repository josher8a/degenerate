...
W when<W>({required W Function() supervised, required W Function() dpo, required W Function() reinforcement, required W Function(String value) $unknown, }) { return switch (this) {
      FineTuneMethodType$supervised() => supervised(),
      FineTuneMethodType$dpo() => dpo(),
      FineTuneMethodType$reinforcement() => reinforcement(),
      FineTuneMethodType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? supervised, W Function()? dpo, W Function()? reinforcement, W Function(String value)? $unknown, }) { return switch (this) {
      FineTuneMethodType$supervised() => supervised != null ? supervised() : orElse(value),
      FineTuneMethodType$dpo() => dpo != null ? dpo() : orElse(value),
      FineTuneMethodType$reinforcement() => reinforcement != null ? reinforcement() : orElse(value),
      FineTuneMethodType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
