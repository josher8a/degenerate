...
W when<W>({required W Function() fineTuningJobSucceeded, required W Function(String value) $unknown, }) { return switch (this) {
      WebhookFineTuningJobSucceededType$fineTuningJobSucceeded() => fineTuningJobSucceeded(),
      WebhookFineTuningJobSucceededType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? fineTuningJobSucceeded, W Function(String value)? $unknown, }) { return switch (this) {
      WebhookFineTuningJobSucceededType$fineTuningJobSucceeded() => fineTuningJobSucceeded != null ? fineTuningJobSucceeded() : orElse(value),
      WebhookFineTuningJobSucceededType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('created_at') && json['created_at'] is num &&
      ...
      json.containsKey('type') && json['type'] == 'fine_tuning.job.succeeded'; } 
