...
// Source: #/components/schemas/ContainerFileListResource

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_openai/models/container_file_list_resource/container_file_list_resource_object.dart';import 'package:pub_openai/models/container_file_resource.dart';@immutable final class ContainerFileListResource {const ContainerFileListResource({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
...
@override String toString() => 'ContainerFileListResource(object: $object, data: $data, firstId: $firstId, lastId: $lastId, hasMore: $hasMore)';
