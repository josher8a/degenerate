...
W when<W>({required W Function() responseCreated, required W Function(String value) $unknown, }) { return switch (this) {
      RealtimeBetaServerEventResponseCreatedType$responseCreated() => responseCreated(),
      RealtimeBetaServerEventResponseCreatedType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? responseCreated, W Function(String value)? $unknown, }) { return switch (this) {
      RealtimeBetaServerEventResponseCreatedType$responseCreated() => responseCreated != null ? responseCreated() : orElse(value),
      RealtimeBetaServerEventResponseCreatedType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event_id') && json['event_id'] is String &&
      json.containsKey('type') && json['type'] == 'response.created' &&
