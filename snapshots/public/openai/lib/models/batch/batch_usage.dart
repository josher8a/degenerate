...
BatchUsage copyWith({int? inputTokens, ResponseUsageInputTokensDetails? inputTokensDetails, int? outputTokens, OutputTokensDetails? outputTokensDetails, int? totalTokens, }) { return BatchUsage(
