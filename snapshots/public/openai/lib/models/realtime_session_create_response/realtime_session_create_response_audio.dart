...
// Source: #/components/schemas/RealtimeSessionCreateResponse (inline: Audio)
...
@override String toString() => 'RealtimeSessionCreateResponseAudio(input: $input, output: $output)';
