...
// Source: #/components/schemas/ListFineTuningCheckpointPermissionResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_openai/models/container_file_list_resource/container_file_list_resource_object.dart';import 'package:pub_openai/models/fine_tuning_checkpoint_permission.dart';@immutable final class ListFineTuningCheckpointPermissionResponse {const ListFineTuningCheckpointPermissionResponse({required this.data, required this.object, required this.hasMore, this.firstId, this.lastId, });
...
ListFineTuningCheckpointPermissionResponse copyWith({List<FineTuningCheckpointPermission>? data, ContainerFileListResourceObject? object, String? Function()? firstId, String? Function()? lastId, bool? hasMore, }) { return ListFineTuningCheckpointPermissionResponse(
  data: data ?? this.data,
