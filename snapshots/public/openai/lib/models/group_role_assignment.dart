...
W when<W>({required W Function() groupRole, required W Function(String value) $unknown, }) { return switch (this) {
      GroupRoleAssignmentObject$groupRole() => groupRole(),
      GroupRoleAssignmentObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? groupRole, W Function(String value)? $unknown, }) { return switch (this) {
      GroupRoleAssignmentObject$groupRole() => groupRole != null ? groupRole() : orElse(value),
      GroupRoleAssignmentObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
