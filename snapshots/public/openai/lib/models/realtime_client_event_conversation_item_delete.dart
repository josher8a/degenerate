...
if (eventId$ != null) {
  if (eventId$.runes.length > 512) { errors.add('eventId: length must be <= 512'); }
}
return errors; } 
...
@override String toString() => 'RealtimeClientEventConversationItemDelete(eventId: $eventId, type: $type, itemId: $itemId)';
