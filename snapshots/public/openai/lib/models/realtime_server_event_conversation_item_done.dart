...
// Source: #/components/schemas/RealtimeServerEventConversationItemDone
...
@override String toString() => 'RealtimeServerEventConversationItemDone(eventId: $eventId, type: $type, previousItemId: $previousItemId, item: $item)';
