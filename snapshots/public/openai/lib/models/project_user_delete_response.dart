...
W when<W>({required W Function() organizationProjectUserDeleted, required W Function(String value) $unknown, }) { return switch (this) {
      ProjectUserDeleteResponseObject$organizationProjectUserDeleted() => organizationProjectUserDeleted(),
      ProjectUserDeleteResponseObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? organizationProjectUserDeleted, W Function(String value)? $unknown, }) { return switch (this) {
      ProjectUserDeleteResponseObject$organizationProjectUserDeleted() => organizationProjectUserDeleted != null ? organizationProjectUserDeleted() : orElse(value),
      ProjectUserDeleteResponseObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
