...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_openai/models/context_management_param.dart';import 'package:pub_openai/models/conversation_param.dart';import 'package:pub_openai/models/create_response.dart';import 'package:pub_openai/models/create_response/prompt_cache_retention.dart';import 'package:pub_openai/models/create_response/truncation.dart';import 'package:pub_openai/models/include_enum.dart';import 'package:pub_openai/models/input_param.dart';import 'package:pub_openai/models/model_ids_responses.dart';import 'package:pub_openai/models/prompt.dart';import 'package:pub_openai/models/reasoning.dart';import 'package:pub_openai/models/response_stream_options.dart';import 'package:pub_openai/models/response_text_param.dart';import 'package:pub_openai/models/service_tier.dart';import 'package:pub_openai/models/tool.dart';import 'package:pub_openai/models/tool_choice_param.dart';sealed class ResponsesClientEventType {const ResponsesClientEventType();
...
factory ResponsesClientEvent.responseCreate({Map<String,String>? metadata, int? topLogprobs, double? temperature, double? topP, String? user, String? safetyIdentifier, String? promptCacheKey, ServiceTier? serviceTier, PromptCacheRetention? promptCacheRetention, String? previousResponseId, ModelIdsResponses? model, Reasoning? reasoning, bool? background, int? maxOutputTokens, int? maxToolCalls, ResponseTextParam? text, List<Tool>? tools, ToolChoiceParam? toolChoice, Prompt? prompt, Truncation? truncation, InputParam? input, List<IncludeEnum>? include, bool? parallelToolCalls, bool? store, String? instructions, bool? stream, ResponseStreamOptions? streamOptions, ConversationParam? conversation, List<ContextManagementParam>? contextManagement, }) { return ResponsesClientEventResponseCreate(CreateResponse(metadata: metadata, topLogprobs: topLogprobs, temperature: temperature, topP: topP, user: user, safetyIdentifier: safetyIdentifier, promptCacheKey: promptCacheKey, serviceTier: serviceTier, promptCacheRetention: promptCacheRetention, previousResponseId: previousResponseId, model: model, reasoning: reasoning, background: background, maxOutputTokens: maxOutputTokens, maxToolCalls: maxToolCalls, text: text, tools: tools, toolChoice: toolChoice, prompt: prompt, truncation: truncation, input: input, include: include, parallelToolCalls: parallelToolCalls, store: store, instructions: instructions, stream: stream, streamOptions: streamOptions, conversation: conversation, contextManagement: contextManagement)); }
