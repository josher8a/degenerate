...
W when<W>({required W Function() userRole, required W Function(String value) $unknown, }) { return switch (this) {
      UserRoleAssignmentObject$userRole() => userRole(),
      UserRoleAssignmentObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? userRole, W Function(String value)? $unknown, }) { return switch (this) {
      UserRoleAssignmentObject$userRole() => userRole != null ? userRole() : orElse(value),
      UserRoleAssignmentObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
