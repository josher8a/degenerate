...
W when<W>({required W Function() threadRunExpired, required W Function(String value) $unknown, }) { return switch (this) {
      ThreadRunExpiredEvent$threadRunExpired() => threadRunExpired(),
      ThreadRunExpiredEvent$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? threadRunExpired, W Function(String value)? $unknown, }) { return switch (this) {
      ThreadRunExpiredEvent$threadRunExpired() => threadRunExpired != null ? threadRunExpired() : orElse(value),
      ThreadRunExpiredEvent$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event') && json['event'] == 'thread.run.expired' &&
