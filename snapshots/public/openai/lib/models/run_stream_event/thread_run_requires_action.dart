...
W when<W>({required W Function() threadRunRequiresAction, required W Function(String value) $unknown, }) { return switch (this) {
      ThreadRunRequiresActionEvent$threadRunRequiresAction() => threadRunRequiresAction(),
      ThreadRunRequiresActionEvent$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? threadRunRequiresAction, W Function(String value)? $unknown, }) { return switch (this) {
      ThreadRunRequiresActionEvent$threadRunRequiresAction() => threadRunRequiresAction != null ? threadRunRequiresAction() : orElse(value),
      ThreadRunRequiresActionEvent$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event') && json['event'] == 'thread.run.requires_action' &&
