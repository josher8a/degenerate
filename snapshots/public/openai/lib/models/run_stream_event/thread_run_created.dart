...
W when<W>({required W Function() threadRunCreated, required W Function(String value) $unknown, }) { return switch (this) {
      ThreadRunCreatedEvent$threadRunCreated() => threadRunCreated(),
      ThreadRunCreatedEvent$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? threadRunCreated, W Function(String value)? $unknown, }) { return switch (this) {
      ThreadRunCreatedEvent$threadRunCreated() => threadRunCreated != null ? threadRunCreated() : orElse(value),
      ThreadRunCreatedEvent$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event') && json['event'] == 'thread.run.created' &&
