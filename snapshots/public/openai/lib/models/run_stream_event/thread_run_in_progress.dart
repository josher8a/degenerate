...
W when<W>({required W Function() threadRunInProgress, required W Function(String value) $unknown, }) { return switch (this) {
      ThreadRunInProgressEvent$threadRunInProgress() => threadRunInProgress(),
      ThreadRunInProgressEvent$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? threadRunInProgress, W Function(String value)? $unknown, }) { return switch (this) {
      ThreadRunInProgressEvent$threadRunInProgress() => threadRunInProgress != null ? threadRunInProgress() : orElse(value),
      ThreadRunInProgressEvent$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event') && json['event'] == 'thread.run.in_progress' &&
