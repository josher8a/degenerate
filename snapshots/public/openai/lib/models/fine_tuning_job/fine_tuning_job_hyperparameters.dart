...
// Source: #/components/schemas/FineTuningJob (inline: Hyperparameters)
...
@override String toString() => 'FineTuningJobHyperparameters(batchSize: $batchSize, learningRateMultiplier: $learningRateMultiplier, nEpochs: $nEpochs)';
