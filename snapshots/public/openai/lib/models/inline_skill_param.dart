...
W when<W>({required W Function() inline, required W Function(String value) $unknown, }) { return switch (this) {
      InlineSkillParamType$inline() => inline(),
      InlineSkillParamType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? inline, W Function(String value)? $unknown, }) { return switch (this) {
      InlineSkillParamType$inline() => inline != null ? inline() : orElse(value),
      InlineSkillParamType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
