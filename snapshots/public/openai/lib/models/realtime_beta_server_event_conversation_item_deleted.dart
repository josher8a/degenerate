...
W when<W>({required W Function() conversationItemDeleted, required W Function(String value) $unknown, }) { return switch (this) {
      RealtimeBetaServerEventConversationItemDeletedType$conversationItemDeleted() => conversationItemDeleted(),
      RealtimeBetaServerEventConversationItemDeletedType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? conversationItemDeleted, W Function(String value)? $unknown, }) { return switch (this) {
      RealtimeBetaServerEventConversationItemDeletedType$conversationItemDeleted() => conversationItemDeleted != null ? conversationItemDeleted() : orElse(value),
      RealtimeBetaServerEventConversationItemDeletedType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event_id') && json['event_id'] is String &&
      json.containsKey('type') && json['type'] == 'conversation.item.deleted' &&
