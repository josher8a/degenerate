...
W when<W>({required W Function() jsonObject, required W Function(String value) $unknown, }) { return switch (this) {
      ResponseFormatJsonObjectType$jsonObject() => jsonObject(),
      ResponseFormatJsonObjectType$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? jsonObject, W Function(String value)? $unknown, }) { return switch (this) {
      ResponseFormatJsonObjectType$jsonObject() => jsonObject != null ? jsonObject() : orElse(value),
      ResponseFormatJsonObjectType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
