...
W when<W>({required W Function() organizationProjectUser, required W Function(String value) $unknown, }) { return switch (this) {
      ProjectUserObject$organizationProjectUser() => organizationProjectUser(),
      ProjectUserObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? organizationProjectUser, W Function(String value)? $unknown, }) { return switch (this) {
      ProjectUserObject$organizationProjectUser() => organizationProjectUser != null ? organizationProjectUser() : orElse(value),
      ProjectUserObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('object') && json['object'] == 'organization.project.user' &&
