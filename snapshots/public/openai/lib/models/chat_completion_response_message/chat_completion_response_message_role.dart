...
W when<W>({required W Function() assistant, required W Function(String value) $unknown, }) { return switch (this) {
      ChatCompletionResponseMessageRole$assistant() => assistant(),
      ChatCompletionResponseMessageRole$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? assistant, W Function(String value)? $unknown, }) { return switch (this) {
      ChatCompletionResponseMessageRole$assistant() => assistant != null ? assistant() : orElse(value),
      ChatCompletionResponseMessageRole$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
