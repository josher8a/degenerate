...
factory ResponseStreamEvent.responseReasoningSummaryPartDone({required String itemId, required int outputIndex, required int summaryIndex, required int sequenceNumber, required ResponseReasoningSummaryPartDoneEventPart $part, }) { return ResponseStreamEventResponseReasoningSummaryPartDone(ResponseReasoningSummaryPartDoneEvent(type: 'response.reasoning_summary_part.done', itemId: itemId, outputIndex: outputIndex, summaryIndex: summaryIndex, sequenceNumber: sequenceNumber, $part: $part)); }
