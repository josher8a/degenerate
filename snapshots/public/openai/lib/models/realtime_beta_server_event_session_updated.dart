...
W when<W>({required W Function() sessionUpdated, required W Function(String value) $unknown, }) { return switch (this) {
      RealtimeBetaServerEventSessionUpdatedType$sessionUpdated() => sessionUpdated(),
      RealtimeBetaServerEventSessionUpdatedType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? sessionUpdated, W Function(String value)? $unknown, }) { return switch (this) {
      RealtimeBetaServerEventSessionUpdatedType$sessionUpdated() => sessionUpdated != null ? sessionUpdated() : orElse(value),
      RealtimeBetaServerEventSessionUpdatedType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event_id') && json['event_id'] is String &&
      json.containsKey('type') && json['type'] == 'session.updated' &&
