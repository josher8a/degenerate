...
@override int get hashCode => Object.hash(type, id, callId, status, output);

@override String toString() => 'ApplyPatchToolCallOutputItemParam(type: $type, id: $id, callId: $callId, status: $status, output: $output)';
