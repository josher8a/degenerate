...
W when<W>({required W Function() transcriptionSessionCreated, required W Function(String value) $unknown, }) { return switch (this) {
      RealtimeBetaServerEventTranscriptionSessionCreatedType$transcriptionSessionCreated() => transcriptionSessionCreated(),
      RealtimeBetaServerEventTranscriptionSessionCreatedType$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? transcriptionSessionCreated, W Function(String value)? $unknown, }) { return switch (this) {
      RealtimeBetaServerEventTranscriptionSessionCreatedType$transcriptionSessionCreated() => transcriptionSessionCreated != null ? transcriptionSessionCreated() : orElse(value),
      RealtimeBetaServerEventTranscriptionSessionCreatedType$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('event_id') && json['event_id'] is String &&
      json.containsKey('type') && json['type'] == 'transcription_session.created' &&
