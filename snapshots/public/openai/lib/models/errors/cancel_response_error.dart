...
sealed class CancelResponseError {
  const CancelResponseError();

  int get statusCode;

  factory CancelResponseError.fromResponse(ApiResponse response) {
    try {
...
final class CancelResponseError$404 extends CancelResponseError {
  const CancelResponseError$404(this.error);
  final ErrorModel error;
  @override
  int get statusCode => 404;
}

final class CancelResponseError$Unknown extends CancelResponseError {
  const CancelResponseError$Unknown(this.statusCode, this.rawBody);
  @override
