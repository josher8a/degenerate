...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_openai/models/error_response.dart';sealed class CreateProjectServiceAccountError {const CreateProjectServiceAccountError();

factory CreateProjectServiceAccountError.fromResponse(ApiResponse response) {     try {
