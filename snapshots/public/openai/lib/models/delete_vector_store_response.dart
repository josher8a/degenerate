...
W when<W>({required W Function() vectorStoreDeleted, required W Function(String value) $unknown, }) { return switch (this) {
      DeleteVectorStoreResponseObject$vectorStoreDeleted() => vectorStoreDeleted(),
      DeleteVectorStoreResponseObject$Unknown(:final value) => $unknown(value),
    }; } 
/// Partial match with a required fallback for unhandled variants.
W maybeWhen<W>({required W Function(String value) orElse, W Function()? vectorStoreDeleted, W Function(String value)? $unknown, }) { return switch (this) {
      DeleteVectorStoreResponseObject$vectorStoreDeleted() => vectorStoreDeleted != null ? vectorStoreDeleted() : orElse(value),
      DeleteVectorStoreResponseObject$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('id') && json['id'] is String &&
      ...
      json.containsKey('object') && json['object'] == 'vector_store.deleted'; } 
