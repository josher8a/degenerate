...
W when<W>({required W Function() stopped, required W Function(String value) $unknown, }) { return switch (this) {
      StreamEnumUpdateStatus$stopped() => stopped(),
      StreamEnumUpdateStatus$Unknown(:final value) => $unknown(value),
    }; } 
...
W maybeWhen<W>({required W Function(String value) orElse, W Function()? stopped, W Function(String value)? $unknown, }) { return switch (this) {
      StreamEnumUpdateStatus$stopped() => stopped != null ? stopped() : orElse(value),
      StreamEnumUpdateStatus$Unknown(:final value) => $unknown != null ? $unknown(value) : orElse(value),
    }; } 
