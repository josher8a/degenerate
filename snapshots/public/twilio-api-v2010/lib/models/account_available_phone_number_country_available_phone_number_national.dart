...
// Source: #/components/schemas/AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_twilio_api_v2010/models/account_available_phone_number_country_available_phone_number_local/capabilities.dart';@immutable final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational({this.friendlyName, this.phoneNumber, this.lata, this.locality, this.rateCenter, this.latitude, this.longitude, this.region, this.postalCode, this.isoCountry, this.addressRequirements, this.beta, this.capabilities, });
...
AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational copyWith({String? Function()? friendlyName, String? Function()? phoneNumber, String? Function()? lata, String? Function()? locality, String? Function()? rateCenter, double? Function()? latitude, double? Function()? longitude, String? Function()? region, String? Function()? postalCode, String? Function()? isoCountry, String? Function()? addressRequirements, bool? Function()? beta, Capabilities? Function()? capabilities, }) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational(
