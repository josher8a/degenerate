...
@override String toString() => 'ListIncomingPhoneNumberAssignedAddOnResponse(assignedAddOns: $assignedAddOns, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
