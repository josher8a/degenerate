...
// Source: #/components/schemas/CreateSiprecRequest
...
sealed class SiprecEnumTrack {const SiprecEnumTrack();
...
factory SiprecEnumTrack.fromJson(String json) { return switch (json) {
  ...
  _ => SiprecEnumTrack$Unknown(json),
}; }

static const SiprecEnumTrack inboundTrack = SiprecEnumTrack$inboundTrack._();

static const SiprecEnumTrack outboundTrack = SiprecEnumTrack$outboundTrack._();

static const SiprecEnumTrack bothTracks = SiprecEnumTrack$bothTracks._();
...
@immutable final class SiprecEnumTrack$inboundTrack extends SiprecEnumTrack {const SiprecEnumTrack$inboundTrack._();

@override String get value => 'inbound_track';

@override bool operator ==(Object other) => identical(this, other) || other is SiprecEnumTrack$inboundTrack;

@override int get hashCode => 'inbound_track'.hashCode;

 }
@immutable final class SiprecEnumTrack$outboundTrack extends SiprecEnumTrack {const SiprecEnumTrack$outboundTrack._();

@override String get value => 'outbound_track';

@override bool operator ==(Object other) => identical(this, other) || other is SiprecEnumTrack$outboundTrack;

@override int get hashCode => 'outbound_track'.hashCode;

 }
@immutable final class SiprecEnumTrack$bothTracks extends SiprecEnumTrack {const SiprecEnumTrack$bothTracks._();

@override String get value => 'both_tracks';

@override bool operator ==(Object other) => identical(this, other) || other is SiprecEnumTrack$bothTracks;

@override int get hashCode => 'both_tracks'.hashCode;

 }
@immutable final class SiprecEnumTrack$Unknown extends SiprecEnumTrack {const SiprecEnumTrack$Unknown(this.value);

@override final String value;

@override bool operator ==(Object other) => identical(this, other) ||
    other is SiprecEnumTrack$Unknown && other.value == value;
