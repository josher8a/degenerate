...
if (parentCallSid$ != null) {
  if (parentCallSid$.runes.length < 34) { errors.add('parentCallSid: length must be >= 34'); }
  if (parentCallSid$.runes.length > 34) { errors.add('parentCallSid: length must be <= 34'); }
...
if (phoneNumberSid$ != null) {
  if (phoneNumberSid$.runes.length < 34) { errors.add('phoneNumberSid: length must be >= 34'); }
  if (phoneNumberSid$.runes.length > 34) { errors.add('phoneNumberSid: length must be <= 34'); }
...
if (groupSid$ != null) {
  if (groupSid$.runes.length < 34) { errors.add('groupSid: length must be >= 34'); }
  if (groupSid$.runes.length > 34) { errors.add('groupSid: length must be <= 34'); }
