...
@override int get hashCode => Object.hash(Object.hashAll(authorizedConnectApps ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri);

@override String toString() => 'ListAuthorizedConnectAppResponse(authorizedConnectApps: $authorizedConnectApps, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
