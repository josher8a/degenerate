...
// Source: #/components/schemas/ListSipCredentialResponse

import 'package:degenerate_runtime/degenerate_runtime.dart';import 'package:pub_twilio_api_v2010/models/account_sip_sip_credential_list_sip_credential.dart';@immutable final class ListSipCredentialResponse {const ListSipCredentialResponse({this.credentials, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
