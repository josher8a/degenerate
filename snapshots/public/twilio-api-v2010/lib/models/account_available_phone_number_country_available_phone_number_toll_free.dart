...
// Source: #/components/schemas/AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree
...
@override String toString() => 'AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree(\n  friendlyName: $friendlyName,\n  phoneNumber: $phoneNumber,\n  lata: $lata,\n  locality: $locality,\n  rateCenter: $rateCenter,\n  latitude: $latitude,\n  longitude: $longitude,\n  region: $region,\n  postalCode: $postalCode,\n  isoCountry: $isoCountry,\n  addressRequirements: $addressRequirements,\n  beta: $beta,\n  capabilities: $capabilities,\n)';
