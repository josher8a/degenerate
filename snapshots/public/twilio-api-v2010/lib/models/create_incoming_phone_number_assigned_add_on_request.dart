...
// Source: #/components/schemas/CreateIncomingPhoneNumberAssignedAddOnRequest
...
if (installedAddOnSid.runes.length < 34) { errors.add('installedAddOnSid: length must be >= 34'); }
if (installedAddOnSid.runes.length > 34) { errors.add('installedAddOnSid: length must be <= 34'); }
