...
// Source: #/components/schemas/CreateSipAuthRegistrationsCredentialListMappingRequest
...
if (credentialListSid.runes.length < 34) { errors.add('credentialListSid: length must be >= 34'); }
if (credentialListSid.runes.length > 34) { errors.add('credentialListSid: length must be <= 34'); }
...
@override String toString() => 'CreateSipAuthRegistrationsCredentialListMappingRequest(credentialListSid: $credentialListSid)';
